...
// extern gboolean _gotk4_atk1_DocumentIface_set_document_attribute(AtkDocument*, gchar*, gchar*);
// extern gchar* _gotk4_atk1_DocumentIface_get_document_attribute_value(AtkDocument*, gchar*);
// extern gchar* _gotk4_atk1_DocumentIface_get_document_locale(AtkDocument*);
...
func ifaceInitDocumenter(gifacePtr, data C.gpointer) {
	iface := (*C.AtkDocumentIface)(unsafe.Pointer(gifacePtr))
	iface.get_current_page_number = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_current_page_number)
	iface.get_document = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_document)
	iface.get_document_attribute_value = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_document_attribute_value)
	iface.get_document_locale = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_document_locale)
	iface.get_document_type = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_document_type)
	iface.get_page_count = (*[0]byte)(C._gotk4_atk1_DocumentIface_get_page_count)
	iface.set_document_attribute = (*[0]byte)(C._gotk4_atk1_DocumentIface_set_document_attribute)
}

//export _gotk4_atk1_DocumentIface_get_current_page_number
func _gotk4_atk1_DocumentIface_get_current_page_number(arg0 *C.AtkDocument) (cret C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	gint := iface.CurrentPageNumber()
...
//export _gotk4_atk1_DocumentIface_get_document
func _gotk4_atk1_DocumentIface_get_document(arg0 *C.AtkDocument) (cret C.gpointer) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	gpointer := iface.Document()
...
//export _gotk4_atk1_DocumentIface_get_document_attribute_value
func _gotk4_atk1_DocumentIface_get_document_attribute_value(arg0 *C.AtkDocument, arg1 *C.gchar) (cret *C.gchar) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	var _attributeName string // out

	_attributeName = C.GoString((*C.gchar)(unsafe.Pointer(arg1)))

	utf8 := iface.DocumentAttributeValue(_attributeName)
...
//export _gotk4_atk1_DocumentIface_get_document_locale
func _gotk4_atk1_DocumentIface_get_document_locale(arg0 *C.AtkDocument) (cret *C.gchar) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	utf8 := iface.DocumentLocale()
...
//export _gotk4_atk1_DocumentIface_get_document_type
func _gotk4_atk1_DocumentIface_get_document_type(arg0 *C.AtkDocument) (cret *C.gchar) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	utf8 := iface.DocumentType()
...
//export _gotk4_atk1_DocumentIface_get_page_count
func _gotk4_atk1_DocumentIface_get_page_count(arg0 *C.AtkDocument) (cret C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)

	gint := iface.PageCount()
...
//export _gotk4_atk1_DocumentIface_set_document_attribute
func _gotk4_atk1_DocumentIface_set_document_attribute(arg0 *C.AtkDocument, arg1 *C.gchar, arg2 *C.gchar) (cret C.gboolean) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(DocumentOverrider)
	...
	ok := iface.SetDocumentAttribute(_attributeName, _attributeValue)
