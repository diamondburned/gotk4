...
// Hypertext: an interface used for objects which implement linking between
...
type Hypertext interface {
	...
	// Link gets the number of links within this hypertext document.
	Link(linkIndex int) Hyperlink
	// LinkIndex gets the number of links within this hypertext document.
