...
const (
	...
	StateTypeCheckable StateType = 39
	...
	StateTypeHasPopup StateType = 40
	// HasTooltip indicates this object has a tooltip. @Since: ATK-2.16
	StateTypeHasTooltip StateType = 41
