...
func (v *Object) Connect(detailedSignal string, f AnyClosure) SignalHandle {
...
func (v *Object) ConnectAfter(detailedSignal string, f AnyClosure) SignalHandle {
	return v.connectClosure(true, detailedSignal, f)
}

func (v *Object) connectClosure(after bool, detailedSignal string, f any) SignalHandle {
...
func NewClosure(v *Object, f AnyClosure) unsafe.Pointer {
...
func closureNew(v *Object, f any) *C.GClosure {
