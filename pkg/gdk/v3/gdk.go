...
func (d display) DeviceManager() DeviceManager {
	...
	var ret1 DeviceManager

	cret = C.gdk_display_get_device_manager(arg0)

	ret1 = gextras.CastObject(externglib.Take(unsafe.Pointer(cret.Native()))).(DeviceManager)
