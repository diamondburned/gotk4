...
// Calling this may change the current GL context.
	func CairoDrawFromGL(cr *cairo.Context, surface SurfaceClass, source int, sourceType int, bufferScale int, x int, y int, width int, height int)  {
...
// returns false.
	func EventsGetAngle(event1 EventClass, event2 EventClass) (float64, bool) {
...
// This assumes that both events have X/Y information. If not, this function
// returns false.
	func EventsGetCenter(event1 EventClass, event2 EventClass) (x float64, y float64, ok bool) {
var _arg1 *C.GdkEvent // out
var _arg2 *C.GdkEvent // out
var _arg3 C.double // in
...
// This assumes that both events have X/Y information. If not, this function
// returns false.
	func EventsGetDistance(event1 EventClass, event2 EventClass) (float64, bool) {
var _arg1 *C.GdkEvent // out
var _arg2 *C.GdkEvent // out
var _arg3 C.double // in
var _cret C.gboolean // in
...
// almost certainly convert the pixbuf back into a texture to draw it on screen.
	func PixbufGetFromTexture(texture TextureClass) gdkpixbuf.Pixbuf {
...
return _ok
	...
	// PaintableInterface contains virtual methods for Paintable, or
	// methods that can be overridden.
	type PaintableInterface interface {
		gextras.Objector
	...
	// nothing.
		Snapshot(snapshot SnapshotClass, width float64, height float64) 
...
// @width and @height are not larger than zero, this function will do nothing.
	func (p Paintable) Snapshot(snapshot SnapshotClass, width float64, height float64)  {
var _arg0 *C.GdkPaintable // out
...
// You might use this function to implement draggable titlebars.
	func (t Toplevel) BeginMove(device DeviceClass, button int, x float64, y float64, timestamp uint32)  {
...
// You might use this function to implement a “window resize grip.”
	func (t Toplevel) BeginResize(edge SurfaceEdge, device DeviceClass, button int, x float64, y float64, timestamp uint32)  {
var _arg0 *C.GdkToplevel // out
...
// listening to the [property@Gdk.Toplevel:shortcuts-inhibited] property.
	func (t Toplevel) InhibitSystemShortcuts(event EventClass)  {
var _arg0 *C.GdkToplevel // out
var _arg1 *C.GdkEvent // out
...
// or [class@Gtk.Dialog].
	func (t Toplevel) SetTransientFor(parent SurfaceClass)  {
var _arg0 *C.GdkToplevel // out
...
// decorations.
	func (t Toplevel) ShowWindowMenu(event EventClass) bool {
var _arg0 *C.GdkToplevel // out
var _arg1 *C.GdkEvent // out
var _cret C.gboolean // in
...
// to draw on that surface.
	...
	// CairoContextClass is an interface that the CairoContext class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type CairoContextClass interface {
		gextras.Objector
		_cairoContext()
	}

	func (CairoContext) _cairoContext() {}
...
// transfer the contents and then request that format from @provider.
	func (c Clipboard) SetContent(provider ContentProviderClass) bool {
var _arg0 *C.GdkClipboard // out
...
// Also see [class@Gdk.ContentSerializer].
	...
	// ContentDeserializerClass is an interface that the ContentDeserializer class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type ContentDeserializerClass interface {
		gextras.Objector
		_contentDeserializer()
	}

	func (ContentDeserializer) _contentDeserializer() {}
...
// to add support for application-specific data formats.
	...
	// ContentProviderClass is an interface that the ContentProvider class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type ContentProviderClass interface {
		gextras.Objector
		_contentProvider()
	}

	func (ContentProvider) _contentProvider() {}
...
// gdk_content_provider_new_typed (G_TYPE_TEXTURE, texture) }, 2); “`
	func NewContentProviderUnion(providers []ContentProviderClass) ContentProvider {
...
// Also see [class@Gdk.ContentDeserializer].
	...
	// ContentSerializerClass is an interface that the ContentSerializer class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type ContentSerializerClass interface {
		gextras.Objector
		_contentSerializer()
	}

	func (ContentSerializer) _contentSerializer() {}
...
// "zoom-out" | |
	func NewCursorFromName(name string, fallback CursorClass) Cursor {
var _arg1 *C.char // out
...
return _cursor
	...
	func NewCursorFromTexture(texture TextureClass, hotspotX int, hotspotY int, fallback CursorClass) Cursor {
var _arg1 *C.GdkTexture // out
var _arg2 C.int // out
var _arg3 C.int // out
...
// Returns a monitor close to @surface if it is outside of all monitors.
	func (d Display) MonitorAtSurface(surface SurfaceClass) Monitor {
var _arg0 *C.GdkDisplay // out
var _arg1 *C.GdkSurface // out
...
// used by applications.
	func (d Display) PutEvent(event EventClass)  {
var _arg0 *C.GdkDisplay // out
var _arg1 *C.GdkEvent // out
...
// section of the GTK documentation for more information.
	...
	// DragClass is an interface that the Drag class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type DragClass interface {
		gextras.Objector
		_drag()
	}
...
// A `GdkDrawContext` is always associated with a single toplevel surface.
	...
	// DrawContextClass is an interface that the DrawContext class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type DrawContextClass interface {
		gextras.Objector
		_drawContext()
	}

	func (DrawContext) _drawContext() {}
...
// section of the GTK documentation for more information.
	...
	// DropClass is an interface that the Drop class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type DropClass interface {
		gextras.Objector
		_drop()
	}
...
C.gdk_gl_context_set_use_es(_arg0, _arg1)
	...
	// GLTextureClass is an interface that the GLTexture class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type GLTextureClass interface {
		gextras.Objector
		_glTexture()
	}

	func (GLTexture) _glTexture() {}
...
C.gdk_gl_texture_release(_arg0)
	...
	// MemoryTextureClass is an interface that the MemoryTexture class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type MemoryTextureClass interface {
		gextras.Objector
		_memoryTexture()
	}

	func (MemoryTexture) _memoryTexture() {}
...
// but you will rarely interact with them directly.
	...
	// SurfaceClass is an interface that the Surface class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type SurfaceClass interface {
		gextras.Objector
		_surface()
	}

	func (Surface) _surface() {}
...
// using [method@Gdk.Popup.present].
	func NewSurfacePopup(parent SurfaceClass, autohide bool) Surface {
var _arg1 *C.GdkSurface // out
var _arg2 C.gboolean // out
var _cret *C.GdkSurface // in

_arg1 = (*C.GdkSurface)(unsafe.Pointer(parent.Native()))
if autohide { _arg2 = C.TRUE }
...
return _surface
	...
	func NewSurfaceToplevel(display DisplayClass) Surface {
var _arg1 *C.GdkDisplay // out
var _cret *C.GdkSurface // in
...
// specified surface, and it is using the cursor for its parent surface.
	func (s Surface) DeviceCursor(device DeviceClass) Cursor {
var _arg0 *C.GdkSurface // out
var _arg1 *C.GdkDevice // out
var _cret *C.GdkCursor // in
...
// @surface.
	func (s Surface) DevicePosition(device DeviceClass) (x float64, y float64, mask ModifierType, ok bool) {
var _arg0 *C.GdkSurface // out
var _arg1 *C.GdkDevice // out
var _arg2 C.double // in
var _arg3 C.double // in
...
// create the cursor. To make the cursor invisible, use GDK_BLANK_CURSOR.
	func (s Surface) SetCursor(cursor CursorClass)  {
var _arg0 *C.GdkSurface // out
...
// Use [ctor@Gdk.Cursor.new_from_name] or [ctor@Gdk.Cursor.new_from_texture] to
// create the cursor. To make the cursor invisible, use GDK_BLANK_CURSOR.
	func (s Surface) SetDeviceCursor(device DeviceClass, cursor CursorClass)  {
var _arg0 *C.GdkSurface // out
var _arg1 *C.GdkDevice // out
var _arg2 *C.GdkCursor // out
...
// about it other than increasing the reference count via g_object_ref().
	...
	// TextureClass is an interface that the Texture class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type TextureClass interface {
		gextras.Objector
		_texture()
	}

	func (Texture) _texture() {}
...
// `GdkPixbuf`.
	func NewTextureForPixbuf(pixbuf gdkpixbuf.PixbufClass) Texture {
...
// fail, returning nil context.
	...
	// VulkanContextClass is an interface that the VulkanContext class always
	// implements. It is only used for parameters that take in not just this
	// class but any other class that extends it.
	type VulkanContextClass interface {
		gextras.Objector
		_vulkanContext()
	}

	func (VulkanContext) _vulkanContext() {}
...
// endeavor.
	...
	func marshalContentFormats(p uintptr) (interface{}, error) {
		...
		return (*ContentFormats)(unsafe.Pointer(b))
	}
...
return _contentFormats
	...
	func (c *ContentFormats) Native() uintptr {
...
// used to create new `GdkContentFormats`, and should not be kept around.
	...
	func marshalContentFormatsBuilder(p uintptr) (interface{}, error) {
		b := C.g_value_get_boxed((*C.GValue)(unsafe.Pointer(p)))
		return (*ContentFormatsBuilder)(unsafe.Pointer(b))
	}
...
return _contentFormatsBuilder
	...
	// Native returns the underlying C source pointer.
	func (c *ContentFormatsBuilder) Native() uintptr {
		return uintptr(unsafe.Pointer(&c.Native))
	}
...
// be presented again.
	...
	func marshalPopupLayout(p uintptr) (interface{}, error) {
		b := C.g_value_get_boxed((*C.GValue)(unsafe.Pointer(p)))
		return (*PopupLayout)(unsafe.Pointer(b))
	}
...
return _popupLayout
	...
	// Native returns the underlying C source pointer.
	func (p *PopupLayout) Native() uintptr {
...
// various states (maximized, on all workspaces, etc).
	...
	func marshalToplevelLayout(p uintptr) (interface{}, error) {
		b := C.g_value_get_boxed((*C.GValue)(unsafe.Pointer(p)))
		return (*ToplevelLayout)(unsafe.Pointer(b))
	}
...
return _toplevelLayout
	...
	// Native returns the underlying C source pointer.
	func (t *ToplevelLayout) Native() uintptr {
		return uintptr(unsafe.Pointer(&t.Native))
	}
...
// fullscreen when presented.
	func (l *ToplevelLayout) SetFullscreen(fullscreen bool, monitor MonitorClass)  {
var _arg0 *C.GdkToplevelLayout // out
var _arg1 C.gboolean // out
var _arg2 *C.GdkMonitor // out

_arg0 = (*C.GdkToplevelLayout)(unsafe.Pointer(l.Native()))
if fullscreen { _arg1 = C.TRUE }
...
// useful to compute the size of a toplevel.
	...
	// Native returns the underlying C source pointer.
	func (t *ToplevelSize) Native() uintptr {
		return uintptr(unsafe.Pointer(&t.Native))
	}
