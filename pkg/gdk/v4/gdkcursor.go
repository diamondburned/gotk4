...
// "zoom-out" | |
func NewCursorFromName(name string, fallback Cursor) *CursorClass {
...
func NewCursorFromTexture(texture Texture, hotspotX int, hotspotY int, fallback Cursor) *CursorClass {
