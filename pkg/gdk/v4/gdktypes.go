...
func (f *ContentFormats) MIMETypes() (uint, []string) {
	var _arg0 *C.GdkContentFormats
	...
	cret = C.gdk_content_formats_get_mime_types(_arg0, &_arg1)

	var _nMimeTypes uint
	var _utf8s []string

	_nMimeTypes = (uint)(_arg1)
	{
		var length int
