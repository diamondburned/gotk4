...
func NewPixbufAnimationFromFile(filename string) (pixbufAnimation PixbufAnimation, err error) {
	...
	goret = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(cret.Native()))).(PixbufAnimation)
...
func (a pixbufAnimation) Iter(startTime *glib.TimeVal) PixbufAnimationIter {
	...
	cret := new(C.GdkPixbufAnimationIter)
	var goret PixbufAnimationIter

	cret = C.gdk_pixbuf_animation_get_iter(arg0, arg1)

	goret = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(cret.Native()))).(PixbufAnimationIter)
...
func (a pixbufAnimation) Ref() PixbufAnimation {
	...
	goret = gextras.CastObject(externglib.Take(unsafe.Pointer(cret.Native()))).(PixbufAnimation)
