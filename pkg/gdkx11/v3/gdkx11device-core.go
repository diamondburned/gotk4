...
// WrapX11DeviceCore wraps a GObject to a type that implements
// interface X11DeviceCore. It is primarily used internally.
func WrapX11DeviceCore(obj *externglib.Object) X11DeviceCore {
	return x11DeviceCore{obj}
}
