...
func (d x11Display) PrimaryMonitor() gdk.Monitor {
	...
	var goret1 gdk.Monitor

	cret = C.gdk_x11_display_get_primary_monitor(arg0)

	goret1 = gextras.CastObject(externglib.Take(unsafe.Pointer(cret.Native()))).(gdk.Monitor)
...
func (d x11Display) Screen() X11Screen {
	...
	var goret1 X11Screen

	cret = C.gdk_x11_display_get_screen(arg0)

	goret1 = gextras.CastObject(externglib.Take(unsafe.Pointer(cret.Native()))).(X11Screen)
...
func (d x11Display) SetSurfaceScale(scale int) {
	...
	C.gdk_x11_display_set_surface_scale(arg0, scale)
}

// StringToCompoundText: convert a string from the encoding of the current
// locale into a form suitable for storing in a window property.
func (d x11Display) StringToCompoundText(str string) (encoding string, format int, ctext []byte, length int, gint int) {
	var arg0 *C.GdkDisplay
	var arg1 *C.char
...
// UTF8ToCompoundText converts from UTF-8 to compound text.
func (d x11Display) UTF8ToCompoundText(str string) (encoding string, format int, ctext []byte, length int, ok bool) {
	var arg0 *C.GdkDisplay
	var arg1 *C.char
