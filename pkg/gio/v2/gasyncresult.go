...
func (r asyncResult) SourceObject() gextras.Objector {
	...
	arg0 = (*C.GAsyncResult)(r.Native())

	ret := C.g_async_result_get_source_object(arg0)
...
func (r asyncResult) UserData() interface{} {
	...
	ret := C.g_async_result_get_user_data(arg0)
...
func (r asyncResult) IsTagged(sourceTag interface{}) bool {
	...
	ret := C.g_async_result_is_tagged(arg0, arg1)
...
func (r asyncResult) LegacyPropagateError() error {
	...
	ret := C.g_async_result_legacy_propagate_error(arg0, &gError)
