...
func NewConverterOutputStream(baseStream OutputStream, converter Converter) ConverterOutputStream {
	...
	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(ConverterOutputStream)
...
func (c converterOutputStream) Converter() Converter {
	...
	arg0 = (*C.GConverterOutputStream)(c.Native())

	ret := C.g_converter_output_stream_get_converter(arg0)
