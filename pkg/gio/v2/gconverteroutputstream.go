...
// WrapConverterOutputStream wraps a GObject to a type that implements
// interface ConverterOutputStream. It is primarily used internally.
func WrapConverterOutputStream(obj *externglib.Object) ConverterOutputStream {
	return converterOutputStream{obj}
}
...
func (c converterOutputStream) AsFilterOutputStream() FilterOutputStream {
	return WrapFilterOutputStream(gextras.InternObject(c))
}
...
func (s converterOutputStream) GetCloseBaseStream() bool {
	return WrapFilterOutputStream(gextras.InternObject(s)).GetCloseBaseStream()
}

func (s converterOutputStream) SetCloseBaseStream(closeBase bool) {
	WrapFilterOutputStream(gextras.InternObject(s)).SetCloseBaseStream(closeBase)
}

func (s converterOutputStream) ClearPending() {
	WrapOutputStream(gextras.InternObject(s)).ClearPending()
}

func (s converterOutputStream) Close(cancellable Cancellable) error {
	return WrapOutputStream(gextras.InternObject(s)).Close(cancellable)
}

func (s converterOutputStream) CloseAsync(ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).CloseAsync(ioPriority, cancellable, callback)
}

func (s converterOutputStream) CloseFinish(result AsyncResult) error {
	return WrapOutputStream(gextras.InternObject(s)).CloseFinish(result)
}

func (s converterOutputStream) Flush(cancellable Cancellable) error {
	return WrapOutputStream(gextras.InternObject(s)).Flush(cancellable)
}

func (s converterOutputStream) FlushAsync(ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).FlushAsync(ioPriority, cancellable, callback)
}

func (s converterOutputStream) FlushFinish(result AsyncResult) error {
	return WrapOutputStream(gextras.InternObject(s)).FlushFinish(result)
}

func (s converterOutputStream) HasPending() bool {
	return WrapOutputStream(gextras.InternObject(s)).HasPending()
}

func (s converterOutputStream) IsClosed() bool {
	return WrapOutputStream(gextras.InternObject(s)).IsClosed()
}

func (s converterOutputStream) IsClosing() bool {
	return WrapOutputStream(gextras.InternObject(s)).IsClosing()
}

func (s converterOutputStream) SetPending() error {
	return WrapOutputStream(gextras.InternObject(s)).SetPending()
}

func (s converterOutputStream) Splice(source InputStream, flags OutputStreamSpliceFlags, cancellable Cancellable) (int, error) {
	return WrapOutputStream(gextras.InternObject(s)).Splice(source, flags, cancellable)
}

func (s converterOutputStream) SpliceAsync(source InputStream, flags OutputStreamSpliceFlags, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).SpliceAsync(source, flags, ioPriority, cancellable, callback)
}

func (s converterOutputStream) SpliceFinish(result AsyncResult) (int, error) {
	return WrapOutputStream(gextras.InternObject(s)).SpliceFinish(result)
}

func (s converterOutputStream) Write(buffer []byte, cancellable Cancellable) (int, error) {
	return WrapOutputStream(gextras.InternObject(s)).Write(buffer, cancellable)
}

func (s converterOutputStream) WriteAll(buffer []byte, cancellable Cancellable) (uint, error) {
	return WrapOutputStream(gextras.InternObject(s)).WriteAll(buffer, cancellable)
}

func (s converterOutputStream) WriteAllAsync(buffer []byte, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).WriteAllAsync(buffer, ioPriority, cancellable, callback)
}

func (s converterOutputStream) WriteAllFinish(result AsyncResult) (uint, error) {
	return WrapOutputStream(gextras.InternObject(s)).WriteAllFinish(result)
}

func (s converterOutputStream) WriteAsync(buffer []byte, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).WriteAsync(buffer, ioPriority, cancellable, callback)
}

func (s converterOutputStream) WriteBytesFinish(result AsyncResult) (int, error) {
	return WrapOutputStream(gextras.InternObject(s)).WriteBytesFinish(result)
}

func (s converterOutputStream) WriteFinish(result AsyncResult) (int, error) {
	return WrapOutputStream(gextras.InternObject(s)).WriteFinish(result)
}

func (s converterOutputStream) Writev(vectors []OutputVector, cancellable Cancellable) (uint, error) {
	return WrapOutputStream(gextras.InternObject(s)).Writev(vectors, cancellable)
}

func (s converterOutputStream) WritevAll(vectors []OutputVector, cancellable Cancellable) (uint, error) {
	return WrapOutputStream(gextras.InternObject(s)).WritevAll(vectors, cancellable)
}

func (s converterOutputStream) WritevAllAsync(vectors []OutputVector, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).WritevAllAsync(vectors, ioPriority, cancellable, callback)
}

func (s converterOutputStream) WritevAllFinish(result AsyncResult) (uint, error) {
	return WrapOutputStream(gextras.InternObject(s)).WritevAllFinish(result)
}

func (s converterOutputStream) WritevAsync(vectors []OutputVector, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapOutputStream(gextras.InternObject(s)).WritevAsync(vectors, ioPriority, cancellable, callback)
}

func (s converterOutputStream) WritevFinish(result AsyncResult) (uint, error) {
