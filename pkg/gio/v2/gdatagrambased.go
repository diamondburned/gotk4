...
type DatagramBasedOverrider interface {
	...
	// other error.
	ReceiveMessages(messages []InputMessage, flags int, timeout int64, cancellable Cancellable) (gint int, err error)
	...
	// @cancellable is cancelled, G_IO_ERROR_CANCELLED is returned as with any
	// other error.
	SendMessages(messages []OutputMessage, flags int, timeout int64, cancellable Cancellable) (gint int, err error)
}
...
func (d datagramBased) ConditionCheck(condition glib.IOCondition) glib.IOCondition {
	...
	arg0 = (*C.GDatagramBased)(d.Native())
	arg1 = (C.GIOCondition)(condition)

	ret := C.g_datagram_based_condition_check(arg0, arg1)
...
func (d datagramBased) ConditionWait(condition glib.IOCondition, timeout int64, cancellable Cancellable) error {
	...
	ret := C.g_datagram_based_condition_wait(arg0, arg1, arg2, arg3, &gError)
...
func (d datagramBased) CreateSource(condition glib.IOCondition, cancellable Cancellable) *glib.Source {
	...
	ret := C.g_datagram_based_create_source(arg0, arg1, arg2)
...
// @cancellable is cancelled, G_IO_ERROR_CANCELLED is returned as with any
// other error.
func (d datagramBased) ReceiveMessages(messages []InputMessage, flags int, timeout int64, cancellable Cancellable) (gint int, err error) {
	var arg0 *C.GDatagramBased
	...
	arg3 = C.gint(flags)
	arg4 = C.gint64(timeout)
	arg5 = (*C.GCancellable)(cancellable.Native())

	ret := C.g_datagram_based_receive_messages(arg0, arg1, arg2, arg3, arg4, arg5, &gError)
...
// @cancellable is cancelled, G_IO_ERROR_CANCELLED is returned as with any
// other error.
func (d datagramBased) SendMessages(messages []OutputMessage, flags int, timeout int64, cancellable Cancellable) (gint int, err error) {
	var arg0 *C.GDatagramBased
	...
	ret := C.g_datagram_based_send_messages(arg0, arg1, arg2, arg3, arg4, arg5, &gError)
