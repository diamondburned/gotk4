...
// Ref: if @info is statically allocated, does nothing. Otherwise decreases the
...
// CacheBuild: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
...
// CacheRelease: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
// the memory used is freed.
...
// LookupMethod: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
// the memory used is freed.
...
// LookupProperty: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
// the memory used is freed.
...
// LookupSignal: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
// the memory used is freed.
...
// LookupInterface: if @info is statically allocated, does nothing. Otherwise
// decreases the reference count of @info. When its reference count drops to 0,
// the memory used is freed.
