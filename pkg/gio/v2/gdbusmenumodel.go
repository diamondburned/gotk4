...
// DBusMenuModel obtains a BusMenuModel for the menu model which is exported at
...
// context unchanged.
func DBusMenuModel(connection *DBusConnection, busName string, objectPath string) *DBusMenuModel {
