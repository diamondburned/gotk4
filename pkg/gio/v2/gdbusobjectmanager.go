...
func (m dBusObjectManager) Interface(objectPath string, interfaceName string) DBusInterface {
	...
	arg0 = (*C.GDBusObjectManager)(m.Native())
	arg1 = (*C.gchar)(C.CString(objectPath))
	defer C.free(unsafe.Pointer(arg1))
	arg2 = (*C.gchar)(C.CString(interfaceName))
	defer C.free(unsafe.Pointer(arg2))

	ret := C.g_dbus_object_manager_get_interface(arg0, arg1, arg2)

	var ret0 DBusInterface

	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(DBusInterface)
...
func (m dBusObjectManager) Object(objectPath string) DBusObject {
	...
	ret := C.g_dbus_object_manager_get_object(arg0, arg1)

	var ret0 DBusObject

	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(DBusObject)
...
func (m dBusObjectManager) ObjectPath() string {
	...
	ret := C.g_dbus_object_manager_get_object_path(arg0)
...
func (m dBusObjectManager) Objects() *glib.List {
	...
	ret := C.g_dbus_object_manager_get_objects(arg0)
