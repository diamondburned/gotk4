...
func (c dtlsConnection) Close(cancellable Cancellable) error {
	...
	arg0 = (*C.GDtlsConnection)(c.Native())
	arg1 = (*C.GCancellable)(cancellable.Native())

	ret := C.g_dtls_connection_close(arg0, arg1, &gError)
...
func (c dtlsConnection) CloseFinish(result AsyncResult) error {
	...
	ret := C.g_dtls_connection_close_finish(arg0, arg1, &gError)
...
func (c dtlsConnection) EmitAcceptCertificate(peerCert TLSCertificate, errors TLSCertificateFlags) bool {
	...
	ret := C.g_dtls_connection_emit_accept_certificate(arg0, arg1, arg2)
...
func (c dtlsConnection) Certificate() TLSCertificate {
	...
	ret := C.g_dtls_connection_get_certificate(arg0)
...
func (c dtlsConnection) ChannelBindingData(typ TLSChannelBindingType) (data []byte, err error) {
	...
	ret := C.g_dtls_connection_get_channel_binding_data(arg0, arg1, &arg2, &gError)
...
func (c dtlsConnection) Database() TLSDatabase {
	...
	ret := C.g_dtls_connection_get_database(arg0)

	var ret0 TLSDatabase

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(TLSDatabase)
...
func (c dtlsConnection) Interaction() TLSInteraction {
	...
	ret := C.g_dtls_connection_get_interaction(arg0)

	var ret0 TLSInteraction

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(TLSInteraction)
...
func (c dtlsConnection) NegotiatedProtocol() string {
	...
	ret := C.g_dtls_connection_get_negotiated_protocol(arg0)
...
func (c dtlsConnection) PeerCertificate() TLSCertificate {
	...
	ret := C.g_dtls_connection_get_peer_certificate(arg0)
...
func (c dtlsConnection) PeerCertificateErrors() TLSCertificateFlags {
	...
	ret := C.g_dtls_connection_get_peer_certificate_errors(arg0)
...
func (c dtlsConnection) RehandshakeMode() TLSRehandshakeMode {
	...
	ret := C.g_dtls_connection_get_rehandshake_mode(arg0)
...
func (c dtlsConnection) RequireCloseNotify() bool {
	...
	ret := C.g_dtls_connection_get_require_close_notify(arg0)
...
func (c dtlsConnection) Handshake(cancellable Cancellable) error {
	...
	ret := C.g_dtls_connection_handshake(arg0, arg1, &gError)
...
func (c dtlsConnection) HandshakeFinish(result AsyncResult) error {
	...
	ret := C.g_dtls_connection_handshake_finish(arg0, arg1, &gError)
...
func (c dtlsConnection) SetAdvertisedProtocols(protocols []string) {
	...
	{
		var dst []*C.gchar
		ptr := C.malloc(unsafe.Sizeof((*struct{})(nil)) * (len(protocols) + 1))
		sliceHeader := (*reflect.SliceHeader)(unsafe.Pointer(&dst))
		sliceHeader.Data = uintptr(unsafe.Pointer(ptr))
		sliceHeader.Len = len(protocols)
		sliceHeader.Cap = len(protocols)
...
func (c dtlsConnection) Shutdown(shutdownRead bool, shutdownWrite bool, cancellable Cancellable) error {
	...
	ret := C.g_dtls_connection_shutdown(arg0, arg1, arg2, arg3, &gError)
...
func (c dtlsConnection) ShutdownFinish(result AsyncResult) error {
	...
	ret := C.g_dtls_connection_shutdown_finish(arg0, arg1, &gError)
