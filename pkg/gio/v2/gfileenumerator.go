...
func (e fileEnumerator) Close(cancellable Cancellable) error {
	...
	arg0 = (*C.GFileEnumerator)(e.Native())
	arg1 = (*C.GCancellable)(cancellable.Native())

	ret := C.g_file_enumerator_close(arg0, arg1, &gError)
...
func (e fileEnumerator) CloseFinish(result AsyncResult) error {
	...
	ret := C.g_file_enumerator_close_finish(arg0, arg1, &gError)
...
func (e fileEnumerator) Child(info FileInfo) File {
	...
	ret := C.g_file_enumerator_get_child(arg0, arg1)
...
func (e fileEnumerator) Container() File {
	...
	ret := C.g_file_enumerator_get_container(arg0)

	var ret0 File

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(File)
...
func (d fileEnumerator) Iterate(cancellable Cancellable) (outInfo FileInfo, outChild File, err error) {
	...
	arg0 = (*C.GFileEnumerator)(d.Native())
	arg3 = (*C.GCancellable)(cancellable.Native())

	ret := C.g_file_enumerator_iterate(arg0, &arg1, &arg2, arg3, &gError)

	var ret0 FileInfo
	var ret1 *File
	var goError error

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(arg1.Native()))).(FileInfo)

	ret1 = gextras.CastObject(externglib.Take(unsafe.Pointer(arg2.Native()))).(*File)
...
func (e fileEnumerator) NextFile(cancellable Cancellable) (fileInfo FileInfo, err error) {
	...
	ret := C.g_file_enumerator_next_file(arg0, arg1, &gError)
...
func (e fileEnumerator) NextFilesFinish(result AsyncResult) (list *glib.List, err error) {
	...
	ret := C.g_file_enumerator_next_files_finish(arg0, arg1, &gError)
