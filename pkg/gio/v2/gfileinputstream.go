...
func (s fileInputStream) QueryInfo(attributes string, cancellable Cancellable) (fileInfo FileInfo, err error) {
	...
	arg0 = (*C.GFileInputStream)(s.Native())
	arg1 = (*C.gchar)(C.CString(attributes))
	defer C.free(unsafe.Pointer(arg1))
	arg2 = (*C.GCancellable)(cancellable.Native())

	ret := C.g_file_input_stream_query_info(arg0, arg1, arg2, &gError)
...
func (s fileInputStream) QueryInfoFinish(result AsyncResult) (fileInfo FileInfo, err error) {
	...
	ret := C.g_file_input_stream_query_info_finish(arg0, arg1, &gError)
