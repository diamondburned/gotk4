...
func (s *FileInputStreamClass) QueryInfo(attributes string, cancellable Cancellable) (FileInfo, error) {
...
// QueryInfoFinish finishes an asynchronous info query operation.
func (s *FileInputStreamClass) QueryInfoFinish(result AsyncResult) (FileInfo, error) {
	var _arg0 *C.GFileInputStream // out
