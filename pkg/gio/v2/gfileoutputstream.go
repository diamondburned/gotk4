...
var GTypeFileOutputStream = externglib.Type(C.g_file_output_stream_get_type())
...
func (stream *FileOutputStream) ETag() string {
	...
	_arg0 = (*C.GFileOutputStream)(unsafe.Pointer(externglib.InternObject(stream).Native()))
