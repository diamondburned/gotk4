...
func NewSettings(schemaID string) Settings {
	...
	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(Settings)
...
func (s settings) CreateAction(key string) Action {
	...
	ret := C.g_settings_create_action(arg0, arg1)
...
func (s settings) Mapped(key string, mapping SettingsGetMapping) interface{} {
	...
	arg3 = C.gpointer(box.Assign(mapping))

	ret := C.g_settings_get_mapped(arg0, arg1, arg2, arg3)
...
func (s settings) SetStrv(key string, value []string) bool {
	...
	{
		var dst []*C.gchar
		ptr := C.malloc(unsafe.Sizeof((*struct{})(nil)) * (len(value) + 1))
