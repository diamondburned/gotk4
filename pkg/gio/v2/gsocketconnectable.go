...
type SocketConnectable interface {
	...
	// Enumerate: format a Connectable as a string. This is a human-readable
	...
	// ProxyEnumerate: format a Connectable as a string. This is a
	// human-readable format for use in debugging output, and is not a stable
	// serialization format. It is not suitable for use in user interfaces as it
	// exposes too much information for a user.
	//
	// If the Connectable implementation does not support string formatting, the
	// implementation’s type name will be returned as a fallback.
