...
// WrapTLSServerConnection wraps a GObject to a type that implements
// interface TLSServerConnection. It is primarily used internally.
func WrapTLSServerConnection(obj *externglib.Object) TLSServerConnection {
	return tlsServerConnection{obj}
}
...
func (t tlsServerConnection) AsTLSConnection() TLSConnection {
	return WrapTLSConnection(gextras.InternObject(t))
}

func (c tlsServerConnection) EmitAcceptCertificate(peerCert TLSCertificate, errors TLSCertificateFlags) bool {
	return WrapTLSConnection(gextras.InternObject(c)).EmitAcceptCertificate(peerCert, errors)
}

func (c tlsServerConnection) GetCertificate() TLSCertificate {
	return WrapTLSConnection(gextras.InternObject(c)).GetCertificate()
}

func (c tlsServerConnection) GetChannelBindingData(typ TLSChannelBindingType) ([]byte, error) {
	return WrapTLSConnection(gextras.InternObject(c)).GetChannelBindingData(typ)
}

func (c tlsServerConnection) GetDatabase() TLSDatabase {
	return WrapTLSConnection(gextras.InternObject(c)).GetDatabase()
}

func (c tlsServerConnection) GetInteraction() TLSInteraction {
	return WrapTLSConnection(gextras.InternObject(c)).GetInteraction()
}

func (c tlsServerConnection) GetNegotiatedProtocol() string {
	return WrapTLSConnection(gextras.InternObject(c)).GetNegotiatedProtocol()
}

func (c tlsServerConnection) GetPeerCertificate() TLSCertificate {
	return WrapTLSConnection(gextras.InternObject(c)).GetPeerCertificate()
}

func (c tlsServerConnection) GetPeerCertificateErrors() TLSCertificateFlags {
	return WrapTLSConnection(gextras.InternObject(c)).GetPeerCertificateErrors()
}

func (c tlsServerConnection) GetRehandshakeMode() TLSRehandshakeMode {
	return WrapTLSConnection(gextras.InternObject(c)).GetRehandshakeMode()
}

func (c tlsServerConnection) GetRequireCloseNotify() bool {
	return WrapTLSConnection(gextras.InternObject(c)).GetRequireCloseNotify()
}

func (c tlsServerConnection) GetUseSystemCertDB() bool {
	return WrapTLSConnection(gextras.InternObject(c)).GetUseSystemCertDB()
}

func (c tlsServerConnection) Handshake(cancellable Cancellable) error {
	return WrapTLSConnection(gextras.InternObject(c)).Handshake(cancellable)
}

func (c tlsServerConnection) HandshakeAsync(ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapTLSConnection(gextras.InternObject(c)).HandshakeAsync(ioPriority, cancellable, callback)
}

func (c tlsServerConnection) HandshakeFinish(result AsyncResult) error {
	return WrapTLSConnection(gextras.InternObject(c)).HandshakeFinish(result)
}

func (c tlsServerConnection) SetAdvertisedProtocols(protocols []string) {
	WrapTLSConnection(gextras.InternObject(c)).SetAdvertisedProtocols(protocols)
}

func (c tlsServerConnection) SetCertificate(certificate TLSCertificate) {
	WrapTLSConnection(gextras.InternObject(c)).SetCertificate(certificate)
}

func (c tlsServerConnection) SetDatabase(database TLSDatabase) {
	WrapTLSConnection(gextras.InternObject(c)).SetDatabase(database)
}

func (c tlsServerConnection) SetInteraction(interaction TLSInteraction) {
	WrapTLSConnection(gextras.InternObject(c)).SetInteraction(interaction)
}

func (c tlsServerConnection) SetRehandshakeMode(mode TLSRehandshakeMode) {
	WrapTLSConnection(gextras.InternObject(c)).SetRehandshakeMode(mode)
}

func (c tlsServerConnection) SetRequireCloseNotify(requireCloseNotify bool) {
	WrapTLSConnection(gextras.InternObject(c)).SetRequireCloseNotify(requireCloseNotify)
}

func (c tlsServerConnection) SetUseSystemCertDB(useSystemCertdb bool) {
	WrapTLSConnection(gextras.InternObject(c)).SetUseSystemCertDB(useSystemCertdb)
}

func (s tlsServerConnection) ClearPending() {
	WrapIOStream(gextras.InternObject(s)).ClearPending()
}

func (s tlsServerConnection) Close(cancellable Cancellable) error {
	return WrapIOStream(gextras.InternObject(s)).Close(cancellable)
}

func (s tlsServerConnection) CloseAsync(ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
	WrapIOStream(gextras.InternObject(s)).CloseAsync(ioPriority, cancellable, callback)
}

func (s tlsServerConnection) CloseFinish(result AsyncResult) error {
	return WrapIOStream(gextras.InternObject(s)).CloseFinish(result)
}

func (s tlsServerConnection) GetInputStream() InputStream {
	return WrapIOStream(gextras.InternObject(s)).GetInputStream()
}

func (s tlsServerConnection) GetOutputStream() OutputStream {
	return WrapIOStream(gextras.InternObject(s)).GetOutputStream()
}

func (s tlsServerConnection) HasPending() bool {
	return WrapIOStream(gextras.InternObject(s)).HasPending()
}

func (s tlsServerConnection) IsClosed() bool {
	return WrapIOStream(gextras.InternObject(s)).IsClosed()
}

func (s tlsServerConnection) SetPending() error {
	return WrapIOStream(gextras.InternObject(s)).SetPending()
}

func (s tlsServerConnection) SpliceAsync(stream2 IOStream, flags IOStreamSpliceFlags, ioPriority int, cancellable Cancellable, callback AsyncReadyCallback) {
