...
func ifaceInitVolumer(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("can_eject"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_can_eject)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("can_mount"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_can_mount)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("changed"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_changed)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("eject_finish"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_eject_finish)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("eject_with_operation_finish"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_eject_with_operation_finish)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("enumerate_identifiers"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_enumerate_identifiers)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_activation_root"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_activation_root)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_drive"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_drive)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_icon"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_icon)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_identifier"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_identifier)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_mount"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_mount)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_name"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_name)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_sort_key"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_sort_key)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_symbolic_icon"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_symbolic_icon)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_uuid"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_get_uuid)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("mount_finish"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_mount_finish)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("removed"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_removed)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("should_automount"))) = unsafe.Pointer(C._gotk4_gio2_VolumeIface_should_automount)
}
