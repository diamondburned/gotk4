...
func NewZlibDecompressor(format ZlibCompressorFormat) ZlibDecompressor {
	...
	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(ZlibDecompressor)
...
func (d zlibDecompressor) FileInfo() FileInfo {
	...
	arg0 = (*C.GZlibDecompressor)(d.Native())

	ret := C.g_zlib_decompressor_get_file_info(arg0)

	var ret0 FileInfo

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(FileInfo)
