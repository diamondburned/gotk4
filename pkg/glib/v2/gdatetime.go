...
func (d *DateTime) Compare(dt2 DateTime) int {
	...
	arg0 = (C.gpointer)(d.Native())
	arg1 = (C.gpointer)(dt2.Native())
...
// parameter is larger).
func (e *DateTime) Difference(begin *DateTime) TimeSpan {
	var arg0 *C.GDateTime
	var arg1 *C.GDateTime

	arg0 = (*C.GDateTime)(e.Native())
...
func (d *DateTime) UtcOffset() TimeSpan {
	var arg0 *C.GDateTime
