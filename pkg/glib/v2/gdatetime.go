...
// GTypeDateTime returns the GType for the type DateTime.
//
// This function has the side effect of registering a GValue marshaler
// globally. Use this if you need that for any reason. The function is
// concurrently safe to use.
func GTypeDateTime() coreglib.Type {
	gtype := coreglib.Type(C.g_date_time_get_type())
	coreglib.RegisterGValueMarshaler(gtype, marshalDateTime)
	return gtype
}
