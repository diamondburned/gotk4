...
func (c *OptionContext) AddGroup(group *OptionGroup) {
	...
	arg0 = (*C.GOptionContext)(c.Native())
...
func (c *OptionContext) Parse(argc int, argv []string) error {
	var arg0 *C.GOptionContext
	var arg1 *C.gint
	var arg2 ***C.gchar
	var gError *C.GError
...
func (g *OptionGroup) SetParseHooks(preParseFunc OptionParseFunc, postParseFunc OptionParseFunc) {
	var arg0 *C.GOptionGroup
