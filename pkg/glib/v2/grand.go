...
// Double initializes the random number generator by an array of longs. Array
// can be of arbitrary size, though only the first 624 values are taken. This
// function is useful if you have many low entropy seeds, or if you require more
// then 32 bits of actual entropy for your application.
...
// DoubleRange initializes the random number generator by an array of longs.
...
// Free initializes the random number generator by an array of longs. Array can
// be of arbitrary size, though only the first 624 values are taken. This
// function is useful if you have many low entropy seeds, or if you require more
// then 32 bits of actual entropy for your application.
func (r *Rand) Free() {
	var _arg0 *C.GRand // out
...
// Int initializes the random number generator by an array of longs. Array can
// be of arbitrary size, though only the first 624 values are taken. This
// function is useful if you have many low entropy seeds, or if you require more
// then 32 bits of actual entropy for your application.
...
// IntRange initializes the random number generator by an array of longs. Array
// can be of arbitrary size, though only the first 624 values are taken. This
// function is useful if you have many low entropy seeds, or if you require more
// then 32 bits of actual entropy for your application.
...
// SetSeed initializes the random number generator by an array of longs. Array
// can be of arbitrary size, though only the first 624 values are taken. This
// function is useful if you have many low entropy seeds, or if you require more
// then 32 bits of actual entropy for your application.
