...
// the array.
func (v *Variant) FixedArray(elementSize uint) (nElements uint, gpointers []interface{}) {
	var arg0 *C.GVariant
	var arg1 *C.gsize // out
	var arg2 C.gsize
...
func (b *VariantBuilder) AddValue(value *Variant) {
	...
	arg0 = (*C.GVariantBuilder)(b.Native())
	arg1 = (*C.GVariant)(value.Native())
