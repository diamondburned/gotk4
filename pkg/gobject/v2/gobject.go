...
func (p typePlugin) CompleteInterfaceInfo(instanceType externglib.Type, interfaceType externglib.Type, info *InterfaceInfo) {
	...
	C.g_type_plugin_complete_interface_info(arg0, instanceType, interfaceType, info)
}
