...
func NewBroadwayRenderer() BroadwayRenderer {
	cret := new(C.GskBroadwayRenderer)
	var goret BroadwayRenderer

	cret = C.gsk_broadway_renderer_new()

	goret = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(cret.Native()))).(BroadwayRenderer)
