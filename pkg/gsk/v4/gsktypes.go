...
func NewTransform() *Transform {
	...
	var goret1 *Transform

	cret = C.gsk_transform_new()

	goret1 = WrapTransform(unsafe.Pointer(cret))
	runtime.SetFinalizer(goret1, func(v *Transform) {
...
func (s *Transform) Category() TransformCategory {
	...
	var goret1 TransformCategory

	cret = C.gsk_transform_get_category(arg0)

	goret1 = TransformCategory(cret)
