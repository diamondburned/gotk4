...
type AccelLabel interface {
	...
	// AsLabel casts the class to the Label interface.
	AsLabel() Label
	// AsBuildable casts the class to the Buildable interface.
	AsBuildable() Buildable

	// GetAngle gets the angle of rotation for the label. See
	// gtk_label_set_angle().
	//
	// This method is inherited from Label
	GetAngle() float64
	...
	// GetCurrentURI returns the URI for the currently active link in the label.
	...
	// This method is inherited from Label
	GetLabel() string
	// GetLayout gets the Layout used to display the label. The layout is useful
	...
	// This method is inherited from Label
	GetLineWrap() bool
	// GetLineWrapMode returns line wrap mode used by the label. See
	...
	// GetMnemonicKeyval: if the label has been set so that it has an mnemonic
	...
	// GetAlignment gets the X and Y alignment of the widget within its
	// allocation. See gtk_misc_set_alignment().
	//
	// Deprecated: since version 3.14.
	//
	// This method is inherited from Misc
	GetAlignment() (xalign float32, yalign float32)
	// GetPadding gets the padding in the X and Y directions of the widget. See
...
// WrapAccelLabel wraps a GObject to a type that implements
// interface AccelLabel. It is primarily used internally.
...
func (a accelLabel) AsLabel() Label {
	return WrapLabel(gextras.InternObject(a))
}
...
func (l accelLabel) GetAngle() float64 {
	return WrapLabel(gextras.InternObject(l)).GetAngle()
}

func (l accelLabel) GetAttributes() *pango.AttrList {
	return WrapLabel(gextras.InternObject(l)).GetAttributes()
}

func (l accelLabel) GetCurrentURI() string {
	return WrapLabel(gextras.InternObject(l)).GetCurrentURI()
}

func (l accelLabel) GetEllipsize() pango.EllipsizeMode {
	return WrapLabel(gextras.InternObject(l)).GetEllipsize()
}

func (l accelLabel) GetJustify() Justification {
	return WrapLabel(gextras.InternObject(l)).GetJustify()
}

func (l accelLabel) GetLabel() string {
	return WrapLabel(gextras.InternObject(l)).GetLabel()
}

func (l accelLabel) GetLayout() pango.Layout {
	return WrapLabel(gextras.InternObject(l)).GetLayout()
}

func (l accelLabel) GetLayoutOffsets() (x int, y int) {
	return WrapLabel(gextras.InternObject(l)).GetLayoutOffsets()
}

func (l accelLabel) GetLineWrap() bool {
	return WrapLabel(gextras.InternObject(l)).GetLineWrap()
}

func (l accelLabel) GetLineWrapMode() pango.WrapMode {
	return WrapLabel(gextras.InternObject(l)).GetLineWrapMode()
}

func (l accelLabel) GetLines() int {
	return WrapLabel(gextras.InternObject(l)).GetLines()
}

func (l accelLabel) GetMaxWidthChars() int {
	return WrapLabel(gextras.InternObject(l)).GetMaxWidthChars()
}

func (l accelLabel) GetMnemonicKeyval() uint {
	return WrapLabel(gextras.InternObject(l)).GetMnemonicKeyval()
}

func (l accelLabel) GetMnemonicWidget() Widget {
	return WrapLabel(gextras.InternObject(l)).GetMnemonicWidget()
}

func (l accelLabel) GetSelectable() bool {
	return WrapLabel(gextras.InternObject(l)).GetSelectable()
}

func (l accelLabel) GetSelectionBounds() (start int, end int, ok bool) {
	return WrapLabel(gextras.InternObject(l)).GetSelectionBounds()
}

func (l accelLabel) GetSingleLineMode() bool {
	return WrapLabel(gextras.InternObject(l)).GetSingleLineMode()
}

func (l accelLabel) GetText() string {
	return WrapLabel(gextras.InternObject(l)).GetText()
}

func (l accelLabel) GetTrackVisitedLinks() bool {
	return WrapLabel(gextras.InternObject(l)).GetTrackVisitedLinks()
}

func (l accelLabel) GetUseMarkup() bool {
	return WrapLabel(gextras.InternObject(l)).GetUseMarkup()
}

func (l accelLabel) GetUseUnderline() bool {
	return WrapLabel(gextras.InternObject(l)).GetUseUnderline()
}

func (l accelLabel) GetWidthChars() int {
	return WrapLabel(gextras.InternObject(l)).GetWidthChars()
}

func (l accelLabel) GetXalign() float32 {
	return WrapLabel(gextras.InternObject(l)).GetXalign()
}

func (l accelLabel) GetYalign() float32 {
	return WrapLabel(gextras.InternObject(l)).GetYalign()
}

func (l accelLabel) SelectRegion(startOffset int, endOffset int) {
	WrapLabel(gextras.InternObject(l)).SelectRegion(startOffset, endOffset)
}

func (l accelLabel) SetAngle(angle float64) {
	WrapLabel(gextras.InternObject(l)).SetAngle(angle)
}

func (l accelLabel) SetAttributes(attrs *pango.AttrList) {
	WrapLabel(gextras.InternObject(l)).SetAttributes(attrs)
}

func (l accelLabel) SetEllipsize(mode pango.EllipsizeMode) {
	WrapLabel(gextras.InternObject(l)).SetEllipsize(mode)
}

func (l accelLabel) SetJustify(jtype Justification) {
	WrapLabel(gextras.InternObject(l)).SetJustify(jtype)
}

func (l accelLabel) SetLabel(str string) {
	WrapLabel(gextras.InternObject(l)).SetLabel(str)
}

func (l accelLabel) SetLineWrap(wrap bool) {
	WrapLabel(gextras.InternObject(l)).SetLineWrap(wrap)
}

func (l accelLabel) SetLineWrapMode(wrapMode pango.WrapMode) {
	WrapLabel(gextras.InternObject(l)).SetLineWrapMode(wrapMode)
}

func (l accelLabel) SetLines(lines int) {
	WrapLabel(gextras.InternObject(l)).SetLines(lines)
}

func (l accelLabel) SetMarkup(str string) {
	WrapLabel(gextras.InternObject(l)).SetMarkup(str)
}

func (l accelLabel) SetMarkupWithMnemonic(str string) {
	WrapLabel(gextras.InternObject(l)).SetMarkupWithMnemonic(str)
}

func (l accelLabel) SetMaxWidthChars(nChars int) {
	WrapLabel(gextras.InternObject(l)).SetMaxWidthChars(nChars)
}

func (l accelLabel) SetMnemonicWidget(widget Widget) {
	WrapLabel(gextras.InternObject(l)).SetMnemonicWidget(widget)
}

func (l accelLabel) SetPattern(pattern string) {
	WrapLabel(gextras.InternObject(l)).SetPattern(pattern)
}

func (l accelLabel) SetSelectable(setting bool) {
	WrapLabel(gextras.InternObject(l)).SetSelectable(setting)
}

func (l accelLabel) SetSingleLineMode(singleLineMode bool) {
	WrapLabel(gextras.InternObject(l)).SetSingleLineMode(singleLineMode)
}

func (l accelLabel) SetText(str string) {
	WrapLabel(gextras.InternObject(l)).SetText(str)
}

func (l accelLabel) SetTextWithMnemonic(str string) {
	WrapLabel(gextras.InternObject(l)).SetTextWithMnemonic(str)
}

func (l accelLabel) SetTrackVisitedLinks(trackLinks bool) {
	WrapLabel(gextras.InternObject(l)).SetTrackVisitedLinks(trackLinks)
}

func (l accelLabel) SetUseMarkup(setting bool) {
	WrapLabel(gextras.InternObject(l)).SetUseMarkup(setting)
}

func (l accelLabel) SetUseUnderline(setting bool) {
	WrapLabel(gextras.InternObject(l)).SetUseUnderline(setting)
}

func (l accelLabel) SetWidthChars(nChars int) {
	WrapLabel(gextras.InternObject(l)).SetWidthChars(nChars)
}

func (l accelLabel) SetXalign(xalign float32) {
	WrapLabel(gextras.InternObject(l)).SetXalign(xalign)
}

func (l accelLabel) SetYalign(yalign float32) {
	WrapLabel(gextras.InternObject(l)).SetYalign(yalign)
}

func (m accelLabel) GetAlignment() (xalign float32, yalign float32) {
	return WrapMisc(gextras.InternObject(m)).GetAlignment()
}

func (m accelLabel) GetPadding() (xpad int, ypad int) {
	return WrapMisc(gextras.InternObject(m)).GetPadding()
}

func (m accelLabel) SetAlignment(xalign float32, yalign float32) {
	WrapMisc(gextras.InternObject(m)).SetAlignment(xalign, yalign)
}

func (m accelLabel) SetPadding(xpad int, ypad int) {
	WrapMisc(gextras.InternObject(m)).SetPadding(xpad, ypad)
}

func (w accelLabel) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w accelLabel) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w accelLabel) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w accelLabel) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w accelLabel) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w accelLabel) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w accelLabel) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w accelLabel) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w accelLabel) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w accelLabel) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w accelLabel) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w accelLabel) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w accelLabel) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w accelLabel) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w accelLabel) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w accelLabel) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w accelLabel) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w accelLabel) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w accelLabel) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w accelLabel) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w accelLabel) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w accelLabel) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w accelLabel) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w accelLabel) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w accelLabel) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w accelLabel) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w accelLabel) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w accelLabel) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w accelLabel) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w accelLabel) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w accelLabel) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w accelLabel) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w accelLabel) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w accelLabel) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w accelLabel) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w accelLabel) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w accelLabel) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w accelLabel) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w accelLabel) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w accelLabel) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w accelLabel) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w accelLabel) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w accelLabel) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w accelLabel) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w accelLabel) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w accelLabel) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w accelLabel) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w accelLabel) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w accelLabel) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w accelLabel) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w accelLabel) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w accelLabel) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w accelLabel) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w accelLabel) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w accelLabel) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w accelLabel) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w accelLabel) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w accelLabel) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w accelLabel) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w accelLabel) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w accelLabel) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w accelLabel) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w accelLabel) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w accelLabel) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w accelLabel) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w accelLabel) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w accelLabel) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w accelLabel) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w accelLabel) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w accelLabel) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w accelLabel) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w accelLabel) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w accelLabel) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w accelLabel) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w accelLabel) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w accelLabel) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w accelLabel) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w accelLabel) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w accelLabel) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w accelLabel) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w accelLabel) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w accelLabel) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w accelLabel) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w accelLabel) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w accelLabel) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w accelLabel) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w accelLabel) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w accelLabel) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w accelLabel) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w accelLabel) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w accelLabel) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w accelLabel) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w accelLabel) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w accelLabel) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w accelLabel) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w accelLabel) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w accelLabel) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w accelLabel) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w accelLabel) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w accelLabel) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w accelLabel) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w accelLabel) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w accelLabel) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w accelLabel) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w accelLabel) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w accelLabel) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w accelLabel) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w accelLabel) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w accelLabel) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w accelLabel) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w accelLabel) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w accelLabel) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w accelLabel) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w accelLabel) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w accelLabel) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w accelLabel) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w accelLabel) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w accelLabel) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w accelLabel) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w accelLabel) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w accelLabel) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w accelLabel) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w accelLabel) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w accelLabel) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w accelLabel) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w accelLabel) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w accelLabel) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w accelLabel) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w accelLabel) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w accelLabel) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w accelLabel) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w accelLabel) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w accelLabel) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w accelLabel) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w accelLabel) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w accelLabel) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w accelLabel) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w accelLabel) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w accelLabel) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w accelLabel) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w accelLabel) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w accelLabel) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w accelLabel) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w accelLabel) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w accelLabel) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w accelLabel) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w accelLabel) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w accelLabel) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w accelLabel) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w accelLabel) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w accelLabel) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w accelLabel) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w accelLabel) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w accelLabel) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w accelLabel) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w accelLabel) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w accelLabel) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w accelLabel) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w accelLabel) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w accelLabel) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w accelLabel) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w accelLabel) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w accelLabel) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w accelLabel) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w accelLabel) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w accelLabel) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w accelLabel) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w accelLabel) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w accelLabel) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w accelLabel) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w accelLabel) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w accelLabel) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w accelLabel) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w accelLabel) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w accelLabel) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w accelLabel) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w accelLabel) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w accelLabel) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w accelLabel) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w accelLabel) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w accelLabel) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w accelLabel) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w accelLabel) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w accelLabel) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w accelLabel) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w accelLabel) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w accelLabel) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w accelLabel) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w accelLabel) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w accelLabel) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w accelLabel) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w accelLabel) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w accelLabel) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w accelLabel) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w accelLabel) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w accelLabel) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w accelLabel) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w accelLabel) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w accelLabel) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w accelLabel) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w accelLabel) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w accelLabel) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w accelLabel) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w accelLabel) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w accelLabel) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w accelLabel) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w accelLabel) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w accelLabel) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w accelLabel) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w accelLabel) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w accelLabel) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w accelLabel) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w accelLabel) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w accelLabel) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w accelLabel) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w accelLabel) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w accelLabel) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w accelLabel) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w accelLabel) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w accelLabel) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w accelLabel) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w accelLabel) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w accelLabel) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w accelLabel) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w accelLabel) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w accelLabel) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w accelLabel) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w accelLabel) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w accelLabel) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w accelLabel) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w accelLabel) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w accelLabel) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w accelLabel) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w accelLabel) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s accelLabel) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w accelLabel) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w accelLabel) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w accelLabel) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w accelLabel) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w accelLabel) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w accelLabel) UnsetStateFlags(flags StateFlags) {
...
func (b accelLabel) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b accelLabel) GetName() string {
