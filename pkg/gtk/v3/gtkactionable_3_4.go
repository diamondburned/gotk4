...
// #include <gtk/gtk.h>
// #include <gtk/gtkx.h>
// GVariant* _gotk4_gtk3_Actionable_virtual_get_action_target_value(void* fnptr, GtkActionable* arg0) {
//   return ((GVariant* (*)(GtkActionable*))(fnptr))(arg0);
// };
// gchar* _gotk4_gtk3_Actionable_virtual_get_action_name(void* fnptr, GtkActionable* arg0) {
//   return ((gchar* (*)(GtkActionable*))(fnptr))(arg0);
// };
// void _gotk4_gtk3_Actionable_virtual_set_action_name(void* fnptr, GtkActionable* arg0, gchar* arg1) {
//   ((void (*)(GtkActionable*, gchar*))(fnptr))(arg0, arg1);
// };
// void _gotk4_gtk3_Actionable_virtual_set_action_target_value(void* fnptr, GtkActionable* arg0, GVariant* arg1) {
...
// “win.” or “app.” prefix that are associated with the ApplicationWindow
...
func (actionable *Actionable) actionName() string {
	...
	_cret = C._gotk4_gtk3_Actionable_virtual_get_action_name(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(actionable)
...
func (actionable *Actionable) actionTargetValue() *glib.Variant {
	...
	_cret = C._gotk4_gtk3_Actionable_virtual_get_action_target_value(unsafe.Pointer(fnarg), _arg0)
	runtime.KeepAlive(actionable)
...
func (actionable *Actionable) setActionName(actionName string) {
	...
	C._gotk4_gtk3_Actionable_virtual_set_action_name(unsafe.Pointer(fnarg), _arg0, _arg1)
	runtime.KeepAlive(actionable)
	runtime.KeepAlive(actionName)
}
...
func (actionable *Actionable) setActionTargetValue(targetValue *glib.Variant) {
	...
	C._gotk4_gtk3_Actionable_virtual_set_action_target_value(unsafe.Pointer(fnarg), _arg0, _arg1)
	runtime.KeepAlive(actionable)
	runtime.KeepAlive(targetValue)
}
