...
// WrapActionBar wraps a GObject to a type that implements
// interface ActionBar. It is primarily used internally.
...
func (a actionBar) AsBin() Bin {
	return WrapBin(gextras.InternObject(a))
}
...
func (b actionBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b actionBar) GetName() string {
