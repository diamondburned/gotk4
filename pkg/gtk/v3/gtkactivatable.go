...
// #include <gtk/gtk.h>
// #include <gtk/gtkx.h>
// void _gotk4_gtk3_Activatable_virtual_sync_action_properties(void* fnptr, GtkActivatable* arg0, GtkAction* arg1) {
//   ((void (*)(GtkActivatable*, GtkAction*))(fnptr))(arg0, arg1);
// };
// void _gotk4_gtk3_Activatable_virtual_update(void* fnptr, GtkActivatable* arg0, GtkAction* arg1, gchar* arg2) {
//   ((void (*)(GtkActivatable*, GtkAction*, gchar*))(fnptr))(arg0, arg1, arg2);
// };
import "C"
...
func (activatable *Activatable) DoSetRelatedAction(action *Action) {
	...
	_arg0 = (*C.GtkActivatable)(unsafe.Pointer(coreglib.InternObject(activatable).Native()))
...
func (activatable *Activatable) syncActionProperties(action *Action) {
	...
	fnarg := gclass.sync_action_properties
	...
	C._gotk4_gtk3_Activatable_virtual_sync_action_properties(unsafe.Pointer(fnarg), _arg0, _arg1)
	runtime.KeepAlive(activatable)
	runtime.KeepAlive(action)
}
...
func (activatable *Activatable) update(action *Action, propertyName string) {
	...
	C._gotk4_gtk3_Activatable_virtual_update(unsafe.Pointer(fnarg), _arg0, _arg1, _arg2)
	runtime.KeepAlive(activatable)
	runtime.KeepAlive(action)
