...
// WrapAlignment wraps a GObject to a type that implements
// interface Alignment. It is primarily used internally.
...
func (b alignment) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b alignment) GetName() string {
