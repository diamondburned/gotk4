...
type AppChooserButton interface {
	...
	GetActive() int
	// GetActiveID returns the ID of the active row of @combo_box. This value is
	...
	// GetAddTearoffs gets the current value of the :add-tearoffs property.
	//
	...
	// GetColumnSpanColumn returns the column with column span information for
	// @combo_box.
	//
	// This method is inherited from ComboBox
	GetColumnSpanColumn() int
	...
	// GetFocusOnClick returns whether the combo box grabs focus when it is
	// clicked with the mouse. See gtk_combo_box_set_focus_on_click().
	//
	...
	// This method is inherited from ComboBox
	GetModel() TreeModel
	// GetPopupAccessible gets the accessible object corresponding to the combo
	// box’s popup.
	//
	...
	// GetPopupFixedWidth gets whether the popup uses a fixed width matching the
	// allocated width of the combo box.
	//
	// This method is inherited from ComboBox
	GetPopupFixedWidth() bool
	// GetRowSpanColumn returns the column with row span information for
	// @combo_box.
	//
	// This method is inherited from ComboBox
	GetRowSpanColumn() int
	// GetTitle gets the current title of the menu in tearoff mode. See
	...
	// This method is inherited from ComboBox
	GetTitle() string
	// GetWrapWidth returns the wrap width which is used to determine the number
	// of columns for the popup menu. If the wrap width is larger than 1, the
...
// WrapAppChooserButton wraps a GObject to a type that implements
// interface AppChooserButton. It is primarily used internally.
...
func (a appChooserButton) AsComboBox() ComboBox {
	return WrapComboBox(gextras.InternObject(a))
}
...
func (c appChooserButton) GetActive() int {
	return WrapComboBox(gextras.InternObject(c)).GetActive()
}

func (c appChooserButton) GetActiveID() string {
	return WrapComboBox(gextras.InternObject(c)).GetActiveID()
}

func (c appChooserButton) GetActiveIter() (TreeIter, bool) {
	return WrapComboBox(gextras.InternObject(c)).GetActiveIter()
}

func (c appChooserButton) GetAddTearoffs() bool {
	return WrapComboBox(gextras.InternObject(c)).GetAddTearoffs()
}

func (c appChooserButton) GetButtonSensitivity() SensitivityType {
	return WrapComboBox(gextras.InternObject(c)).GetButtonSensitivity()
}

func (c appChooserButton) GetColumnSpanColumn() int {
	return WrapComboBox(gextras.InternObject(c)).GetColumnSpanColumn()
}

func (c appChooserButton) GetEntryTextColumn() int {
	return WrapComboBox(gextras.InternObject(c)).GetEntryTextColumn()
}

func (c appChooserButton) GetFocusOnClick() bool {
	return WrapComboBox(gextras.InternObject(c)).GetFocusOnClick()
}

func (c appChooserButton) GetHasEntry() bool {
	return WrapComboBox(gextras.InternObject(c)).GetHasEntry()
}

func (c appChooserButton) GetIDColumn() int {
	return WrapComboBox(gextras.InternObject(c)).GetIDColumn()
}

func (c appChooserButton) GetModel() TreeModel {
	return WrapComboBox(gextras.InternObject(c)).GetModel()
}

func (c appChooserButton) GetPopupAccessible() atk.Object {
	return WrapComboBox(gextras.InternObject(c)).GetPopupAccessible()
}

func (c appChooserButton) GetPopupFixedWidth() bool {
	return WrapComboBox(gextras.InternObject(c)).GetPopupFixedWidth()
}

func (c appChooserButton) GetRowSpanColumn() int {
	return WrapComboBox(gextras.InternObject(c)).GetRowSpanColumn()
}

func (c appChooserButton) GetTitle() string {
	return WrapComboBox(gextras.InternObject(c)).GetTitle()
}

func (c appChooserButton) GetWrapWidth() int {
	return WrapComboBox(gextras.InternObject(c)).GetWrapWidth()
}

func (c appChooserButton) Popdown() {
	WrapComboBox(gextras.InternObject(c)).Popdown()
}

func (c appChooserButton) Popup() {
	WrapComboBox(gextras.InternObject(c)).Popup()
}

func (c appChooserButton) PopupForDevice(device gdk.Device) {
	WrapComboBox(gextras.InternObject(c)).PopupForDevice(device)
}

func (c appChooserButton) SetActive(index_ int) {
	WrapComboBox(gextras.InternObject(c)).SetActive(index_)
}

func (c appChooserButton) SetActiveID(activeId string) bool {
	return WrapComboBox(gextras.InternObject(c)).SetActiveID(activeId)
}

func (c appChooserButton) SetActiveIter(iter *TreeIter) {
	WrapComboBox(gextras.InternObject(c)).SetActiveIter(iter)
}

func (c appChooserButton) SetAddTearoffs(addTearoffs bool) {
	WrapComboBox(gextras.InternObject(c)).SetAddTearoffs(addTearoffs)
}

func (c appChooserButton) SetButtonSensitivity(sensitivity SensitivityType) {
	WrapComboBox(gextras.InternObject(c)).SetButtonSensitivity(sensitivity)
}

func (c appChooserButton) SetColumnSpanColumn(columnSpan int) {
	WrapComboBox(gextras.InternObject(c)).SetColumnSpanColumn(columnSpan)
}

func (c appChooserButton) SetEntryTextColumn(textColumn int) {
	WrapComboBox(gextras.InternObject(c)).SetEntryTextColumn(textColumn)
}

func (c appChooserButton) SetFocusOnClick(focusOnClick bool) {
	WrapComboBox(gextras.InternObject(c)).SetFocusOnClick(focusOnClick)
}

func (c appChooserButton) SetIDColumn(idColumn int) {
	WrapComboBox(gextras.InternObject(c)).SetIDColumn(idColumn)
}

func (c appChooserButton) SetModel(model TreeModel) {
	WrapComboBox(gextras.InternObject(c)).SetModel(model)
}

func (c appChooserButton) SetPopupFixedWidth(fixed bool) {
	WrapComboBox(gextras.InternObject(c)).SetPopupFixedWidth(fixed)
}

func (c appChooserButton) SetRowSpanColumn(rowSpan int) {
	WrapComboBox(gextras.InternObject(c)).SetRowSpanColumn(rowSpan)
}

func (c appChooserButton) SetTitle(title string) {
	WrapComboBox(gextras.InternObject(c)).SetTitle(title)
}

func (c appChooserButton) SetWrapWidth(width int) {
	WrapComboBox(gextras.InternObject(c)).SetWrapWidth(width)
}

func (b appChooserButton) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c appChooserButton) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c appChooserButton) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c appChooserButton) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c appChooserButton) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c appChooserButton) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c appChooserButton) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c appChooserButton) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c appChooserButton) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c appChooserButton) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c appChooserButton) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c appChooserButton) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c appChooserButton) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c appChooserButton) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c appChooserButton) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c appChooserButton) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c appChooserButton) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c appChooserButton) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c appChooserButton) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c appChooserButton) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c appChooserButton) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c appChooserButton) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c appChooserButton) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c appChooserButton) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c appChooserButton) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w appChooserButton) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w appChooserButton) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w appChooserButton) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w appChooserButton) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w appChooserButton) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w appChooserButton) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w appChooserButton) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w appChooserButton) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w appChooserButton) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w appChooserButton) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w appChooserButton) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w appChooserButton) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w appChooserButton) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w appChooserButton) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w appChooserButton) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w appChooserButton) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w appChooserButton) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w appChooserButton) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w appChooserButton) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w appChooserButton) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w appChooserButton) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w appChooserButton) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w appChooserButton) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w appChooserButton) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w appChooserButton) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w appChooserButton) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w appChooserButton) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w appChooserButton) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w appChooserButton) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w appChooserButton) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w appChooserButton) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w appChooserButton) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w appChooserButton) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w appChooserButton) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w appChooserButton) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w appChooserButton) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w appChooserButton) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w appChooserButton) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w appChooserButton) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w appChooserButton) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w appChooserButton) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w appChooserButton) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w appChooserButton) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w appChooserButton) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w appChooserButton) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w appChooserButton) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w appChooserButton) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w appChooserButton) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w appChooserButton) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w appChooserButton) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w appChooserButton) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w appChooserButton) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w appChooserButton) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w appChooserButton) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w appChooserButton) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w appChooserButton) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w appChooserButton) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w appChooserButton) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w appChooserButton) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w appChooserButton) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w appChooserButton) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w appChooserButton) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w appChooserButton) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w appChooserButton) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w appChooserButton) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w appChooserButton) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w appChooserButton) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w appChooserButton) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w appChooserButton) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w appChooserButton) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w appChooserButton) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w appChooserButton) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w appChooserButton) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w appChooserButton) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w appChooserButton) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w appChooserButton) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w appChooserButton) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w appChooserButton) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w appChooserButton) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w appChooserButton) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w appChooserButton) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w appChooserButton) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w appChooserButton) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w appChooserButton) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w appChooserButton) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w appChooserButton) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w appChooserButton) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w appChooserButton) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w appChooserButton) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w appChooserButton) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w appChooserButton) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w appChooserButton) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w appChooserButton) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w appChooserButton) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w appChooserButton) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w appChooserButton) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w appChooserButton) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w appChooserButton) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w appChooserButton) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w appChooserButton) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w appChooserButton) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w appChooserButton) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w appChooserButton) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w appChooserButton) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w appChooserButton) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w appChooserButton) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w appChooserButton) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w appChooserButton) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w appChooserButton) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w appChooserButton) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w appChooserButton) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w appChooserButton) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w appChooserButton) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w appChooserButton) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w appChooserButton) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w appChooserButton) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w appChooserButton) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w appChooserButton) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w appChooserButton) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w appChooserButton) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w appChooserButton) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w appChooserButton) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w appChooserButton) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w appChooserButton) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w appChooserButton) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w appChooserButton) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w appChooserButton) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w appChooserButton) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w appChooserButton) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w appChooserButton) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w appChooserButton) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w appChooserButton) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w appChooserButton) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w appChooserButton) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w appChooserButton) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w appChooserButton) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w appChooserButton) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w appChooserButton) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w appChooserButton) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w appChooserButton) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w appChooserButton) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w appChooserButton) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w appChooserButton) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w appChooserButton) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w appChooserButton) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w appChooserButton) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w appChooserButton) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w appChooserButton) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w appChooserButton) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w appChooserButton) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w appChooserButton) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w appChooserButton) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w appChooserButton) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w appChooserButton) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w appChooserButton) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w appChooserButton) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w appChooserButton) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w appChooserButton) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w appChooserButton) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w appChooserButton) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w appChooserButton) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w appChooserButton) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w appChooserButton) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w appChooserButton) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w appChooserButton) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w appChooserButton) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w appChooserButton) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w appChooserButton) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w appChooserButton) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w appChooserButton) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w appChooserButton) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w appChooserButton) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w appChooserButton) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w appChooserButton) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w appChooserButton) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w appChooserButton) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w appChooserButton) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w appChooserButton) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w appChooserButton) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w appChooserButton) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w appChooserButton) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w appChooserButton) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w appChooserButton) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w appChooserButton) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w appChooserButton) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w appChooserButton) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w appChooserButton) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w appChooserButton) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w appChooserButton) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w appChooserButton) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w appChooserButton) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w appChooserButton) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w appChooserButton) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w appChooserButton) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w appChooserButton) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w appChooserButton) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w appChooserButton) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w appChooserButton) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w appChooserButton) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w appChooserButton) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w appChooserButton) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w appChooserButton) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w appChooserButton) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w appChooserButton) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w appChooserButton) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w appChooserButton) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w appChooserButton) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w appChooserButton) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w appChooserButton) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w appChooserButton) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w appChooserButton) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w appChooserButton) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w appChooserButton) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w appChooserButton) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w appChooserButton) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w appChooserButton) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w appChooserButton) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w appChooserButton) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w appChooserButton) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w appChooserButton) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w appChooserButton) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w appChooserButton) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w appChooserButton) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w appChooserButton) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w appChooserButton) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w appChooserButton) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w appChooserButton) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w appChooserButton) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w appChooserButton) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w appChooserButton) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w appChooserButton) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w appChooserButton) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w appChooserButton) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w appChooserButton) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s appChooserButton) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w appChooserButton) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w appChooserButton) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w appChooserButton) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w appChooserButton) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w appChooserButton) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w appChooserButton) UnsetStateFlags(flags StateFlags) {
...
func (b appChooserButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b appChooserButton) GetName() string {
...
func (c appChooserButton) GetArea() CellArea {
...
func (s appChooserButton) GetContentType() string {
