...
type AppChooserDialog interface {
	...
	// This method is inherited from Buildable
	SetName(name string)
	// GetContentType returns the current value of the AppChooser:content-type
	// property.
	//
	// This method is inherited from AppChooser
...
// WrapAppChooserDialog wraps a GObject to a type that implements
// interface AppChooserDialog. It is primarily used internally.
...
func (a appChooserDialog) AsDialog() Dialog {
	return WrapDialog(gextras.InternObject(a))
}
...
func (w appChooserDialog) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w appChooserDialog) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w appChooserDialog) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w appChooserDialog) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w appChooserDialog) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w appChooserDialog) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w appChooserDialog) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w appChooserDialog) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w appChooserDialog) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w appChooserDialog) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w appChooserDialog) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w appChooserDialog) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w appChooserDialog) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w appChooserDialog) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w appChooserDialog) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w appChooserDialog) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w appChooserDialog) GetScaleFactor() int {
...
func (b appChooserDialog) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b appChooserDialog) GetName() string {
...
func (s appChooserDialog) GetContentType() string {
	return WrapAppChooser(gextras.InternObject(s)).GetContentType()
}
