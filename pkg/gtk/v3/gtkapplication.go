...
func classInitApplicationer(gclassPtr, data C.gpointer) {
	...
	*(*C.gpointer)(unsafe.Add(unsafe.Pointer(gclassPtr), goffset)) = data
	...
	if _, ok := goval.(interface{ WindowAdded(window *Window) }); ok {
		...
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_ApplicationClass_window_added)
	}

	if _, ok := goval.(interface{ WindowRemoved(window *Window) }); ok {
		o := pclass.StructFieldOffset("window_removed")
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_ApplicationClass_window_removed)
	}
}

//export _gotk4_gtk3_ApplicationClass_window_added
func _gotk4_gtk3_ApplicationClass_window_added(arg0 *C.void, arg1 *C.void) {
...
func _gotk4_gtk3_ApplicationClass_window_removed(arg0 *C.void, arg1 *C.void) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
...
func (application *Application) AddAccelerator(accelerator, actionName string, parameter *glib.Variant) {
	...
	*(**C.gchar)(unsafe.Pointer(&_args[2])) = (*C.gchar)(unsafe.Pointer(C.CString(actionName)))
	defer C.free(unsafe.Pointer(*(**C.gchar)(unsafe.Pointer(&_args[2]))))
	if parameter != nil {
		*(**C.GVariant)(unsafe.Pointer(&_args[3])) = (*C.GVariant)(gextras.StructNative(unsafe.Pointer(parameter)))
	}

	_info := girepository.MustFind("Gtk", "Application")
	_info.InvokeClassMethod("add_accelerator", _args[:], nil)
...
func (application *Application) AccelsForAction(detailedActionName string) []string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(application).Native()))
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(detailedActionName)))
	defer C.free(unsafe.Pointer(*(**C.gchar)(unsafe.Pointer(&_args[1]))))
...
func (application *Application) ActionsForAccel(accel string) []string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(application).Native()))
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(accel)))
	defer C.free(unsafe.Pointer(*(**C.gchar)(unsafe.Pointer(&_args[1]))))
...
func (application *Application) AppMenu() gio.MenuModeller {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(application).Native()))
	...
	_info := girepository.MustFind("Gtk", "Application")
	_gret := _info.InvokeClassMethod("get_app_menu", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func (application *Application) PrefersAppMenu() bool {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(application).Native()))
	...
	_info := girepository.MustFind("Gtk", "Application")
	_gret := _info.InvokeClassMethod("prefers_app_menu", _args[:], nil)
...
func (application *Application) RemoveAccelerator(actionName string, parameter *glib.Variant) {
	...
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(actionName)))
	...
	_info := girepository.MustFind("Gtk", "Application")
	_info.InvokeClassMethod("remove_accelerator", _args[:], nil)
...
func (application *Application) SetAccelsForAction(detailedActionName string, accels []string) {
	...
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(detailedActionName)))
	defer C.free(unsafe.Pointer(*(**C.gchar)(unsafe.Pointer(&_args[1]))))
	{
		*(***C.gchar)(unsafe.Pointer(&_args[2])) = (**C.gchar)(C.calloc(C.size_t((len(accels) + 1)), C.size_t(unsafe.Sizeof(uint(0)))))
		defer C.free(unsafe.Pointer(*(***C.gchar)(unsafe.Pointer(&_args[2]))))
		{
			...
			out[len(accels)] = zero
			for i := range accels {
				*(**C.gchar)(unsafe.Pointer(&out[i])) = (*C.gchar)(unsafe.Pointer(C.CString(accels[i])))
...
func (application *Application) SetAppMenu(appMenu gio.MenuModeller) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(application).Native()))
	if appMenu != nil {
		*(**C.void)(unsafe.Pointer(&_args[1])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(appMenu).Native()))
	}

	_info := girepository.MustFind("Gtk", "Application")
	_info.InvokeClassMethod("set_app_menu", _args[:], nil)
