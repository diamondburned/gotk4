...
// WrapApplicationWindow wraps a GObject to a type that implements
// interface ApplicationWindow. It is primarily used internally.
func WrapApplicationWindow(obj *externglib.Object) ApplicationWindow {
	return applicationWindow{obj}
}
...
func (a applicationWindow) AsWindow() Window {
...
func (w applicationWindow) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w applicationWindow) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w applicationWindow) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w applicationWindow) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w applicationWindow) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w applicationWindow) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w applicationWindow) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w applicationWindow) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w applicationWindow) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w applicationWindow) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w applicationWindow) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w applicationWindow) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w applicationWindow) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w applicationWindow) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w applicationWindow) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w applicationWindow) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w applicationWindow) GetScaleFactor() int {
...
func (b applicationWindow) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b applicationWindow) GetName() string {
...
func (a applicationWindow) GetActionEnabled(actionName string) bool {
	return gio.WrapActionGroup(gextras.InternObject(a)).GetActionEnabled(actionName)
}

func (a applicationWindow) GetActionParameterType(actionName string) *glib.VariantType {
	return gio.WrapActionGroup(gextras.InternObject(a)).GetActionParameterType(actionName)
}

func (a applicationWindow) GetActionState(actionName string) *glib.Variant {
	return gio.WrapActionGroup(gextras.InternObject(a)).GetActionState(actionName)
}

func (a applicationWindow) GetActionStateHint(actionName string) *glib.Variant {
	return gio.WrapActionGroup(gextras.InternObject(a)).GetActionStateHint(actionName)
}

func (a applicationWindow) GetActionStateType(actionName string) *glib.VariantType {
