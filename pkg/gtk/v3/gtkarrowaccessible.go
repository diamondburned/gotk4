...
// WrapArrowAccessible wraps a GObject to a type that implements
// interface ArrowAccessible. It is primarily used internally.
func WrapArrowAccessible(obj *externglib.Object) ArrowAccessible {
	return arrowAccessible{obj}
}
...
func (a arrowAccessible) AsWidgetAccessible() WidgetAccessible {
	return WrapWidgetAccessible(gextras.InternObject(a))
}
