...
type AspectFrame interface {
	...
	//
	// This method is inherited from Frame
	GetLabel() string
	// GetLabelAlign retrieves the X and Y alignment of the frame’s label. See
	// gtk_frame_set_label_align().
	//
	// This method is inherited from Frame
	GetLabelAlign() (xalign float32, yalign float32)
	// GetLabelWidget retrieves the label widget for the frame. See
	// gtk_frame_set_label_widget().
	//
	// This method is inherited from Frame
	GetLabelWidget() Widget
	// GetShadowType retrieves the shadow type of the frame. See
...
// WrapAspectFrame wraps a GObject to a type that implements
// interface AspectFrame. It is primarily used internally.
...
func (a aspectFrame) AsFrame() Frame {
	return WrapFrame(gextras.InternObject(a))
}
...
func (b aspectFrame) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b aspectFrame) GetName() string {
