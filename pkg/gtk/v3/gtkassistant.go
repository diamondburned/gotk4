...
func (w assistant) ActivateDefault() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateDefault()
}

func (w assistant) ActivateFocus() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateFocus()
}

func (w assistant) ActivateKey(event *gdk.EventKey) bool {
	return WrapWindow(gextras.InternObject(w)).ActivateKey(event)
}

func (w assistant) AddAccelGroup(accelGroup AccelGroup) {
	WrapWindow(gextras.InternObject(w)).AddAccelGroup(accelGroup)
}

func (w assistant) AddMnemonic(keyval uint, target Widget) {
	WrapWindow(gextras.InternObject(w)).AddMnemonic(keyval, target)
}

func (w assistant) BeginMoveDrag(button int, rootX int, rootY int, timestamp uint32) {
	WrapWindow(gextras.InternObject(w)).BeginMoveDrag(button, rootX, rootY, timestamp)
}

func (w assistant) BeginResizeDrag(edge gdk.WindowEdge, button int, rootX int, rootY int, timestamp uint32) {
...
func (w assistant) FullscreenOnMonitor(screen gdk.Screen, monitor int) {
	WrapWindow(gextras.InternObject(w)).FullscreenOnMonitor(screen, monitor)
}

func (w assistant) GetAcceptFocus() bool {
...
func (w assistant) GetAttachedTo() Widget {
...
func (w assistant) GetFocusOnMap() bool {
...
func (w assistant) GetGravity() gdk.Gravity {
...
func (w assistant) GetHasResizeGrip() bool {
	return WrapWindow(gextras.InternObject(w)).GetHasResizeGrip()
}

func (w assistant) GetHideTitlebarWhenMaximized() bool {
	return WrapWindow(gextras.InternObject(w)).GetHideTitlebarWhenMaximized()
}

func (w assistant) GetIcon() gdkpixbuf.Pixbuf {
...
func (w assistant) GetMnemonicModifier() gdk.ModifierType {
...
func (w assistant) GetPosition() (rootX int, rootY int) {
...
func (w assistant) GetTypeHint() gdk.WindowTypeHint {
	return WrapWindow(gextras.InternObject(w)).GetTypeHint()
}

func (w assistant) GetUrgencyHint() bool {
	return WrapWindow(gextras.InternObject(w)).GetUrgencyHint()
}

func (w assistant) GetWindowType() WindowType {
...
func (w assistant) HasToplevelFocus() bool {
	return WrapWindow(gextras.InternObject(w)).HasToplevelFocus()
}

func (w assistant) Iconify() {
...
func (w assistant) MnemonicActivate(keyval uint, modifier gdk.ModifierType) bool {
	return WrapWindow(gextras.InternObject(w)).MnemonicActivate(keyval, modifier)
}

func (w assistant) Move(x int, y int) {
	WrapWindow(gextras.InternObject(w)).Move(x, y)
}

func (w assistant) ParseGeometry(geometry string) bool {
...
func (w assistant) SetAttachedTo(attachWidget Widget) {
...
func (w assistant) SetDefault(defaultWidget Widget) {
	WrapWindow(gextras.InternObject(w)).SetDefault(defaultWidget)
}

func (w assistant) SetDefaultGeometry(width int, height int) {
...
func (w assistant) SetFocusOnMap(setting bool) {
...
func (w assistant) SetGeometryHints(geometryWidget Widget, geometry *gdk.Geometry, geomMask gdk.WindowHints) {
	WrapWindow(gextras.InternObject(w)).SetGeometryHints(geometryWidget, geometry, geomMask)
}

func (w assistant) SetGravity(gravity gdk.Gravity) {
	WrapWindow(gextras.InternObject(w)).SetGravity(gravity)
}

func (w assistant) SetHasResizeGrip(value bool) {
	WrapWindow(gextras.InternObject(w)).SetHasResizeGrip(value)
}

func (w assistant) SetHasUserRefCount(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetHasUserRefCount(setting)
}

func (w assistant) SetHideTitlebarWhenMaximized(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetHideTitlebarWhenMaximized(setting)
}

func (w assistant) SetIcon(icon gdkpixbuf.Pixbuf) {
	WrapWindow(gextras.InternObject(w)).SetIcon(icon)
}

func (w assistant) SetIconFromFile(filename string) error {
...
func (w assistant) SetKeepAbove(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetKeepAbove(setting)
}

func (w assistant) SetKeepBelow(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetKeepBelow(setting)
}

func (w assistant) SetMnemonicModifier(modifier gdk.ModifierType) {
...
func (w assistant) SetPosition(position WindowPosition) {
...
func (w assistant) SetRole(role string) {
	WrapWindow(gextras.InternObject(w)).SetRole(role)
}

func (w assistant) SetScreen(screen gdk.Screen) {
	WrapWindow(gextras.InternObject(w)).SetScreen(screen)
}

func (w assistant) SetSkipPagerHint(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetSkipPagerHint(setting)
}

func (w assistant) SetSkipTaskbarHint(setting bool) {
...
func (w assistant) SetTypeHint(hint gdk.WindowTypeHint) {
	WrapWindow(gextras.InternObject(w)).SetTypeHint(hint)
}

func (w assistant) SetUrgencyHint(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetUrgencyHint(setting)
}

func (w assistant) SetWmclass(wmclassName string, wmclassClass string) {
	WrapWindow(gextras.InternObject(w)).SetWmclass(wmclassName, wmclassClass)
}

func (w assistant) Stick() {
...
func (w assistant) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w assistant) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w assistant) AddEvents(events int) {
...
func (w assistant) CanActivateAccel(signalId uint) bool {
...
func (w assistant) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w assistant) ClassPath() (pathLength uint, path string, pathReversed string) {
...
func (w assistant) DeviceIsShadowed(device gdk.Device) bool {
...
func (w assistant) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w assistant) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w assistant) GetActionGroup(prefix string) gio.ActionGroup {
...
func (w assistant) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w assistant) GetCanDefault() bool {
...
func (w assistant) GetChildRequisition() Requisition {
...
func (w assistant) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w assistant) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w assistant) GetDeviceEvents(device gdk.Device) gdk.EventMask {
...
func (w assistant) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w assistant) GetEvents() int {
...
func (w assistant) GetHasWindow() bool {
...
func (w assistant) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w assistant) GetMarginRight() int {
...
func (w assistant) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w assistant) GetModifierStyle() RCStyle {
...
func (w assistant) GetNoShowAll() bool {
...
func (w assistant) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w assistant) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w assistant) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w assistant) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w assistant) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w assistant) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
...
func (w assistant) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w assistant) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
...
func (w assistant) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w assistant) GetRootWindow() gdk.Window {
...
func (w assistant) GetState() StateType {
...
func (w assistant) GetStyle() Style {
...
func (w assistant) GetSupportMultidevice() bool {
...
func (w assistant) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w assistant) GetToplevel() Widget {
...
func (w assistant) GetVAlignWithBaseline() Align {
...
func (w assistant) HideOnDelete() bool {
...
func (w assistant) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w assistant) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w assistant) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
...
func (w assistant) IsComposited() bool {
...
func (w assistant) IsToplevel() bool {
...
func (w assistant) ListActionPrefixes() []string {
...
func (w assistant) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w assistant) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w assistant) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w assistant) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w assistant) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w assistant) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w assistant) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w assistant) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w assistant) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w assistant) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w assistant) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w assistant) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w assistant) Path() (pathLength uint, path string, pathReversed string) {
...
func (w assistant) QueueComputeExpand() {
...
func (w assistant) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w assistant) QueueDrawRegion(region *cairo.Region) {
...
func (w assistant) QueueResizeNoRedraw() {
...
func (w assistant) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w assistant) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w assistant) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
...
func (w assistant) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w assistant) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w assistant) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w assistant) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w assistant) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w assistant) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w assistant) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w assistant) SetCanDefault(canDefault bool) {
...
func (w assistant) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w assistant) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w assistant) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w assistant) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
...
func (w assistant) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w assistant) SetEvents(events int) {
...
func (w assistant) SetHasWindow(hasWindow bool) {
...
func (w assistant) SetMapped(mapped bool) {
...
func (w assistant) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w assistant) SetMarginRight(margin int) {
...
func (w assistant) SetNoShowAll(noShowAll bool) {
...
func (w assistant) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w assistant) SetRealized(realized bool) {
...
func (w assistant) SetRedrawOnAllocate(redrawOnAllocate bool) {
...
func (w assistant) SetState(state StateType) {
...
func (w assistant) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w assistant) SetSupportMultidevice(supportMultidevice bool) {
...
func (w assistant) SetTooltipWindow(customWindow Window) {
...
func (w assistant) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w assistant) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w assistant) ShapeCombineRegion(region *cairo.Region) {
...
func (w assistant) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w assistant) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w assistant) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w assistant) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w assistant) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w assistant) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s assistant) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
...
func (w assistant) UnregisterWindow(window gdk.Window) {
...
func (b assistant) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b assistant) GetName() string {
