...
// WrapButtonBox wraps a GObject to a type that implements
// interface ButtonBox. It is primarily used internally.
...
func (b buttonBox) AsBox() Box {
	return WrapBox(gextras.InternObject(b))
}
...
func (b buttonBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b buttonBox) GetName() string {
...
func (o buttonBox) GetOrientation() Orientation {
