...
// WrapBin wraps a GObject to a type that implements
// interface Bin. It is primarily used internally.
...
func (b bin) AsContainer() Container {
...
func (w bin) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w bin) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w bin) UnsetStateFlags(flags StateFlags) {
...
func (b bin) GetInternalChild(builder Builder, childname string) gextras.Objector {
