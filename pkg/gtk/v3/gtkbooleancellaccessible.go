...
// WrapBooleanCellAccessible wraps a GObject to a type that implements
// interface BooleanCellAccessible. It is primarily used internally.
func WrapBooleanCellAccessible(obj *externglib.Object) BooleanCellAccessible {
	return booleanCellAccessible{obj}
}
...
func (b booleanCellAccessible) AsRendererCellAccessible() RendererCellAccessible {
	return WrapRendererCellAccessible(gextras.InternObject(b))
}
...
func (a booleanCellAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a booleanCellAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a booleanCellAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a booleanCellAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a booleanCellAccessible) GetName(i int) string {
