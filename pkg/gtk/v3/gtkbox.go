...
// WrapBox wraps a GObject to a type that implements
// interface Box. It is primarily used internally.
...
func (b box) AsContainer() Container {
	return WrapContainer(gextras.InternObject(b))
}
...
func (w box) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w box) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w box) UnsetStateFlags(flags StateFlags) {
...
func (b box) GetInternalChild(builder Builder, childname string) gextras.Objector {
...
func (o box) GetOrientation() Orientation {
