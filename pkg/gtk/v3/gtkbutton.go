...
// WrapButton wraps a GObject to a type that implements
// interface Button. It is primarily used internally.
...
func (b button) AsBin() Bin {
	return WrapBin(gextras.InternObject(b))
}
...
func (w button) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w button) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w button) ShapeCombineRegion(region *cairo.Region) {
...
func (b button) GetInternalChild(builder Builder, childname string) gextras.Objector {
...
func (a button) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a button) GetActionTargetValue() *glib.Variant {
...
func (a button) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a button) GetUseActionAppearance() bool {
