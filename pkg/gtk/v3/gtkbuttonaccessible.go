...
// WrapButtonAccessible wraps a GObject to a type that implements
// interface ButtonAccessible. It is primarily used internally.
func WrapButtonAccessible(obj *externglib.Object) ButtonAccessible {
	return buttonAccessible{obj}
}
...
func (b buttonAccessible) AsContainerAccessible() ContainerAccessible {
	return WrapContainerAccessible(gextras.InternObject(b))
}
...
func (i buttonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i buttonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i buttonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i buttonAccessible) GetImageSize() (width int, height int) {
