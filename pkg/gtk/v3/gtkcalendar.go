...
// WrapCalendar wraps a GObject to a type that implements
// interface Calendar. It is primarily used internally.
...
func (c calendar) AsWidget() Widget {
...
func (b calendar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b calendar) GetName() string {
