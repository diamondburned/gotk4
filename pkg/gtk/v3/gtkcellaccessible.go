...
// cellAccessible implements the CellAccessible interface.
type cellAccessible struct {
	*externglib.Object
}

var _ CellAccessible = (*cellAccessible)(nil)

// WrapCellAccessible wraps a GObject to a type that implements
// interface CellAccessible. It is primarily used internally.
func WrapCellAccessible(obj *externglib.Object) CellAccessible {
	return cellAccessible{obj}
}
...
func (c cellAccessible) AsAccessible() Accessible {
