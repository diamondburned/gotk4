...
// extern void _gotk4_gtk3_CellAreaContextClass_allocate(void*, gint, gint);
// extern void _gotk4_gtk3_CellAreaContextClass_get_preferred_height_for_width(void*, gint, gint*, gint*);
// extern void _gotk4_gtk3_CellAreaContextClass_get_preferred_width_for_height(void*, gint, gint*, gint*);
// extern void _gotk4_gtk3_CellAreaContextClass_reset(void*);
import "C"
...
func classInitCellAreaContexter(gclassPtr, data C.gpointer) {
	...
	*(*C.gpointer)(unsafe.Add(unsafe.Pointer(gclassPtr), goffset)) = data
	...
	if _, ok := goval.(interface{ Allocate(width, height int32) }); ok {
		...
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_CellAreaContextClass_allocate)
	}
	...
	if _, ok := goval.(interface {
		...
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_CellAreaContextClass_get_preferred_height_for_width)
	}
	...
	if _, ok := goval.(interface {
		...
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_CellAreaContextClass_get_preferred_width_for_height)
	}

	if _, ok := goval.(interface{ Reset() }); ok {
		o := pclass.StructFieldOffset("reset")
		*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gclassPtr), o)) = unsafe.Pointer(C._gotk4_gtk3_CellAreaContextClass_reset)
	}
}

//export _gotk4_gtk3_CellAreaContextClass_allocate
func _gotk4_gtk3_CellAreaContextClass_allocate(arg0 *C.void, arg1 C.gint, arg2 C.gint) {
...
func _gotk4_gtk3_CellAreaContextClass_get_preferred_height_for_width(arg0 *C.void, arg1 C.gint, arg2 *C.gint, arg3 *C.gint) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
...
func _gotk4_gtk3_CellAreaContextClass_get_preferred_width_for_height(arg0 *C.void, arg1 C.gint, arg2 *C.gint, arg3 *C.gint) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(interface {
		PreferredWidthForHeight(height int32) (minimumWidth, naturalWidth int32)
	})
...
func _gotk4_gtk3_CellAreaContextClass_reset(arg0 *C.void) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
