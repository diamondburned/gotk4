...
// WrapCellView wraps a GObject to a type that implements
// interface CellView. It is primarily used internally.
...
func (c cellView) AsWidget() Widget {
...
func (b cellView) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b cellView) GetName() string {
...
func (c cellView) GetArea() CellArea {
...
func (o cellView) GetOrientation() Orientation {
