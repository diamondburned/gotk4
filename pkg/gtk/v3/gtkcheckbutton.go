...
// WrapCheckButton wraps a GObject to a type that implements
// interface CheckButton. It is primarily used internally.
...
func (c checkButton) AsToggleButton() ToggleButton {
	return WrapToggleButton(gextras.InternObject(c))
}
...
func (b checkButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b checkButton) GetName() string {
...
func (a checkButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a checkButton) GetActionTargetValue() *glib.Variant {
...
func (a checkButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a checkButton) GetUseActionAppearance() bool {
