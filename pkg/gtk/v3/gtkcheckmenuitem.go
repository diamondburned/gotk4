...
// CheckMenuItemClass implements the CheckMenuItem interface.
...
func NewCheckMenuItem() *CheckMenuItemClass {
	...
	_checkMenuItem = (gextras.CastObject(externglib.Take(unsafe.Pointer(_cret)))).(*CheckMenuItemClass)
