...
// WrapCheckMenuItem wraps a GObject to a type that implements
// interface CheckMenuItem. It is primarily used internally.
...
func (c checkMenuItem) AsMenuItem() MenuItem {
	return WrapMenuItem(gextras.InternObject(c))
}
...
func (b checkMenuItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b checkMenuItem) GetName() string {
...
func (a checkMenuItem) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a checkMenuItem) GetActionTargetValue() *glib.Variant {
...
func (a checkMenuItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a checkMenuItem) GetUseActionAppearance() bool {
