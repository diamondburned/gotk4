...
// WrapColorButton wraps a GObject to a type that implements
// interface ColorButton. It is primarily used internally.
...
func (c colorButton) AsButton() Button {
	return WrapButton(gextras.InternObject(c))
}
...
func (b colorButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b colorButton) GetName() string {
...
func (a colorButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a colorButton) GetActionTargetValue() *glib.Variant {
...
func (a colorButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a colorButton) GetUseActionAppearance() bool {
...
func (c colorButton) GetRGBA() gdk.RGBA {
