...
// #include <stdlib.h>
// #include <glib.h>
// extern void _gotk4_gtk3_ColorChooserInterface_color_activated(void*, void*);
// extern void _gotk4_gtk3_ColorChooserInterface_get_rgba(void*, void*);
// extern void _gotk4_gtk3_ColorChooserInterface_set_rgba(void*, void*);
...
func ifaceInitColorChooserer(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("color_activated"))) = unsafe.Pointer(C._gotk4_gtk3_ColorChooserInterface_color_activated)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_rgba"))) = unsafe.Pointer(C._gotk4_gtk3_ColorChooserInterface_get_rgba)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("set_rgba"))) = unsafe.Pointer(C._gotk4_gtk3_ColorChooserInterface_set_rgba)
}

//export _gotk4_gtk3_ColorChooserInterface_color_activated
func _gotk4_gtk3_ColorChooserInterface_color_activated(arg0 *C.void, arg1 *C.void) {
...
func _gotk4_gtk3_ColorChooserInterface_get_rgba(arg0 *C.void, arg1 *C.void) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(ColorChooserOverrider)
...
func _gotk4_gtk3_ColorChooserInterface_set_rgba(arg0 *C.void, arg1 *C.void) {
	goval := coreglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(ColorChooserOverrider)
...
func _gotk4_gtk3_ColorChooser_ConnectColorActivated(arg0 C.gpointer, arg1 *C.void, arg2 C.guintptr) {
