...
type ColorChooserDialog interface {
	...
	//
	// This method is inherited from ColorChooser
	AddPalette(orientation Orientation, colorsPerLine int, colors []gdk.RGBA)
	// GetRGBA gets the currently-selected color.
	//
	// This method is inherited from ColorChooser
	GetRGBA() gdk.RGBA
	// GetUseAlpha returns whether the color chooser shows the alpha channel.
	//
	// This method is inherited from ColorChooser
	GetUseAlpha() bool
...
// WrapColorChooserDialog wraps a GObject to a type that implements
// interface ColorChooserDialog. It is primarily used internally.
func WrapColorChooserDialog(obj *externglib.Object) ColorChooserDialog {
	return colorChooserDialog{obj}
}
...
func (c colorChooserDialog) AsDialog() Dialog {
...
func (w colorChooserDialog) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w colorChooserDialog) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w colorChooserDialog) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w colorChooserDialog) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w colorChooserDialog) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w colorChooserDialog) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w colorChooserDialog) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w colorChooserDialog) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w colorChooserDialog) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w colorChooserDialog) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w colorChooserDialog) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w colorChooserDialog) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w colorChooserDialog) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w colorChooserDialog) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w colorChooserDialog) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w colorChooserDialog) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w colorChooserDialog) GetScaleFactor() int {
...
func (w colorChooserDialog) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w colorChooserDialog) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w colorChooserDialog) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w colorChooserDialog) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w colorChooserDialog) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w colorChooserDialog) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w colorChooserDialog) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w colorChooserDialog) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w colorChooserDialog) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w colorChooserDialog) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w colorChooserDialog) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w colorChooserDialog) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w colorChooserDialog) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w colorChooserDialog) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w colorChooserDialog) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w colorChooserDialog) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w colorChooserDialog) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w colorChooserDialog) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w colorChooserDialog) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w colorChooserDialog) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w colorChooserDialog) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w colorChooserDialog) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w colorChooserDialog) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w colorChooserDialog) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w colorChooserDialog) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w colorChooserDialog) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w colorChooserDialog) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w colorChooserDialog) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s colorChooserDialog) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w colorChooserDialog) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w colorChooserDialog) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w colorChooserDialog) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w colorChooserDialog) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w colorChooserDialog) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w colorChooserDialog) UnsetStateFlags(flags StateFlags) {
...
func (b colorChooserDialog) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b colorChooserDialog) GetName() string {
...
func (c colorChooserDialog) GetRGBA() gdk.RGBA {
	return WrapColorChooser(gextras.InternObject(c)).GetRGBA()
}

func (c colorChooserDialog) GetUseAlpha() bool {
	return WrapColorChooser(gextras.InternObject(c)).GetUseAlpha()
}
