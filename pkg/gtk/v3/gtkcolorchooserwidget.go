...
// WrapColorChooserWidget wraps a GObject to a type that implements
// interface ColorChooserWidget. It is primarily used internally.
func WrapColorChooserWidget(obj *externglib.Object) ColorChooserWidget {
	return colorChooserWidget{obj}
}
...
func (c colorChooserWidget) AsBox() Box {
	return WrapBox(gextras.InternObject(c))
}
...
func (b colorChooserWidget) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b colorChooserWidget) GetName() string {
...
func (o colorChooserWidget) GetOrientation() Orientation {
...
func (c colorChooserWidget) GetRGBA() gdk.RGBA {
	return WrapColorChooser(gextras.InternObject(c)).GetRGBA()
}

func (c colorChooserWidget) GetUseAlpha() bool {
