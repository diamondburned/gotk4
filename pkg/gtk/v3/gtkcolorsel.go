...
// WrapColorSelection wraps a GObject to a type that implements
// interface ColorSelection. It is primarily used internally.
...
func (c colorSelection) AsBox() Box {
...
func (b colorSelection) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b colorSelection) GetName() string {
...
func (o colorSelection) GetOrientation() Orientation {
