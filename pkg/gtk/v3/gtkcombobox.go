...
// WrapComboBox wraps a GObject to a type that implements
// interface ComboBox. It is primarily used internally.
...
func (c comboBox) AsBin() Bin {
	return WrapBin(gextras.InternObject(c))
}
...
func (b comboBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b comboBox) GetName() string {
...
func (c comboBox) GetArea() CellArea {
