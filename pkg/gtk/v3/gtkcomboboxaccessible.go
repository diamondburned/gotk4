...
// WrapComboBoxAccessible wraps a GObject to a type that implements
// interface ComboBoxAccessible. It is primarily used internally.
func WrapComboBoxAccessible(obj *externglib.Object) ComboBoxAccessible {
	return comboBoxAccessible{obj}
}
...
func (c comboBoxAccessible) AsContainerAccessible() ContainerAccessible {
	return WrapContainerAccessible(gextras.InternObject(c))
}
...
func (a comboBoxAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a comboBoxAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a comboBoxAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a comboBoxAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a comboBoxAccessible) GetName(i int) string {
