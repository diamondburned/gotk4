...
type ComboBoxText interface {
	...
	// @combo_box. If @id is non-nil then it is used as the ID of the row.
	//
	...
	// stored in @combo_box. If @id is non-nil then it is used as the ID of the
	// row. See ComboBox:id-column.
	//
