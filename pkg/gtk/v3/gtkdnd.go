...
// in drag and drop.
func DragSetIconGIcon(context *gdk.DragContext, icon gio.Iconner, hotX int32, hotY int32) {
	var _arg1 *C.GdkDragContext // out
...
func DragSetIconWidget(context *gdk.DragContext, widget Widgetter, hotX int32, hotY int32) {
	var _arg1 *C.GdkDragContext // out
