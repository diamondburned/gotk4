...
// WrapDrawingArea wraps a GObject to a type that implements
// interface DrawingArea. It is primarily used internally.
...
func (d drawingArea) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(d))
}
...
func (b drawingArea) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b drawingArea) GetName() string {
