...
// extern void _gotk4_gtk3_EditableInterface_do_delete_text(GtkEditable*, gint, gint);
// extern void _gotk4_gtk3_EditableInterface_set_position(GtkEditable*, gint);
// extern void _gotk4_gtk3_EditableInterface_set_selection_bounds(GtkEditable*, gint, gint);
...
func ifaceInitEditabler(gifacePtr, data C.gpointer) {
	...
	iface.changed = (*[0]byte)(C._gotk4_gtk3_EditableInterface_changed)
	iface.delete_text = (*[0]byte)(C._gotk4_gtk3_EditableInterface_delete_text)
	iface.do_delete_text = (*[0]byte)(C._gotk4_gtk3_EditableInterface_do_delete_text)
	iface.get_chars = (*[0]byte)(C._gotk4_gtk3_EditableInterface_get_chars)
	iface.get_position = (*[0]byte)(C._gotk4_gtk3_EditableInterface_get_position)
	iface.get_selection_bounds = (*[0]byte)(C._gotk4_gtk3_EditableInterface_get_selection_bounds)
	iface.set_position = (*[0]byte)(C._gotk4_gtk3_EditableInterface_set_position)
	iface.set_selection_bounds = (*[0]byte)(C._gotk4_gtk3_EditableInterface_set_selection_bounds)
}

//export _gotk4_gtk3_EditableInterface_changed
func _gotk4_gtk3_EditableInterface_changed(arg0 *C.GtkEditable) {
...
//export _gotk4_gtk3_EditableInterface_delete_text
func _gotk4_gtk3_EditableInterface_delete_text(arg0 *C.GtkEditable, arg1 C.gint, arg2 C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
...
//export _gotk4_gtk3_EditableInterface_do_delete_text
func _gotk4_gtk3_EditableInterface_do_delete_text(arg0 *C.GtkEditable, arg1 C.gint, arg2 C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
...
//export _gotk4_gtk3_EditableInterface_get_chars
func _gotk4_gtk3_EditableInterface_get_chars(arg0 *C.GtkEditable, arg1 C.gint, arg2 C.gint) (cret *C.gchar) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
	...
	utf8 := iface.Chars(_startPos, _endPos)
...
//export _gotk4_gtk3_EditableInterface_get_position
func _gotk4_gtk3_EditableInterface_get_position(arg0 *C.GtkEditable) (cret C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
...
//export _gotk4_gtk3_EditableInterface_get_selection_bounds
func _gotk4_gtk3_EditableInterface_get_selection_bounds(arg0 *C.GtkEditable, arg1 *C.gint, arg2 *C.gint) (cret C.gboolean) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
...
//export _gotk4_gtk3_EditableInterface_set_position
func _gotk4_gtk3_EditableInterface_set_position(arg0 *C.GtkEditable, arg1 C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
	...
	iface.SetPosition(_position)
}

//export _gotk4_gtk3_EditableInterface_set_selection_bounds
func _gotk4_gtk3_EditableInterface_set_selection_bounds(arg0 *C.GtkEditable, arg1 C.gint, arg2 C.gint) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(EditableOverrider)
