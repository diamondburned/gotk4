...
// WrapEntryAccessible wraps a GObject to a type that implements
// interface EntryAccessible. It is primarily used internally.
func WrapEntryAccessible(obj *externglib.Object) EntryAccessible {
	return entryAccessible{obj}
}
...
func (e entryAccessible) AsWidgetAccessible() WidgetAccessible {
	return WrapWidgetAccessible(gextras.InternObject(e))
}
