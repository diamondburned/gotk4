...
// WrapEventBox wraps a GObject to a type that implements
// interface EventBox. It is primarily used internally.
...
func (b eventBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b eventBox) GetName() string {
