...
// WrapExpander wraps a GObject to a type that implements
// interface Expander. It is primarily used internally.
...
func (e expander) AsBin() Bin {
	return WrapBin(gextras.InternObject(e))
}
...
func (b expander) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b expander) GetName() string {
