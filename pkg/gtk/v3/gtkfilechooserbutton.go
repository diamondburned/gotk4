...
// WrapFileChooserButton wraps a GObject to a type that implements
// interface FileChooserButton. It is primarily used internally.
...
func (f fileChooserButton) AsBox() Box {
...
func (b fileChooserButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fileChooserButton) GetName() string {
...
func (o fileChooserButton) GetOrientation() Orientation {
