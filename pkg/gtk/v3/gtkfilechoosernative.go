...
// FileChooserNative is an abstraction of a dialog box suitable for use
// with “File/Open” or “File/Save as” commands. By default, this just uses
// a FileChooserDialog to implement the actual dialog. However, on certain
...
// use with FileChooserNative, as such use would prohibit the use of a native
// dialog.
//
// There is no support for the signals that are emitted when the user
// navigates in the dialog, including: * FileChooser::current-folder-changed
