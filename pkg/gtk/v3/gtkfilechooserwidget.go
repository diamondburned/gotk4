...
// WrapFileChooserWidget wraps a GObject to a type that implements
// interface FileChooserWidget. It is primarily used internally.
...
func (f fileChooserWidget) AsBox() Box {
...
func (b fileChooserWidget) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fileChooserWidget) GetName() string {
...
func (o fileChooserWidget) GetOrientation() Orientation {
