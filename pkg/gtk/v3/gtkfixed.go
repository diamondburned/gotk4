...
// WrapFixed wraps a GObject to a type that implements
// interface Fixed. It is primarily used internally.
...
func (f fixed) AsContainer() Container {
...
func (b fixed) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fixed) GetName() string {
