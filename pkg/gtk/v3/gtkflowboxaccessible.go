...
// WrapFlowBoxAccessible wraps a GObject to a type that implements
// interface FlowBoxAccessible. It is primarily used internally.
func WrapFlowBoxAccessible(obj *externglib.Object) FlowBoxAccessible {
	return flowBoxAccessible{obj}
}
