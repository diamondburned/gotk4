...
// WrapFontButton wraps a GObject to a type that implements
// interface FontButton. It is primarily used internally.
...
func (f fontButton) AsButton() Button {
	return WrapButton(gextras.InternObject(f))
}
...
func (b fontButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fontButton) GetName() string {
...
func (a fontButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a fontButton) GetActionTargetValue() *glib.Variant {
...
func (a fontButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a fontButton) GetUseActionAppearance() bool {
