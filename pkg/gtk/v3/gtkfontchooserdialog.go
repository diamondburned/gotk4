...
type FontChooserDialog interface {
	...
	// This method is inherited from Buildable
	SetName(name string)
	// GetFont gets the currently-selected font name.
	//
	...
	// descriptions.
	//
	// This method is inherited from FontChooser
	GetFont() string
	// GetFontDesc gets the currently-selected font.
	//
	// Note that this can be a different string than what you set with
	// gtk_font_chooser_set_font(), as the font chooser widget may normalize
	// font names and thus return a string with a different structure. For
	...
	// GetFontFace gets the FontFace representing the selected font group
	...
	// GetFontFamily gets the FontFamily representing the selected font family.
	...
	// GetFontFeatures gets the currently-selected font features.
	//
	// This method is inherited from FontChooser
	GetFontFeatures() string
	// GetFontMap gets the custom font map of this font chooser widget, or nil
	// if it does not have one.
	//
	// This method is inherited from FontChooser
	GetFontMap() pango.FontMap
	// GetFontSize: the selected font size.
	//
	// This method is inherited from FontChooser
	GetFontSize() int
	// GetLanguage gets the language that is used for font features.
	//
	// This method is inherited from FontChooser
	GetLanguage() string
	// GetLevel returns the current level of granularity for selecting fonts.
	//
	// This method is inherited from FontChooser
	GetLevel() FontChooserLevel
	// GetPreviewText gets the text displayed in the preview area.
	//
	// This method is inherited from FontChooser
	GetPreviewText() string
	// GetShowPreviewEntry returns whether the preview entry is shown or not.
	//
	// This method is inherited from FontChooser
...
// WrapFontChooserDialog wraps a GObject to a type that implements
// interface FontChooserDialog. It is primarily used internally.
...
func (f fontChooserDialog) AsDialog() Dialog {
...
func (w fontChooserDialog) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w fontChooserDialog) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w fontChooserDialog) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w fontChooserDialog) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w fontChooserDialog) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w fontChooserDialog) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w fontChooserDialog) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w fontChooserDialog) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w fontChooserDialog) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w fontChooserDialog) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w fontChooserDialog) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w fontChooserDialog) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w fontChooserDialog) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w fontChooserDialog) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w fontChooserDialog) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w fontChooserDialog) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w fontChooserDialog) GetScaleFactor() int {
...
func (b fontChooserDialog) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fontChooserDialog) GetName() string {
...
func (f fontChooserDialog) GetFont() string {
	return WrapFontChooser(gextras.InternObject(f)).GetFont()
}

func (f fontChooserDialog) GetFontDesc() *pango.FontDescription {
	return WrapFontChooser(gextras.InternObject(f)).GetFontDesc()
}

func (f fontChooserDialog) GetFontFace() pango.FontFace {
	return WrapFontChooser(gextras.InternObject(f)).GetFontFace()
}

func (f fontChooserDialog) GetFontFamily() pango.FontFamily {
	return WrapFontChooser(gextras.InternObject(f)).GetFontFamily()
}

func (f fontChooserDialog) GetFontFeatures() string {
	return WrapFontChooser(gextras.InternObject(f)).GetFontFeatures()
}

func (f fontChooserDialog) GetFontMap() pango.FontMap {
	return WrapFontChooser(gextras.InternObject(f)).GetFontMap()
}

func (f fontChooserDialog) GetFontSize() int {
	return WrapFontChooser(gextras.InternObject(f)).GetFontSize()
}

func (f fontChooserDialog) GetLanguage() string {
	return WrapFontChooser(gextras.InternObject(f)).GetLanguage()
}

func (f fontChooserDialog) GetLevel() FontChooserLevel {
	return WrapFontChooser(gextras.InternObject(f)).GetLevel()
}

func (f fontChooserDialog) GetPreviewText() string {
	return WrapFontChooser(gextras.InternObject(f)).GetPreviewText()
}

func (f fontChooserDialog) GetShowPreviewEntry() bool {
	return WrapFontChooser(gextras.InternObject(f)).GetShowPreviewEntry()
}
