...
// WrapFontChooserWidget wraps a GObject to a type that implements
// interface FontChooserWidget. It is primarily used internally.
...
func (f fontChooserWidget) AsBox() Box {
...
func (b fontChooserWidget) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fontChooserWidget) GetName() string {
...
func (o fontChooserWidget) GetOrientation() Orientation {
