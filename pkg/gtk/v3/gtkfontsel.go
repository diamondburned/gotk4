...
type FontSelection interface {
	...
	//
	// This method is inherited from Box
	GetBaselinePosition() BaselinePosition
	// GetCenterWidget retrieves the center widget of the box.
	//
	// This method is inherited from Box
...
// WrapFontSelection wraps a GObject to a type that implements
// interface FontSelection. It is primarily used internally.
...
func (f fontSelection) AsBox() Box {
	return WrapBox(gextras.InternObject(f))
}
...
func (b fontSelection) GetBaselinePosition() BaselinePosition {
	return WrapBox(gextras.InternObject(b)).GetBaselinePosition()
}

func (b fontSelection) GetCenterWidget() Widget {
	return WrapBox(gextras.InternObject(b)).GetCenterWidget()
}

func (b fontSelection) GetHomogeneous() bool {
	return WrapBox(gextras.InternObject(b)).GetHomogeneous()
}

func (b fontSelection) GetSpacing() int {
	return WrapBox(gextras.InternObject(b)).GetSpacing()
}

func (b fontSelection) PackEnd(child Widget, expand bool, fill bool, padding uint) {
	WrapBox(gextras.InternObject(b)).PackEnd(child, expand, fill, padding)
}

func (b fontSelection) PackStart(child Widget, expand bool, fill bool, padding uint) {
	WrapBox(gextras.InternObject(b)).PackStart(child, expand, fill, padding)
}

func (b fontSelection) QueryChildPacking(child Widget) (expand bool, fill bool, padding uint, packType PackType) {
	return WrapBox(gextras.InternObject(b)).QueryChildPacking(child)
}

func (b fontSelection) ReorderChild(child Widget, position int) {
	WrapBox(gextras.InternObject(b)).ReorderChild(child, position)
}

func (b fontSelection) SetBaselinePosition(position BaselinePosition) {
	WrapBox(gextras.InternObject(b)).SetBaselinePosition(position)
}

func (b fontSelection) SetCenterWidget(widget Widget) {
	WrapBox(gextras.InternObject(b)).SetCenterWidget(widget)
}

func (b fontSelection) SetChildPacking(child Widget, expand bool, fill bool, padding uint, packType PackType) {
	WrapBox(gextras.InternObject(b)).SetChildPacking(child, expand, fill, padding, packType)
}

func (b fontSelection) SetHomogeneous(homogeneous bool) {
	WrapBox(gextras.InternObject(b)).SetHomogeneous(homogeneous)
}

func (b fontSelection) SetSpacing(spacing int) {
	WrapBox(gextras.InternObject(b)).SetSpacing(spacing)
}

func (c fontSelection) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c fontSelection) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c fontSelection) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c fontSelection) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c fontSelection) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c fontSelection) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c fontSelection) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c fontSelection) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c fontSelection) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c fontSelection) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c fontSelection) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c fontSelection) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c fontSelection) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c fontSelection) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c fontSelection) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c fontSelection) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c fontSelection) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c fontSelection) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c fontSelection) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c fontSelection) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c fontSelection) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c fontSelection) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c fontSelection) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c fontSelection) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w fontSelection) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w fontSelection) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w fontSelection) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w fontSelection) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w fontSelection) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w fontSelection) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w fontSelection) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w fontSelection) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w fontSelection) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w fontSelection) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w fontSelection) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w fontSelection) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w fontSelection) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w fontSelection) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w fontSelection) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w fontSelection) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w fontSelection) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w fontSelection) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w fontSelection) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w fontSelection) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w fontSelection) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w fontSelection) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w fontSelection) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w fontSelection) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w fontSelection) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w fontSelection) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w fontSelection) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w fontSelection) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w fontSelection) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w fontSelection) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w fontSelection) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w fontSelection) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w fontSelection) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w fontSelection) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w fontSelection) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w fontSelection) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w fontSelection) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w fontSelection) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w fontSelection) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w fontSelection) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w fontSelection) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w fontSelection) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w fontSelection) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w fontSelection) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w fontSelection) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w fontSelection) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w fontSelection) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w fontSelection) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w fontSelection) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w fontSelection) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w fontSelection) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w fontSelection) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w fontSelection) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w fontSelection) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w fontSelection) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w fontSelection) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w fontSelection) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w fontSelection) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w fontSelection) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w fontSelection) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w fontSelection) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w fontSelection) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w fontSelection) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w fontSelection) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w fontSelection) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w fontSelection) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w fontSelection) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w fontSelection) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w fontSelection) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w fontSelection) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w fontSelection) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w fontSelection) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w fontSelection) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w fontSelection) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w fontSelection) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w fontSelection) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w fontSelection) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w fontSelection) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w fontSelection) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w fontSelection) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w fontSelection) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w fontSelection) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w fontSelection) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w fontSelection) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w fontSelection) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w fontSelection) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w fontSelection) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w fontSelection) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w fontSelection) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w fontSelection) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w fontSelection) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w fontSelection) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w fontSelection) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w fontSelection) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w fontSelection) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w fontSelection) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w fontSelection) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w fontSelection) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w fontSelection) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w fontSelection) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w fontSelection) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w fontSelection) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w fontSelection) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w fontSelection) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w fontSelection) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w fontSelection) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w fontSelection) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w fontSelection) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w fontSelection) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w fontSelection) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w fontSelection) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w fontSelection) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w fontSelection) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w fontSelection) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w fontSelection) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w fontSelection) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w fontSelection) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w fontSelection) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w fontSelection) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w fontSelection) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w fontSelection) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w fontSelection) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w fontSelection) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w fontSelection) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w fontSelection) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w fontSelection) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w fontSelection) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w fontSelection) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w fontSelection) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w fontSelection) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w fontSelection) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w fontSelection) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w fontSelection) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w fontSelection) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w fontSelection) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w fontSelection) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w fontSelection) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w fontSelection) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w fontSelection) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w fontSelection) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w fontSelection) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w fontSelection) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w fontSelection) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w fontSelection) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w fontSelection) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w fontSelection) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w fontSelection) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w fontSelection) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w fontSelection) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w fontSelection) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w fontSelection) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w fontSelection) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w fontSelection) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w fontSelection) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w fontSelection) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w fontSelection) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w fontSelection) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w fontSelection) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w fontSelection) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w fontSelection) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w fontSelection) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w fontSelection) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w fontSelection) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w fontSelection) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w fontSelection) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w fontSelection) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w fontSelection) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w fontSelection) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w fontSelection) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w fontSelection) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w fontSelection) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w fontSelection) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w fontSelection) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w fontSelection) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w fontSelection) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w fontSelection) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w fontSelection) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w fontSelection) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w fontSelection) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w fontSelection) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w fontSelection) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w fontSelection) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w fontSelection) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w fontSelection) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w fontSelection) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w fontSelection) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w fontSelection) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w fontSelection) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w fontSelection) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w fontSelection) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w fontSelection) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w fontSelection) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w fontSelection) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w fontSelection) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w fontSelection) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w fontSelection) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w fontSelection) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w fontSelection) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w fontSelection) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w fontSelection) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w fontSelection) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w fontSelection) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w fontSelection) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w fontSelection) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w fontSelection) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w fontSelection) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w fontSelection) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w fontSelection) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w fontSelection) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w fontSelection) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w fontSelection) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w fontSelection) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w fontSelection) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w fontSelection) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w fontSelection) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w fontSelection) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w fontSelection) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w fontSelection) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w fontSelection) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w fontSelection) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w fontSelection) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w fontSelection) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w fontSelection) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w fontSelection) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w fontSelection) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w fontSelection) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w fontSelection) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w fontSelection) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w fontSelection) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w fontSelection) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w fontSelection) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w fontSelection) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w fontSelection) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w fontSelection) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s fontSelection) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w fontSelection) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w fontSelection) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w fontSelection) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w fontSelection) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w fontSelection) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w fontSelection) UnsetStateFlags(flags StateFlags) {
...
func (b fontSelection) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fontSelection) GetName() string {
...
func (o fontSelection) GetOrientation() Orientation {
...
type FontSelectionDialog interface {
	...
	// GetActionArea returns the action area of @dialog.
	//
	// Deprecated: since version 3.12.
	//
	// This method is inherited from Dialog
...
// WrapFontSelectionDialog wraps a GObject to a type that implements
// interface FontSelectionDialog. It is primarily used internally.
...
func (f fontSelectionDialog) AsDialog() Dialog {
	return WrapDialog(gextras.InternObject(f))
}
...
func (d fontSelectionDialog) AddActionWidget(child Widget, responseId int) {
	WrapDialog(gextras.InternObject(d)).AddActionWidget(child, responseId)
}

func (d fontSelectionDialog) AddButton(buttonText string, responseId int) Widget {
	return WrapDialog(gextras.InternObject(d)).AddButton(buttonText, responseId)
}

func (d fontSelectionDialog) GetActionArea() Box {
	return WrapDialog(gextras.InternObject(d)).GetActionArea()
}

func (d fontSelectionDialog) GetContentArea() Box {
	return WrapDialog(gextras.InternObject(d)).GetContentArea()
}

func (d fontSelectionDialog) GetHeaderBar() HeaderBar {
	return WrapDialog(gextras.InternObject(d)).GetHeaderBar()
}

func (d fontSelectionDialog) GetResponseForWidget(widget Widget) int {
	return WrapDialog(gextras.InternObject(d)).GetResponseForWidget(widget)
}

func (d fontSelectionDialog) GetWidgetForResponse(responseId int) Widget {
	return WrapDialog(gextras.InternObject(d)).GetWidgetForResponse(responseId)
}

func (d fontSelectionDialog) Response(responseId int) {
	WrapDialog(gextras.InternObject(d)).Response(responseId)
}

func (d fontSelectionDialog) Run() int {
	return WrapDialog(gextras.InternObject(d)).Run()
}

func (d fontSelectionDialog) SetAlternativeButtonOrderFromArray(newOrder []int) {
	WrapDialog(gextras.InternObject(d)).SetAlternativeButtonOrderFromArray(newOrder)
}

func (d fontSelectionDialog) SetDefaultResponse(responseId int) {
	WrapDialog(gextras.InternObject(d)).SetDefaultResponse(responseId)
}

func (d fontSelectionDialog) SetResponseSensitive(responseId int, setting bool) {
	WrapDialog(gextras.InternObject(d)).SetResponseSensitive(responseId, setting)
}

func (w fontSelectionDialog) ActivateDefault() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateDefault()
}

func (w fontSelectionDialog) ActivateFocus() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateFocus()
}

func (w fontSelectionDialog) ActivateKey(event *gdk.EventKey) bool {
	return WrapWindow(gextras.InternObject(w)).ActivateKey(event)
}

func (w fontSelectionDialog) AddAccelGroup(accelGroup AccelGroup) {
	WrapWindow(gextras.InternObject(w)).AddAccelGroup(accelGroup)
}

func (w fontSelectionDialog) AddMnemonic(keyval uint, target Widget) {
	WrapWindow(gextras.InternObject(w)).AddMnemonic(keyval, target)
}

func (w fontSelectionDialog) BeginMoveDrag(button int, rootX int, rootY int, timestamp uint32) {
	WrapWindow(gextras.InternObject(w)).BeginMoveDrag(button, rootX, rootY, timestamp)
}

func (w fontSelectionDialog) BeginResizeDrag(edge gdk.WindowEdge, button int, rootX int, rootY int, timestamp uint32) {
	WrapWindow(gextras.InternObject(w)).BeginResizeDrag(edge, button, rootX, rootY, timestamp)
}

func (w fontSelectionDialog) Close() {
	WrapWindow(gextras.InternObject(w)).Close()
}

func (w fontSelectionDialog) Deiconify() {
	WrapWindow(gextras.InternObject(w)).Deiconify()
}

func (w fontSelectionDialog) Fullscreen() {
	WrapWindow(gextras.InternObject(w)).Fullscreen()
}

func (w fontSelectionDialog) FullscreenOnMonitor(screen gdk.Screen, monitor int) {
	WrapWindow(gextras.InternObject(w)).FullscreenOnMonitor(screen, monitor)
}

func (w fontSelectionDialog) GetAcceptFocus() bool {
	return WrapWindow(gextras.InternObject(w)).GetAcceptFocus()
}

func (w fontSelectionDialog) GetApplication() Application {
	return WrapWindow(gextras.InternObject(w)).GetApplication()
}

func (w fontSelectionDialog) GetAttachedTo() Widget {
	return WrapWindow(gextras.InternObject(w)).GetAttachedTo()
}

func (w fontSelectionDialog) GetDecorated() bool {
	return WrapWindow(gextras.InternObject(w)).GetDecorated()
}

func (w fontSelectionDialog) GetDefaultSize() (width int, height int) {
	return WrapWindow(gextras.InternObject(w)).GetDefaultSize()
}

func (w fontSelectionDialog) GetDefaultWidget() Widget {
	return WrapWindow(gextras.InternObject(w)).GetDefaultWidget()
}

func (w fontSelectionDialog) GetDeletable() bool {
	return WrapWindow(gextras.InternObject(w)).GetDeletable()
}

func (w fontSelectionDialog) GetDestroyWithParent() bool {
	return WrapWindow(gextras.InternObject(w)).GetDestroyWithParent()
}

func (w fontSelectionDialog) GetFocus() Widget {
	return WrapWindow(gextras.InternObject(w)).GetFocus()
}

func (w fontSelectionDialog) GetFocusOnMap() bool {
	return WrapWindow(gextras.InternObject(w)).GetFocusOnMap()
}

func (w fontSelectionDialog) GetFocusVisible() bool {
	return WrapWindow(gextras.InternObject(w)).GetFocusVisible()
}

func (w fontSelectionDialog) GetGravity() gdk.Gravity {
	return WrapWindow(gextras.InternObject(w)).GetGravity()
}

func (w fontSelectionDialog) GetGroup() WindowGroup {
	return WrapWindow(gextras.InternObject(w)).GetGroup()
}

func (w fontSelectionDialog) GetHasResizeGrip() bool {
	return WrapWindow(gextras.InternObject(w)).GetHasResizeGrip()
}

func (w fontSelectionDialog) GetHideTitlebarWhenMaximized() bool {
	return WrapWindow(gextras.InternObject(w)).GetHideTitlebarWhenMaximized()
}

func (w fontSelectionDialog) GetIcon() gdkpixbuf.Pixbuf {
	return WrapWindow(gextras.InternObject(w)).GetIcon()
}

func (w fontSelectionDialog) GetIconName() string {
	return WrapWindow(gextras.InternObject(w)).GetIconName()
}

func (w fontSelectionDialog) GetMnemonicModifier() gdk.ModifierType {
	return WrapWindow(gextras.InternObject(w)).GetMnemonicModifier()
}

func (w fontSelectionDialog) GetMnemonicsVisible() bool {
	return WrapWindow(gextras.InternObject(w)).GetMnemonicsVisible()
}

func (w fontSelectionDialog) GetModal() bool {
	return WrapWindow(gextras.InternObject(w)).GetModal()
}

func (w fontSelectionDialog) GetOpacity() float64 {
	return WrapWindow(gextras.InternObject(w)).GetOpacity()
}

func (w fontSelectionDialog) GetPosition() (rootX int, rootY int) {
	return WrapWindow(gextras.InternObject(w)).GetPosition()
}

func (w fontSelectionDialog) GetResizable() bool {
	return WrapWindow(gextras.InternObject(w)).GetResizable()
}

func (w fontSelectionDialog) GetResizeGripArea() (gdk.Rectangle, bool) {
	return WrapWindow(gextras.InternObject(w)).GetResizeGripArea()
}

func (w fontSelectionDialog) GetRole() string {
	return WrapWindow(gextras.InternObject(w)).GetRole()
}

func (w fontSelectionDialog) GetScreen() gdk.Screen {
	return WrapWindow(gextras.InternObject(w)).GetScreen()
}

func (w fontSelectionDialog) GetSize() (width int, height int) {
	return WrapWindow(gextras.InternObject(w)).GetSize()
}

func (w fontSelectionDialog) GetSkipPagerHint() bool {
	return WrapWindow(gextras.InternObject(w)).GetSkipPagerHint()
}

func (w fontSelectionDialog) GetSkipTaskbarHint() bool {
	return WrapWindow(gextras.InternObject(w)).GetSkipTaskbarHint()
}

func (w fontSelectionDialog) GetTitle() string {
	return WrapWindow(gextras.InternObject(w)).GetTitle()
}

func (w fontSelectionDialog) GetTitlebar() Widget {
	return WrapWindow(gextras.InternObject(w)).GetTitlebar()
}

func (w fontSelectionDialog) GetTransientFor() Window {
	return WrapWindow(gextras.InternObject(w)).GetTransientFor()
}

func (w fontSelectionDialog) GetTypeHint() gdk.WindowTypeHint {
	return WrapWindow(gextras.InternObject(w)).GetTypeHint()
}

func (w fontSelectionDialog) GetUrgencyHint() bool {
	return WrapWindow(gextras.InternObject(w)).GetUrgencyHint()
}

func (w fontSelectionDialog) GetWindowType() WindowType {
	return WrapWindow(gextras.InternObject(w)).GetWindowType()
}

func (w fontSelectionDialog) HasGroup() bool {
	return WrapWindow(gextras.InternObject(w)).HasGroup()
}

func (w fontSelectionDialog) HasToplevelFocus() bool {
	return WrapWindow(gextras.InternObject(w)).HasToplevelFocus()
}

func (w fontSelectionDialog) Iconify() {
	WrapWindow(gextras.InternObject(w)).Iconify()
}

func (w fontSelectionDialog) IsActive() bool {
	return WrapWindow(gextras.InternObject(w)).IsActive()
}

func (w fontSelectionDialog) IsMaximized() bool {
	return WrapWindow(gextras.InternObject(w)).IsMaximized()
}

func (w fontSelectionDialog) Maximize() {
	WrapWindow(gextras.InternObject(w)).Maximize()
}

func (w fontSelectionDialog) MnemonicActivate(keyval uint, modifier gdk.ModifierType) bool {
	return WrapWindow(gextras.InternObject(w)).MnemonicActivate(keyval, modifier)
}

func (w fontSelectionDialog) Move(x int, y int) {
	WrapWindow(gextras.InternObject(w)).Move(x, y)
}

func (w fontSelectionDialog) ParseGeometry(geometry string) bool {
	return WrapWindow(gextras.InternObject(w)).ParseGeometry(geometry)
}

func (w fontSelectionDialog) Present() {
	WrapWindow(gextras.InternObject(w)).Present()
}

func (w fontSelectionDialog) PresentWithTime(timestamp uint32) {
	WrapWindow(gextras.InternObject(w)).PresentWithTime(timestamp)
}

func (w fontSelectionDialog) PropagateKeyEvent(event *gdk.EventKey) bool {
	return WrapWindow(gextras.InternObject(w)).PropagateKeyEvent(event)
}

func (w fontSelectionDialog) RemoveAccelGroup(accelGroup AccelGroup) {
	WrapWindow(gextras.InternObject(w)).RemoveAccelGroup(accelGroup)
}

func (w fontSelectionDialog) RemoveMnemonic(keyval uint, target Widget) {
	WrapWindow(gextras.InternObject(w)).RemoveMnemonic(keyval, target)
}

func (w fontSelectionDialog) ReshowWithInitialSize() {
	WrapWindow(gextras.InternObject(w)).ReshowWithInitialSize()
}

func (w fontSelectionDialog) Resize(width int, height int) {
	WrapWindow(gextras.InternObject(w)).Resize(width, height)
}

func (w fontSelectionDialog) ResizeGripIsVisible() bool {
	return WrapWindow(gextras.InternObject(w)).ResizeGripIsVisible()
}

func (w fontSelectionDialog) ResizeToGeometry(width int, height int) {
	WrapWindow(gextras.InternObject(w)).ResizeToGeometry(width, height)
}

func (w fontSelectionDialog) SetAcceptFocus(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetAcceptFocus(setting)
}

func (w fontSelectionDialog) SetApplication(application Application) {
	WrapWindow(gextras.InternObject(w)).SetApplication(application)
}

func (w fontSelectionDialog) SetAttachedTo(attachWidget Widget) {
	WrapWindow(gextras.InternObject(w)).SetAttachedTo(attachWidget)
}

func (w fontSelectionDialog) SetDecorated(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetDecorated(setting)
}

func (w fontSelectionDialog) SetDefault(defaultWidget Widget) {
	WrapWindow(gextras.InternObject(w)).SetDefault(defaultWidget)
}

func (w fontSelectionDialog) SetDefaultGeometry(width int, height int) {
	WrapWindow(gextras.InternObject(w)).SetDefaultGeometry(width, height)
}

func (w fontSelectionDialog) SetDefaultSize(width int, height int) {
	WrapWindow(gextras.InternObject(w)).SetDefaultSize(width, height)
}

func (w fontSelectionDialog) SetDeletable(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetDeletable(setting)
}

func (w fontSelectionDialog) SetDestroyWithParent(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetDestroyWithParent(setting)
}

func (w fontSelectionDialog) SetFocus(focus Widget) {
	WrapWindow(gextras.InternObject(w)).SetFocus(focus)
}

func (w fontSelectionDialog) SetFocusOnMap(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetFocusOnMap(setting)
}

func (w fontSelectionDialog) SetFocusVisible(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetFocusVisible(setting)
}

func (w fontSelectionDialog) SetGeometryHints(geometryWidget Widget, geometry *gdk.Geometry, geomMask gdk.WindowHints) {
	WrapWindow(gextras.InternObject(w)).SetGeometryHints(geometryWidget, geometry, geomMask)
}

func (w fontSelectionDialog) SetGravity(gravity gdk.Gravity) {
	WrapWindow(gextras.InternObject(w)).SetGravity(gravity)
}

func (w fontSelectionDialog) SetHasResizeGrip(value bool) {
	WrapWindow(gextras.InternObject(w)).SetHasResizeGrip(value)
}

func (w fontSelectionDialog) SetHasUserRefCount(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetHasUserRefCount(setting)
}

func (w fontSelectionDialog) SetHideTitlebarWhenMaximized(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetHideTitlebarWhenMaximized(setting)
}

func (w fontSelectionDialog) SetIcon(icon gdkpixbuf.Pixbuf) {
	WrapWindow(gextras.InternObject(w)).SetIcon(icon)
}

func (w fontSelectionDialog) SetIconFromFile(filename string) error {
	return WrapWindow(gextras.InternObject(w)).SetIconFromFile(filename)
}

func (w fontSelectionDialog) SetIconName(name string) {
	WrapWindow(gextras.InternObject(w)).SetIconName(name)
}

func (w fontSelectionDialog) SetKeepAbove(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetKeepAbove(setting)
}

func (w fontSelectionDialog) SetKeepBelow(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetKeepBelow(setting)
}

func (w fontSelectionDialog) SetMnemonicModifier(modifier gdk.ModifierType) {
	WrapWindow(gextras.InternObject(w)).SetMnemonicModifier(modifier)
}

func (w fontSelectionDialog) SetMnemonicsVisible(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetMnemonicsVisible(setting)
}

func (w fontSelectionDialog) SetModal(modal bool) {
	WrapWindow(gextras.InternObject(w)).SetModal(modal)
}

func (w fontSelectionDialog) SetOpacity(opacity float64) {
	WrapWindow(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w fontSelectionDialog) SetPosition(position WindowPosition) {
	WrapWindow(gextras.InternObject(w)).SetPosition(position)
}

func (w fontSelectionDialog) SetResizable(resizable bool) {
	WrapWindow(gextras.InternObject(w)).SetResizable(resizable)
}

func (w fontSelectionDialog) SetRole(role string) {
	WrapWindow(gextras.InternObject(w)).SetRole(role)
}

func (w fontSelectionDialog) SetScreen(screen gdk.Screen) {
	WrapWindow(gextras.InternObject(w)).SetScreen(screen)
}

func (w fontSelectionDialog) SetSkipPagerHint(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetSkipPagerHint(setting)
}

func (w fontSelectionDialog) SetSkipTaskbarHint(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetSkipTaskbarHint(setting)
}

func (w fontSelectionDialog) SetStartupID(startupId string) {
	WrapWindow(gextras.InternObject(w)).SetStartupID(startupId)
}

func (w fontSelectionDialog) SetTitle(title string) {
	WrapWindow(gextras.InternObject(w)).SetTitle(title)
}

func (w fontSelectionDialog) SetTitlebar(titlebar Widget) {
	WrapWindow(gextras.InternObject(w)).SetTitlebar(titlebar)
}

func (w fontSelectionDialog) SetTransientFor(parent Window) {
	WrapWindow(gextras.InternObject(w)).SetTransientFor(parent)
}

func (w fontSelectionDialog) SetTypeHint(hint gdk.WindowTypeHint) {
	WrapWindow(gextras.InternObject(w)).SetTypeHint(hint)
}

func (w fontSelectionDialog) SetUrgencyHint(setting bool) {
	WrapWindow(gextras.InternObject(w)).SetUrgencyHint(setting)
}

func (w fontSelectionDialog) SetWmclass(wmclassName string, wmclassClass string) {
	WrapWindow(gextras.InternObject(w)).SetWmclass(wmclassName, wmclassClass)
}

func (w fontSelectionDialog) Stick() {
	WrapWindow(gextras.InternObject(w)).Stick()
}

func (w fontSelectionDialog) Unfullscreen() {
	WrapWindow(gextras.InternObject(w)).Unfullscreen()
}

func (w fontSelectionDialog) Unmaximize() {
	WrapWindow(gextras.InternObject(w)).Unmaximize()
}

func (w fontSelectionDialog) Unstick() {
	WrapWindow(gextras.InternObject(w)).Unstick()
}

func (b fontSelectionDialog) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c fontSelectionDialog) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c fontSelectionDialog) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c fontSelectionDialog) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c fontSelectionDialog) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c fontSelectionDialog) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c fontSelectionDialog) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c fontSelectionDialog) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c fontSelectionDialog) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c fontSelectionDialog) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c fontSelectionDialog) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c fontSelectionDialog) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c fontSelectionDialog) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c fontSelectionDialog) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c fontSelectionDialog) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c fontSelectionDialog) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c fontSelectionDialog) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c fontSelectionDialog) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c fontSelectionDialog) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c fontSelectionDialog) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c fontSelectionDialog) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c fontSelectionDialog) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c fontSelectionDialog) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c fontSelectionDialog) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c fontSelectionDialog) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w fontSelectionDialog) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w fontSelectionDialog) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w fontSelectionDialog) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w fontSelectionDialog) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w fontSelectionDialog) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w fontSelectionDialog) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w fontSelectionDialog) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w fontSelectionDialog) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w fontSelectionDialog) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w fontSelectionDialog) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w fontSelectionDialog) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w fontSelectionDialog) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w fontSelectionDialog) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w fontSelectionDialog) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w fontSelectionDialog) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w fontSelectionDialog) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w fontSelectionDialog) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w fontSelectionDialog) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w fontSelectionDialog) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w fontSelectionDialog) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w fontSelectionDialog) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w fontSelectionDialog) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w fontSelectionDialog) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w fontSelectionDialog) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w fontSelectionDialog) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w fontSelectionDialog) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w fontSelectionDialog) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w fontSelectionDialog) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w fontSelectionDialog) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w fontSelectionDialog) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w fontSelectionDialog) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w fontSelectionDialog) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w fontSelectionDialog) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w fontSelectionDialog) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w fontSelectionDialog) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w fontSelectionDialog) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w fontSelectionDialog) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w fontSelectionDialog) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w fontSelectionDialog) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w fontSelectionDialog) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w fontSelectionDialog) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w fontSelectionDialog) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w fontSelectionDialog) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w fontSelectionDialog) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w fontSelectionDialog) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w fontSelectionDialog) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w fontSelectionDialog) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w fontSelectionDialog) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w fontSelectionDialog) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w fontSelectionDialog) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w fontSelectionDialog) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w fontSelectionDialog) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w fontSelectionDialog) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w fontSelectionDialog) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w fontSelectionDialog) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w fontSelectionDialog) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w fontSelectionDialog) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w fontSelectionDialog) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w fontSelectionDialog) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w fontSelectionDialog) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w fontSelectionDialog) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w fontSelectionDialog) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w fontSelectionDialog) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w fontSelectionDialog) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w fontSelectionDialog) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w fontSelectionDialog) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w fontSelectionDialog) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w fontSelectionDialog) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w fontSelectionDialog) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w fontSelectionDialog) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w fontSelectionDialog) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w fontSelectionDialog) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w fontSelectionDialog) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w fontSelectionDialog) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w fontSelectionDialog) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w fontSelectionDialog) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w fontSelectionDialog) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w fontSelectionDialog) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w fontSelectionDialog) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}
...
func (w fontSelectionDialog) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w fontSelectionDialog) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w fontSelectionDialog) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w fontSelectionDialog) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w fontSelectionDialog) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w fontSelectionDialog) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w fontSelectionDialog) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w fontSelectionDialog) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w fontSelectionDialog) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w fontSelectionDialog) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w fontSelectionDialog) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w fontSelectionDialog) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w fontSelectionDialog) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w fontSelectionDialog) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w fontSelectionDialog) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w fontSelectionDialog) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w fontSelectionDialog) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}
...
func (w fontSelectionDialog) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w fontSelectionDialog) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w fontSelectionDialog) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w fontSelectionDialog) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w fontSelectionDialog) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w fontSelectionDialog) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w fontSelectionDialog) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w fontSelectionDialog) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w fontSelectionDialog) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w fontSelectionDialog) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w fontSelectionDialog) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w fontSelectionDialog) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w fontSelectionDialog) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w fontSelectionDialog) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w fontSelectionDialog) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w fontSelectionDialog) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w fontSelectionDialog) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w fontSelectionDialog) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w fontSelectionDialog) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w fontSelectionDialog) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w fontSelectionDialog) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w fontSelectionDialog) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w fontSelectionDialog) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w fontSelectionDialog) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w fontSelectionDialog) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w fontSelectionDialog) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w fontSelectionDialog) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w fontSelectionDialog) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w fontSelectionDialog) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w fontSelectionDialog) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w fontSelectionDialog) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w fontSelectionDialog) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w fontSelectionDialog) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w fontSelectionDialog) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w fontSelectionDialog) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w fontSelectionDialog) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w fontSelectionDialog) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w fontSelectionDialog) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w fontSelectionDialog) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w fontSelectionDialog) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w fontSelectionDialog) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w fontSelectionDialog) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w fontSelectionDialog) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w fontSelectionDialog) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w fontSelectionDialog) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w fontSelectionDialog) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w fontSelectionDialog) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w fontSelectionDialog) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w fontSelectionDialog) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w fontSelectionDialog) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w fontSelectionDialog) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w fontSelectionDialog) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w fontSelectionDialog) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w fontSelectionDialog) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w fontSelectionDialog) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w fontSelectionDialog) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w fontSelectionDialog) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w fontSelectionDialog) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w fontSelectionDialog) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w fontSelectionDialog) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w fontSelectionDialog) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w fontSelectionDialog) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w fontSelectionDialog) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w fontSelectionDialog) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w fontSelectionDialog) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w fontSelectionDialog) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w fontSelectionDialog) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w fontSelectionDialog) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w fontSelectionDialog) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w fontSelectionDialog) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w fontSelectionDialog) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w fontSelectionDialog) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w fontSelectionDialog) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w fontSelectionDialog) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w fontSelectionDialog) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w fontSelectionDialog) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w fontSelectionDialog) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w fontSelectionDialog) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w fontSelectionDialog) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w fontSelectionDialog) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w fontSelectionDialog) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w fontSelectionDialog) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w fontSelectionDialog) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w fontSelectionDialog) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w fontSelectionDialog) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w fontSelectionDialog) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w fontSelectionDialog) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w fontSelectionDialog) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w fontSelectionDialog) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w fontSelectionDialog) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w fontSelectionDialog) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w fontSelectionDialog) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w fontSelectionDialog) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w fontSelectionDialog) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w fontSelectionDialog) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w fontSelectionDialog) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w fontSelectionDialog) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w fontSelectionDialog) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w fontSelectionDialog) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w fontSelectionDialog) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w fontSelectionDialog) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w fontSelectionDialog) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w fontSelectionDialog) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w fontSelectionDialog) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w fontSelectionDialog) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w fontSelectionDialog) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w fontSelectionDialog) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}
...
func (w fontSelectionDialog) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w fontSelectionDialog) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w fontSelectionDialog) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w fontSelectionDialog) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w fontSelectionDialog) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w fontSelectionDialog) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w fontSelectionDialog) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w fontSelectionDialog) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w fontSelectionDialog) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w fontSelectionDialog) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w fontSelectionDialog) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w fontSelectionDialog) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w fontSelectionDialog) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w fontSelectionDialog) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w fontSelectionDialog) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w fontSelectionDialog) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w fontSelectionDialog) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w fontSelectionDialog) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w fontSelectionDialog) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w fontSelectionDialog) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w fontSelectionDialog) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w fontSelectionDialog) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w fontSelectionDialog) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w fontSelectionDialog) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w fontSelectionDialog) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w fontSelectionDialog) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w fontSelectionDialog) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w fontSelectionDialog) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s fontSelectionDialog) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w fontSelectionDialog) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w fontSelectionDialog) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w fontSelectionDialog) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w fontSelectionDialog) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w fontSelectionDialog) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w fontSelectionDialog) UnsetStateFlags(flags StateFlags) {
	WrapWidget(gextras.InternObject(w)).UnsetStateFlags(flags)
}
...
func (b fontSelectionDialog) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b fontSelectionDialog) GetName() string {
	return WrapBuildable(gextras.InternObject(b)).GetName()
}
