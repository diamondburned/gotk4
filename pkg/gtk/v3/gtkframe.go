...
// WrapFrame wraps a GObject to a type that implements
// interface Frame. It is primarily used internally.
...
func (b frame) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b frame) GetName() string {
