...
// WrapFrameAccessible wraps a GObject to a type that implements
// interface FrameAccessible. It is primarily used internally.
func WrapFrameAccessible(obj *externglib.Object) FrameAccessible {
	return frameAccessible{obj}
}
