...
func (w glArea) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w glArea) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w glArea) AddEvents(events int) {
...
func (w glArea) CanActivateAccel(signalId uint) bool {
...
func (w glArea) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w glArea) ClassPath() (pathLength uint, path string, pathReversed string) {
...
func (w glArea) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w glArea) DeviceIsShadowed(device gdk.Device) bool {
...
func (w glArea) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w glArea) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w glArea) GetActionGroup(prefix string) gio.ActionGroup {
...
func (w glArea) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w glArea) GetCanDefault() bool {
...
func (w glArea) GetChildRequisition() Requisition {
...
func (w glArea) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w glArea) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w glArea) GetDeviceEvents(device gdk.Device) gdk.EventMask {
...
func (w glArea) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w glArea) GetEvents() int {
...
func (w glArea) GetHasWindow() bool {
...
func (w glArea) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w glArea) GetMarginRight() int {
...
func (w glArea) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w glArea) GetModifierStyle() RCStyle {
...
func (w glArea) GetNoShowAll() bool {
...
func (w glArea) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w glArea) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w glArea) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w glArea) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w glArea) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w glArea) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
...
func (w glArea) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w glArea) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
...
func (w glArea) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w glArea) GetRootWindow() gdk.Window {
...
func (w glArea) GetScreen() gdk.Screen {
...
func (w glArea) GetState() StateType {
...
func (w glArea) GetSupportMultidevice() bool {
...
func (w glArea) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w glArea) GetToplevel() Widget {
...
func (w glArea) GetVAlignWithBaseline() Align {
...
func (w glArea) HideOnDelete() bool {
...
func (w glArea) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w glArea) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w glArea) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
...
func (w glArea) IsComposited() bool {
...
func (w glArea) ListActionPrefixes() []string {
...
func (w glArea) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w glArea) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w glArea) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w glArea) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w glArea) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w glArea) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w glArea) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w glArea) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w glArea) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w glArea) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w glArea) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w glArea) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w glArea) Path() (pathLength uint, path string, pathReversed string) {
...
func (w glArea) QueueComputeExpand() {
...
func (w glArea) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w glArea) QueueDrawRegion(region *cairo.Region) {
...
func (w glArea) QueueResizeNoRedraw() {
...
func (w glArea) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w glArea) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w glArea) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
...
func (w glArea) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w glArea) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w glArea) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w glArea) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
...
func (w glArea) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w glArea) SetEvents(events int) {
...
func (w glArea) SetHasWindow(hasWindow bool) {
...
func (w glArea) SetMapped(mapped bool) {
...
func (w glArea) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w glArea) SetMarginRight(margin int) {
...
func (w glArea) SetNoShowAll(noShowAll bool) {
...
func (w glArea) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w glArea) SetRealized(realized bool) {
...
func (w glArea) SetRedrawOnAllocate(redrawOnAllocate bool) {
...
func (w glArea) SetState(state StateType) {
...
func (w glArea) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w glArea) SetSupportMultidevice(supportMultidevice bool) {
...
func (w glArea) SetTooltipWindow(customWindow Window) {
...
func (w glArea) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w glArea) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w glArea) ShapeCombineRegion(region *cairo.Region) {
...
func (w glArea) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w glArea) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w glArea) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w glArea) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w glArea) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w glArea) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s glArea) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
...
func (w glArea) UnregisterWindow(window gdk.Window) {
...
func (b glArea) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b glArea) GetName() string {
