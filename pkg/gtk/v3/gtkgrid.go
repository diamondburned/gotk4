...
// WrapGrid wraps a GObject to a type that implements
// interface Grid. It is primarily used internally.
...
func (g grid) AsContainer() Container {
	return WrapContainer(gextras.InternObject(g))
}
...
func (b grid) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b grid) GetName() string {
...
func (o grid) GetOrientation() Orientation {
