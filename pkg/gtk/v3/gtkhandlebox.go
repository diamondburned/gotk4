...
// WrapHandleBox wraps a GObject to a type that implements
// interface HandleBox. It is primarily used internally.
...
func (h handleBox) AsBin() Bin {
	return WrapBin(gextras.InternObject(h))
}
...
func (b handleBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b handleBox) GetName() string {
