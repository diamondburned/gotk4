...
// WrapHButtonBox wraps a GObject to a type that implements
// interface HButtonBox. It is primarily used internally.
...
func (h hButtonBox) AsButtonBox() ButtonBox {
	return WrapButtonBox(gextras.InternObject(h))
}
...
func (b hButtonBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hButtonBox) GetName() string {
...
func (o hButtonBox) GetOrientation() Orientation {
