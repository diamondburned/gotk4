...
// WrapHBox wraps a GObject to a type that implements
// interface HBox. It is primarily used internally.
...
func (h hBox) AsBox() Box {
	return WrapBox(gextras.InternObject(h))
}
...
func (b hBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hBox) GetName() string {
...
func (o hBox) GetOrientation() Orientation {
