...
// WrapHeaderBar wraps a GObject to a type that implements
// interface HeaderBar. It is primarily used internally.
func WrapHeaderBar(obj *externglib.Object) HeaderBar {
	return headerBar{obj}
}
...
func (h headerBar) AsContainer() Container {
	return WrapContainer(gextras.InternObject(h))
}
...
func (b headerBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b headerBar) GetName() string {
