...
// WrapHPaned wraps a GObject to a type that implements
// interface HPaned. It is primarily used internally.
...
func (h hPaned) AsPaned() Paned {
	return WrapPaned(gextras.InternObject(h))
}
...
func (b hPaned) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hPaned) GetName() string {
...
func (o hPaned) GetOrientation() Orientation {
