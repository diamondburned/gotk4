...
// WrapHScale wraps a GObject to a type that implements
// interface HScale. It is primarily used internally.
...
func (h hScale) AsScale() Scale {
	return WrapScale(gextras.InternObject(h))
}
...
func (b hScale) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hScale) GetName() string {
...
func (o hScale) GetOrientation() Orientation {
