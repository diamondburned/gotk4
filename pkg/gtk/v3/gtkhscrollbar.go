...
type HScrollbar interface {
	...
	// This method is inherited from Range
	GetInverted() bool
	// GetLowerStepperSensitivity gets the sensitivity policy for the stepper
	// that points to the 'lower' end of the GtkRange’s adjustment.
	//
	// This method is inherited from Range
	GetLowerStepperSensitivity() SensitivityType
	// GetMinSliderSize: this function is useful mainly for Range subclasses.
	//
	...
	// GetUpperStepperSensitivity gets the sensitivity policy for the stepper
...
// WrapHScrollbar wraps a GObject to a type that implements
// interface HScrollbar. It is primarily used internally.
...
func (b hScrollbar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hScrollbar) GetName() string {
...
func (o hScrollbar) GetOrientation() Orientation {
