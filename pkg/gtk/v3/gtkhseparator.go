...
// WrapHSeparator wraps a GObject to a type that implements
// interface HSeparator. It is primarily used internally.
...
func (h hSeparator) AsSeparator() Separator {
	return WrapSeparator(gextras.InternObject(h))
}
...
func (b hSeparator) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hSeparator) GetName() string {
...
func (o hSeparator) GetOrientation() Orientation {
