...
// WrapHSV wraps a GObject to a type that implements
// interface HSV. It is primarily used internally.
...
func (h hsV) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(h))
}
...
func (w hsV) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w hsV) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w hsV) UnsetStateFlags(flags StateFlags) {
...
func (b hsV) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b hsV) GetName() string {
