...
// WrapImageMenuItem wraps a GObject to a type that implements
// interface ImageMenuItem. It is primarily used internally.
...
func (i imageMenuItem) AsMenuItem() MenuItem {
	return WrapMenuItem(gextras.InternObject(i))
}
...
func (b imageMenuItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b imageMenuItem) GetName() string {
...
func (a imageMenuItem) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a imageMenuItem) GetActionTargetValue() *glib.Variant {
...
func (a imageMenuItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a imageMenuItem) GetUseActionAppearance() bool {
