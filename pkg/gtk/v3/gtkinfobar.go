...
// WrapInfoBar wraps a GObject to a type that implements
// interface InfoBar. It is primarily used internally.
...
func (i infoBar) AsBox() Box {
	return WrapBox(gextras.InternObject(i))
}
...
func (b infoBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b infoBar) GetName() string {
...
func (o infoBar) GetOrientation() Orientation {
