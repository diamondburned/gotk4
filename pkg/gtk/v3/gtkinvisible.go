...
// WrapInvisible wraps a GObject to a type that implements
// interface Invisible. It is primarily used internally.
...
func (i invisible) AsWidget() Widget {
...
func (b invisible) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b invisible) GetName() string {
