...
func (l label) AsMisc() Misc {
	return WrapMisc(gextras.InternObject(l))
}
...
func (m label) GetAlignment() (xalign float32, yalign float32) {
	return WrapMisc(gextras.InternObject(m)).GetAlignment()
}

func (m label) GetPadding() (xpad int, ypad int) {
	return WrapMisc(gextras.InternObject(m)).GetPadding()
}

func (m label) SetAlignment(xalign float32, yalign float32) {
	WrapMisc(gextras.InternObject(m)).SetAlignment(xalign, yalign)
}

func (m label) SetPadding(xpad int, ypad int) {
...
func (w label) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w label) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w label) AddEvents(events int) {
...
func (w label) CanActivateAccel(signalId uint) bool {
...
func (w label) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w label) ClassPath() (pathLength uint, path string, pathReversed string) {
...
func (w label) DeviceIsShadowed(device gdk.Device) bool {
...
func (w label) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w label) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w label) GetActionGroup(prefix string) gio.ActionGroup {
...
func (w label) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w label) GetCanDefault() bool {
...
func (w label) GetChildRequisition() Requisition {
...
func (w label) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w label) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w label) GetDeviceEvents(device gdk.Device) gdk.EventMask {
...
func (w label) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w label) GetEvents() int {
...
func (w label) GetHasWindow() bool {
...
func (w label) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w label) GetMarginRight() int {
...
func (w label) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w label) GetModifierStyle() RCStyle {
...
func (w label) GetNoShowAll() bool {
...
func (w label) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w label) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w label) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w label) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w label) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w label) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
...
func (w label) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w label) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
...
func (w label) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w label) GetRootWindow() gdk.Window {
...
func (w label) GetScreen() gdk.Screen {
...
func (w label) GetState() StateType {
...
func (w label) GetSupportMultidevice() bool {
...
func (w label) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w label) GetToplevel() Widget {
...
func (w label) GetVAlignWithBaseline() Align {
...
func (w label) HideOnDelete() bool {
...
func (w label) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w label) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w label) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
...
func (w label) IsComposited() bool {
...
func (w label) ListActionPrefixes() []string {
...
func (w label) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w label) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w label) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w label) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w label) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w label) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w label) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w label) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w label) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w label) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w label) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w label) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w label) Path() (pathLength uint, path string, pathReversed string) {
...
func (w label) QueueComputeExpand() {
...
func (w label) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w label) QueueDrawRegion(region *cairo.Region) {
...
func (w label) QueueResizeNoRedraw() {
...
func (w label) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w label) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w label) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
...
func (w label) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w label) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w label) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w label) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
...
func (w label) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w label) SetEvents(events int) {
...
func (w label) SetHasWindow(hasWindow bool) {
...
func (w label) SetMapped(mapped bool) {
...
func (w label) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w label) SetMarginRight(margin int) {
...
func (w label) SetNoShowAll(noShowAll bool) {
...
func (w label) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w label) SetRealized(realized bool) {
...
func (w label) SetRedrawOnAllocate(redrawOnAllocate bool) {
...
func (w label) SetState(state StateType) {
...
func (w label) SetSupportMultidevice(supportMultidevice bool) {
...
func (w label) SetTooltipWindow(customWindow Window) {
...
func (w label) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w label) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w label) ShapeCombineRegion(region *cairo.Region) {
...
func (w label) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w label) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w label) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w label) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w label) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w label) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s label) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
...
func (w label) UnregisterWindow(window gdk.Window) {
...
func (b label) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b label) GetName() string {
