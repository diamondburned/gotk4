...
// WrapLabelAccessible wraps a GObject to a type that implements
// interface LabelAccessible. It is primarily used internally.
func WrapLabelAccessible(obj *externglib.Object) LabelAccessible {
	return labelAccessible{obj}
}
