...
func (l layout) AsContainer() Container {
...
func (w layout) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w layout) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w layout) ShapeCombineRegion(region *cairo.Region) {
...
func (b layout) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b layout) GetName() string {
