...
// WrapLevelBar wraps a GObject to a type that implements
// interface LevelBar. It is primarily used internally.
...
func (l levelBar) AsWidget() Widget {
...
func (b levelBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b levelBar) GetName() string {
...
func (o levelBar) GetOrientation() Orientation {
