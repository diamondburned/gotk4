...
// WrapLevelBarAccessible wraps a GObject to a type that implements
// interface LevelBarAccessible. It is primarily used internally.
func WrapLevelBarAccessible(obj *externglib.Object) LevelBarAccessible {
	return levelBarAccessible{obj}
}
