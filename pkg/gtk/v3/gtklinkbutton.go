...
// WrapLinkButton wraps a GObject to a type that implements
// interface LinkButton. It is primarily used internally.
...
func (l linkButton) AsButton() Button {
	return WrapButton(gextras.InternObject(l))
}
...
func (b linkButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b linkButton) GetName() string {
...
func (a linkButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a linkButton) GetActionTargetValue() *glib.Variant {
...
func (a linkButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a linkButton) GetUseActionAppearance() bool {
