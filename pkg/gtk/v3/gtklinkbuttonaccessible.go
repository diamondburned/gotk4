...
// WrapLinkButtonAccessible wraps a GObject to a type that implements
// interface LinkButtonAccessible. It is primarily used internally.
func WrapLinkButtonAccessible(obj *externglib.Object) LinkButtonAccessible {
	return linkButtonAccessible{obj}
}
...
func (l linkButtonAccessible) AsButtonAccessible() ButtonAccessible {
	return WrapButtonAccessible(gextras.InternObject(l))
}
...
func (a linkButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a linkButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a linkButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a linkButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a linkButtonAccessible) GetName(i int) string {
...
func (i linkButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i linkButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i linkButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i linkButtonAccessible) GetImageSize() (width int, height int) {
