...
// WrapListBoxAccessible wraps a GObject to a type that implements
// interface ListBoxAccessible. It is primarily used internally.
func WrapListBoxAccessible(obj *externglib.Object) ListBoxAccessible {
	return listBoxAccessible{obj}
}
