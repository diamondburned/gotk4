...
// WrapLockButton wraps a GObject to a type that implements
// interface LockButton. It is primarily used internally.
...
func (l lockButton) AsButton() Button {
...
func (b lockButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b lockButton) GetName() string {
...
func (a lockButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a lockButton) GetActionTargetValue() *glib.Variant {
...
func (a lockButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a lockButton) GetUseActionAppearance() bool {
