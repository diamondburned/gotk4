...
// WrapLockButtonAccessible wraps a GObject to a type that implements
// interface LockButtonAccessible. It is primarily used internally.
func WrapLockButtonAccessible(obj *externglib.Object) LockButtonAccessible {
	return lockButtonAccessible{obj}
}
...
func (l lockButtonAccessible) AsButtonAccessible() ButtonAccessible {
...
func (a lockButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a lockButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a lockButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a lockButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a lockButtonAccessible) GetName(i int) string {
...
func (i lockButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i lockButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i lockButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i lockButtonAccessible) GetImageSize() (width int, height int) {
