...
func (m menu) AsMenuShell() MenuShell {
...
func (m menu) ActivateItem(menuItem Widget, forceDeactivate bool) {
	WrapMenuShell(gextras.InternObject(m)).ActivateItem(menuItem, forceDeactivate)
}

func (m menu) Append(child MenuItem) {
	WrapMenuShell(gextras.InternObject(m)).Append(child)
}

func (m menu) BindModel(model gio.MenuModel, actionNamespace string, withSeparators bool) {
...
func (b menu) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menu) GetName() string {
