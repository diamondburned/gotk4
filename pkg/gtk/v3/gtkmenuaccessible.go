...
// WrapMenuAccessible wraps a GObject to a type that implements
// interface MenuAccessible. It is primarily used internally.
func WrapMenuAccessible(obj *externglib.Object) MenuAccessible {
	return menuAccessible{obj}
}
