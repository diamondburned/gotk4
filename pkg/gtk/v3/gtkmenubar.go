...
// WrapMenuBar wraps a GObject to a type that implements
// interface MenuBar. It is primarily used internally.
...
func (m menuBar) AsMenuShell() MenuShell {
	return WrapMenuShell(gextras.InternObject(m))
}
...
func (m menuBar) ActivateItem(menuItem Widget, forceDeactivate bool) {
	WrapMenuShell(gextras.InternObject(m)).ActivateItem(menuItem, forceDeactivate)
}

func (m menuBar) Append(child MenuItem) {
	WrapMenuShell(gextras.InternObject(m)).Append(child)
}

func (m menuBar) BindModel(model gio.MenuModel, actionNamespace string, withSeparators bool) {
	WrapMenuShell(gextras.InternObject(m)).BindModel(model, actionNamespace, withSeparators)
}

func (m menuBar) Cancel() {
...
func (b menuBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menuBar) GetName() string {
