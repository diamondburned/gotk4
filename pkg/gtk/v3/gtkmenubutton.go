...
// WrapMenuButton wraps a GObject to a type that implements
// interface MenuButton. It is primarily used internally.
...
func (m menuButton) AsToggleButton() ToggleButton {
	return WrapToggleButton(gextras.InternObject(m))
}
...
func (b menuButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menuButton) GetName() string {
...
func (a menuButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a menuButton) GetActionTargetValue() *glib.Variant {
...
func (a menuButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a menuButton) GetUseActionAppearance() bool {
