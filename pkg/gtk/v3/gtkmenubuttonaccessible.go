...
// WrapMenuButtonAccessible wraps a GObject to a type that implements
// interface MenuButtonAccessible. It is primarily used internally.
func WrapMenuButtonAccessible(obj *externglib.Object) MenuButtonAccessible {
	return menuButtonAccessible{obj}
}
...
func (m menuButtonAccessible) AsToggleButtonAccessible() ToggleButtonAccessible {
	return WrapToggleButtonAccessible(gextras.InternObject(m))
}
...
func (a menuButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a menuButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a menuButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a menuButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a menuButtonAccessible) GetName(i int) string {
...
func (i menuButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i menuButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i menuButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i menuButtonAccessible) GetImageSize() (width int, height int) {
