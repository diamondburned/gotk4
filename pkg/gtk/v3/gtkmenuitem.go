...
func (m menuItem) AsBin() Bin {
	return WrapBin(gextras.InternObject(m))
}
...
func (b menuItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menuItem) GetName() string {
...
func (a menuItem) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a menuItem) GetActionTargetValue() *glib.Variant {
...
func (a menuItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a menuItem) GetUseActionAppearance() bool {
