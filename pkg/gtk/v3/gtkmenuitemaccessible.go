...
// WrapMenuItemAccessible wraps a GObject to a type that implements
// interface MenuItemAccessible. It is primarily used internally.
func WrapMenuItemAccessible(obj *externglib.Object) MenuItemAccessible {
	return menuItemAccessible{obj}
}
...
func (m menuItemAccessible) AsContainerAccessible() ContainerAccessible {
	return WrapContainerAccessible(gextras.InternObject(m))
}
...
func (a menuItemAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a menuItemAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a menuItemAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a menuItemAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a menuItemAccessible) GetName(i int) string {
