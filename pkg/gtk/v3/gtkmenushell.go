...
// WrapMenuShell wraps a GObject to a type that implements
// interface MenuShell. It is primarily used internally.
...
func (m menuShell) AsContainer() Container {
	return WrapContainer(gextras.InternObject(m))
}
...
func (b menuShell) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menuShell) GetName() string {
