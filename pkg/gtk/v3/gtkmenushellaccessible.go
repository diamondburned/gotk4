...
// WrapMenuShellAccessible wraps a GObject to a type that implements
// interface MenuShellAccessible. It is primarily used internally.
func WrapMenuShellAccessible(obj *externglib.Object) MenuShellAccessible {
	return menuShellAccessible{obj}
}
