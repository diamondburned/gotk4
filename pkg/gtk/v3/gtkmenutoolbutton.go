...
// WrapMenuToolButton wraps a GObject to a type that implements
// interface MenuToolButton. It is primarily used internally.
...
func (m menuToolButton) AsToolButton() ToolButton {
	return WrapToolButton(gextras.InternObject(m))
}
...
func (b menuToolButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b menuToolButton) GetName() string {
...
func (a menuToolButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a menuToolButton) GetUseActionAppearance() bool {
...
func (a menuToolButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a menuToolButton) GetActionTargetValue() *glib.Variant {
