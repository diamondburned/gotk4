...
func (m misc) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(m))
}
...
func (b misc) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b misc) GetName() string {
