...
// WrapModelButton wraps a GObject to a type that implements
// interface ModelButton. It is primarily used internally.
...
func (m modelButton) AsButton() Button {
	return WrapButton(gextras.InternObject(m))
}
...
func (b modelButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b modelButton) GetName() string {
...
func (a modelButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a modelButton) GetActionTargetValue() *glib.Variant {
...
func (a modelButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a modelButton) GetUseActionAppearance() bool {
