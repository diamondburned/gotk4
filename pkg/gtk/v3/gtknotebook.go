...
func (n notebook) AsContainer() Container {
	return WrapContainer(gextras.InternObject(n))
}
...
func (w notebook) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w notebook) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w notebook) AddEvents(events int) {
...
func (w notebook) CanActivateAccel(signalId uint) bool {
...
func (w notebook) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w notebook) ClassPath() (pathLength uint, path string, pathReversed string) {
...
func (w notebook) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w notebook) DeviceIsShadowed(device gdk.Device) bool {
...
func (w notebook) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w notebook) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w notebook) GetActionGroup(prefix string) gio.ActionGroup {
...
func (w notebook) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w notebook) GetCanDefault() bool {
...
func (w notebook) GetChildRequisition() Requisition {
...
func (w notebook) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w notebook) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w notebook) GetDeviceEvents(device gdk.Device) gdk.EventMask {
...
func (w notebook) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w notebook) GetEvents() int {
...
func (w notebook) GetHasWindow() bool {
...
func (w notebook) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w notebook) GetMarginRight() int {
...
func (w notebook) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w notebook) GetModifierStyle() RCStyle {
...
func (w notebook) GetNoShowAll() bool {
...
func (w notebook) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w notebook) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w notebook) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w notebook) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w notebook) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w notebook) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
...
func (w notebook) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w notebook) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
...
func (w notebook) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w notebook) GetRootWindow() gdk.Window {
...
func (w notebook) GetScreen() gdk.Screen {
...
func (w notebook) GetState() StateType {
...
func (w notebook) GetStyle() Style {
...
func (w notebook) GetSupportMultidevice() bool {
...
func (w notebook) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w notebook) GetToplevel() Widget {
...
func (w notebook) GetVAlignWithBaseline() Align {
...
func (w notebook) HideOnDelete() bool {
...
func (w notebook) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w notebook) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w notebook) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
...
func (w notebook) IsComposited() bool {
...
func (w notebook) IsToplevel() bool {
...
func (w notebook) ListActionPrefixes() []string {
...
func (w notebook) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w notebook) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w notebook) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w notebook) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w notebook) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w notebook) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w notebook) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w notebook) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w notebook) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w notebook) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w notebook) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w notebook) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w notebook) Path() (pathLength uint, path string, pathReversed string) {
...
func (w notebook) QueueComputeExpand() {
...
func (w notebook) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w notebook) QueueDrawRegion(region *cairo.Region) {
...
func (w notebook) QueueResizeNoRedraw() {
...
func (w notebook) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w notebook) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w notebook) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
...
func (w notebook) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w notebook) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w notebook) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w notebook) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
...
func (w notebook) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w notebook) SetEvents(events int) {
...
func (w notebook) SetHasWindow(hasWindow bool) {
...
func (w notebook) SetMapped(mapped bool) {
...
func (w notebook) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w notebook) SetMarginRight(margin int) {
...
func (w notebook) SetNoShowAll(noShowAll bool) {
...
func (w notebook) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w notebook) SetRealized(realized bool) {
...
func (w notebook) SetRedrawOnAllocate(redrawOnAllocate bool) {
...
func (w notebook) SetState(state StateType) {
...
func (w notebook) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w notebook) SetSupportMultidevice(supportMultidevice bool) {
...
func (w notebook) SetTooltipWindow(customWindow Window) {
...
func (w notebook) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w notebook) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w notebook) ShapeCombineRegion(region *cairo.Region) {
...
func (w notebook) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w notebook) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w notebook) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w notebook) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w notebook) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w notebook) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s notebook) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
...
func (w notebook) UnregisterWindow(window gdk.Window) {
...
func (b notebook) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b notebook) GetName() string {
