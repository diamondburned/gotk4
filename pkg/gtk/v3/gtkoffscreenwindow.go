...
// WrapOffscreenWindow wraps a GObject to a type that implements
// interface OffscreenWindow. It is primarily used internally.
...
func (o offscreenWindow) AsWindow() Window {
	return WrapWindow(gextras.InternObject(o))
}
...
func (w offscreenWindow) ActivateDefault() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateDefault()
}

func (w offscreenWindow) ActivateFocus() bool {
	return WrapWindow(gextras.InternObject(w)).ActivateFocus()
}

func (w offscreenWindow) ActivateKey(event *gdk.EventKey) bool {
	return WrapWindow(gextras.InternObject(w)).ActivateKey(event)
}

func (w offscreenWindow) AddAccelGroup(accelGroup AccelGroup) {
	WrapWindow(gextras.InternObject(w)).AddAccelGroup(accelGroup)
}

func (w offscreenWindow) AddMnemonic(keyval uint, target Widget) {
	WrapWindow(gextras.InternObject(w)).AddMnemonic(keyval, target)
}

func (w offscreenWindow) BeginMoveDrag(button int, rootX int, rootY int, timestamp uint32) {
	WrapWindow(gextras.InternObject(w)).BeginMoveDrag(button, rootX, rootY, timestamp)
}

func (w offscreenWindow) BeginResizeDrag(edge gdk.WindowEdge, button int, rootX int, rootY int, timestamp uint32) {
...
func (w offscreenWindow) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w offscreenWindow) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w offscreenWindow) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w offscreenWindow) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w offscreenWindow) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w offscreenWindow) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w offscreenWindow) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w offscreenWindow) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w offscreenWindow) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w offscreenWindow) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w offscreenWindow) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w offscreenWindow) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w offscreenWindow) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w offscreenWindow) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w offscreenWindow) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w offscreenWindow) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w offscreenWindow) GetScaleFactor() int {
...
func (b offscreenWindow) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b offscreenWindow) GetName() string {
