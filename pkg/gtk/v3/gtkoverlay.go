...
// WrapOverlay wraps a GObject to a type that implements
// interface Overlay. It is primarily used internally.
...
func (o overlay) AsBin() Bin {
	return WrapBin(gextras.InternObject(o))
}
...
func (b overlay) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b overlay) GetName() string {
