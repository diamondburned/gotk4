...
// WrapPaned wraps a GObject to a type that implements
// interface Paned. It is primarily used internally.
...
func (p paned) AsContainer() Container {
	return WrapContainer(gextras.InternObject(p))
}
...
func (b paned) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b paned) GetName() string {
...
func (o paned) GetOrientation() Orientation {
