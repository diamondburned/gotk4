...
// WrapPanedAccessible wraps a GObject to a type that implements
// interface PanedAccessible. It is primarily used internally.
func WrapPanedAccessible(obj *externglib.Object) PanedAccessible {
	return panedAccessible{obj}
}
