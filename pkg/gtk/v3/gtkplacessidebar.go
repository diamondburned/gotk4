...
type PlacesSidebar interface {
	...
	//
	// This method is inherited from ScrolledWindow
	AddWithViewport(child Widget)
	// GetCaptureButtonPress: return whether button presses are captured during
	// kinetic scrolling. See gtk_scrolled_window_set_capture_button_press().
	//
	// This method is inherited from ScrolledWindow
	GetCaptureButtonPress() bool
	...
	// GetMinContentWidth gets the minimum content width of @scrolled_window, or
	// -1 if not set.
	//
	// This method is inherited from ScrolledWindow
	GetMinContentWidth() int
	// GetOverlayScrolling returns whether overlay scrolling is enabled for this
	// scrolled window.
	//
	// This method is inherited from ScrolledWindow
	...
	// GetPropagateNaturalHeight reports whether the natural height of the child
	...
	// GetShadowType gets the shadow type of the scrolled window. See
...
// WrapPlacesSidebar wraps a GObject to a type that implements
// interface PlacesSidebar. It is primarily used internally.
func WrapPlacesSidebar(obj *externglib.Object) PlacesSidebar {
	return placesSidebar{obj}
}
...
func (p placesSidebar) AsScrolledWindow() ScrolledWindow {
	return WrapScrolledWindow(gextras.InternObject(p))
}
...
func (s placesSidebar) AddWithViewport(child Widget) {
	WrapScrolledWindow(gextras.InternObject(s)).AddWithViewport(child)
}

func (s placesSidebar) GetCaptureButtonPress() bool {
	return WrapScrolledWindow(gextras.InternObject(s)).GetCaptureButtonPress()
}

func (s placesSidebar) GetHAdjustment() Adjustment {
	return WrapScrolledWindow(gextras.InternObject(s)).GetHAdjustment()
}

func (s placesSidebar) GetHscrollbar() Widget {
	return WrapScrolledWindow(gextras.InternObject(s)).GetHscrollbar()
}

func (s placesSidebar) GetKineticScrolling() bool {
	return WrapScrolledWindow(gextras.InternObject(s)).GetKineticScrolling()
}

func (s placesSidebar) GetMaxContentHeight() int {
	return WrapScrolledWindow(gextras.InternObject(s)).GetMaxContentHeight()
}

func (s placesSidebar) GetMaxContentWidth() int {
	return WrapScrolledWindow(gextras.InternObject(s)).GetMaxContentWidth()
}

func (s placesSidebar) GetMinContentHeight() int {
	return WrapScrolledWindow(gextras.InternObject(s)).GetMinContentHeight()
}

func (s placesSidebar) GetMinContentWidth() int {
	return WrapScrolledWindow(gextras.InternObject(s)).GetMinContentWidth()
}

func (s placesSidebar) GetOverlayScrolling() bool {
	return WrapScrolledWindow(gextras.InternObject(s)).GetOverlayScrolling()
}

func (s placesSidebar) GetPlacement() CornerType {
	return WrapScrolledWindow(gextras.InternObject(s)).GetPlacement()
}

func (s placesSidebar) GetPolicy() (hscrollbarPolicy PolicyType, vscrollbarPolicy PolicyType) {
	return WrapScrolledWindow(gextras.InternObject(s)).GetPolicy()
}

func (s placesSidebar) GetPropagateNaturalHeight() bool {
	return WrapScrolledWindow(gextras.InternObject(s)).GetPropagateNaturalHeight()
}

func (s placesSidebar) GetPropagateNaturalWidth() bool {
	return WrapScrolledWindow(gextras.InternObject(s)).GetPropagateNaturalWidth()
}

func (s placesSidebar) GetShadowType() ShadowType {
	return WrapScrolledWindow(gextras.InternObject(s)).GetShadowType()
}

func (s placesSidebar) GetVAdjustment() Adjustment {
	return WrapScrolledWindow(gextras.InternObject(s)).GetVAdjustment()
}

func (s placesSidebar) GetVscrollbar() Widget {
	return WrapScrolledWindow(gextras.InternObject(s)).GetVscrollbar()
}

func (s placesSidebar) SetCaptureButtonPress(captureButtonPress bool) {
	WrapScrolledWindow(gextras.InternObject(s)).SetCaptureButtonPress(captureButtonPress)
}

func (s placesSidebar) SetHAdjustment(hadjustment Adjustment) {
	WrapScrolledWindow(gextras.InternObject(s)).SetHAdjustment(hadjustment)
}

func (s placesSidebar) SetKineticScrolling(kineticScrolling bool) {
	WrapScrolledWindow(gextras.InternObject(s)).SetKineticScrolling(kineticScrolling)
}

func (s placesSidebar) SetMaxContentHeight(height int) {
	WrapScrolledWindow(gextras.InternObject(s)).SetMaxContentHeight(height)
}

func (s placesSidebar) SetMaxContentWidth(width int) {
	WrapScrolledWindow(gextras.InternObject(s)).SetMaxContentWidth(width)
}

func (s placesSidebar) SetMinContentHeight(height int) {
	WrapScrolledWindow(gextras.InternObject(s)).SetMinContentHeight(height)
}

func (s placesSidebar) SetMinContentWidth(width int) {
	WrapScrolledWindow(gextras.InternObject(s)).SetMinContentWidth(width)
}

func (s placesSidebar) SetOverlayScrolling(overlayScrolling bool) {
	WrapScrolledWindow(gextras.InternObject(s)).SetOverlayScrolling(overlayScrolling)
}

func (s placesSidebar) SetPlacement(windowPlacement CornerType) {
	WrapScrolledWindow(gextras.InternObject(s)).SetPlacement(windowPlacement)
}

func (s placesSidebar) SetPolicy(hscrollbarPolicy PolicyType, vscrollbarPolicy PolicyType) {
	WrapScrolledWindow(gextras.InternObject(s)).SetPolicy(hscrollbarPolicy, vscrollbarPolicy)
}

func (s placesSidebar) SetPropagateNaturalHeight(propagate bool) {
	WrapScrolledWindow(gextras.InternObject(s)).SetPropagateNaturalHeight(propagate)
}

func (s placesSidebar) SetPropagateNaturalWidth(propagate bool) {
	WrapScrolledWindow(gextras.InternObject(s)).SetPropagateNaturalWidth(propagate)
}

func (s placesSidebar) SetShadowType(typ ShadowType) {
	WrapScrolledWindow(gextras.InternObject(s)).SetShadowType(typ)
}

func (s placesSidebar) SetVAdjustment(vadjustment Adjustment) {
	WrapScrolledWindow(gextras.InternObject(s)).SetVAdjustment(vadjustment)
}

func (s placesSidebar) UnsetPlacement() {
	WrapScrolledWindow(gextras.InternObject(s)).UnsetPlacement()
}

func (b placesSidebar) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c placesSidebar) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c placesSidebar) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c placesSidebar) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c placesSidebar) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c placesSidebar) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c placesSidebar) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c placesSidebar) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c placesSidebar) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c placesSidebar) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c placesSidebar) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c placesSidebar) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c placesSidebar) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c placesSidebar) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c placesSidebar) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c placesSidebar) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c placesSidebar) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c placesSidebar) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c placesSidebar) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c placesSidebar) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c placesSidebar) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c placesSidebar) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c placesSidebar) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c placesSidebar) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c placesSidebar) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w placesSidebar) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w placesSidebar) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w placesSidebar) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w placesSidebar) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w placesSidebar) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w placesSidebar) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w placesSidebar) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w placesSidebar) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w placesSidebar) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w placesSidebar) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w placesSidebar) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w placesSidebar) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w placesSidebar) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w placesSidebar) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w placesSidebar) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w placesSidebar) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w placesSidebar) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w placesSidebar) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w placesSidebar) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w placesSidebar) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w placesSidebar) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w placesSidebar) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w placesSidebar) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w placesSidebar) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w placesSidebar) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w placesSidebar) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w placesSidebar) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w placesSidebar) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w placesSidebar) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w placesSidebar) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w placesSidebar) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w placesSidebar) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w placesSidebar) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w placesSidebar) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w placesSidebar) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w placesSidebar) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w placesSidebar) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w placesSidebar) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w placesSidebar) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w placesSidebar) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w placesSidebar) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w placesSidebar) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w placesSidebar) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w placesSidebar) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w placesSidebar) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w placesSidebar) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w placesSidebar) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w placesSidebar) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w placesSidebar) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w placesSidebar) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w placesSidebar) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w placesSidebar) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w placesSidebar) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w placesSidebar) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w placesSidebar) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w placesSidebar) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w placesSidebar) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w placesSidebar) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w placesSidebar) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w placesSidebar) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w placesSidebar) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w placesSidebar) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w placesSidebar) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w placesSidebar) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w placesSidebar) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w placesSidebar) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w placesSidebar) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w placesSidebar) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w placesSidebar) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w placesSidebar) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w placesSidebar) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w placesSidebar) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w placesSidebar) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w placesSidebar) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w placesSidebar) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w placesSidebar) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w placesSidebar) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w placesSidebar) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w placesSidebar) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w placesSidebar) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w placesSidebar) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w placesSidebar) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w placesSidebar) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w placesSidebar) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w placesSidebar) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w placesSidebar) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w placesSidebar) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w placesSidebar) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w placesSidebar) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w placesSidebar) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w placesSidebar) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w placesSidebar) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w placesSidebar) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w placesSidebar) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w placesSidebar) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w placesSidebar) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w placesSidebar) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w placesSidebar) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w placesSidebar) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w placesSidebar) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w placesSidebar) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w placesSidebar) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w placesSidebar) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w placesSidebar) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w placesSidebar) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w placesSidebar) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w placesSidebar) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w placesSidebar) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w placesSidebar) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w placesSidebar) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w placesSidebar) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w placesSidebar) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w placesSidebar) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w placesSidebar) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w placesSidebar) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w placesSidebar) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w placesSidebar) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w placesSidebar) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w placesSidebar) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w placesSidebar) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w placesSidebar) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w placesSidebar) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w placesSidebar) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w placesSidebar) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w placesSidebar) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w placesSidebar) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w placesSidebar) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w placesSidebar) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w placesSidebar) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w placesSidebar) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w placesSidebar) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w placesSidebar) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w placesSidebar) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w placesSidebar) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w placesSidebar) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w placesSidebar) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w placesSidebar) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w placesSidebar) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w placesSidebar) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w placesSidebar) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w placesSidebar) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w placesSidebar) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w placesSidebar) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w placesSidebar) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w placesSidebar) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w placesSidebar) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w placesSidebar) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w placesSidebar) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w placesSidebar) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w placesSidebar) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w placesSidebar) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w placesSidebar) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w placesSidebar) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w placesSidebar) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w placesSidebar) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w placesSidebar) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w placesSidebar) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w placesSidebar) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w placesSidebar) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w placesSidebar) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w placesSidebar) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w placesSidebar) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w placesSidebar) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w placesSidebar) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w placesSidebar) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w placesSidebar) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w placesSidebar) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w placesSidebar) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w placesSidebar) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w placesSidebar) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w placesSidebar) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w placesSidebar) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w placesSidebar) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w placesSidebar) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w placesSidebar) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w placesSidebar) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w placesSidebar) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w placesSidebar) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w placesSidebar) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w placesSidebar) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w placesSidebar) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w placesSidebar) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w placesSidebar) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w placesSidebar) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w placesSidebar) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w placesSidebar) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w placesSidebar) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w placesSidebar) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w placesSidebar) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w placesSidebar) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w placesSidebar) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w placesSidebar) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w placesSidebar) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w placesSidebar) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w placesSidebar) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w placesSidebar) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w placesSidebar) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w placesSidebar) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w placesSidebar) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w placesSidebar) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w placesSidebar) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w placesSidebar) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w placesSidebar) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w placesSidebar) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w placesSidebar) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w placesSidebar) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w placesSidebar) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w placesSidebar) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w placesSidebar) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w placesSidebar) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w placesSidebar) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w placesSidebar) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w placesSidebar) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w placesSidebar) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w placesSidebar) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w placesSidebar) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w placesSidebar) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w placesSidebar) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w placesSidebar) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w placesSidebar) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w placesSidebar) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w placesSidebar) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w placesSidebar) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w placesSidebar) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w placesSidebar) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w placesSidebar) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w placesSidebar) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w placesSidebar) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w placesSidebar) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w placesSidebar) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w placesSidebar) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w placesSidebar) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w placesSidebar) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w placesSidebar) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s placesSidebar) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w placesSidebar) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w placesSidebar) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w placesSidebar) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w placesSidebar) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w placesSidebar) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w placesSidebar) UnsetStateFlags(flags StateFlags) {
...
func (b placesSidebar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b placesSidebar) GetName() string {
