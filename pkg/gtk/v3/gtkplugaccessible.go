...
// WrapPlugAccessible wraps a GObject to a type that implements
// interface PlugAccessible. It is primarily used internally.
func WrapPlugAccessible(obj *externglib.Object) PlugAccessible {
	return plugAccessible{obj}
}
