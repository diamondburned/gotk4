...
// WrapPopover wraps a GObject to a type that implements
// interface Popover. It is primarily used internally.
...
func (p popover) AsBin() Bin {
	return WrapBin(gextras.InternObject(p))
}
...
func (b popover) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b popover) GetName() string {
