...
type PopoverMenu interface {
	...
	// your Model.
	//
	// This method is inherited from Popover
	BindModel(model gio.MenuModel, actionNamespace string)
	// GetConstrainTo returns the constraint for placing this popover. See
	// gtk_popover_set_constrain_to().
	//
	// This method is inherited from Popover
	GetConstrainTo() PopoverConstraint
	// GetDefaultWidget gets the widget that should be set as the default while
	// the popover is shown.
	//
	// This method is inherited from Popover
	GetDefaultWidget() Widget
	// GetModal returns whether the popover is modal, see gtk_popover_set_modal
	...
	// GetRelativeTo returns the widget @popover is currently attached to
	//
	// This method is inherited from Popover
	GetRelativeTo() Widget
	// GetTransitionsEnabled returns whether show/hide transitions are enabled
	// on this popover.
	//
...
// WrapPopoverMenu wraps a GObject to a type that implements
// interface PopoverMenu. It is primarily used internally.
func WrapPopoverMenu(obj *externglib.Object) PopoverMenu {
	return popoverMenu{obj}
}
...
func (p popoverMenu) AsPopover() Popover {
	return WrapPopover(gextras.InternObject(p))
}
...
func (b popoverMenu) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b popoverMenu) GetName() string {
