...
func ifaceInitPrintOperationPreviewer(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("end_preview"))) = unsafe.Pointer(C._gotk4_gtk3_PrintOperationPreviewIface_end_preview)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("got_page_size"))) = unsafe.Pointer(C._gotk4_gtk3_PrintOperationPreviewIface_got_page_size)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("is_selected"))) = unsafe.Pointer(C._gotk4_gtk3_PrintOperationPreviewIface_is_selected)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("ready"))) = unsafe.Pointer(C._gotk4_gtk3_PrintOperationPreviewIface_ready)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("render_page"))) = unsafe.Pointer(C._gotk4_gtk3_PrintOperationPreviewIface_render_page)
}
