...
const PRINT_SETTINGS_COLLATE = C.PRINT_SETTINGS_COLLATE
const PRINT_SETTINGS_DEFAULT_SOURCE = C.PRINT_SETTINGS_DEFAULT_SOURCE
const PRINT_SETTINGS_DITHER = C.PRINT_SETTINGS_DITHER
const PRINT_SETTINGS_DUPLEX = C.PRINT_SETTINGS_DUPLEX
const PRINT_SETTINGS_FINISHINGS = C.PRINT_SETTINGS_FINISHINGS
const PRINT_SETTINGS_MEDIA_TYPE = C.PRINT_SETTINGS_MEDIA_TYPE
const PRINT_SETTINGS_NUMBER_UP = C.PRINT_SETTINGS_NUMBER_UP
const PRINT_SETTINGS_NUMBER_UP_LAYOUT = C.PRINT_SETTINGS_NUMBER_UP_LAYOUT
const PRINT_SETTINGS_N_COPIES = C.PRINT_SETTINGS_N_COPIES
const PRINT_SETTINGS_ORIENTATION = C.PRINT_SETTINGS_ORIENTATION
...
// file extension.
const PRINT_SETTINGS_OUTPUT_BASENAME = C.PRINT_SETTINGS_OUTPUT_BASENAME
const PRINT_SETTINGS_OUTPUT_BIN = C.PRINT_SETTINGS_OUTPUT_BIN
...
const PRINT_SETTINGS_OUTPUT_DIR = C.PRINT_SETTINGS_OUTPUT_DIR
...
const PRINT_SETTINGS_OUTPUT_FILE_FORMAT = C.PRINT_SETTINGS_OUTPUT_FILE_FORMAT
...
// “file://” URIs.
const PRINT_SETTINGS_OUTPUT_URI = C.PRINT_SETTINGS_OUTPUT_URI
const PRINT_SETTINGS_PAGE_RANGES = C.PRINT_SETTINGS_PAGE_RANGES
const PRINT_SETTINGS_PAGE_SET = C.PRINT_SETTINGS_PAGE_SET
const PRINT_SETTINGS_PAPER_FORMAT = C.PRINT_SETTINGS_PAPER_FORMAT
const PRINT_SETTINGS_PAPER_HEIGHT = C.PRINT_SETTINGS_PAPER_HEIGHT
const PRINT_SETTINGS_PAPER_WIDTH = C.PRINT_SETTINGS_PAPER_WIDTH
const PRINT_SETTINGS_PRINTER = C.PRINT_SETTINGS_PRINTER
const PRINT_SETTINGS_PRINTER_LPI = C.PRINT_SETTINGS_PRINTER_LPI
const PRINT_SETTINGS_PRINT_PAGES = C.PRINT_SETTINGS_PRINT_PAGES
const PRINT_SETTINGS_QUALITY = C.PRINT_SETTINGS_QUALITY
const PRINT_SETTINGS_RESOLUTION = C.PRINT_SETTINGS_RESOLUTION
const PRINT_SETTINGS_RESOLUTION_X = C.PRINT_SETTINGS_RESOLUTION_X
const PRINT_SETTINGS_RESOLUTION_Y = C.PRINT_SETTINGS_RESOLUTION_Y
const PRINT_SETTINGS_REVERSE = C.PRINT_SETTINGS_REVERSE
const PRINT_SETTINGS_SCALE = C.PRINT_SETTINGS_SCALE
const PRINT_SETTINGS_USE_COLOR = C.PRINT_SETTINGS_USE_COLOR
const PRINT_SETTINGS_WIN32_DRIVER_EXTRA = C.PRINT_SETTINGS_WIN32_DRIVER_EXTRA
const PRINT_SETTINGS_WIN32_DRIVER_VERSION = C.PRINT_SETTINGS_WIN32_DRIVER_VERSION
