...
// WrapProgressBar wraps a GObject to a type that implements
// interface ProgressBar. It is primarily used internally.
...
func (p progressBar) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(p))
}
...
func (b progressBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b progressBar) GetName() string {
...
func (o progressBar) GetOrientation() Orientation {
