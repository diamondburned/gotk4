...
type RadioButton interface {
	...
	//
	// This method is inherited from ToggleButton
	GetActive() bool
	// GetInconsistent gets the value set by
	// gtk_toggle_button_set_inconsistent().
	//
	// This method is inherited from ToggleButton
	GetInconsistent() bool
	// GetMode retrieves whether the button is displayed as a separate indicator
...
// WrapRadioButton wraps a GObject to a type that implements
// interface RadioButton. It is primarily used internally.
...
func (r radioButton) AsCheckButton() CheckButton {
	return WrapCheckButton(gextras.InternObject(r))
}
...
func (t radioButton) GetActive() bool {
	return WrapToggleButton(gextras.InternObject(t)).GetActive()
}

func (t radioButton) GetInconsistent() bool {
	return WrapToggleButton(gextras.InternObject(t)).GetInconsistent()
}

func (t radioButton) GetMode() bool {
	return WrapToggleButton(gextras.InternObject(t)).GetMode()
}

func (t radioButton) SetActive(isActive bool) {
	WrapToggleButton(gextras.InternObject(t)).SetActive(isActive)
}

func (t radioButton) SetInconsistent(setting bool) {
	WrapToggleButton(gextras.InternObject(t)).SetInconsistent(setting)
}

func (t radioButton) SetMode(drawIndicator bool) {
	WrapToggleButton(gextras.InternObject(t)).SetMode(drawIndicator)
}

func (t radioButton) Toggled() {
	WrapToggleButton(gextras.InternObject(t)).Toggled()
}

func (b radioButton) Clicked() {
	WrapButton(gextras.InternObject(b)).Clicked()
}

func (b radioButton) Enter() {
	WrapButton(gextras.InternObject(b)).Enter()
}

func (b radioButton) GetAlignment() (xalign float32, yalign float32) {
	return WrapButton(gextras.InternObject(b)).GetAlignment()
}

func (b radioButton) GetAlwaysShowImage() bool {
	return WrapButton(gextras.InternObject(b)).GetAlwaysShowImage()
}

func (b radioButton) GetEventWindow() gdk.Window {
	return WrapButton(gextras.InternObject(b)).GetEventWindow()
}

func (b radioButton) GetFocusOnClick() bool {
	return WrapButton(gextras.InternObject(b)).GetFocusOnClick()
}

func (b radioButton) GetImage() Widget {
	return WrapButton(gextras.InternObject(b)).GetImage()
}

func (b radioButton) GetImagePosition() PositionType {
	return WrapButton(gextras.InternObject(b)).GetImagePosition()
}

func (b radioButton) GetLabel() string {
	return WrapButton(gextras.InternObject(b)).GetLabel()
}

func (b radioButton) GetRelief() ReliefStyle {
	return WrapButton(gextras.InternObject(b)).GetRelief()
}

func (b radioButton) GetUseStock() bool {
	return WrapButton(gextras.InternObject(b)).GetUseStock()
}

func (b radioButton) GetUseUnderline() bool {
	return WrapButton(gextras.InternObject(b)).GetUseUnderline()
}

func (b radioButton) Leave() {
	WrapButton(gextras.InternObject(b)).Leave()
}

func (b radioButton) Pressed() {
	WrapButton(gextras.InternObject(b)).Pressed()
}

func (b radioButton) Released() {
	WrapButton(gextras.InternObject(b)).Released()
}

func (b radioButton) SetAlignment(xalign float32, yalign float32) {
	WrapButton(gextras.InternObject(b)).SetAlignment(xalign, yalign)
}

func (b radioButton) SetAlwaysShowImage(alwaysShow bool) {
	WrapButton(gextras.InternObject(b)).SetAlwaysShowImage(alwaysShow)
}

func (b radioButton) SetFocusOnClick(focusOnClick bool) {
	WrapButton(gextras.InternObject(b)).SetFocusOnClick(focusOnClick)
}

func (b radioButton) SetImage(image Widget) {
	WrapButton(gextras.InternObject(b)).SetImage(image)
}

func (b radioButton) SetImagePosition(position PositionType) {
	WrapButton(gextras.InternObject(b)).SetImagePosition(position)
}

func (b radioButton) SetLabel(label string) {
	WrapButton(gextras.InternObject(b)).SetLabel(label)
}

func (b radioButton) SetRelief(relief ReliefStyle) {
	WrapButton(gextras.InternObject(b)).SetRelief(relief)
}

func (b radioButton) SetUseStock(useStock bool) {
	WrapButton(gextras.InternObject(b)).SetUseStock(useStock)
}

func (b radioButton) SetUseUnderline(useUnderline bool) {
	WrapButton(gextras.InternObject(b)).SetUseUnderline(useUnderline)
}

func (b radioButton) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c radioButton) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c radioButton) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c radioButton) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c radioButton) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c radioButton) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c radioButton) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c radioButton) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c radioButton) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c radioButton) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c radioButton) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c radioButton) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c radioButton) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c radioButton) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c radioButton) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c radioButton) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c radioButton) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c radioButton) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c radioButton) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c radioButton) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c radioButton) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c radioButton) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c radioButton) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c radioButton) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c radioButton) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w radioButton) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w radioButton) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w radioButton) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w radioButton) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w radioButton) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w radioButton) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w radioButton) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w radioButton) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w radioButton) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w radioButton) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w radioButton) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w radioButton) CreatePangoLayout(text string) pango.Layout {
...
func (b radioButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b radioButton) GetName() string {
...
func (a radioButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a radioButton) GetActionTargetValue() *glib.Variant {
...
func (a radioButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a radioButton) GetUseActionAppearance() bool {
