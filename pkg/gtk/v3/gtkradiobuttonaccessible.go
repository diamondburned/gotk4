...
// WrapRadioButtonAccessible wraps a GObject to a type that implements
// interface RadioButtonAccessible. It is primarily used internally.
func WrapRadioButtonAccessible(obj *externglib.Object) RadioButtonAccessible {
	return radioButtonAccessible{obj}
}
...
func (r radioButtonAccessible) AsToggleButtonAccessible() ToggleButtonAccessible {
	return WrapToggleButtonAccessible(gextras.InternObject(r))
}
...
func (a radioButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a radioButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a radioButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a radioButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a radioButtonAccessible) GetName(i int) string {
...
func (i radioButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i radioButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i radioButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i radioButtonAccessible) GetImageSize() (width int, height int) {
