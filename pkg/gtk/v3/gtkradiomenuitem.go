...
// GTypeRadioMenuItem returns the GType for the type RadioMenuItem.
//
// This function has the side effect of registering a GValue marshaler
// globally. Use this if you need that for any reason. The function is
// concurrently safe to use.
func GTypeRadioMenuItem() coreglib.Type {
	gtype := coreglib.Type(girepository.MustFind("Gtk", "RadioMenuItem").RegisteredGType())
	coreglib.RegisterGValueMarshaler(gtype, marshalRadioMenuItem)
	return gtype
}
...
func NewRadioMenuItem(group []*RadioMenuItem) *RadioMenuItem {
	...
	_gret := _info.InvokeClassMethod("new_RadioMenuItem", _args[:], nil)
	...
	_radioMenuItem = wrapRadioMenuItem(coreglib.Take(unsafe.Pointer(*(**C.void)(unsafe.Pointer(&_cret)))))
...
func NewRadioMenuItemFromWidget(group *RadioMenuItem) *RadioMenuItem {
	...
	_info := girepository.MustFind("Gtk", "RadioMenuItem")
	_gret := _info.InvokeClassMethod("new_RadioMenuItem_from_widget", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func NewRadioMenuItemWithLabel(group []*RadioMenuItem, label string) *RadioMenuItem {
	...
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(label)))
	...
	_info := girepository.MustFind("Gtk", "RadioMenuItem")
	_gret := _info.InvokeClassMethod("new_RadioMenuItem_with_label", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func NewRadioMenuItemWithLabelFromWidget(group *RadioMenuItem, label string) *RadioMenuItem {
	...
	_info := girepository.MustFind("Gtk", "RadioMenuItem")
	_gret := _info.InvokeClassMethod("new_RadioMenuItem_with_label_from_widget", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func NewRadioMenuItemWithMnemonic(group []*RadioMenuItem, label string) *RadioMenuItem {
	...
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(label)))
	...
	_info := girepository.MustFind("Gtk", "RadioMenuItem")
	_gret := _info.InvokeClassMethod("new_RadioMenuItem_with_mnemonic", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func NewRadioMenuItemWithMnemonicFromWidget(group *RadioMenuItem, label string) *RadioMenuItem {
	...
	_info := girepository.MustFind("Gtk", "RadioMenuItem")
	_gret := _info.InvokeClassMethod("new_RadioMenuItem_with_mnemonic_from_widget", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
