...
type RadioMenuItem interface {
	...
	// GetActive returns whether the check menu item is active. See
	// gtk_check_menu_item_set_active ().
	//
	// This method is inherited from CheckMenuItem
	GetActive() bool
	// GetDrawAsRadio returns whether @check_menu_item looks like a
	// RadioMenuItem
	//
	// This method is inherited from CheckMenuItem
	GetDrawAsRadio() bool
	// GetInconsistent retrieves the value set by
...
// WrapRadioMenuItem wraps a GObject to a type that implements
// interface RadioMenuItem. It is primarily used internally.
...
func (r radioMenuItem) AsCheckMenuItem() CheckMenuItem {
	return WrapCheckMenuItem(gextras.InternObject(r))
}
...
func (b radioMenuItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b radioMenuItem) GetName() string {
...
func (a radioMenuItem) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a radioMenuItem) GetActionTargetValue() *glib.Variant {
...
func (a radioMenuItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a radioMenuItem) GetUseActionAppearance() bool {
