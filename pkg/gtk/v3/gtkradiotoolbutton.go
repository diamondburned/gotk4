...
type RadioToolButton interface {
	...
	// GetActive queries a ToggleToolButton and returns its current state.
	// Returns true if the toggle button is pressed in and false if it is
	// raised.
	//
	// This method is inherited from ToggleToolButton
	GetActive() bool
	...
	// GetIconName returns the name of the themed icon for the tool button, see
	// gtk_tool_button_set_icon_name().
	//
	// This method is inherited from ToolButton
	GetIconName() string
	// GetIconWidget: return the widget used as icon widget on @button. See
	// gtk_tool_button_set_icon_widget().
	//
	// This method is inherited from ToolButton
	GetIconWidget() Widget
	// GetLabel returns the label used by the tool button, or nil if the tool
	...
	// This method is inherited from ToolButton
	GetLabel() string
	// GetLabelWidget returns the widget used as label on @button. See
	// gtk_tool_button_set_label_widget().
	//
	// This method is inherited from ToolButton
	GetLabelWidget() Widget
	// GetStockID returns the name of the stock item. See
	...
	// This method is inherited from ToolButton
	GetStockID() string
	// GetUseUnderline returns whether underscores in the label property are
	// used as mnemonics on menu items on the overflow menu. See
	...
	// GetEllipsizeMode returns the ellipsize mode used for @tool_item. Custom
	// subclasses of ToolItem should call this function to find out how text
	// should be ellipsized.
	//
	// This method is inherited from ToolItem
	GetEllipsizeMode() pango.EllipsizeMode
	// GetExpand returns whether @tool_item is allocated extra space. See
	// gtk_tool_item_set_expand().
	//
	// This method is inherited from ToolItem
	GetExpand() bool
	// GetHomogeneous returns whether @tool_item is the same size as other
	// homogeneous items. See gtk_tool_item_set_homogeneous().
	//
	// This method is inherited from ToolItem
	GetHomogeneous() bool
	// GetIconSize returns the icon size used for @tool_item. Custom subclasses
	// of ToolItem should call this function to find out what size icons they
	// should use.
	//
	// This method is inherited from ToolItem
	GetIconSize() int
	// GetIsImportant returns whether @tool_item is considered important. See
	// gtk_tool_item_set_is_important()
	//
	// This method is inherited from ToolItem
	GetIsImportant() bool
	// GetOrientation returns the orientation used for @tool_item. Custom
	// subclasses of ToolItem should call this function to find out what size
	// icons they should use.
	//
	// This method is inherited from ToolItem
	GetOrientation() Orientation
	// GetProxyMenuItem: if @menu_item_id matches the string passed to
	...
	// GetReliefStyle returns the relief style of @tool_item. See
	...
	// GetTextAlignment returns the text alignment used for @tool_item. Custom
	// subclasses of ToolItem should call this function to find out how text
	// should be aligned.
	//
	// This method is inherited from ToolItem
	GetTextAlignment() float32
	// GetTextOrientation returns the text orientation used for @tool_item.
	// Custom subclasses of ToolItem should call this function to find out how
	// text should be orientated.
	//
	// This method is inherited from ToolItem
	GetTextOrientation() Orientation
	// GetTextSizeGroup returns the size group used for labels in @tool_item.
	// Custom subclasses of ToolItem should call this function and use the size
	// group for labels.
	//
	// This method is inherited from ToolItem
	GetTextSizeGroup() SizeGroup
	// GetToolbarStyle returns the toolbar style used for @tool_item. Custom
	...
	// GetUseDragWindow returns whether @tool_item has a drag window. See
	// gtk_tool_item_set_use_drag_window().
	//
	// This method is inherited from ToolItem
	GetUseDragWindow() bool
	// GetVisibleHorizontal returns whether the @tool_item is visible on
	// toolbars that are docked horizontally.
	//
	// This method is inherited from ToolItem
	GetVisibleHorizontal() bool
	// GetVisibleVertical returns whether @tool_item is visible when the toolbar
	// is docked vertically. See gtk_tool_item_set_visible_vertical().
	//
	// This method is inherited from ToolItem
	...
	// Deprecated: since version 3.10.
	//
	// This method is inherited from Activatable
	DoSetRelatedAction(action Action)
	// GetRelatedAction gets the related Action for @activatable.
	//
	// Deprecated: since version 3.10.
	//
	// This method is inherited from Activatable
	GetRelatedAction() Action
	// GetUseActionAppearance gets whether this activatable should reset its
...
// WrapRadioToolButton wraps a GObject to a type that implements
// interface RadioToolButton. It is primarily used internally.
...
func (r radioToolButton) AsToggleToolButton() ToggleToolButton {
	return WrapToggleToolButton(gextras.InternObject(r))
}
...
func (b radioToolButton) GetActive() bool {
	return WrapToggleToolButton(gextras.InternObject(b)).GetActive()
}

func (b radioToolButton) SetActive(isActive bool) {
	WrapToggleToolButton(gextras.InternObject(b)).SetActive(isActive)
}

func (b radioToolButton) GetIconName() string {
	return WrapToolButton(gextras.InternObject(b)).GetIconName()
}

func (b radioToolButton) GetIconWidget() Widget {
	return WrapToolButton(gextras.InternObject(b)).GetIconWidget()
}

func (b radioToolButton) GetLabel() string {
	return WrapToolButton(gextras.InternObject(b)).GetLabel()
}

func (b radioToolButton) GetLabelWidget() Widget {
	return WrapToolButton(gextras.InternObject(b)).GetLabelWidget()
}

func (b radioToolButton) GetStockID() string {
	return WrapToolButton(gextras.InternObject(b)).GetStockID()
}

func (b radioToolButton) GetUseUnderline() bool {
	return WrapToolButton(gextras.InternObject(b)).GetUseUnderline()
}

func (b radioToolButton) SetIconName(iconName string) {
	WrapToolButton(gextras.InternObject(b)).SetIconName(iconName)
}

func (b radioToolButton) SetIconWidget(iconWidget Widget) {
	WrapToolButton(gextras.InternObject(b)).SetIconWidget(iconWidget)
}

func (b radioToolButton) SetLabel(label string) {
	WrapToolButton(gextras.InternObject(b)).SetLabel(label)
}

func (b radioToolButton) SetLabelWidget(labelWidget Widget) {
	WrapToolButton(gextras.InternObject(b)).SetLabelWidget(labelWidget)
}

func (b radioToolButton) SetStockID(stockId string) {
	WrapToolButton(gextras.InternObject(b)).SetStockID(stockId)
}

func (b radioToolButton) SetUseUnderline(useUnderline bool) {
	WrapToolButton(gextras.InternObject(b)).SetUseUnderline(useUnderline)
}

func (t radioToolButton) GetEllipsizeMode() pango.EllipsizeMode {
	return WrapToolItem(gextras.InternObject(t)).GetEllipsizeMode()
}

func (t radioToolButton) GetExpand() bool {
	return WrapToolItem(gextras.InternObject(t)).GetExpand()
}

func (t radioToolButton) GetHomogeneous() bool {
	return WrapToolItem(gextras.InternObject(t)).GetHomogeneous()
}

func (t radioToolButton) GetIconSize() int {
	return WrapToolItem(gextras.InternObject(t)).GetIconSize()
}

func (t radioToolButton) GetIsImportant() bool {
	return WrapToolItem(gextras.InternObject(t)).GetIsImportant()
}

func (t radioToolButton) GetOrientation() Orientation {
	return WrapToolItem(gextras.InternObject(t)).GetOrientation()
}

func (t radioToolButton) GetProxyMenuItem(menuItemId string) Widget {
	return WrapToolItem(gextras.InternObject(t)).GetProxyMenuItem(menuItemId)
}

func (t radioToolButton) GetReliefStyle() ReliefStyle {
	return WrapToolItem(gextras.InternObject(t)).GetReliefStyle()
}

func (t radioToolButton) GetTextAlignment() float32 {
	return WrapToolItem(gextras.InternObject(t)).GetTextAlignment()
}

func (t radioToolButton) GetTextOrientation() Orientation {
	return WrapToolItem(gextras.InternObject(t)).GetTextOrientation()
}

func (t radioToolButton) GetTextSizeGroup() SizeGroup {
	return WrapToolItem(gextras.InternObject(t)).GetTextSizeGroup()
}

func (t radioToolButton) GetToolbarStyle() ToolbarStyle {
	return WrapToolItem(gextras.InternObject(t)).GetToolbarStyle()
}

func (t radioToolButton) GetUseDragWindow() bool {
	return WrapToolItem(gextras.InternObject(t)).GetUseDragWindow()
}

func (t radioToolButton) GetVisibleHorizontal() bool {
	return WrapToolItem(gextras.InternObject(t)).GetVisibleHorizontal()
}

func (t radioToolButton) GetVisibleVertical() bool {
	return WrapToolItem(gextras.InternObject(t)).GetVisibleVertical()
}

func (t radioToolButton) RebuildMenu() {
	WrapToolItem(gextras.InternObject(t)).RebuildMenu()
}

func (t radioToolButton) RetrieveProxyMenuItem() Widget {
	return WrapToolItem(gextras.InternObject(t)).RetrieveProxyMenuItem()
}

func (t radioToolButton) SetExpand(expand bool) {
	WrapToolItem(gextras.InternObject(t)).SetExpand(expand)
}

func (t radioToolButton) SetHomogeneous(homogeneous bool) {
	WrapToolItem(gextras.InternObject(t)).SetHomogeneous(homogeneous)
}

func (t radioToolButton) SetIsImportant(isImportant bool) {
	WrapToolItem(gextras.InternObject(t)).SetIsImportant(isImportant)
}

func (t radioToolButton) SetProxyMenuItem(menuItemId string, menuItem Widget) {
	WrapToolItem(gextras.InternObject(t)).SetProxyMenuItem(menuItemId, menuItem)
}

func (t radioToolButton) SetTooltipMarkup(markup string) {
	WrapToolItem(gextras.InternObject(t)).SetTooltipMarkup(markup)
}

func (t radioToolButton) SetTooltipText(text string) {
	WrapToolItem(gextras.InternObject(t)).SetTooltipText(text)
}

func (t radioToolButton) SetUseDragWindow(useDragWindow bool) {
	WrapToolItem(gextras.InternObject(t)).SetUseDragWindow(useDragWindow)
}

func (t radioToolButton) SetVisibleHorizontal(visibleHorizontal bool) {
	WrapToolItem(gextras.InternObject(t)).SetVisibleHorizontal(visibleHorizontal)
}

func (t radioToolButton) SetVisibleVertical(visibleVertical bool) {
	WrapToolItem(gextras.InternObject(t)).SetVisibleVertical(visibleVertical)
}

func (t radioToolButton) ToolbarReconfigured() {
	WrapToolItem(gextras.InternObject(t)).ToolbarReconfigured()
}

func (b radioToolButton) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c radioToolButton) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c radioToolButton) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c radioToolButton) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c radioToolButton) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c radioToolButton) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c radioToolButton) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c radioToolButton) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c radioToolButton) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c radioToolButton) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c radioToolButton) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c radioToolButton) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c radioToolButton) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c radioToolButton) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c radioToolButton) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c radioToolButton) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c radioToolButton) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c radioToolButton) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c radioToolButton) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c radioToolButton) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c radioToolButton) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c radioToolButton) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c radioToolButton) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c radioToolButton) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c radioToolButton) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w radioToolButton) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w radioToolButton) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w radioToolButton) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w radioToolButton) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w radioToolButton) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w radioToolButton) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w radioToolButton) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w radioToolButton) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w radioToolButton) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w radioToolButton) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w radioToolButton) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w radioToolButton) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w radioToolButton) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w radioToolButton) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w radioToolButton) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w radioToolButton) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w radioToolButton) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w radioToolButton) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w radioToolButton) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w radioToolButton) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w radioToolButton) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w radioToolButton) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w radioToolButton) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w radioToolButton) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w radioToolButton) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w radioToolButton) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w radioToolButton) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w radioToolButton) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w radioToolButton) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w radioToolButton) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w radioToolButton) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w radioToolButton) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w radioToolButton) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w radioToolButton) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w radioToolButton) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w radioToolButton) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w radioToolButton) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w radioToolButton) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w radioToolButton) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w radioToolButton) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w radioToolButton) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w radioToolButton) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w radioToolButton) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w radioToolButton) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w radioToolButton) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w radioToolButton) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w radioToolButton) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w radioToolButton) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w radioToolButton) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w radioToolButton) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w radioToolButton) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w radioToolButton) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w radioToolButton) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w radioToolButton) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w radioToolButton) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w radioToolButton) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w radioToolButton) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w radioToolButton) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w radioToolButton) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w radioToolButton) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w radioToolButton) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w radioToolButton) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w radioToolButton) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w radioToolButton) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w radioToolButton) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w radioToolButton) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w radioToolButton) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w radioToolButton) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w radioToolButton) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w radioToolButton) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w radioToolButton) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w radioToolButton) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w radioToolButton) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w radioToolButton) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w radioToolButton) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w radioToolButton) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w radioToolButton) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w radioToolButton) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w radioToolButton) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w radioToolButton) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w radioToolButton) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w radioToolButton) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w radioToolButton) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w radioToolButton) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w radioToolButton) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w radioToolButton) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w radioToolButton) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w radioToolButton) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w radioToolButton) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w radioToolButton) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w radioToolButton) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w radioToolButton) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w radioToolButton) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w radioToolButton) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w radioToolButton) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w radioToolButton) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w radioToolButton) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w radioToolButton) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w radioToolButton) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w radioToolButton) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w radioToolButton) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w radioToolButton) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w radioToolButton) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w radioToolButton) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w radioToolButton) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w radioToolButton) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w radioToolButton) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w radioToolButton) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w radioToolButton) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w radioToolButton) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w radioToolButton) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w radioToolButton) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w radioToolButton) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w radioToolButton) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w radioToolButton) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w radioToolButton) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w radioToolButton) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w radioToolButton) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w radioToolButton) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w radioToolButton) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w radioToolButton) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w radioToolButton) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w radioToolButton) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w radioToolButton) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w radioToolButton) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w radioToolButton) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w radioToolButton) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w radioToolButton) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w radioToolButton) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w radioToolButton) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w radioToolButton) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w radioToolButton) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w radioToolButton) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w radioToolButton) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w radioToolButton) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w radioToolButton) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w radioToolButton) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w radioToolButton) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w radioToolButton) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w radioToolButton) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w radioToolButton) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w radioToolButton) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w radioToolButton) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w radioToolButton) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w radioToolButton) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w radioToolButton) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w radioToolButton) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w radioToolButton) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w radioToolButton) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w radioToolButton) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w radioToolButton) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w radioToolButton) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w radioToolButton) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w radioToolButton) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w radioToolButton) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w radioToolButton) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w radioToolButton) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w radioToolButton) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w radioToolButton) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w radioToolButton) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w radioToolButton) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w radioToolButton) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w radioToolButton) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w radioToolButton) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w radioToolButton) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w radioToolButton) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w radioToolButton) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w radioToolButton) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w radioToolButton) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w radioToolButton) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w radioToolButton) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w radioToolButton) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w radioToolButton) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w radioToolButton) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w radioToolButton) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w radioToolButton) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w radioToolButton) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w radioToolButton) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w radioToolButton) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w radioToolButton) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w radioToolButton) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w radioToolButton) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w radioToolButton) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w radioToolButton) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w radioToolButton) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w radioToolButton) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w radioToolButton) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w radioToolButton) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w radioToolButton) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w radioToolButton) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w radioToolButton) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w radioToolButton) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w radioToolButton) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w radioToolButton) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w radioToolButton) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w radioToolButton) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w radioToolButton) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w radioToolButton) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w radioToolButton) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w radioToolButton) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w radioToolButton) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w radioToolButton) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w radioToolButton) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w radioToolButton) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w radioToolButton) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w radioToolButton) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w radioToolButton) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w radioToolButton) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w radioToolButton) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w radioToolButton) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w radioToolButton) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w radioToolButton) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w radioToolButton) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w radioToolButton) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w radioToolButton) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w radioToolButton) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w radioToolButton) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w radioToolButton) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w radioToolButton) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w radioToolButton) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w radioToolButton) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w radioToolButton) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w radioToolButton) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w radioToolButton) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w radioToolButton) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w radioToolButton) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w radioToolButton) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w radioToolButton) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w radioToolButton) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w radioToolButton) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w radioToolButton) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w radioToolButton) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w radioToolButton) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w radioToolButton) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s radioToolButton) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w radioToolButton) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w radioToolButton) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w radioToolButton) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w radioToolButton) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w radioToolButton) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w radioToolButton) UnsetStateFlags(flags StateFlags) {
...
func (b radioToolButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b radioToolButton) GetName() string {
...
func (a radioToolButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a radioToolButton) GetUseActionAppearance() bool {
	return WrapActivatable(gextras.InternObject(a)).GetUseActionAppearance()
}
...
func (a radioToolButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a radioToolButton) GetActionTargetValue() *glib.Variant {
