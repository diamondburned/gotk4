...
// WrapRadioToolButtonOverrider wraps the RadioToolButtonOverrider
// interface implementation to access the instance methods.
func WrapRadioToolButtonOverrider(obj RadioToolButtonOverrider) *RadioToolButton {
	return wrapRadioToolButton(externglib.BaseObject(obj))
}
