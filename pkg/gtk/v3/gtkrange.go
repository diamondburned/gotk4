...
// WrapRange wraps a GObject to a type that implements
// interface Range. It is primarily used internally.
...
func (b _range) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b _range) GetName() string {
...
func (o _range) GetOrientation() Orientation {
