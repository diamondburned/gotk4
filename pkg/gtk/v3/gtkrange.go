...
type Range interface {
	...
	UpperStepperSensitivity(r Range)
	...
	SetLowerStepperSensitivity(r Range, sensitivity SensitivityType)
	// SetMinSliderSize sets the minimum size of the range’s slider.
	//
	// This function is useful mainly for Range subclasses.
	SetMinSliderSize(r Range, minSize int)
	...
	SetUpperStepperSensitivity(r Range, sensitivity SensitivityType)
...
// LowerStepperSensitivity gets the sensitivity policy for the stepper that
// points to the 'lower' end of the GtkRange’s adjustment.
func (r _range) LowerStepperSensitivity(r Range) {
	var arg0 *C.GtkRange

	arg0 = (*C.GtkRange)(unsafe.Pointer(r.Native()))

	C.gtk_range_get_lower_stepper_sensitivity(arg0)
}

// MinSliderSize: this function is useful mainly for Range subclasses.
//
// See gtk_range_set_min_slider_size().
func (r _range) MinSliderSize(r Range) {
	var arg0 *C.GtkRange

	arg0 = (*C.GtkRange)(unsafe.Pointer(r.Native()))

	C.gtk_range_get_min_slider_size(arg0)
}
...
// UpperStepperSensitivity gets the sensitivity policy for the stepper that
// points to the 'upper' end of the GtkRange’s adjustment.
func (r _range) UpperStepperSensitivity(r Range) {
	var arg0 *C.GtkRange

	arg0 = (*C.GtkRange)(unsafe.Pointer(r.Native()))

	C.gtk_range_get_upper_stepper_sensitivity(arg0)
}
...
// SetLowerStepperSensitivity sets the sensitivity policy for the stepper
// that points to the 'lower' end of the GtkRange’s adjustment.
func (r _range) SetLowerStepperSensitivity(r Range, sensitivity SensitivityType) {
	var arg0 *C.GtkRange
...
//
// This function is useful mainly for Range subclasses.
func (r _range) SetMinSliderSize(r Range, minSize int) {
	var arg0 *C.GtkRange
	var arg1 C.gint
...
// SetUpperStepperSensitivity sets the sensitivity policy for the stepper
// that points to the 'upper' end of the GtkRange’s adjustment.
func (r _range) SetUpperStepperSensitivity(r Range, sensitivity SensitivityType) {
	var arg0 *C.GtkRange
	var arg1 C.GtkSensitivityType
