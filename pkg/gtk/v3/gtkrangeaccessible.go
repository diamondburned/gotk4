...
// WrapRangeAccessible wraps a GObject to a type that implements
// interface RangeAccessible. It is primarily used internally.
func WrapRangeAccessible(obj *externglib.Object) RangeAccessible {
	return rangeAccessible{obj}
}
