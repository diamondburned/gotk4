...
type RecentChooserMenu interface {
	...
	//
	// This method is inherited from Menu
	...
	// This method is inherited from Menu
	Detach()
	// GetAccelGroup gets the AccelGroup which holds global accelerators for the
	// menu. See gtk_menu_set_accel_group().
	//
	// This method is inherited from Menu
	GetAccelGroup() AccelGroup
	// GetAccelPath retrieves the accelerator path set on the menu.
	//
	// This method is inherited from Menu
	GetAccelPath() string
	// GetActive returns the selected menu item from the menu. This is used by
	// the ComboBox.
	//
	// This method is inherited from Menu
	GetActive() Widget
	// GetAttachWidget returns the Widget that the menu is attached to.
	//
	// This method is inherited from Menu
	GetAttachWidget() Widget
	// GetMonitor retrieves the number of the monitor on which to show the menu.
	//
	// This method is inherited from Menu
	GetMonitor() int
	// GetReserveToggleSize returns whether the menu reserves space for toggles
	// and icons, regardless of their actual presence.
	//
	// This method is inherited from Menu
	GetReserveToggleSize() bool
	// GetTearoffState returns whether the menu is torn off. See
	...
	// GetTitle returns the title of the menu. See gtk_menu_set_title().
	//
	// Deprecated: since version 3.10.
	//
	// This method is inherited from Menu
	...
	//
	// This method is inherited from MenuShell
	...
	// This method is inherited from MenuShell
	Deselect()
	// GetParentShell gets the parent menu shell.
	//
	// The parent menu shell of a submenu is the Menu or MenuBar from which it
	// was opened up.
	//
	// This method is inherited from MenuShell
	GetParentShell() Widget
	// GetSelectedItem gets the currently selected item.
	//
	// This method is inherited from MenuShell
	GetSelectedItem() Widget
	// GetTakeFocus returns true if the menu shell will take the keyboard focus
	// on popup.
	//
	// This method is inherited from MenuShell
	GetTakeFocus() bool
...
// WrapRecentChooserMenu wraps a GObject to a type that implements
// interface RecentChooserMenu. It is primarily used internally.
...
func (r recentChooserMenu) AsMenu() Menu {
	return WrapMenu(gextras.InternObject(r))
}
...
func (m recentChooserMenu) Attach(child Widget, leftAttach uint, rightAttach uint, topAttach uint, bottomAttach uint) {
	WrapMenu(gextras.InternObject(m)).Attach(child, leftAttach, rightAttach, topAttach, bottomAttach)
}

func (m recentChooserMenu) Detach() {
	WrapMenu(gextras.InternObject(m)).Detach()
}

func (m recentChooserMenu) GetAccelGroup() AccelGroup {
	return WrapMenu(gextras.InternObject(m)).GetAccelGroup()
}

func (m recentChooserMenu) GetAccelPath() string {
	return WrapMenu(gextras.InternObject(m)).GetAccelPath()
}

func (m recentChooserMenu) GetActive() Widget {
	return WrapMenu(gextras.InternObject(m)).GetActive()
}

func (m recentChooserMenu) GetAttachWidget() Widget {
	return WrapMenu(gextras.InternObject(m)).GetAttachWidget()
}

func (m recentChooserMenu) GetMonitor() int {
	return WrapMenu(gextras.InternObject(m)).GetMonitor()
}

func (m recentChooserMenu) GetReserveToggleSize() bool {
	return WrapMenu(gextras.InternObject(m)).GetReserveToggleSize()
}

func (m recentChooserMenu) GetTearoffState() bool {
	return WrapMenu(gextras.InternObject(m)).GetTearoffState()
}

func (m recentChooserMenu) GetTitle() string {
	return WrapMenu(gextras.InternObject(m)).GetTitle()
}

func (m recentChooserMenu) PlaceOnMonitor(monitor gdk.Monitor) {
	WrapMenu(gextras.InternObject(m)).PlaceOnMonitor(monitor)
}

func (m recentChooserMenu) Popdown() {
	WrapMenu(gextras.InternObject(m)).Popdown()
}

func (m recentChooserMenu) Popup(parentMenuShell Widget, parentMenuItem Widget, fn MenuPositionFunc, button uint, activateTime uint32) {
	WrapMenu(gextras.InternObject(m)).Popup(parentMenuShell, parentMenuItem, fn, button, activateTime)
}

func (m recentChooserMenu) ReorderChild(child Widget, position int) {
	WrapMenu(gextras.InternObject(m)).ReorderChild(child, position)
}

func (m recentChooserMenu) Reposition() {
	WrapMenu(gextras.InternObject(m)).Reposition()
}

func (m recentChooserMenu) SetAccelGroup(accelGroup AccelGroup) {
	WrapMenu(gextras.InternObject(m)).SetAccelGroup(accelGroup)
}

func (m recentChooserMenu) SetAccelPath(accelPath string) {
	WrapMenu(gextras.InternObject(m)).SetAccelPath(accelPath)
}

func (m recentChooserMenu) SetActive(index uint) {
	WrapMenu(gextras.InternObject(m)).SetActive(index)
}

func (m recentChooserMenu) SetMonitor(monitorNum int) {
	WrapMenu(gextras.InternObject(m)).SetMonitor(monitorNum)
}

func (m recentChooserMenu) SetReserveToggleSize(reserveToggleSize bool) {
	WrapMenu(gextras.InternObject(m)).SetReserveToggleSize(reserveToggleSize)
}

func (m recentChooserMenu) SetScreen(screen gdk.Screen) {
	WrapMenu(gextras.InternObject(m)).SetScreen(screen)
}

func (m recentChooserMenu) SetTearoffState(tornOff bool) {
	WrapMenu(gextras.InternObject(m)).SetTearoffState(tornOff)
}

func (m recentChooserMenu) SetTitle(title string) {
	WrapMenu(gextras.InternObject(m)).SetTitle(title)
}

func (m recentChooserMenu) ActivateItem(menuItem Widget, forceDeactivate bool) {
	WrapMenuShell(gextras.InternObject(m)).ActivateItem(menuItem, forceDeactivate)
}

func (m recentChooserMenu) Append(child MenuItem) {
	WrapMenuShell(gextras.InternObject(m)).Append(child)
}

func (m recentChooserMenu) BindModel(model gio.MenuModel, actionNamespace string, withSeparators bool) {
	WrapMenuShell(gextras.InternObject(m)).BindModel(model, actionNamespace, withSeparators)
}

func (m recentChooserMenu) Cancel() {
	WrapMenuShell(gextras.InternObject(m)).Cancel()
}

func (m recentChooserMenu) Deactivate() {
	WrapMenuShell(gextras.InternObject(m)).Deactivate()
}

func (m recentChooserMenu) Deselect() {
	WrapMenuShell(gextras.InternObject(m)).Deselect()
}

func (m recentChooserMenu) GetParentShell() Widget {
	return WrapMenuShell(gextras.InternObject(m)).GetParentShell()
}

func (m recentChooserMenu) GetSelectedItem() Widget {
	return WrapMenuShell(gextras.InternObject(m)).GetSelectedItem()
}

func (m recentChooserMenu) GetTakeFocus() bool {
	return WrapMenuShell(gextras.InternObject(m)).GetTakeFocus()
}

func (m recentChooserMenu) Insert(child Widget, position int) {
	WrapMenuShell(gextras.InternObject(m)).Insert(child, position)
}

func (m recentChooserMenu) Prepend(child Widget) {
	WrapMenuShell(gextras.InternObject(m)).Prepend(child)
}

func (m recentChooserMenu) SelectFirst(searchSensitive bool) {
	WrapMenuShell(gextras.InternObject(m)).SelectFirst(searchSensitive)
}

func (m recentChooserMenu) SelectItem(menuItem Widget) {
	WrapMenuShell(gextras.InternObject(m)).SelectItem(menuItem)
}

func (m recentChooserMenu) SetTakeFocus(takeFocus bool) {
	WrapMenuShell(gextras.InternObject(m)).SetTakeFocus(takeFocus)
}

func (c recentChooserMenu) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c recentChooserMenu) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c recentChooserMenu) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c recentChooserMenu) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c recentChooserMenu) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c recentChooserMenu) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c recentChooserMenu) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c recentChooserMenu) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c recentChooserMenu) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c recentChooserMenu) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c recentChooserMenu) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c recentChooserMenu) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c recentChooserMenu) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c recentChooserMenu) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c recentChooserMenu) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c recentChooserMenu) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c recentChooserMenu) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c recentChooserMenu) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c recentChooserMenu) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c recentChooserMenu) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c recentChooserMenu) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c recentChooserMenu) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c recentChooserMenu) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c recentChooserMenu) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w recentChooserMenu) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w recentChooserMenu) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w recentChooserMenu) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w recentChooserMenu) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w recentChooserMenu) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w recentChooserMenu) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w recentChooserMenu) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w recentChooserMenu) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w recentChooserMenu) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w recentChooserMenu) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w recentChooserMenu) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w recentChooserMenu) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w recentChooserMenu) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w recentChooserMenu) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w recentChooserMenu) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w recentChooserMenu) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w recentChooserMenu) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w recentChooserMenu) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w recentChooserMenu) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w recentChooserMenu) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w recentChooserMenu) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w recentChooserMenu) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w recentChooserMenu) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w recentChooserMenu) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w recentChooserMenu) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w recentChooserMenu) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w recentChooserMenu) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w recentChooserMenu) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w recentChooserMenu) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w recentChooserMenu) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w recentChooserMenu) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w recentChooserMenu) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w recentChooserMenu) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w recentChooserMenu) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w recentChooserMenu) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w recentChooserMenu) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w recentChooserMenu) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w recentChooserMenu) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w recentChooserMenu) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w recentChooserMenu) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w recentChooserMenu) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w recentChooserMenu) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w recentChooserMenu) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w recentChooserMenu) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w recentChooserMenu) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w recentChooserMenu) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w recentChooserMenu) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w recentChooserMenu) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w recentChooserMenu) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w recentChooserMenu) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w recentChooserMenu) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w recentChooserMenu) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w recentChooserMenu) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w recentChooserMenu) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w recentChooserMenu) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w recentChooserMenu) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w recentChooserMenu) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w recentChooserMenu) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w recentChooserMenu) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w recentChooserMenu) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w recentChooserMenu) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w recentChooserMenu) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w recentChooserMenu) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w recentChooserMenu) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w recentChooserMenu) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w recentChooserMenu) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w recentChooserMenu) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w recentChooserMenu) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w recentChooserMenu) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w recentChooserMenu) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w recentChooserMenu) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w recentChooserMenu) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w recentChooserMenu) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w recentChooserMenu) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w recentChooserMenu) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w recentChooserMenu) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w recentChooserMenu) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w recentChooserMenu) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w recentChooserMenu) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w recentChooserMenu) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w recentChooserMenu) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w recentChooserMenu) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w recentChooserMenu) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w recentChooserMenu) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w recentChooserMenu) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w recentChooserMenu) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w recentChooserMenu) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w recentChooserMenu) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w recentChooserMenu) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w recentChooserMenu) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w recentChooserMenu) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w recentChooserMenu) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w recentChooserMenu) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w recentChooserMenu) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w recentChooserMenu) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w recentChooserMenu) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w recentChooserMenu) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w recentChooserMenu) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w recentChooserMenu) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w recentChooserMenu) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w recentChooserMenu) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w recentChooserMenu) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w recentChooserMenu) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w recentChooserMenu) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w recentChooserMenu) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w recentChooserMenu) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w recentChooserMenu) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w recentChooserMenu) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w recentChooserMenu) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w recentChooserMenu) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w recentChooserMenu) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w recentChooserMenu) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w recentChooserMenu) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w recentChooserMenu) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w recentChooserMenu) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w recentChooserMenu) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w recentChooserMenu) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w recentChooserMenu) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w recentChooserMenu) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w recentChooserMenu) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w recentChooserMenu) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w recentChooserMenu) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w recentChooserMenu) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w recentChooserMenu) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w recentChooserMenu) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w recentChooserMenu) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w recentChooserMenu) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w recentChooserMenu) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w recentChooserMenu) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w recentChooserMenu) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w recentChooserMenu) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w recentChooserMenu) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w recentChooserMenu) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w recentChooserMenu) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w recentChooserMenu) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w recentChooserMenu) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w recentChooserMenu) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w recentChooserMenu) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w recentChooserMenu) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w recentChooserMenu) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w recentChooserMenu) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w recentChooserMenu) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w recentChooserMenu) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w recentChooserMenu) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w recentChooserMenu) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w recentChooserMenu) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w recentChooserMenu) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w recentChooserMenu) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w recentChooserMenu) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w recentChooserMenu) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w recentChooserMenu) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w recentChooserMenu) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w recentChooserMenu) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w recentChooserMenu) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w recentChooserMenu) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w recentChooserMenu) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w recentChooserMenu) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w recentChooserMenu) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w recentChooserMenu) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w recentChooserMenu) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w recentChooserMenu) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w recentChooserMenu) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w recentChooserMenu) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w recentChooserMenu) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w recentChooserMenu) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w recentChooserMenu) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w recentChooserMenu) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w recentChooserMenu) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w recentChooserMenu) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w recentChooserMenu) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w recentChooserMenu) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w recentChooserMenu) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w recentChooserMenu) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w recentChooserMenu) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w recentChooserMenu) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w recentChooserMenu) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w recentChooserMenu) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w recentChooserMenu) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w recentChooserMenu) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w recentChooserMenu) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w recentChooserMenu) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w recentChooserMenu) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w recentChooserMenu) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w recentChooserMenu) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w recentChooserMenu) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w recentChooserMenu) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w recentChooserMenu) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w recentChooserMenu) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w recentChooserMenu) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w recentChooserMenu) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w recentChooserMenu) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w recentChooserMenu) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w recentChooserMenu) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w recentChooserMenu) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w recentChooserMenu) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w recentChooserMenu) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w recentChooserMenu) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w recentChooserMenu) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w recentChooserMenu) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w recentChooserMenu) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w recentChooserMenu) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w recentChooserMenu) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w recentChooserMenu) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w recentChooserMenu) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w recentChooserMenu) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w recentChooserMenu) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w recentChooserMenu) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w recentChooserMenu) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w recentChooserMenu) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w recentChooserMenu) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w recentChooserMenu) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w recentChooserMenu) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w recentChooserMenu) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w recentChooserMenu) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w recentChooserMenu) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w recentChooserMenu) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w recentChooserMenu) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w recentChooserMenu) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w recentChooserMenu) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w recentChooserMenu) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w recentChooserMenu) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w recentChooserMenu) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w recentChooserMenu) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w recentChooserMenu) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w recentChooserMenu) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w recentChooserMenu) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w recentChooserMenu) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w recentChooserMenu) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w recentChooserMenu) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w recentChooserMenu) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w recentChooserMenu) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w recentChooserMenu) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w recentChooserMenu) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w recentChooserMenu) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s recentChooserMenu) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w recentChooserMenu) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w recentChooserMenu) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w recentChooserMenu) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w recentChooserMenu) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w recentChooserMenu) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w recentChooserMenu) UnsetStateFlags(flags StateFlags) {
...
func (b recentChooserMenu) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b recentChooserMenu) GetName() string {
...
func (a recentChooserMenu) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a recentChooserMenu) GetUseActionAppearance() bool {
