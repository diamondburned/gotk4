...
// WrapRevealer wraps a GObject to a type that implements
// interface Revealer. It is primarily used internally.
...
func (r revealer) AsBin() Bin {
	return WrapBin(gextras.InternObject(r))
}
...
func (b revealer) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b revealer) GetName() string {
