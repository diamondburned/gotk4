...
// WrapScaleAccessible wraps a GObject to a type that implements
// interface ScaleAccessible. It is primarily used internally.
func WrapScaleAccessible(obj *externglib.Object) ScaleAccessible {
	return scaleAccessible{obj}
}
