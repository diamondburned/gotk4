...
// WrapScaleButton wraps a GObject to a type that implements
// interface ScaleButton. It is primarily used internally.
...
func (s scaleButton) AsButton() Button {
	return WrapButton(gextras.InternObject(s))
}
...
func (b scaleButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b scaleButton) GetName() string {
...
func (a scaleButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a scaleButton) GetActionTargetValue() *glib.Variant {
...
func (a scaleButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a scaleButton) GetUseActionAppearance() bool {
...
func (o scaleButton) GetOrientation() Orientation {
