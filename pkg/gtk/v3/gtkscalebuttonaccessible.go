...
// WrapScaleButtonAccessible wraps a GObject to a type that implements
// interface ScaleButtonAccessible. It is primarily used internally.
func WrapScaleButtonAccessible(obj *externglib.Object) ScaleButtonAccessible {
	return scaleButtonAccessible{obj}
}
...
func (s scaleButtonAccessible) AsButtonAccessible() ButtonAccessible {
	return WrapButtonAccessible(gextras.InternObject(s))
}
...
func (a scaleButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a scaleButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a scaleButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a scaleButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a scaleButtonAccessible) GetName(i int) string {
...
func (i scaleButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i scaleButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i scaleButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i scaleButtonAccessible) GetImageSize() (width int, height int) {
