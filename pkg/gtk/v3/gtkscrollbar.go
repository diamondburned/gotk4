...
// WrapScrollbar wraps a GObject to a type that implements
// interface Scrollbar. It is primarily used internally.
...
func (s scrollbar) AsRange() Range {
...
func (b scrollbar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b scrollbar) GetName() string {
...
func (o scrollbar) GetOrientation() Orientation {
