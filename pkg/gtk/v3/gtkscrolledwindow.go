...
// WrapScrolledWindow wraps a GObject to a type that implements
// interface ScrolledWindow. It is primarily used internally.
...
func (s scrolledWindow) AsBin() Bin {
	return WrapBin(gextras.InternObject(s))
}
...
func (b scrolledWindow) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b scrolledWindow) GetName() string {
