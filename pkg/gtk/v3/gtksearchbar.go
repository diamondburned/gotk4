...
// WrapSearchBar wraps a GObject to a type that implements
// interface SearchBar. It is primarily used internally.
func WrapSearchBar(obj *externglib.Object) SearchBar {
	return searchBar{obj}
}
...
func (b searchBar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b searchBar) GetName() string {
