...
// WrapSearchEntry wraps a GObject to a type that implements
// interface SearchEntry. It is primarily used internally.
func WrapSearchEntry(obj *externglib.Object) SearchEntry {
	return searchEntry{obj}
}
...
func (s searchEntry) AsEntry() Entry {
...
func (e searchEntry) SetAttributes(attrs *pango.AttrList) {
	WrapEntry(gextras.InternObject(e)).SetAttributes(attrs)
}

func (e searchEntry) SetBuffer(buffer EntryBuffer) {
	WrapEntry(gextras.InternObject(e)).SetBuffer(buffer)
}

func (e searchEntry) SetCompletion(completion EntryCompletion) {
	WrapEntry(gextras.InternObject(e)).SetCompletion(completion)
}

func (e searchEntry) SetCursorHAdjustment(adjustment Adjustment) {
	WrapEntry(gextras.InternObject(e)).SetCursorHAdjustment(adjustment)
}

func (e searchEntry) SetHasFrame(setting bool) {
	WrapEntry(gextras.InternObject(e)).SetHasFrame(setting)
}

func (e searchEntry) SetIconActivatable(iconPos EntryIconPosition, activatable bool) {
	WrapEntry(gextras.InternObject(e)).SetIconActivatable(iconPos, activatable)
}

func (e searchEntry) SetIconDragSource(iconPos EntryIconPosition, targetList *TargetList, actions gdk.DragAction) {
	WrapEntry(gextras.InternObject(e)).SetIconDragSource(iconPos, targetList, actions)
}

func (e searchEntry) SetIconFromIconName(iconPos EntryIconPosition, iconName string) {
	WrapEntry(gextras.InternObject(e)).SetIconFromIconName(iconPos, iconName)
}

func (e searchEntry) SetIconFromPixbuf(iconPos EntryIconPosition, pixbuf gdkpixbuf.Pixbuf) {
	WrapEntry(gextras.InternObject(e)).SetIconFromPixbuf(iconPos, pixbuf)
}

func (e searchEntry) SetIconFromStock(iconPos EntryIconPosition, stockId string) {
	WrapEntry(gextras.InternObject(e)).SetIconFromStock(iconPos, stockId)
}

func (e searchEntry) SetIconSensitive(iconPos EntryIconPosition, sensitive bool) {
	WrapEntry(gextras.InternObject(e)).SetIconSensitive(iconPos, sensitive)
}

func (e searchEntry) SetIconTooltipMarkup(iconPos EntryIconPosition, tooltip string) {
	WrapEntry(gextras.InternObject(e)).SetIconTooltipMarkup(iconPos, tooltip)
}

func (e searchEntry) SetIconTooltipText(iconPos EntryIconPosition, tooltip string) {
	WrapEntry(gextras.InternObject(e)).SetIconTooltipText(iconPos, tooltip)
}

func (e searchEntry) SetInnerBorder(border *Border) {
...
func (e searchEntry) SetInvisibleChar(ch uint32) {
	WrapEntry(gextras.InternObject(e)).SetInvisibleChar(ch)
}

func (e searchEntry) SetMaxLength(max int) {
...
func (e searchEntry) SetOverwriteMode(overwrite bool) {
...
func (e searchEntry) SetProgressFraction(fraction float64) {
	WrapEntry(gextras.InternObject(e)).SetProgressFraction(fraction)
}

func (e searchEntry) SetProgressPulseStep(fraction float64) {
	WrapEntry(gextras.InternObject(e)).SetProgressPulseStep(fraction)
}

func (e searchEntry) SetTabs(tabs *pango.TabArray) {
...
func (e searchEntry) SetVisibility(visible bool) {
...
func (b searchEntry) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b searchEntry) GetName() string {
...
func (e searchEntry) GetChars(startPos int, endPos int) string {
	return WrapEditable(gextras.InternObject(e)).GetChars(startPos, endPos)
}

func (e searchEntry) GetEditable() bool {
	return WrapEditable(gextras.InternObject(e)).GetEditable()
}

func (e searchEntry) GetPosition() int {
	return WrapEditable(gextras.InternObject(e)).GetPosition()
}

func (e searchEntry) GetSelectionBounds() (startPos int, endPos int, ok bool) {
