...
// WrapSeparator wraps a GObject to a type that implements
// interface Separator. It is primarily used internally.
...
func (s separator) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(s))
}
...
func (b separator) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b separator) GetName() string {
...
func (o separator) GetOrientation() Orientation {
