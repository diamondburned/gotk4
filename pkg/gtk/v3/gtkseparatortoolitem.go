...
// WrapSeparatorToolItem wraps a GObject to a type that implements
// interface SeparatorToolItem. It is primarily used internally.
...
func (s separatorToolItem) AsToolItem() ToolItem {
	return WrapToolItem(gextras.InternObject(s))
}
...
func (b separatorToolItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b separatorToolItem) GetName() string {
...
func (a separatorToolItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a separatorToolItem) GetUseActionAppearance() bool {
