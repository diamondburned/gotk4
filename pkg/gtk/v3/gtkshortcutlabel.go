...
// WrapShortcutLabel wraps a GObject to a type that implements
// interface ShortcutLabel. It is primarily used internally.
func WrapShortcutLabel(obj *externglib.Object) ShortcutLabel {
	return shortcutLabel{obj}
}
...
func (s shortcutLabel) AsBox() Box {
...
func (b shortcutLabel) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b shortcutLabel) GetName() string {
...
func (o shortcutLabel) GetOrientation() Orientation {
