...
// WrapShortcutsGroup wraps a GObject to a type that implements
// interface ShortcutsGroup. It is primarily used internally.
func WrapShortcutsGroup(obj *externglib.Object) ShortcutsGroup {
	return shortcutsGroup{obj}
}
...
func (s shortcutsGroup) AsBox() Box {
...
func (b shortcutsGroup) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b shortcutsGroup) GetName() string {
...
func (o shortcutsGroup) GetOrientation() Orientation {
