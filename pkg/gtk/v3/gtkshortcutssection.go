...
// WrapShortcutsSection wraps a GObject to a type that implements
// interface ShortcutsSection. It is primarily used internally.
func WrapShortcutsSection(obj *externglib.Object) ShortcutsSection {
	return shortcutsSection{obj}
}
...
func (s shortcutsSection) AsBox() Box {
...
func (b shortcutsSection) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b shortcutsSection) GetName() string {
...
func (o shortcutsSection) GetOrientation() Orientation {
