...
// WrapShortcutsShortcut wraps a GObject to a type that implements
// interface ShortcutsShortcut. It is primarily used internally.
func WrapShortcutsShortcut(obj *externglib.Object) ShortcutsShortcut {
	return shortcutsShortcut{obj}
}
...
func (s shortcutsShortcut) AsBox() Box {
	return WrapBox(gextras.InternObject(s))
}
...
func (b shortcutsShortcut) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b shortcutsShortcut) GetName() string {
...
func (o shortcutsShortcut) GetOrientation() Orientation {
