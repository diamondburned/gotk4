...
func (s socket) AsContainer() Container {
	return WrapContainer(gextras.InternObject(s))
}
...
func (b socket) GetInternalChild(builder Builder, childname string) gextras.Objector {
