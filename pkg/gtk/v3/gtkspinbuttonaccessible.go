...
// WrapSpinButtonAccessible wraps a GObject to a type that implements
// interface SpinButtonAccessible. It is primarily used internally.
func WrapSpinButtonAccessible(obj *externglib.Object) SpinButtonAccessible {
	return spinButtonAccessible{obj}
}
...
func (s spinButtonAccessible) AsEntryAccessible() EntryAccessible {
	return WrapEntryAccessible(gextras.InternObject(s))
}
...
func (a spinButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a spinButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a spinButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a spinButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a spinButtonAccessible) GetName(i int) string {
