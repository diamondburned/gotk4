...
// WrapStack wraps a GObject to a type that implements
// interface Stack. It is primarily used internally.
...
func (s stack) AsContainer() Container {
...
func (b stack) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b stack) GetName() string {
