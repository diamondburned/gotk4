...
// WrapStackAccessible wraps a GObject to a type that implements
// interface StackAccessible. It is primarily used internally.
func WrapStackAccessible(obj *externglib.Object) StackAccessible {
	return stackAccessible{obj}
}
