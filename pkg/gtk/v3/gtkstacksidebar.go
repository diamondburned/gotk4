...
// WrapStackSidebar wraps a GObject to a type that implements
// interface StackSidebar. It is primarily used internally.
func WrapStackSidebar(obj *externglib.Object) StackSidebar {
	return stackSidebar{obj}
}
...
func (b stackSidebar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b stackSidebar) GetName() string {
