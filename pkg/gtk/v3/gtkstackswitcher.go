...
// WrapStackSwitcher wraps a GObject to a type that implements
// interface StackSwitcher. It is primarily used internally.
func WrapStackSwitcher(obj *externglib.Object) StackSwitcher {
	return stackSwitcher{obj}
}
...
func (s stackSwitcher) AsBox() Box {
...
func (b stackSwitcher) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b stackSwitcher) GetName() string {
...
func (o stackSwitcher) GetOrientation() Orientation {
