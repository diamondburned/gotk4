...
// WrapStatusbar wraps a GObject to a type that implements
// interface Statusbar. It is primarily used internally.
...
func (b statusbar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b statusbar) GetName() string {
...
func (o statusbar) GetOrientation() Orientation {
