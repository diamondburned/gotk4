...
// WrapStatusbarAccessible wraps a GObject to a type that implements
// interface StatusbarAccessible. It is primarily used internally.
func WrapStatusbarAccessible(obj *externglib.Object) StatusbarAccessible {
	return statusbarAccessible{obj}
}
