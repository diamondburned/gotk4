...
func (p styleProperties) IconFactory(path *WidgetPath) IconFactory {
	return WrapStyleProvider(gextras.InternObject(p)).IconFactory(path)
}

func (p styleProperties) Style(path *WidgetPath) StyleProperties {
...
// AddColorStop decreases the reference count of @gradient, freeing its memory
...
// Ref decreases the reference count of @gradient, freeing its memory if the
...
// Resolve decreases the reference count of @gradient, freeing its memory if the
// reference count reaches 0.
//
// Deprecated: since version 3.8.
...
// ResolveForContext decreases the reference count of @gradient, freeing its
...
// String decreases the reference count of @gradient, freeing its memory if the
// reference count reaches 0.
//
// Deprecated: since version 3.8.
...
// Ref decreases the reference count of @color, freeing its memory if the
// reference count reaches 0.
//
// Deprecated: since version 3.8.
...
// Resolve decreases the reference count of @color, freeing its memory if the
// reference count reaches 0.
//
// Deprecated: since version 3.8.
...
// String decreases the reference count of @color, freeing its memory if the
// reference count reaches 0.
//
// Deprecated: since version 3.8.
