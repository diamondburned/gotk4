...
// WrapSwitch wraps a GObject to a type that implements
// interface Switch. It is primarily used internally.
...
func (_ _switch) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(_))
}
...
func (b _switch) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b _switch) GetName() string {
...
func (a _switch) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a _switch) GetActionTargetValue() *glib.Variant {
...
func (a _switch) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a _switch) GetUseActionAppearance() bool {
