...
// WrapSwitchAccessible wraps a GObject to a type that implements
// interface SwitchAccessible. It is primarily used internally.
func WrapSwitchAccessible(obj *externglib.Object) SwitchAccessible {
	return switchAccessible{obj}
}
...
func (s switchAccessible) AsWidgetAccessible() WidgetAccessible {
