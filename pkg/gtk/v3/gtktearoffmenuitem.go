...
// WrapTearoffMenuItem wraps a GObject to a type that implements
// interface TearoffMenuItem. It is primarily used internally.
...
func (t tearoffMenuItem) AsMenuItem() MenuItem {
	return WrapMenuItem(gextras.InternObject(t))
}
...
func (b tearoffMenuItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b tearoffMenuItem) GetName() string {
...
func (a tearoffMenuItem) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a tearoffMenuItem) GetActionTargetValue() *glib.Variant {
...
func (a tearoffMenuItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a tearoffMenuItem) GetUseActionAppearance() bool {
