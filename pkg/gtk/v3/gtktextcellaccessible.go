...
// WrapTextCellAccessible wraps a GObject to a type that implements
// interface TextCellAccessible. It is primarily used internally.
func WrapTextCellAccessible(obj *externglib.Object) TextCellAccessible {
	return textCellAccessible{obj}
}
...
func (t textCellAccessible) AsRendererCellAccessible() RendererCellAccessible {
	return WrapRendererCellAccessible(gextras.InternObject(t))
}
...
func (a textCellAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a textCellAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a textCellAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a textCellAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a textCellAccessible) GetName(i int) string {
