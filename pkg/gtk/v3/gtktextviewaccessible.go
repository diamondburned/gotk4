...
// WrapTextViewAccessible wraps a GObject to a type that implements
// interface TextViewAccessible. It is primarily used internally.
func WrapTextViewAccessible(obj *externglib.Object) TextViewAccessible {
	return textViewAccessible{obj}
}
