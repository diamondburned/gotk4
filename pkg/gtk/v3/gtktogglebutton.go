...
// WrapToggleButton wraps a GObject to a type that implements
// interface ToggleButton. It is primarily used internally.
...
func (t toggleButton) AsButton() Button {
	return WrapButton(gextras.InternObject(t))
}
...
func (b toggleButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
...
func (a toggleButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a toggleButton) GetActionTargetValue() *glib.Variant {
...
func (a toggleButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a toggleButton) GetUseActionAppearance() bool {
