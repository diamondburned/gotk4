...
// WrapToggleButtonAccessible wraps a GObject to a type that implements
// interface ToggleButtonAccessible. It is primarily used internally.
func WrapToggleButtonAccessible(obj *externglib.Object) ToggleButtonAccessible {
	return toggleButtonAccessible{obj}
}
...
func (t toggleButtonAccessible) AsButtonAccessible() ButtonAccessible {
	return WrapButtonAccessible(gextras.InternObject(t))
}
...
func (a toggleButtonAccessible) GetDescription(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetDescription(i)
}

func (a toggleButtonAccessible) GetKeybinding(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetKeybinding(i)
}

func (a toggleButtonAccessible) GetLocalizedName(i int) string {
	return atk.WrapAction(gextras.InternObject(a)).GetLocalizedName(i)
}

func (a toggleButtonAccessible) GetNActions() int {
	return atk.WrapAction(gextras.InternObject(a)).GetNActions()
}

func (a toggleButtonAccessible) GetName(i int) string {
...
func (i toggleButtonAccessible) GetImageDescription() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageDescription()
}

func (i toggleButtonAccessible) GetImageLocale() string {
	return atk.WrapImage(gextras.InternObject(i)).GetImageLocale()
}

func (i toggleButtonAccessible) GetImagePosition(coordType atk.CoordType) (x int, y int) {
	return atk.WrapImage(gextras.InternObject(i)).GetImagePosition(coordType)
}

func (i toggleButtonAccessible) GetImageSize() (width int, height int) {
