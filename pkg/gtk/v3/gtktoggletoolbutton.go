...
// WrapToggleToolButton wraps a GObject to a type that implements
// interface ToggleToolButton. It is primarily used internally.
...
func (t toggleToolButton) AsToolButton() ToolButton {
	return WrapToolButton(gextras.InternObject(t))
}
...
func (b toggleToolButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toggleToolButton) GetName() string {
...
func (a toggleToolButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a toggleToolButton) GetUseActionAppearance() bool {
...
func (a toggleToolButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a toggleToolButton) GetActionTargetValue() *glib.Variant {
