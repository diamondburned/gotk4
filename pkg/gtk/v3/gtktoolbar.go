...
// WrapToolbar wraps a GObject to a type that implements
// interface Toolbar. It is primarily used internally.
...
func (t toolbar) AsContainer() Container {
...
func (b toolbar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toolbar) GetName() string {
...
func (o toolbar) GetOrientation() Orientation {
