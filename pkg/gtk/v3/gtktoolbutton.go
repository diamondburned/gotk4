...
// WrapToolButton wraps a GObject to a type that implements
// interface ToolButton. It is primarily used internally.
...
func (t toolButton) AsToolItem() ToolItem {
	return WrapToolItem(gextras.InternObject(t))
}
...
func (b toolButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toolButton) GetName() string {
...
func (a toolButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a toolButton) GetUseActionAppearance() bool {
...
func (a toolButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a toolButton) GetActionTargetValue() *glib.Variant {
