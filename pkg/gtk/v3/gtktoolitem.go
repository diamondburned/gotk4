...
// WrapToolItem wraps a GObject to a type that implements
// interface ToolItem. It is primarily used internally.
...
func (t toolItem) AsBin() Bin {
	return WrapBin(gextras.InternObject(t))
}
...
func (b toolItem) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toolItem) GetName() string {
...
func (a toolItem) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a toolItem) GetUseActionAppearance() bool {
