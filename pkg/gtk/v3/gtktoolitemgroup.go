...
type ToolItemGroup interface {
	...
	// This method is inherited from Buildable
	SetName(name string)
	// GetEllipsizeMode retrieves the current ellipsize mode for the tool shell.
	// Tool items must not call this function directly, but rely on
	// gtk_tool_item_get_ellipsize_mode() instead.
	//
	// This method is inherited from ToolShell
	GetEllipsizeMode() pango.EllipsizeMode
	// GetIconSize retrieves the icon size for the tool shell. Tool items must
	// not call this function directly, but rely on
	// gtk_tool_item_get_icon_size() instead.
	//
	// This method is inherited from ToolShell
	GetIconSize() int
	// GetOrientation retrieves the current orientation for the tool shell. Tool
	// items must not call this function directly, but rely on
	// gtk_tool_item_get_orientation() instead.
	//
	// This method is inherited from ToolShell
	GetOrientation() Orientation
	// GetReliefStyle returns the relief style of buttons on @shell. Tool items
	// must not call this function directly, but rely on
	// gtk_tool_item_get_relief_style() instead.
	//
	// This method is inherited from ToolShell
	GetReliefStyle() ReliefStyle
	// GetStyle retrieves whether the tool shell has text, icons, or both. Tool
	// items must not call this function directly, but rely on
	// gtk_tool_item_get_toolbar_style() instead.
	//
	// This method is inherited from ToolShell
	GetStyle() ToolbarStyle
	// GetTextAlignment retrieves the current text alignment for the tool shell.
	// Tool items must not call this function directly, but rely on
	// gtk_tool_item_get_text_alignment() instead.
	//
	// This method is inherited from ToolShell
	GetTextAlignment() float32
	// GetTextOrientation retrieves the current text orientation for the tool
	...
	// GetTextSizeGroup retrieves the current text size group for the tool
	// shell. Tool items must not call this function directly, but rely on
...
// WrapToolItemGroup wraps a GObject to a type that implements
// interface ToolItemGroup. It is primarily used internally.
...
func (t toolItemGroup) AsContainer() Container {
...
func (b toolItemGroup) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toolItemGroup) GetName() string {
...
func (s toolItemGroup) GetEllipsizeMode() pango.EllipsizeMode {
	return WrapToolShell(gextras.InternObject(s)).GetEllipsizeMode()
}

func (s toolItemGroup) GetIconSize() int {
	return WrapToolShell(gextras.InternObject(s)).GetIconSize()
}

func (s toolItemGroup) GetOrientation() Orientation {
	return WrapToolShell(gextras.InternObject(s)).GetOrientation()
}

func (s toolItemGroup) GetReliefStyle() ReliefStyle {
	return WrapToolShell(gextras.InternObject(s)).GetReliefStyle()
}

func (s toolItemGroup) GetStyle() ToolbarStyle {
	return WrapToolShell(gextras.InternObject(s)).GetStyle()
}

func (s toolItemGroup) GetTextAlignment() float32 {
	return WrapToolShell(gextras.InternObject(s)).GetTextAlignment()
}

func (s toolItemGroup) GetTextOrientation() Orientation {
	return WrapToolShell(gextras.InternObject(s)).GetTextOrientation()
}

func (s toolItemGroup) GetTextSizeGroup() SizeGroup {
	return WrapToolShell(gextras.InternObject(s)).GetTextSizeGroup()
}
