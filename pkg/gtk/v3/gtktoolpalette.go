...
// WrapToolPalette wraps a GObject to a type that implements
// interface ToolPalette. It is primarily used internally.
...
func (t toolPalette) AsContainer() Container {
...
func (b toolPalette) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b toolPalette) GetName() string {
...
func (o toolPalette) GetOrientation() Orientation {
