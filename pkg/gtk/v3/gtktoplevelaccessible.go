...
// toplevelAccessible implements the ToplevelAccessible interface.
type toplevelAccessible struct {
	*externglib.Object
}

var _ ToplevelAccessible = (*toplevelAccessible)(nil)

// WrapToplevelAccessible wraps a GObject to a type that implements
// interface ToplevelAccessible. It is primarily used internally.
func WrapToplevelAccessible(obj *externglib.Object) ToplevelAccessible {
	return toplevelAccessible{obj}
}
