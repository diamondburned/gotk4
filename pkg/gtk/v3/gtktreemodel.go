...
func ifaceInitTreeModeller(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("get_value"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_get_value)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_children"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_children)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_has_child"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_has_child)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_n_children"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_n_children)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_next"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_next)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_nth_child"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_nth_child)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_parent"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_parent)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("iter_previous"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_iter_previous)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("ref_node"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_ref_node)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("row_changed"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_row_changed)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("row_deleted"))) = unsafe.Pointer(C._gotk4_gtk3_TreeModelIface_row_deleted)
...
func (treeModel *TreeModel) IterFromString(pathString string) (*TreeIter, bool) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(treeModel).Native()))
	*(**C.gchar)(unsafe.Pointer(&_args[1])) = (*C.gchar)(unsafe.Pointer(C.CString(pathString)))
...
func (treeModel *TreeModel) RowsReordered(path *TreePath, iter *TreeIter, newOrder []int32) {
	...
	*(**C.gint)(unsafe.Pointer(&_args[3])) = (*C.gint)(C.calloc(C.size_t(len(newOrder)), C.size_t(C.sizeof_gint)))
	defer C.free(unsafe.Pointer(*(**C.gint)(unsafe.Pointer(&_args[3]))))
	{
		out := unsafe.Slice((*C.gint)(*(**C.gint)(unsafe.Pointer(&_args[3]))), len(newOrder))
...
func NewTreePathFromIndices(indices []int32) *TreePath {
	...
	*(**C.gint)(unsafe.Pointer(&_args[0])) = (*C.gint)(C.calloc(C.size_t(len(indices)), C.size_t(C.sizeof_gint)))
	defer C.free(unsafe.Pointer(*(**C.gint)(unsafe.Pointer(&_args[0]))))
	{
		out := unsafe.Slice((*C.gint)(*(**C.gint)(unsafe.Pointer(&_args[0]))), len(indices))
		for i := range indices {
...
func (path *TreePath) Indices() []int32 {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(gextras.StructNative(unsafe.Pointer(path)))
	...
	{
		src := unsafe.Slice((*C.gint)(*(**C.gint)(unsafe.Pointer(&_cret))), *(*C.gint)(unsafe.Pointer(&_outs[0])))
		_gints = make([]int32, *(*C.gint)(unsafe.Pointer(&_outs[0])))
		for i := 0; i < int(*(*C.gint)(unsafe.Pointer(&_outs[0]))); i++ {
