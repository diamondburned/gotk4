...
func ifaceInitTreeSortabler(gifacePtr, data C.gpointer) {
	...
	iface.get_sort_column_id = (*[0]byte)(C._gotk4_gtk3_TreeSortableIface_get_sort_column_id)
	iface.has_default_sort_func = (*[0]byte)(C._gotk4_gtk3_TreeSortableIface_has_default_sort_func)
	iface.set_sort_column_id = (*[0]byte)(C._gotk4_gtk3_TreeSortableIface_set_sort_column_id)
	iface.sort_column_changed = (*[0]byte)(C._gotk4_gtk3_TreeSortableIface_sort_column_changed)
}

//export _gotk4_gtk3_TreeSortableIface_get_sort_column_id
func _gotk4_gtk3_TreeSortableIface_get_sort_column_id(arg0 *C.GtkTreeSortable, arg1 *C.gint, arg2 *C.GtkSortType) (cret C.gboolean) {
...
//export _gotk4_gtk3_TreeSortableIface_set_sort_column_id
func _gotk4_gtk3_TreeSortableIface_set_sort_column_id(arg0 *C.GtkTreeSortable, arg1 C.gint, arg2 C.GtkSortType) {
	goval := externglib.GoPrivateFromObject(unsafe.Pointer(arg0))
	iface := goval.(TreeSortableOverrider)
...
func (sortable *TreeSortable) ConnectSortColumnChanged(f func()) externglib.SignalHandle {
	return externglib.ConnectGeneratedClosure(sortable, "sort-column-changed", false, unsafe.Pointer(C._gotk4_gtk3_TreeSortable_ConnectSortColumnChanged), f)
}
