...
// It is primarily for things like popup menus. If path is non-NULL, then it
// will be filled with the TreePath at that point. This path should be freed
// with gtk_tree_path_free(). If column is non-NULL, then it will be filled
...
// The function takes the following parameters:
//
//   - fn (optional): function to be called when a view row is destroyed,
//     or NULL.
//
...
// that appearance all the time can choose those themes. You should call this
