...
// WrapTreeViewColumnOverrider wraps the TreeViewColumnOverrider
// interface implementation to access the instance methods.
func WrapTreeViewColumnOverrider(obj TreeViewColumnOverrider) *TreeViewColumn {
	return wrapTreeViewColumn(externglib.BaseObject(obj))
}
...
func (treeColumn *TreeViewColumn) ConnectClicked(f func()) externglib.SignalHandle {
	return externglib.ConnectGeneratedClosure(treeColumn, "clicked", false, unsafe.Pointer(C._gotk4_gtk3_TreeViewColumn_ConnectClicked), f)
}
...
func (treeColumn *TreeViewColumn) AddAttribute(cellRenderer CellRendererer, attribute string, column int) {
	...
	_arg0 = (*C.GtkTreeViewColumn)(unsafe.Pointer(externglib.InternObject(treeColumn).Native()))
	_arg1 = (*C.GtkCellRenderer)(unsafe.Pointer(externglib.InternObject(cellRenderer).Native()))
