...
type UIManager interface {
	...
	AddUi(m UIManager, mergeID uint, path string, name string, action string, typ UIManagerItemType, top bool)
	// AddUiFromFile parses a file containing a [UI definition][XML-UI] and
	// merges it with the current contents of @manager.
	AddUiFromFile(m UIManager, filename string) error
	...
	AddUiFromResource(m UIManager, resourcePath string) error
	...
	AddUiFromString(m UIManager, buffer string, length int) error
	...
	Widget(m UIManager, path string)
	...
	SetAddTearoffs(m UIManager, addTearoffs bool)
}
...
// If @path points to a menuitem or toolitem, the new element will be
// inserted before or after this item, depending on @top.
func (m uiManager) AddUi(m UIManager, mergeID uint, path string, name string, action string, typ UIManagerItemType, top bool) {
...
// AddUiFromFile parses a file containing a [UI definition][XML-UI] and
// merges it with the current contents of @manager.
func (m uiManager) AddUiFromFile(m UIManager, filename string) error {
	var arg0 *C.GtkUIManager
	var arg1 *C.gchar
	...
	C.gtk_ui_manager_add_ui_from_file(arg0, arg1, &errout)
...
// AddUiFromResource parses a resource file containing a [UI
// definition][XML-UI] and merges it with the current contents of @manager.
func (m uiManager) AddUiFromResource(m UIManager, resourcePath string) error {
	var arg0 *C.GtkUIManager
	var arg1 *C.gchar
	...
	C.gtk_ui_manager_add_ui_from_resource(arg0, arg1, &errout)
...
// merges it with the current contents of @manager. An enclosing <ui>
// element is added if it is missing.
func (m uiManager) AddUiFromString(m UIManager, buffer string, length int) error {
	var arg0 *C.GtkUIManager
	var arg1 *C.gchar
	var arg2 C.gssize
	...
	C.gtk_ui_manager_add_ui_from_string(arg0, arg1, arg2, &errout)
...
//    gtk_ui_manager_ensure_update (merge);
//    gtk_widget_show (window);
func (m uiManager) EnsureUpdate(m UIManager) {
	var arg0 *C.GtkUIManager
...
// AccelGroup returns the AccelGroup associated with @manager.
func (m uiManager) AccelGroup(m UIManager) {
	var arg0 *C.GtkUIManager

	arg0 = (*C.GtkUIManager)(unsafe.Pointer(m.Native()))

	C.gtk_ui_manager_get_accel_group(arg0)
}

// Action looks up an action by following a path. See
// gtk_ui_manager_get_widget() for more information about paths.
func (m uiManager) Action(m UIManager, path string) {
	var arg0 *C.GtkUIManager
	var arg1 *C.gchar
	...
	C.gtk_ui_manager_get_action(arg0, arg1)
}

// ActionGroups returns the list of action groups associated with @manager.
func (m uiManager) ActionGroups(m UIManager) {
	var arg0 *C.GtkUIManager

	arg0 = (*C.GtkUIManager)(unsafe.Pointer(m.Native()))

	C.gtk_ui_manager_get_action_groups(arg0)
}

// AddTearoffs returns whether menus generated by this UIManager will have
// tearoff menu items.
func (m uiManager) AddTearoffs(m UIManager) bool {
	var arg0 *C.GtkUIManager
...
// Toplevels obtains a list of all toplevel widgets of the requested types.
func (m uiManager) Toplevels(m UIManager, types UIManagerItemType) {
	var arg0 *C.GtkUIManager
	...
	C.gtk_ui_manager_get_toplevels(arg0, arg1)
}

// Ui creates a [UI definition][XML-UI] of the merged UI.
func (m uiManager) Ui(m UIManager) {
	var arg0 *C.GtkUIManager

	arg0 = (*C.GtkUIManager)(unsafe.Pointer(m.Native()))

	C.gtk_ui_manager_get_ui(arg0)
}
...
// function to some container or explicitly ref them, they will survive the
// destruction of the ui manager.
func (m uiManager) Widget(m UIManager, path string) {
	var arg0 *C.GtkUIManager
	var arg1 *C.gchar
	...
	C.gtk_ui_manager_get_widget(arg0, arg1)
}
...
// If @pos is larger than the number of action groups in @manager, or
// negative, @action_group will be inserted at the end of the internal list.
func (m uiManager) InsertActionGroup(m UIManager, actionGroup ActionGroup, pos int) {
	var arg0 *C.GtkUIManager
...
// NewMergeID returns an unused merge id, suitable for use with
// gtk_ui_manager_add_ui().
func (m uiManager) NewMergeID(m UIManager) {
	var arg0 *C.GtkUIManager

	arg0 = (*C.GtkUIManager)(unsafe.Pointer(m.Native()))

	C.gtk_ui_manager_new_merge_id(arg0)
}

// RemoveActionGroup removes an action group from the list of action groups
// associated with @manager.
func (m uiManager) RemoveActionGroup(m UIManager, actionGroup ActionGroup) {
	var arg0 *C.GtkUIManager
	var arg1 *C.GtkActionGroup
...
// RemoveUi unmerges the part of @manager's content identified by @merge_id.
func (m uiManager) RemoveUi(m UIManager, mergeID uint) {
	var arg0 *C.GtkUIManager
	var arg1 C.guint
...
// Note that this only affects regular menus. Generated popup menus never
// have tearoff menu items.
func (m uiManager) SetAddTearoffs(m UIManager, addTearoffs bool) {
	var arg0 *C.GtkUIManager
	var arg1 C.gboolean
