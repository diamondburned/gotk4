...
type UIManager interface {
	...
	// AddUiUIManager adds a UI element to the current contents of @manager.
	//
	...
	// AddUiFromFileUIManager parses a file containing a [UI definition][XML-UI]
	// and merges it with the current contents of @manager.
	//
	// Deprecated: since version 3.10.
	AddUiFromFileUIManager(filename string) (uint, error)
	// AddUiFromResourceUIManager parses a resource file containing a [UI
	...
	// AddUiFromStringUIManager parses a string containing a [UI
	// definition][XML-UI] and merges it with the current contents of @manager.
	// An enclosing <ui> element is added if it is missing.
	//
	// Deprecated: since version 3.10.
	AddUiFromStringUIManager(buffer string, length int) (uint, error)
	// EnsureUpdateUIManager makes sure that all pending updates to the UI have
	// been completed.
	//
	...
	// InsertActionGroupUIManager inserts an action group into the list of
	// action groups associated with @manager. Actions in earlier groups hide
	// actions with the same name in later groups.
	//
	...
	// NewMergeIDUIManager returns an unused merge id, suitable for use with
	// gtk_ui_manager_add_ui().
	//
	// Deprecated: since version 3.10.
	NewMergeIDUIManager() uint
	// RemoveActionGroupUIManager removes an action group from the list of
	// action groups associated with @manager.
	//
	// Deprecated: since version 3.10.
	RemoveActionGroupUIManager(actionGroup ActionGroup)
	// RemoveUiUIManager unmerges the part of @manager's content identified by
	// @merge_id.
	//
	// Deprecated: since version 3.10.
	RemoveUiUIManager(mergeId uint)
	// SetAddTearoffsUIManager sets the “add_tearoffs” property, which controls
	// whether menus generated by this UIManager will have tearoff menu items.
	//
...
func (m uiManager) AddUiUIManager(mergeId uint, path string, name string, action string, typ UIManagerItemType, top bool) {
...
func (m uiManager) AddUiFromFileUIManager(filename string) (uint, error) {
	var _arg0 *C.GtkUIManager // out
...
func (m uiManager) AddUiFromResourceUIManager(resourcePath string) (uint, error) {
	var _arg0 *C.GtkUIManager // out
	var _arg1 *C.gchar        // out
	var _cret C.guint         // in
	var _cerr *C.GError       // in
...
func (m uiManager) AddUiFromStringUIManager(buffer string, length int) (uint, error) {
	var _arg0 *C.GtkUIManager // out
	var _arg1 *C.gchar        // out
...
func (m uiManager) EnsureUpdateUIManager() {
	var _arg0 *C.GtkUIManager // out
...
func (m uiManager) InsertActionGroupUIManager(actionGroup ActionGroup, pos int) {
	var _arg0 *C.GtkUIManager   // out
...
func (m uiManager) NewMergeIDUIManager() uint {
	var _arg0 *C.GtkUIManager // out
	var _cret C.guint         // in
...
func (m uiManager) RemoveActionGroupUIManager(actionGroup ActionGroup) {
	var _arg0 *C.GtkUIManager   // out
	var _arg1 *C.GtkActionGroup // out
...
func (m uiManager) RemoveUiUIManager(mergeId uint) {
	var _arg0 *C.GtkUIManager // out
	var _arg1 C.guint         // out
...
func (m uiManager) SetAddTearoffsUIManager(addTearoffs bool) {
	var _arg0 *C.GtkUIManager // out
