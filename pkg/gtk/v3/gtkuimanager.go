...
func NewUIManager() *UIManagerClass {
	...
	_uiManager = gextras.CastObject(
		externglib.AssumeOwnership(unsafe.Pointer(_cret))).(*UIManagerClass)
...
//
// Deprecated: since version 3.10.
func (m *UIManagerClass) AccelGroup() *AccelGroupClass {
	var _arg0 *C.GtkUIManager  // out
...
//
// Deprecated: since version 3.10.
func (m *UIManagerClass) Action(path string) *ActionClass {
	var _arg0 *C.GtkUIManager // out
	var _arg1 *C.gchar        // out
...
//
// Deprecated: since version 3.10.
func (m *UIManagerClass) Widget(path string) *WidgetClass {
	var _arg0 *C.GtkUIManager // out
	var _arg1 *C.gchar        // out
