...
func NewUIManager() UIManager {
	...
	var goret1 UIManager

	cret = C.gtk_ui_manager_new()

	goret1 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(cret.Native()))).(UIManager)
...
func (m uiManager) AddUi(mergeID uint, path string, name string, action string, typ UIManagerItemType, top bool) {
	...
	C.gtk_ui_manager_add_ui(arg0, mergeID, path, name, action, typ, top)
}
...
func (m uiManager) Action(path string) Action {
	...
	cret = C.gtk_ui_manager_get_action(arg0, path)
...
func (m uiManager) Toplevels(types UIManagerItemType) *glib.SList {
	...
	cret = C.gtk_ui_manager_get_toplevels(arg0, types)
...
func (m uiManager) Widget(path string) Widget {
	...
	cret = C.gtk_ui_manager_get_widget(arg0, path)
...
func (m uiManager) InsertActionGroup(actionGroup ActionGroup, pos int) {
	...
	C.gtk_ui_manager_insert_action_group(arg0, actionGroup, pos)
}
...
func (m uiManager) RemoveActionGroup(actionGroup ActionGroup) {
	...
	C.gtk_ui_manager_remove_action_group(arg0, actionGroup)
}
...
func (m uiManager) RemoveUi(mergeID uint) {
	...
	C.gtk_ui_manager_remove_ui(arg0, mergeID)
}
...
func (m uiManager) SetAddTearoffs(addTearoffs bool) {
	...
	C.gtk_ui_manager_set_add_tearoffs(arg0, addTearoffs)
}
