...
func init() {
	externglib.RegisterGValueMarshalers([]externglib.TypeMarshaler{
		...
		{T: externglib.Type(C.gtk_ui_manager_get_type()), F: marshalUIManagerrer},
	})
}
...
// UIManagerrerOverrider contains methods that are overridable.
//
// As of right now, interface overriding and subclassing is not supported
// yet, so the interface currently has no use.
type UIManagerrerOverrider interface {
	ActionsChanged()
...
// UIManagerrer describes UIManager's methods.
type UIManagerrer interface {
	gextras.Objector
...
var _ UIManagerrer = (*UIManager)(nil)

func wrapUIManagerrer(obj *externglib.Object) UIManagerrer {
	return &UIManager{
		Object: obj,
		Buildable: Buildable{
			Object: obj,
...
func marshalUIManagerrer(p uintptr) (interface{}, error) {
	val := C.g_value_get_object((*C.GValue)(unsafe.Pointer(p)))
	obj := externglib.Take(unsafe.Pointer(val))
	return wrapUIManagerrer(obj), nil
}
