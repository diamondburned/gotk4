...
type VButtonBox interface {
	...
	// GetChildNonHomogeneous returns whether the child is exempted from
	// homogenous sizing.
	//
	// This method is inherited from ButtonBox
	GetChildNonHomogeneous(child Widget) bool
	// GetChildSecondary returns whether @child should appear in a secondary
	// group of children.
	//
	// This method is inherited from ButtonBox
	GetChildSecondary(child Widget) bool
	// GetLayout retrieves the method being used to arrange the buttons in a
	// button box.
	//
	// This method is inherited from ButtonBox
...
// WrapVButtonBox wraps a GObject to a type that implements
// interface VButtonBox. It is primarily used internally.
...
func (v vButtonBox) AsButtonBox() ButtonBox {
	return WrapButtonBox(gextras.InternObject(v))
}
...
func (b vButtonBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vButtonBox) GetName() string {
...
func (o vButtonBox) GetOrientation() Orientation {
