...
// WrapVBox wraps a GObject to a type that implements
// interface VBox. It is primarily used internally.
...
func (v vBox) AsBox() Box {
	return WrapBox(gextras.InternObject(v))
}
...
func (b vBox) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vBox) GetName() string {
...
func (o vBox) GetOrientation() Orientation {
