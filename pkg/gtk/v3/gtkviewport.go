...
// WrapViewport wraps a GObject to a type that implements
// interface Viewport. It is primarily used internally.
...
func (v viewport) AsBin() Bin {
	return WrapBin(gextras.InternObject(v))
}
...
func (b viewport) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b viewport) GetName() string {
