...
type VolumeButton interface {
	...
	//
	// This method is inherited from ScaleButton
	...
	//
	// This method is inherited from Button
	Clicked()
	...
	// This method is inherited from Button
	Enter()
	// GetAlignment gets the alignment of the child in the button.
	//
	// Deprecated: since version 3.14.
	//
	// This method is inherited from Button
	GetAlignment() (xalign float32, yalign float32)
	// GetAlwaysShowImage returns whether the button will ignore the
	// Settings:gtk-button-images setting and always show the image, if
	// available.
	//
	// This method is inherited from Button
	GetAlwaysShowImage() bool
	// GetEventWindow returns the button’s event window if it is realized, nil
	// otherwise. This function should be rarely needed.
	//
	// This method is inherited from Button
	GetEventWindow() gdk.Window
	// GetFocusOnClick returns whether the button grabs focus when it is clicked
	...
	// GetImage gets the widget that is currenty set as the image of @button.
	// This may have been explicitly set by gtk_button_set_image() or
	// constructed by gtk_button_new_from_stock().
	//
	// This method is inherited from Button
	GetImage() Widget
	// GetImagePosition gets the position of the image relative to the text
	// inside the button.
	//
	// This method is inherited from Button
	...
	// This method is inherited from Button
	GetLabel() string
	// GetRelief returns the current relief style of the given Button.
	//
	// This method is inherited from Button
	...
	// This method is inherited from Button
	GetUseStock() bool
	// GetUseUnderline returns whether an embedded underline in the button label
...
// WrapVolumeButton wraps a GObject to a type that implements
// interface VolumeButton. It is primarily used internally.
...
func (v volumeButton) AsScaleButton() ScaleButton {
	return WrapScaleButton(gextras.InternObject(v))
}
...
func (b volumeButton) GetAdjustment() Adjustment {
	return WrapScaleButton(gextras.InternObject(b)).GetAdjustment()
}

func (b volumeButton) GetMinusButton() Button {
	return WrapScaleButton(gextras.InternObject(b)).GetMinusButton()
}

func (b volumeButton) GetPlusButton() Button {
	return WrapScaleButton(gextras.InternObject(b)).GetPlusButton()
}

func (b volumeButton) GetPopup() Widget {
	return WrapScaleButton(gextras.InternObject(b)).GetPopup()
}

func (b volumeButton) GetValue() float64 {
	return WrapScaleButton(gextras.InternObject(b)).GetValue()
}

func (b volumeButton) SetAdjustment(adjustment Adjustment) {
	WrapScaleButton(gextras.InternObject(b)).SetAdjustment(adjustment)
}

func (b volumeButton) SetIcons(icons []string) {
	WrapScaleButton(gextras.InternObject(b)).SetIcons(icons)
}

func (b volumeButton) SetValue(value float64) {
	WrapScaleButton(gextras.InternObject(b)).SetValue(value)
}

func (b volumeButton) Clicked() {
	WrapButton(gextras.InternObject(b)).Clicked()
}

func (b volumeButton) Enter() {
	WrapButton(gextras.InternObject(b)).Enter()
}

func (b volumeButton) GetAlignment() (xalign float32, yalign float32) {
	return WrapButton(gextras.InternObject(b)).GetAlignment()
}

func (b volumeButton) GetAlwaysShowImage() bool {
	return WrapButton(gextras.InternObject(b)).GetAlwaysShowImage()
}

func (b volumeButton) GetEventWindow() gdk.Window {
	return WrapButton(gextras.InternObject(b)).GetEventWindow()
}

func (b volumeButton) GetFocusOnClick() bool {
	return WrapButton(gextras.InternObject(b)).GetFocusOnClick()
}

func (b volumeButton) GetImage() Widget {
	return WrapButton(gextras.InternObject(b)).GetImage()
}

func (b volumeButton) GetImagePosition() PositionType {
	return WrapButton(gextras.InternObject(b)).GetImagePosition()
}

func (b volumeButton) GetLabel() string {
	return WrapButton(gextras.InternObject(b)).GetLabel()
}

func (b volumeButton) GetRelief() ReliefStyle {
	return WrapButton(gextras.InternObject(b)).GetRelief()
}

func (b volumeButton) GetUseStock() bool {
	return WrapButton(gextras.InternObject(b)).GetUseStock()
}

func (b volumeButton) GetUseUnderline() bool {
	return WrapButton(gextras.InternObject(b)).GetUseUnderline()
}

func (b volumeButton) Leave() {
	WrapButton(gextras.InternObject(b)).Leave()
}

func (b volumeButton) Pressed() {
	WrapButton(gextras.InternObject(b)).Pressed()
}

func (b volumeButton) Released() {
	WrapButton(gextras.InternObject(b)).Released()
}

func (b volumeButton) SetAlignment(xalign float32, yalign float32) {
	WrapButton(gextras.InternObject(b)).SetAlignment(xalign, yalign)
}

func (b volumeButton) SetAlwaysShowImage(alwaysShow bool) {
	WrapButton(gextras.InternObject(b)).SetAlwaysShowImage(alwaysShow)
}

func (b volumeButton) SetFocusOnClick(focusOnClick bool) {
	WrapButton(gextras.InternObject(b)).SetFocusOnClick(focusOnClick)
}

func (b volumeButton) SetImage(image Widget) {
	WrapButton(gextras.InternObject(b)).SetImage(image)
}

func (b volumeButton) SetImagePosition(position PositionType) {
	WrapButton(gextras.InternObject(b)).SetImagePosition(position)
}

func (b volumeButton) SetLabel(label string) {
	WrapButton(gextras.InternObject(b)).SetLabel(label)
}

func (b volumeButton) SetRelief(relief ReliefStyle) {
	WrapButton(gextras.InternObject(b)).SetRelief(relief)
}

func (b volumeButton) SetUseStock(useStock bool) {
	WrapButton(gextras.InternObject(b)).SetUseStock(useStock)
}

func (b volumeButton) SetUseUnderline(useUnderline bool) {
	WrapButton(gextras.InternObject(b)).SetUseUnderline(useUnderline)
}

func (b volumeButton) GetChild() Widget {
	return WrapBin(gextras.InternObject(b)).GetChild()
}

func (c volumeButton) Add(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Add(widget)
}

func (c volumeButton) CheckResize() {
	WrapContainer(gextras.InternObject(c)).CheckResize()
}

func (c volumeButton) ChildGetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildGetProperty(child, propertyName, value)
}

func (c volumeButton) ChildNotify(child Widget, childProperty string) {
	WrapContainer(gextras.InternObject(c)).ChildNotify(child, childProperty)
}

func (c volumeButton) ChildSetProperty(child Widget, propertyName string, value externglib.Value) {
	WrapContainer(gextras.InternObject(c)).ChildSetProperty(child, propertyName, value)
}

func (c volumeButton) ChildType() externglib.Type {
	return WrapContainer(gextras.InternObject(c)).ChildType()
}

func (c volumeButton) Forall(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Forall(callback)
}

func (c volumeButton) Foreach(callback Callback) {
	WrapContainer(gextras.InternObject(c)).Foreach(callback)
}

func (c volumeButton) GetBorderWidth() uint {
	return WrapContainer(gextras.InternObject(c)).GetBorderWidth()
}

func (c volumeButton) GetFocusChild() Widget {
	return WrapContainer(gextras.InternObject(c)).GetFocusChild()
}

func (c volumeButton) GetFocusHAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusHAdjustment()
}

func (c volumeButton) GetFocusVAdjustment() Adjustment {
	return WrapContainer(gextras.InternObject(c)).GetFocusVAdjustment()
}

func (c volumeButton) GetPathForChild(child Widget) *WidgetPath {
	return WrapContainer(gextras.InternObject(c)).GetPathForChild(child)
}

func (c volumeButton) GetResizeMode() ResizeMode {
	return WrapContainer(gextras.InternObject(c)).GetResizeMode()
}

func (c volumeButton) PropagateDraw(child Widget, cr *cairo.Context) {
	WrapContainer(gextras.InternObject(c)).PropagateDraw(child, cr)
}

func (c volumeButton) Remove(widget Widget) {
	WrapContainer(gextras.InternObject(c)).Remove(widget)
}

func (c volumeButton) ResizeChildren() {
	WrapContainer(gextras.InternObject(c)).ResizeChildren()
}

func (c volumeButton) SetBorderWidth(borderWidth uint) {
	WrapContainer(gextras.InternObject(c)).SetBorderWidth(borderWidth)
}

func (c volumeButton) SetFocusChild(child Widget) {
	WrapContainer(gextras.InternObject(c)).SetFocusChild(child)
}

func (c volumeButton) SetFocusHAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusHAdjustment(adjustment)
}

func (c volumeButton) SetFocusVAdjustment(adjustment Adjustment) {
	WrapContainer(gextras.InternObject(c)).SetFocusVAdjustment(adjustment)
}

func (c volumeButton) SetReallocateRedraws(needsRedraws bool) {
	WrapContainer(gextras.InternObject(c)).SetReallocateRedraws(needsRedraws)
}

func (c volumeButton) SetResizeMode(resizeMode ResizeMode) {
	WrapContainer(gextras.InternObject(c)).SetResizeMode(resizeMode)
}

func (c volumeButton) UnsetFocusChain() {
	WrapContainer(gextras.InternObject(c)).UnsetFocusChain()
}

func (w volumeButton) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w volumeButton) AddAccelerator(accelSignal string, accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType, accelFlags AccelFlags) {
	WrapWidget(gextras.InternObject(w)).AddAccelerator(accelSignal, accelGroup, accelKey, accelMods, accelFlags)
}

func (w volumeButton) AddDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).AddDeviceEvents(device, events)
}

func (w volumeButton) AddEvents(events int) {
	WrapWidget(gextras.InternObject(w)).AddEvents(events)
}

func (w volumeButton) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w volumeButton) CanActivateAccel(signalId uint) bool {
	return WrapWidget(gextras.InternObject(w)).CanActivateAccel(signalId)
}

func (w volumeButton) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w volumeButton) ChildNotify(childProperty string) {
	WrapWidget(gextras.InternObject(w)).ChildNotify(childProperty)
}

func (w volumeButton) ClassPath() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).ClassPath()
}

func (w volumeButton) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w volumeButton) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w volumeButton) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w volumeButton) Destroy() {
	WrapWidget(gextras.InternObject(w)).Destroy()
}

func (w volumeButton) DeviceIsShadowed(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).DeviceIsShadowed(device)
}

func (w volumeButton) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w volumeButton) DragDestAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddImageTargets()
}

func (w volumeButton) DragDestAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddTextTargets()
}

func (w volumeButton) DragDestAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragDestAddURITargets()
}

func (w volumeButton) DragDestGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTargetList()
}

func (w volumeButton) DragDestGetTrackMotion() bool {
	return WrapWidget(gextras.InternObject(w)).DragDestGetTrackMotion()
}

func (w volumeButton) DragDestSet(flags DestDefaults, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragDestSet(flags, targets, actions)
}

func (w volumeButton) DragDestSetProxy(proxyWindow gdk.Window, protocol gdk.DragProtocol, useCoordinates bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetProxy(proxyWindow, protocol, useCoordinates)
}

func (w volumeButton) DragDestSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTargetList(targetList)
}

func (w volumeButton) DragDestSetTrackMotion(trackMotion bool) {
	WrapWidget(gextras.InternObject(w)).DragDestSetTrackMotion(trackMotion)
}

func (w volumeButton) DragDestUnset() {
	WrapWidget(gextras.InternObject(w)).DragDestUnset()
}

func (w volumeButton) DragHighlight() {
	WrapWidget(gextras.InternObject(w)).DragHighlight()
}

func (w volumeButton) DragSourceAddImageTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddImageTargets()
}

func (w volumeButton) DragSourceAddTextTargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddTextTargets()
}

func (w volumeButton) DragSourceAddURITargets() {
	WrapWidget(gextras.InternObject(w)).DragSourceAddURITargets()
}

func (w volumeButton) DragSourceGetTargetList() *TargetList {
	return WrapWidget(gextras.InternObject(w)).DragSourceGetTargetList()
}

func (w volumeButton) DragSourceSet(startButtonMask gdk.ModifierType, targets []TargetEntry, actions gdk.DragAction) {
	WrapWidget(gextras.InternObject(w)).DragSourceSet(startButtonMask, targets, actions)
}

func (w volumeButton) DragSourceSetIconName(iconName string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconName(iconName)
}

func (w volumeButton) DragSourceSetIconPixbuf(pixbuf gdkpixbuf.Pixbuf) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconPixbuf(pixbuf)
}

func (w volumeButton) DragSourceSetIconStock(stockId string) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetIconStock(stockId)
}

func (w volumeButton) DragSourceSetTargetList(targetList *TargetList) {
	WrapWidget(gextras.InternObject(w)).DragSourceSetTargetList(targetList)
}

func (w volumeButton) DragSourceUnset() {
	WrapWidget(gextras.InternObject(w)).DragSourceUnset()
}

func (w volumeButton) DragUnhighlight() {
	WrapWidget(gextras.InternObject(w)).DragUnhighlight()
}

func (w volumeButton) Draw(cr *cairo.Context) {
	WrapWidget(gextras.InternObject(w)).Draw(cr)
}

func (w volumeButton) EnsureStyle() {
	WrapWidget(gextras.InternObject(w)).EnsureStyle()
}

func (w volumeButton) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w volumeButton) FreezeChildNotify() {
	WrapWidget(gextras.InternObject(w)).FreezeChildNotify()
}

func (w volumeButton) GetAccessible() atk.Object {
	return WrapWidget(gextras.InternObject(w)).GetAccessible()
}

func (w volumeButton) GetActionGroup(prefix string) gio.ActionGroup {
	return WrapWidget(gextras.InternObject(w)).GetActionGroup(prefix)
}

func (w volumeButton) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w volumeButton) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w volumeButton) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w volumeButton) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w volumeButton) GetAppPaintable() bool {
	return WrapWidget(gextras.InternObject(w)).GetAppPaintable()
}

func (w volumeButton) GetCanDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanDefault()
}

func (w volumeButton) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w volumeButton) GetChildRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetChildRequisition()
}

func (w volumeButton) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w volumeButton) GetCompositeName() string {
	return WrapWidget(gextras.InternObject(w)).GetCompositeName()
}

func (w volumeButton) GetDeviceEnabled(device gdk.Device) bool {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEnabled(device)
}

func (w volumeButton) GetDeviceEvents(device gdk.Device) gdk.EventMask {
	return WrapWidget(gextras.InternObject(w)).GetDeviceEvents(device)
}

func (w volumeButton) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w volumeButton) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w volumeButton) GetDoubleBuffered() bool {
	return WrapWidget(gextras.InternObject(w)).GetDoubleBuffered()
}

func (w volumeButton) GetEvents() int {
	return WrapWidget(gextras.InternObject(w)).GetEvents()
}

func (w volumeButton) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w volumeButton) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w volumeButton) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w volumeButton) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w volumeButton) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w volumeButton) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w volumeButton) GetHasWindow() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasWindow()
}

func (w volumeButton) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w volumeButton) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w volumeButton) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w volumeButton) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w volumeButton) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w volumeButton) GetMarginLeft() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginLeft()
}

func (w volumeButton) GetMarginRight() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginRight()
}

func (w volumeButton) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w volumeButton) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w volumeButton) GetModifierMask(intent gdk.ModifierIntent) gdk.ModifierType {
	return WrapWidget(gextras.InternObject(w)).GetModifierMask(intent)
}

func (w volumeButton) GetModifierStyle() RCStyle {
	return WrapWidget(gextras.InternObject(w)).GetModifierStyle()
}

func (w volumeButton) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w volumeButton) GetNoShowAll() bool {
	return WrapWidget(gextras.InternObject(w)).GetNoShowAll()
}

func (w volumeButton) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w volumeButton) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w volumeButton) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w volumeButton) GetParentWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetParentWindow()
}

func (w volumeButton) GetPath() *WidgetPath {
	return WrapWidget(gextras.InternObject(w)).GetPath()
}

func (w volumeButton) GetPointer() (x int, y int) {
	return WrapWidget(gextras.InternObject(w)).GetPointer()
}

func (w volumeButton) GetPreferredHeight() (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeight()
}

func (w volumeButton) GetPreferredHeightAndBaselineForWidth(width int) (minimumHeight int, naturalHeight int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightAndBaselineForWidth(width)
}

func (w volumeButton) GetPreferredHeightForWidth(width int) (minimumHeight int, naturalHeight int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredHeightForWidth(width)
}

func (w volumeButton) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w volumeButton) GetPreferredWidth() (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidth()
}

func (w volumeButton) GetPreferredWidthForHeight(height int) (minimumWidth int, naturalWidth int) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredWidthForHeight(height)
}

func (w volumeButton) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w volumeButton) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w volumeButton) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w volumeButton) GetRequisition() Requisition {
	return WrapWidget(gextras.InternObject(w)).GetRequisition()
}

func (w volumeButton) GetRootWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetRootWindow()
}

func (w volumeButton) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w volumeButton) GetScreen() gdk.Screen {
	return WrapWidget(gextras.InternObject(w)).GetScreen()
}

func (w volumeButton) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w volumeButton) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w volumeButton) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w volumeButton) GetState() StateType {
	return WrapWidget(gextras.InternObject(w)).GetState()
}

func (w volumeButton) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w volumeButton) GetStyle() Style {
	return WrapWidget(gextras.InternObject(w)).GetStyle()
}

func (w volumeButton) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w volumeButton) GetSupportMultidevice() bool {
	return WrapWidget(gextras.InternObject(w)).GetSupportMultidevice()
}

func (w volumeButton) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w volumeButton) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w volumeButton) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w volumeButton) GetTooltipWindow() Window {
	return WrapWidget(gextras.InternObject(w)).GetTooltipWindow()
}

func (w volumeButton) GetToplevel() Widget {
	return WrapWidget(gextras.InternObject(w)).GetToplevel()
}

func (w volumeButton) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w volumeButton) GetVAlignWithBaseline() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlignWithBaseline()
}

func (w volumeButton) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w volumeButton) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w volumeButton) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w volumeButton) GetVisual() gdk.Visual {
	return WrapWidget(gextras.InternObject(w)).GetVisual()
}

func (w volumeButton) GetWindow() gdk.Window {
	return WrapWidget(gextras.InternObject(w)).GetWindow()
}

func (w volumeButton) GrabAdd() {
	WrapWidget(gextras.InternObject(w)).GrabAdd()
}

func (w volumeButton) GrabDefault() {
	WrapWidget(gextras.InternObject(w)).GrabDefault()
}

func (w volumeButton) GrabFocus() {
	WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w volumeButton) GrabRemove() {
	WrapWidget(gextras.InternObject(w)).GrabRemove()
}

func (w volumeButton) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w volumeButton) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w volumeButton) HasGrab() bool {
	return WrapWidget(gextras.InternObject(w)).HasGrab()
}

func (w volumeButton) HasRCStyle() bool {
	return WrapWidget(gextras.InternObject(w)).HasRCStyle()
}

func (w volumeButton) HasScreen() bool {
	return WrapWidget(gextras.InternObject(w)).HasScreen()
}

func (w volumeButton) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w volumeButton) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w volumeButton) HideOnDelete() bool {
	return WrapWidget(gextras.InternObject(w)).HideOnDelete()
}

func (w volumeButton) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w volumeButton) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w volumeButton) InputShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).InputShapeCombineRegion(region)
}

func (w volumeButton) InsertActionGroup(name string, group gio.ActionGroup) {
	WrapWidget(gextras.InternObject(w)).InsertActionGroup(name, group)
}

func (w volumeButton) Intersect(area *gdk.Rectangle) (gdk.Rectangle, bool) {
	return WrapWidget(gextras.InternObject(w)).Intersect(area)
}

func (w volumeButton) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w volumeButton) IsComposited() bool {
	return WrapWidget(gextras.InternObject(w)).IsComposited()
}

func (w volumeButton) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w volumeButton) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w volumeButton) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w volumeButton) IsToplevel() bool {
	return WrapWidget(gextras.InternObject(w)).IsToplevel()
}

func (w volumeButton) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w volumeButton) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w volumeButton) ListActionPrefixes() []string {
	return WrapWidget(gextras.InternObject(w)).ListActionPrefixes()
}

func (w volumeButton) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w volumeButton) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w volumeButton) ModifyBase(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBase(state, color)
}

func (w volumeButton) ModifyBg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyBg(state, color)
}

func (w volumeButton) ModifyCursor(primary *gdk.Color, secondary *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyCursor(primary, secondary)
}

func (w volumeButton) ModifyFg(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyFg(state, color)
}

func (w volumeButton) ModifyFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).ModifyFont(fontDesc)
}

func (w volumeButton) ModifyStyle(style RCStyle) {
	WrapWidget(gextras.InternObject(w)).ModifyStyle(style)
}

func (w volumeButton) ModifyText(state StateType, color *gdk.Color) {
	WrapWidget(gextras.InternObject(w)).ModifyText(state, color)
}

func (w volumeButton) OverrideBackgroundColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideBackgroundColor(state, color)
}

func (w volumeButton) OverrideColor(state StateFlags, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideColor(state, color)
}

func (w volumeButton) OverrideCursor(cursor *gdk.RGBA, secondaryCursor *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideCursor(cursor, secondaryCursor)
}

func (w volumeButton) OverrideFont(fontDesc *pango.FontDescription) {
	WrapWidget(gextras.InternObject(w)).OverrideFont(fontDesc)
}

func (w volumeButton) OverrideSymbolicColor(name string, color *gdk.RGBA) {
	WrapWidget(gextras.InternObject(w)).OverrideSymbolicColor(name, color)
}

func (w volumeButton) Path() (pathLength uint, path string, pathReversed string) {
	return WrapWidget(gextras.InternObject(w)).Path()
}

func (w volumeButton) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w volumeButton) QueueComputeExpand() {
	WrapWidget(gextras.InternObject(w)).QueueComputeExpand()
}

func (w volumeButton) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w volumeButton) QueueDrawArea(x int, y int, width int, height int) {
	WrapWidget(gextras.InternObject(w)).QueueDrawArea(x, y, width, height)
}

func (w volumeButton) QueueDrawRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).QueueDrawRegion(region)
}

func (w volumeButton) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w volumeButton) QueueResizeNoRedraw() {
	WrapWidget(gextras.InternObject(w)).QueueResizeNoRedraw()
}

func (w volumeButton) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w volumeButton) RegionIntersect(region *cairo.Region) *cairo.Region {
	return WrapWidget(gextras.InternObject(w)).RegionIntersect(region)
}

func (w volumeButton) RegisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).RegisterWindow(window)
}

func (w volumeButton) RemoveAccelerator(accelGroup AccelGroup, accelKey uint, accelMods gdk.ModifierType) bool {
	return WrapWidget(gextras.InternObject(w)).RemoveAccelerator(accelGroup, accelKey, accelMods)
}

func (w volumeButton) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w volumeButton) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w volumeButton) RenderIcon(stockId string, size int, detail string) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIcon(stockId, size, detail)
}

func (w volumeButton) RenderIconPixbuf(stockId string, size int) gdkpixbuf.Pixbuf {
	return WrapWidget(gextras.InternObject(w)).RenderIconPixbuf(stockId, size)
}

func (w volumeButton) Reparent(newParent Widget) {
	WrapWidget(gextras.InternObject(w)).Reparent(newParent)
}

func (w volumeButton) ResetRCStyles() {
	WrapWidget(gextras.InternObject(w)).ResetRCStyles()
}

func (w volumeButton) ResetStyle() {
	WrapWidget(gextras.InternObject(w)).ResetStyle()
}

func (w volumeButton) SetAccelPath(accelPath string, accelGroup AccelGroup) {
	WrapWidget(gextras.InternObject(w)).SetAccelPath(accelPath, accelGroup)
}

func (w volumeButton) SetAppPaintable(appPaintable bool) {
	WrapWidget(gextras.InternObject(w)).SetAppPaintable(appPaintable)
}

func (w volumeButton) SetCanDefault(canDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetCanDefault(canDefault)
}

func (w volumeButton) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w volumeButton) SetChildVisible(isVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(isVisible)
}

func (w volumeButton) SetCompositeName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCompositeName(name)
}

func (w volumeButton) SetDeviceEnabled(device gdk.Device, enabled bool) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEnabled(device, enabled)
}

func (w volumeButton) SetDeviceEvents(device gdk.Device, events gdk.EventMask) {
	WrapWidget(gextras.InternObject(w)).SetDeviceEvents(device, events)
}

func (w volumeButton) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w volumeButton) SetDoubleBuffered(doubleBuffered bool) {
	WrapWidget(gextras.InternObject(w)).SetDoubleBuffered(doubleBuffered)
}

func (w volumeButton) SetEvents(events int) {
	WrapWidget(gextras.InternObject(w)).SetEvents(events)
}

func (w volumeButton) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w volumeButton) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w volumeButton) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w volumeButton) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w volumeButton) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w volumeButton) SetHasWindow(hasWindow bool) {
	WrapWidget(gextras.InternObject(w)).SetHasWindow(hasWindow)
}

func (w volumeButton) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w volumeButton) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w volumeButton) SetMapped(mapped bool) {
	WrapWidget(gextras.InternObject(w)).SetMapped(mapped)
}

func (w volumeButton) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w volumeButton) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w volumeButton) SetMarginLeft(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginLeft(margin)
}

func (w volumeButton) SetMarginRight(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginRight(margin)
}

func (w volumeButton) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w volumeButton) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w volumeButton) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w volumeButton) SetNoShowAll(noShowAll bool) {
	WrapWidget(gextras.InternObject(w)).SetNoShowAll(noShowAll)
}

func (w volumeButton) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w volumeButton) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w volumeButton) SetParentWindow(parentWindow gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetParentWindow(parentWindow)
}

func (w volumeButton) SetRealized(realized bool) {
	WrapWidget(gextras.InternObject(w)).SetRealized(realized)
}

func (w volumeButton) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w volumeButton) SetRedrawOnAllocate(redrawOnAllocate bool) {
	WrapWidget(gextras.InternObject(w)).SetRedrawOnAllocate(redrawOnAllocate)
}

func (w volumeButton) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w volumeButton) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w volumeButton) SetState(state StateType) {
	WrapWidget(gextras.InternObject(w)).SetState(state)
}

func (w volumeButton) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w volumeButton) SetStyle(style Style) {
	WrapWidget(gextras.InternObject(w)).SetStyle(style)
}

func (w volumeButton) SetSupportMultidevice(supportMultidevice bool) {
	WrapWidget(gextras.InternObject(w)).SetSupportMultidevice(supportMultidevice)
}

func (w volumeButton) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w volumeButton) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w volumeButton) SetTooltipWindow(customWindow Window) {
	WrapWidget(gextras.InternObject(w)).SetTooltipWindow(customWindow)
}

func (w volumeButton) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w volumeButton) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w volumeButton) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w volumeButton) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w volumeButton) SetVisual(visual gdk.Visual) {
	WrapWidget(gextras.InternObject(w)).SetVisual(visual)
}

func (w volumeButton) SetWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).SetWindow(window)
}

func (w volumeButton) ShapeCombineRegion(region *cairo.Region) {
	WrapWidget(gextras.InternObject(w)).ShapeCombineRegion(region)
}

func (w volumeButton) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w volumeButton) ShowAll() {
	WrapWidget(gextras.InternObject(w)).ShowAll()
}

func (w volumeButton) ShowNow() {
	WrapWidget(gextras.InternObject(w)).ShowNow()
}

func (w volumeButton) SizeRequest() Requisition {
	return WrapWidget(gextras.InternObject(w)).SizeRequest()
}

func (w volumeButton) StyleAttach() {
	WrapWidget(gextras.InternObject(w)).StyleAttach()
}

func (w volumeButton) StyleGetProperty(propertyName string, value externglib.Value) {
	WrapWidget(gextras.InternObject(w)).StyleGetProperty(propertyName, value)
}

func (w volumeButton) ThawChildNotify() {
	WrapWidget(gextras.InternObject(w)).ThawChildNotify()
}

func (s volumeButton) TranslateCoordinates(destWidget Widget, srcX int, srcY int) (destX int, destY int, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w volumeButton) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w volumeButton) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w volumeButton) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w volumeButton) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w volumeButton) UnregisterWindow(window gdk.Window) {
	WrapWidget(gextras.InternObject(w)).UnregisterWindow(window)
}

func (w volumeButton) UnsetStateFlags(flags StateFlags) {
...
func (b volumeButton) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b volumeButton) GetName() string {
...
func (a volumeButton) GetActionName() string {
	return WrapActionable(gextras.InternObject(a)).GetActionName()
}

func (a volumeButton) GetActionTargetValue() *glib.Variant {
...
func (a volumeButton) GetRelatedAction() Action {
	return WrapActivatable(gextras.InternObject(a)).GetRelatedAction()
}

func (a volumeButton) GetUseActionAppearance() bool {
...
func (o volumeButton) GetOrientation() Orientation {
