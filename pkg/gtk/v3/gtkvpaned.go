...
type VPaned interface {
	...
	//
	// This method is inherited from Paned
	Add1(child Widget)
	...
	// This method is inherited from Paned
	Add2(child Widget)
	// GetChild1 obtains the first child of the paned widget.
	//
	// This method is inherited from Paned
	GetChild1() Widget
	// GetChild2 obtains the second child of the paned widget.
	//
	// This method is inherited from Paned
	GetChild2() Widget
	// GetHandleWindow returns the Window of the handle. This function is useful
...
// WrapVPaned wraps a GObject to a type that implements
// interface VPaned. It is primarily used internally.
...
func (v vPaned) AsPaned() Paned {
	return WrapPaned(gextras.InternObject(v))
}
...
func (b vPaned) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vPaned) GetName() string {
...
func (o vPaned) GetOrientation() Orientation {
