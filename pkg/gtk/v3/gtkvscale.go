...
type VScale interface {
	...
	//
	// This method is inherited from Scale
...
// WrapVScale wraps a GObject to a type that implements
// interface VScale. It is primarily used internally.
...
func (v vScale) AsScale() Scale {
	return WrapScale(gextras.InternObject(v))
}
...
func (b vScale) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vScale) GetName() string {
...
func (o vScale) GetOrientation() Orientation {
