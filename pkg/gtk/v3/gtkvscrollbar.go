...
// WrapVScrollbar wraps a GObject to a type that implements
// interface VScrollbar. It is primarily used internally.
...
func (v vScrollbar) AsScrollbar() Scrollbar {
	return WrapScrollbar(gextras.InternObject(v))
}
...
func (b vScrollbar) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vScrollbar) GetName() string {
...
func (o vScrollbar) GetOrientation() Orientation {
