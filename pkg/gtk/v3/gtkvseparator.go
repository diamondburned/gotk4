...
// WrapVSeparator wraps a GObject to a type that implements
// interface VSeparator. It is primarily used internally.
...
func (v vSeparator) AsSeparator() Separator {
	return WrapSeparator(gextras.InternObject(v))
}
...
func (b vSeparator) GetInternalChild(builder Builder, childname string) gextras.Objector {
	return WrapBuildable(gextras.InternObject(b)).GetInternalChild(builder, childname)
}

func (b vSeparator) GetName() string {
...
func (o vSeparator) GetOrientation() Orientation {
