...
// widgetAccessible implements the WidgetAccessible interface.
type widgetAccessible struct {
	*externglib.Object
}

var _ WidgetAccessible = (*widgetAccessible)(nil)

// WrapWidgetAccessible wraps a GObject to a type that implements
// interface WidgetAccessible. It is primarily used internally.
func WrapWidgetAccessible(obj *externglib.Object) WidgetAccessible {
	return widgetAccessible{obj}
}
