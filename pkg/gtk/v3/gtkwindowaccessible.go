...
// WrapWindowAccessible wraps a GObject to a type that implements
// interface WindowAccessible. It is primarily used internally.
func WrapWindowAccessible(obj *externglib.Object) WindowAccessible {
	return windowAccessible{obj}
}
