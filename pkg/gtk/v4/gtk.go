...
func marshalPrintCapabilities(p uintptr) (interface{}, error) {
	return PrintCapabilities(C.g_value_get_bitfield((*C.GValue)(unsafe.Pointer(p)))), nil
}
...
// PrintErrorQuark registers an error quark for `GtkPrintOperation` if
// necessary.
...
func (a aboutDialog) AddCreditSection(sectionName string, people []string) {
	...
	arg0 = (*C.GtkAboutDialog)(a.Native())
...
func (s appChooserButton) AppendCustomItem(name string, label string, icon gio.Icon) {
	...
	arg0 = (*C.GtkAppChooserButton)(s.Native())
	arg1 = (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(arg1))
	arg2 = (*C.gchar)(C.CString(label))
	defer C.free(unsafe.Pointer(arg2))
...
func (s appChooserDialog) Heading() string {
	...
	arg0 = (*C.GtkAppChooserDialog)(s.Native())
...
func (s appChooserWidget) DefaultText() string {
	...
	arg0 = (*C.GtkAppChooserWidget)(s.Native())
...
func (s aspectFrame) Child() Widget {
	...
	arg0 = (*C.GtkAspectFrame)(s.Native())
...
func (p assistantPage) Child() Widget {
	...
	arg0 = (*C.GtkAssistantPage)(p.Native())
...
func (b cellAreaBox) Spacing() int {
	...
	arg0 = (*C.GtkCellAreaBox)(b.Native())
...
func (t cellRendererToggle) Activatable() bool {
	...
	arg0 = (*C.GtkCellRendererToggle)(t.Native())
...
func (b colorButton) Modal() bool {
	...
	arg0 = (*C.GtkColorButton)(b.Native())
...
func (c comboBoxText) Append(id string, text string) {
	...
	arg0 = (*C.GtkComboBoxText)(c.Native())
	arg1 = (*C.gchar)(C.CString(id))
	defer C.free(unsafe.Pointer(arg1))
...
func (c entryCompletion) Complete() {
	...
	arg0 = (*C.GtkEntryCompletion)(c.Native())
...
func (s iconPaintable) File() gio.File {
	...
	arg0 = (*C.GtkIconPaintable)(s.Native())
...
func (s iconTheme) HasGIcon(gicon gio.Icon) bool {
	...
	ret := C.gtk_icon_theme_has_gicon(arg0, arg1)
...
func (p notebookPage) Child() Widget {
	...
	arg0 = (*C.GtkNotebookPage)(p.Native())
...
func NewPageSetupUnixDialog(title string, parent Window) PageSetupUnixDialog {
	...
	ret := C.gtk_page_setup_unix_dialog_new(arg1, arg2)

	var ret0 PageSetupUnixDialog

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(PageSetupUnixDialog)
...
func (d pageSetupUnixDialog) PageSetup() PageSetup {
	...
	arg0 = (*C.GtkPageSetupUnixDialog)(d.Native())

	ret := C.gtk_page_setup_unix_dialog_get_page_setup(arg0)
...
func (d pageSetupUnixDialog) PrintSettings() PrintSettings {
	...
	ret := C.gtk_page_setup_unix_dialog_get_print_settings(arg0)
...
func (p popoverMenu) AddChild(child Widget, id string) bool {
	...
	arg0 = (*C.GtkPopoverMenu)(p.Native())
	arg1 = (*C.GtkWidget)(child.Native())
	arg2 = (*C.gchar)(C.CString(id))
	defer C.free(unsafe.Pointer(arg2))
...
func (b popoverMenuBar) AddChild(child Widget, id string) bool {
	...
	arg0 = (*C.GtkPopoverMenuBar)(b.Native())
	arg1 = (*C.GtkWidget)(child.Native())
	arg2 = (*C.gchar)(C.CString(id))
	defer C.free(unsafe.Pointer(arg2))
...
type PrintJob interface {
	...
	PageRanges() (nRanges int, pageRanges []PageRange)
	...
	Send(callback PrintJobCompleteFunc)
...
func NewPrintJob(title string, printer Printer, settings PrintSettings, pageSetup PageSetup) PrintJob {
	...
	arg1 = (*C.gchar)(C.CString(title))
	defer C.free(unsafe.Pointer(arg1))
	arg2 = (*C.GtkPrinter)(printer.Native())
	arg3 = (*C.GtkPrintSettings)(settings.Native())
	arg4 = (*C.GtkPageSetup)(pageSetup.Native())

	ret := C.gtk_print_job_new(arg1, arg2, arg3, arg4)

	var ret0 PrintJob

	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(PrintJob)
...
func (j printJob) Collate() bool {
	...
	arg0 = (*C.GtkPrintJob)(j.Native())

	ret := C.gtk_print_job_get_collate(arg0)
...
func (j printJob) NUp() uint {
	...
	ret := C.gtk_print_job_get_n_up(arg0)
...
func (j printJob) NUpLayout() NumberUpLayout {
	...
	ret := C.gtk_print_job_get_n_up_layout(arg0)
...
func (j printJob) NumCopies() int {
	...
	ret := C.gtk_print_job_get_num_copies(arg0)
...
// PageRanges gets the page ranges for this job.
func (j printJob) PageRanges() (nRanges int, pageRanges []PageRange) {
	var arg0 *C.GtkPrintJob
	var arg1 *C.int // out

	arg0 = (*C.GtkPrintJob)(j.Native())

	ret := C.gtk_print_job_get_page_ranges(arg0, &arg1)
...
func (j printJob) PageSet() PageSet {
	...
	ret := C.gtk_print_job_get_page_set(arg0)
...
func (j printJob) Pages() PrintPages {
	...
	ret := C.gtk_print_job_get_pages(arg0)
...
func (j printJob) Printer() Printer {
	...
	ret := C.gtk_print_job_get_printer(arg0)

	var ret0 Printer

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(Printer)
...
func (j printJob) Reverse() bool {
	...
	ret := C.gtk_print_job_get_reverse(arg0)
...
func (j printJob) Rotate() bool {
	...
	ret := C.gtk_print_job_get_rotate(arg0)
...
func (j printJob) Scale() float64 {
	...
	ret := C.gtk_print_job_get_scale(arg0)
...
func (j printJob) Settings() PrintSettings {
	...
	ret := C.gtk_print_job_get_settings(arg0)
...
func (j printJob) Status() PrintStatus {
	...
	ret := C.gtk_print_job_get_status(arg0)
...
func (j printJob) Surface() (surface *cairo.Surface, err error) {
	...
	ret := C.gtk_print_job_get_surface(arg0, &gError)
...
func (j printJob) Title() string {
	...
	ret := C.gtk_print_job_get_title(arg0)
...
func (j printJob) TrackPrintStatus() bool {
	...
	ret := C.gtk_print_job_get_track_print_status(arg0)
...
// Send sends the print job off to the printer.
func (j printJob) Send(callback PrintJobCompleteFunc) {
	var arg0 *C.GtkPrintJob
	var arg1 C.GtkPrintJobCompleteFunc
	var arg2 C.gpointer
	var arg3 C.GDestroyNotify

	arg0 = (*C.GtkPrintJob)(j.Native())
	arg1 = (*[0]byte)(C.gotk4_PrintJobCompleteFunc)
...
func (j printJob) SetPageRanges(ranges []PageRange) {
	...
	arg0 = (*C.GtkPrintJob)(j.Native())
	{
		...
		ptr := C.malloc(C.sizeof_GtkPageRange * len(ranges))
		sliceHeader := (*reflect.SliceHeader)(unsafe.Pointer(&dst))
		sliceHeader.Data = uintptr(unsafe.Pointer(ptr))
		sliceHeader.Len = len(ranges)
		sliceHeader.Cap = len(ranges)
		...
		arg1 = (*C.GtkPageRange)(unsafe.Pointer(ptr))
		arg2 = len(ranges)
	}
...
func (j printJob) SetSourceFd(fd int) error {
	...
	ret := C.gtk_print_job_set_source_fd(arg0, arg1, &gError)
...
func (j printJob) SetSourceFile(filename string) error {
	...
	ret := C.gtk_print_job_set_source_file(arg0, arg1, &gError)
...
func NewPrintUnixDialog(title string, parent Window) PrintUnixDialog {
	...
	ret := C.gtk_print_unix_dialog_new(arg1, arg2)

	var ret0 PrintUnixDialog

	ret0 = gextras.CastObject(externglib.Take(unsafe.Pointer(ret.Native()))).(PrintUnixDialog)
...
func (d printUnixDialog) AddCustomTab(child Widget, tabLabel Widget) {
	...
	arg0 = (*C.GtkPrintUnixDialog)(d.Native())
	arg1 = (*C.GtkWidget)(child.Native())
	arg2 = (*C.GtkWidget)(tabLabel.Native())
...
func (d printUnixDialog) CurrentPage() int {
	...
	ret := C.gtk_print_unix_dialog_get_current_page(arg0)
...
func (d printUnixDialog) EmbedPageSetup() bool {
	...
	ret := C.gtk_print_unix_dialog_get_embed_page_setup(arg0)
...
func (d printUnixDialog) HasSelection() bool {
	...
	ret := C.gtk_print_unix_dialog_get_has_selection(arg0)
...
func (d printUnixDialog) ManualCapabilities() PrintCapabilities {
	...
	ret := C.gtk_print_unix_dialog_get_manual_capabilities(arg0)

	var ret0 PrintCapabilities

	ret0 = PrintCapabilities(ret)
...
func (d printUnixDialog) PageSetup() PageSetup {
	...
	ret := C.gtk_print_unix_dialog_get_page_setup(arg0)
...
func (d printUnixDialog) PageSetupSet() bool {
	...
	ret := C.gtk_print_unix_dialog_get_page_setup_set(arg0)
...
func (d printUnixDialog) SelectedPrinter() Printer {
	...
	ret := C.gtk_print_unix_dialog_get_selected_printer(arg0)
...
func (d printUnixDialog) Settings() PrintSettings {
	...
	ret := C.gtk_print_unix_dialog_get_settings(arg0)
...
func (d printUnixDialog) SupportSelection() bool {
	...
	ret := C.gtk_print_unix_dialog_get_support_selection(arg0)
...
func (d printUnixDialog) SetSettings(settings PrintSettings) {
	...
	arg0 = (*C.GtkPrintUnixDialog)(d.Native())
	arg1 = (*C.GtkPrintSettings)(settings.Native())
...
func NewPrinter(name string, backend *PrintBackend, virtual_ bool) Printer {
	...
	arg1 = (*C.gchar)(C.CString(name))
	defer C.free(unsafe.Pointer(arg1))
	arg2 = (*C.GtkPrintBackend)(backend.Native())
	if virtual_ {
		arg3 = C.TRUE
	}

	ret := C.gtk_printer_new(arg1, arg2, arg3)

	var ret0 Printer

	ret0 = gextras.CastObject(externglib.AssumeOwnership(unsafe.Pointer(ret.Native()))).(Printer)
...
func (p printer) AcceptsPdf() bool {
	...
	arg0 = (*C.GtkPrinter)(p.Native())

	ret := C.gtk_printer_accepts_pdf(arg0)
...
func (p printer) AcceptsPs() bool {
	...
	ret := C.gtk_printer_accepts_ps(arg0)
...
func (a printer) Compare(b Printer) int {
	...
	arg0 = (*C.GtkPrinter)(a.Native())
	arg1 = (*C.GtkPrinter)(b.Native())

	ret := C.gtk_printer_compare(arg0, arg1)
...
func (p printer) Backend() *PrintBackend {
	...
	ret := C.gtk_printer_get_backend(arg0)

	var ret0 *PrintBackend

	{
		ret0 = WrapPrintBackend(unsafe.Pointer(ret))
	}
...
func (p printer) Capabilities() PrintCapabilities {
	...
	ret := C.gtk_printer_get_capabilities(arg0)
...
func (p printer) DefaultPageSize() PageSetup {
	...
	ret := C.gtk_printer_get_default_page_size(arg0)
...
func (p printer) Description() string {
	...
	ret := C.gtk_printer_get_description(arg0)
...
func (p printer) HardMargins() (top float64, bottom float64, left float64, right float64, ok bool) {
	...
	ret := C.gtk_printer_get_hard_margins(arg0, &arg1, &arg2, &arg3, &arg4)
...
func (p printer) HardMarginsForPaperSize(paperSize *PaperSize) (top float64, bottom float64, left float64, right float64, ok bool) {
	...
	ret := C.gtk_printer_get_hard_margins_for_paper_size(arg0, arg1, &arg2, &arg3, &arg4, &arg5)
...
func (p printer) IconName() string {
	...
	ret := C.gtk_printer_get_icon_name(arg0)
...
func (p printer) JobCount() int {
	...
	ret := C.gtk_printer_get_job_count(arg0)
...
func (p printer) Location() string {
	...
	ret := C.gtk_printer_get_location(arg0)
...
func (p printer) Name() string {
	...
	ret := C.gtk_printer_get_name(arg0)
...
func (p printer) StateMessage() string {
	...
	ret := C.gtk_printer_get_state_message(arg0)
...
func (p printer) HasDetails() bool {
	...
	ret := C.gtk_printer_has_details(arg0)
...
func (p printer) IsAcceptingJobs() bool {
	...
	ret := C.gtk_printer_is_accepting_jobs(arg0)
...
func (p printer) IsActive() bool {
	...
	ret := C.gtk_printer_is_active(arg0)
...
func (p printer) IsDefault() bool {
	...
	ret := C.gtk_printer_is_default(arg0)
...
func (p printer) IsPaused() bool {
	...
	ret := C.gtk_printer_is_paused(arg0)
...
func (p printer) IsVirtual() bool {
	...
	ret := C.gtk_printer_is_virtual(arg0)
...
func (p printer) ListPapers() *glib.List {
	...
	ret := C.gtk_printer_list_papers(arg0)
...
func (p progressBar) Ellipsize() pango.EllipsizeMode {
	...
	arg0 = (*C.GtkProgressBar)(p.Native())
...
func (s scrolledWindow) Child() Widget {
	...
	arg0 = (*C.GtkScrolledWindow)(s.Native())
...
func (e searchEntry) KeyCaptureWidget() Widget {
	...
	arg0 = (*C.GtkSearchEntry)(e.Native())
...
func (s stackSidebar) Stack() Stack {
	...
	arg0 = (*C.GtkStackSidebar)(s.Native())
...
func (s stackSwitcher) Stack() Stack {
	...
	arg0 = (*C.GtkStackSwitcher)(s.Native())
...
func (t textTagTable) Add(tag TextTag) bool {
	...
	arg0 = (*C.GtkTextTagTable)(t.Native())
...
func (s treeSelection) CountSelectedRows() int {
	...
	arg0 = (*C.GtkTreeSelection)(s.Native())
