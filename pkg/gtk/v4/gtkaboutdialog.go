...
func NewAboutDialog() *AboutDialog {
	...
	_gret := _info.InvokeClassMethod("new_AboutDialog", nil, nil)
...
func (about *AboutDialog) AddCreditSection(sectionName string, people []string) {
	...
	*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(sectionName)))
	defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	{
		*(***C.char)(unsafe.Pointer(&_args[2])) = (**C.char)(C.calloc(C.size_t((len(people) + 1)), C.size_t(unsafe.Sizeof(uint(0)))))
		defer C.free(unsafe.Pointer(*(***C.char)(unsafe.Pointer(&_args[2]))))
		{
			...
			out[len(people)] = zero
			for i := range people {
				*(**C.char)(unsafe.Pointer(&out[i])) = (*C.char)(unsafe.Pointer(C.CString(people[i])))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("add_credit_section", _args[:], nil)
...
func (about *AboutDialog) Artists() []string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_artists", _args[:], nil)
...
func (about *AboutDialog) Authors() []string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_authors", _args[:], nil)
	_cret := *(***C.char)(unsafe.Pointer(&_gret))
...
func (about *AboutDialog) Documenters() []string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_documenters", _args[:], nil)
	_cret := *(***C.char)(unsafe.Pointer(&_gret))
...
func (about *AboutDialog) Logo() *gdk.Paintable {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_logo", _args[:], nil)
	_cret := *(**C.void)(unsafe.Pointer(&_gret))
...
func (about *AboutDialog) SystemInformation() string {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_system_information", _args[:], nil)
	_cret := *(**C.char)(unsafe.Pointer(&_gret))
...
func (about *AboutDialog) WrapLicense() bool {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_gret := _info.InvokeClassMethod("get_wrap_license", _args[:], nil)
...
func (about *AboutDialog) SetArtists(artists []string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	{
		*(***C.char)(unsafe.Pointer(&_args[1])) = (**C.char)(C.calloc(C.size_t((len(artists) + 1)), C.size_t(unsafe.Sizeof(uint(0)))))
		defer C.free(unsafe.Pointer(*(***C.char)(unsafe.Pointer(&_args[1]))))
		{
			...
			for i := range artists {
				*(**C.char)(unsafe.Pointer(&out[i])) = (*C.char)(unsafe.Pointer(C.CString(artists[i])))
				defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&out[i]))))
			}
		}
	}
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_artists", _args[:], nil)
...
func (about *AboutDialog) SetAuthors(authors []string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	{
		*(***C.char)(unsafe.Pointer(&_args[1])) = (**C.char)(C.calloc(C.size_t((len(authors) + 1)), C.size_t(unsafe.Sizeof(uint(0)))))
		defer C.free(unsafe.Pointer(*(***C.char)(unsafe.Pointer(&_args[1]))))
		{
			...
			for i := range authors {
				*(**C.char)(unsafe.Pointer(&out[i])) = (*C.char)(unsafe.Pointer(C.CString(authors[i])))
				defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&out[i]))))
			}
		}
	}
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_authors", _args[:], nil)
...
func (about *AboutDialog) SetComments(comments string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if comments != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(comments)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_comments", _args[:], nil)
...
func (about *AboutDialog) SetCopyright(copyright string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if copyright != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(copyright)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_copyright", _args[:], nil)
...
func (about *AboutDialog) SetDocumenters(documenters []string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	{
		*(***C.char)(unsafe.Pointer(&_args[1])) = (**C.char)(C.calloc(C.size_t((len(documenters) + 1)), C.size_t(unsafe.Sizeof(uint(0)))))
		defer C.free(unsafe.Pointer(*(***C.char)(unsafe.Pointer(&_args[1]))))
		{
			...
			for i := range documenters {
				*(**C.char)(unsafe.Pointer(&out[i])) = (*C.char)(unsafe.Pointer(C.CString(documenters[i])))
				defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&out[i]))))
			}
		}
	}
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_documenters", _args[:], nil)
...
func (about *AboutDialog) SetLicense(license string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if license != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(license)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_license", _args[:], nil)
...
func (about *AboutDialog) SetLogo(logo gdk.Paintabler) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_logo", _args[:], nil)
...
func (about *AboutDialog) SetLogoIconName(iconName string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_logo_icon_name", _args[:], nil)
...
func (about *AboutDialog) SetSystemInformation(systemInformation string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if systemInformation != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(systemInformation)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_system_information", _args[:], nil)
...
func (about *AboutDialog) SetTranslatorCredits(translatorCredits string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if translatorCredits != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(translatorCredits)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_translator_credits", _args[:], nil)
...
func (about *AboutDialog) SetVersion(version string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if version != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(version)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_version", _args[:], nil)
...
func (about *AboutDialog) SetWebsite(website string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	if website != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(website)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}

	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_website", _args[:], nil)
...
func (about *AboutDialog) SetWebsiteLabel(websiteLabel string) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(websiteLabel)))
	defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
...
func (about *AboutDialog) SetWrapLicense(wrapLicense bool) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(unsafe.Pointer(coreglib.InternObject(about).Native()))
	...
	_info := girepository.MustFind("Gtk", "AboutDialog")
	_info.InvokeClassMethod("set_wrap_license", _args[:], nil)
