...
func (w actionable) ActionSetEnabled(actionName string, enabled bool) {
...
func (w actionable) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w actionable) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w actionable) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w actionable) AddCSSClass(cssClass string) {
...
func (w actionable) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w actionable) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w actionable) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w actionable) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w actionable) Contains(x float64, y float64) bool {
...
func (w actionable) GetCanTarget() bool {
...
func (w actionable) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w actionable) GetFocusChild() Widget {
...
func (w actionable) GetFocusable() bool {
...
func (w actionable) GetHeight() int {
...
func (w actionable) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w actionable) GetLayoutManager() LayoutManager {
...
func (w actionable) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w actionable) GetNextSibling() Widget {
...
func (w actionable) GetOverflow() Overflow {
...
func (w actionable) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w actionable) GetPrimaryClipboard() gdk.Clipboard {
...
func (w actionable) GetRoot() Root {
...
func (w actionable) GetSize(orientation Orientation) int {
...
func (w actionable) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w actionable) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w actionable) HasCSSClass(cssClass string) bool {
...
func (w actionable) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w actionable) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w actionable) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w actionable) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w actionable) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w actionable) RemoveCSSClass(cssClass string) {
...
func (w actionable) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w actionable) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w actionable) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w actionable) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w actionable) SetCursorFromName(name string) {
...
func (w actionable) SetFocusChild(child Widget) {
...
func (w actionable) SetFocusable(focusable bool) {
...
func (w actionable) SetLayoutManager(layoutManager LayoutManager) {
...
func (w actionable) SetOverflow(overflow Overflow) {
...
func (w actionable) ShouldLayout() bool {
...
func (w actionable) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s actionable) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s actionable) GetAccessibleRole() AccessibleRole {
	return WrapAccessible(gextras.InternObject(s)).GetAccessibleRole()
}

func (s actionable) ResetProperty(property AccessibleProperty) {
	WrapAccessible(gextras.InternObject(s)).ResetProperty(property)
}

func (s actionable) ResetRelation(relation AccessibleRelation) {
	WrapAccessible(gextras.InternObject(s)).ResetRelation(relation)
}

func (s actionable) ResetState(state AccessibleState) {
	WrapAccessible(gextras.InternObject(s)).ResetState(state)
}

func (s actionable) UpdatePropertyValue(properties []AccessibleProperty, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdatePropertyValue(properties, values)
}

func (s actionable) UpdateRelationValue(relations []AccessibleRelation, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateRelationValue(relations, values)
}

func (s actionable) UpdateStateValue(states []AccessibleState, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateStateValue(states, values)
}

func (b actionable) GetBuildableID() string {
