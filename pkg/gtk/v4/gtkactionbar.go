...
func (a actionBar) AsWidget() Widget {
...
func (w actionBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w actionBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w actionBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w actionBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w actionBar) AddCSSClass(cssClass string) {
...
func (w actionBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w actionBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w actionBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w actionBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w actionBar) Contains(x float64, y float64) bool {
...
func (w actionBar) GetCanTarget() bool {
...
func (w actionBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w actionBar) GetFocusChild() Widget {
...
func (w actionBar) GetFocusable() bool {
...
func (w actionBar) GetHeight() int {
...
func (w actionBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w actionBar) GetLayoutManager() LayoutManager {
...
func (w actionBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w actionBar) GetNextSibling() Widget {
...
func (w actionBar) GetOverflow() Overflow {
...
func (w actionBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w actionBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w actionBar) GetSize(orientation Orientation) int {
...
func (w actionBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w actionBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w actionBar) HasCSSClass(cssClass string) bool {
...
func (w actionBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w actionBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w actionBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w actionBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w actionBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w actionBar) RemoveCSSClass(cssClass string) {
...
func (w actionBar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w actionBar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w actionBar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w actionBar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w actionBar) SetCursorFromName(name string) {
...
func (w actionBar) SetFocusChild(child Widget) {
...
func (w actionBar) SetFocusable(focusable bool) {
...
func (w actionBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w actionBar) SetOverflow(overflow Overflow) {
...
func (w actionBar) ShouldLayout() bool {
...
func (w actionBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s actionBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s actionBar) GetAccessibleRole() AccessibleRole {
...
func (b actionBar) GetBuildableID() string {
