...
func (w appChooser) ActionSetEnabled(actionName string, enabled bool) {
...
func (w appChooser) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w appChooser) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w appChooser) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w appChooser) AddCSSClass(cssClass string) {
...
func (w appChooser) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w appChooser) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w appChooser) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w appChooser) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w appChooser) Contains(x float64, y float64) bool {
...
func (w appChooser) GetCanTarget() bool {
...
func (w appChooser) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w appChooser) GetFocusChild() Widget {
...
func (w appChooser) GetFocusable() bool {
...
func (w appChooser) GetHeight() int {
...
func (w appChooser) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w appChooser) GetLayoutManager() LayoutManager {
...
func (w appChooser) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w appChooser) GetNextSibling() Widget {
...
func (w appChooser) GetOverflow() Overflow {
...
func (w appChooser) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w appChooser) GetPrimaryClipboard() gdk.Clipboard {
...
func (w appChooser) GetRoot() Root {
...
func (w appChooser) GetSize(orientation Orientation) int {
...
func (w appChooser) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w appChooser) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w appChooser) HasCSSClass(cssClass string) bool {
...
func (w appChooser) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w appChooser) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w appChooser) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w appChooser) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w appChooser) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w appChooser) RemoveCSSClass(cssClass string) {
...
func (w appChooser) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w appChooser) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w appChooser) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w appChooser) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w appChooser) SetCursorFromName(name string) {
...
func (w appChooser) SetFocusChild(child Widget) {
...
func (w appChooser) SetFocusable(focusable bool) {
...
func (w appChooser) SetLayoutManager(layoutManager LayoutManager) {
...
func (w appChooser) SetOverflow(overflow Overflow) {
...
func (w appChooser) ShouldLayout() bool {
...
func (w appChooser) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s appChooser) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s appChooser) GetAccessibleRole() AccessibleRole {
	return WrapAccessible(gextras.InternObject(s)).GetAccessibleRole()
}

func (s appChooser) ResetProperty(property AccessibleProperty) {
	WrapAccessible(gextras.InternObject(s)).ResetProperty(property)
}

func (s appChooser) ResetRelation(relation AccessibleRelation) {
	WrapAccessible(gextras.InternObject(s)).ResetRelation(relation)
}

func (s appChooser) ResetState(state AccessibleState) {
	WrapAccessible(gextras.InternObject(s)).ResetState(state)
}

func (s appChooser) UpdatePropertyValue(properties []AccessibleProperty, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdatePropertyValue(properties, values)
}

func (s appChooser) UpdateRelationValue(relations []AccessibleRelation, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateRelationValue(relations, values)
}

func (s appChooser) UpdateStateValue(states []AccessibleState, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateStateValue(states, values)
}

func (b appChooser) GetBuildableID() string {
