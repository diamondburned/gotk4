...
func (a appChooserWidget) AsWidget() Widget {
...
func (w appChooserWidget) ActionSetEnabled(actionName string, enabled bool) {
...
func (w appChooserWidget) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w appChooserWidget) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w appChooserWidget) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w appChooserWidget) AddCSSClass(cssClass string) {
...
func (w appChooserWidget) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w appChooserWidget) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w appChooserWidget) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w appChooserWidget) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w appChooserWidget) Contains(x float64, y float64) bool {
...
func (w appChooserWidget) GetCanTarget() bool {
...
func (w appChooserWidget) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w appChooserWidget) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s appChooserWidget) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w appChooserWidget) GetCursor() gdk.Cursor {
...
func (w appChooserWidget) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w appChooserWidget) GetFocusChild() Widget {
...
func (w appChooserWidget) GetFocusable() bool {
...
func (w appChooserWidget) GetHeight() int {
...
func (w appChooserWidget) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w appChooserWidget) GetLayoutManager() LayoutManager {
...
func (w appChooserWidget) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w appChooserWidget) GetNextSibling() Widget {
...
func (w appChooserWidget) GetOverflow() Overflow {
...
func (w appChooserWidget) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w appChooserWidget) GetPrimaryClipboard() gdk.Clipboard {
...
func (w appChooserWidget) GetRoot() Root {
...
func (w appChooserWidget) GetSize(orientation Orientation) int {
...
func (w appChooserWidget) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w appChooserWidget) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w appChooserWidget) HasCSSClass(cssClass string) bool {
...
func (w appChooserWidget) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w appChooserWidget) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w appChooserWidget) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w appChooserWidget) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w appChooserWidget) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w appChooserWidget) RemoveCSSClass(cssClass string) {
...
func (w appChooserWidget) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w appChooserWidget) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w appChooserWidget) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w appChooserWidget) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w appChooserWidget) SetCursorFromName(name string) {
...
func (w appChooserWidget) SetFocusChild(child Widget) {
...
func (w appChooserWidget) SetFocusable(focusable bool) {
...
func (w appChooserWidget) SetLayoutManager(layoutManager LayoutManager) {
...
func (w appChooserWidget) SetOverflow(overflow Overflow) {
...
func (w appChooserWidget) ShouldLayout() bool {
...
func (w appChooserWidget) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s appChooserWidget) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s appChooserWidget) GetAccessibleRole() AccessibleRole {
...
func (b appChooserWidget) GetBuildableID() string {
