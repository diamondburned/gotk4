...
func (a aspectFrame) AsWidget() Widget {
...
func (w aspectFrame) ActionSetEnabled(actionName string, enabled bool) {
...
func (w aspectFrame) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w aspectFrame) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w aspectFrame) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w aspectFrame) AddCSSClass(cssClass string) {
...
func (w aspectFrame) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w aspectFrame) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w aspectFrame) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w aspectFrame) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w aspectFrame) Contains(x float64, y float64) bool {
...
func (w aspectFrame) GetCanTarget() bool {
...
func (w aspectFrame) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w aspectFrame) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s aspectFrame) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w aspectFrame) GetCursor() gdk.Cursor {
...
func (w aspectFrame) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w aspectFrame) GetFocusChild() Widget {
...
func (w aspectFrame) GetFocusable() bool {
...
func (w aspectFrame) GetHeight() int {
...
func (w aspectFrame) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w aspectFrame) GetLayoutManager() LayoutManager {
...
func (w aspectFrame) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w aspectFrame) GetNextSibling() Widget {
...
func (w aspectFrame) GetOverflow() Overflow {
...
func (w aspectFrame) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w aspectFrame) GetPrimaryClipboard() gdk.Clipboard {
...
func (w aspectFrame) GetRoot() Root {
...
func (w aspectFrame) GetSize(orientation Orientation) int {
...
func (w aspectFrame) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w aspectFrame) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w aspectFrame) HasCSSClass(cssClass string) bool {
...
func (w aspectFrame) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w aspectFrame) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w aspectFrame) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w aspectFrame) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w aspectFrame) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w aspectFrame) RemoveCSSClass(cssClass string) {
...
func (w aspectFrame) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w aspectFrame) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w aspectFrame) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w aspectFrame) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w aspectFrame) SetCursorFromName(name string) {
...
func (w aspectFrame) SetFocusChild(child Widget) {
...
func (w aspectFrame) SetFocusable(focusable bool) {
...
func (w aspectFrame) SetLayoutManager(layoutManager LayoutManager) {
...
func (w aspectFrame) SetOverflow(overflow Overflow) {
...
func (w aspectFrame) ShouldLayout() bool {
...
func (w aspectFrame) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s aspectFrame) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s aspectFrame) GetAccessibleRole() AccessibleRole {
...
func (b aspectFrame) GetBuildableID() string {
