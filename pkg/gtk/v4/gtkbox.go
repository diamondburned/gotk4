...
func (w box) ActionSetEnabled(actionName string, enabled bool) {
...
func (w box) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w box) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w box) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w box) AddCSSClass(cssClass string) {
...
func (w box) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w box) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w box) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w box) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w box) Contains(x float64, y float64) bool {
...
func (w box) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w box) GetFocusChild() Widget {
...
func (w box) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w box) GetLayoutManager() LayoutManager {
...
func (w box) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w box) GetNextSibling() Widget {
...
func (w box) GetOverflow() Overflow {
...
func (w box) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w box) GetPrimaryClipboard() gdk.Clipboard {
...
func (w box) GetSize(orientation Orientation) int {
...
func (w box) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w box) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w box) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w box) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w box) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w box) RemoveCSSClass(cssClass string) {
...
func (w box) SetFocusChild(child Widget) {
...
func (w box) SetFocusable(focusable bool) {
...
func (w box) SetLayoutManager(layoutManager LayoutManager) {
...
func (w box) SetOverflow(overflow Overflow) {
...
func (w box) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s box) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s box) GetAccessibleRole() AccessibleRole {
...
func (b box) GetBuildableID() string {
