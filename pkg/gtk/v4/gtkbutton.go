...
func (b button) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(b))
}
...
func (w button) ActionSetEnabled(actionName string, enabled bool) {
...
func (w button) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w button) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w button) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w button) AddCSSClass(cssClass string) {
...
func (w button) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w button) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w button) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w button) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w button) Contains(x float64, y float64) bool {
...
func (w button) GetCanTarget() bool {
...
func (w button) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w button) GetFocusChild() Widget {
...
func (w button) GetFocusable() bool {
...
func (w button) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w button) GetLayoutManager() LayoutManager {
...
func (w button) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w button) GetNextSibling() Widget {
...
func (w button) GetOverflow() Overflow {
...
func (w button) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w button) GetPrimaryClipboard() gdk.Clipboard {
...
func (w button) GetSize(orientation Orientation) int {
...
func (w button) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w button) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w button) HasCSSClass(cssClass string) bool {
...
func (w button) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w button) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w button) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w button) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w button) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w button) RemoveCSSClass(cssClass string) {
...
func (w button) SetFocusChild(child Widget) {
...
func (w button) SetFocusable(focusable bool) {
...
func (w button) SetLayoutManager(layoutManager LayoutManager) {
...
func (w button) SetOverflow(overflow Overflow) {
...
func (w button) ShouldLayout() bool {
...
func (w button) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s button) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s button) GetAccessibleRole() AccessibleRole {
...
func (b button) GetBuildableID() string {
