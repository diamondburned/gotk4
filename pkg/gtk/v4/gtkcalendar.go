...
func (w calendar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w calendar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w calendar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w calendar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w calendar) AddCSSClass(cssClass string) {
...
func (w calendar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w calendar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w calendar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w calendar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w calendar) Contains(x float64, y float64) bool {
...
func (w calendar) GetCanTarget() bool {
...
func (w calendar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w calendar) GetFocusChild() Widget {
...
func (w calendar) GetFocusable() bool {
...
func (w calendar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w calendar) GetLayoutManager() LayoutManager {
...
func (w calendar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w calendar) GetNextSibling() Widget {
...
func (w calendar) GetOverflow() Overflow {
...
func (w calendar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w calendar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w calendar) GetSize(orientation Orientation) int {
...
func (w calendar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w calendar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w calendar) HasCSSClass(cssClass string) bool {
...
func (w calendar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w calendar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w calendar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w calendar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w calendar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w calendar) RemoveCSSClass(cssClass string) {
...
func (w calendar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w calendar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w calendar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w calendar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w calendar) SetCursorFromName(name string) {
...
func (w calendar) SetFocusChild(child Widget) {
...
func (w calendar) SetFocusable(focusable bool) {
...
func (w calendar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w calendar) SetOverflow(overflow Overflow) {
...
func (w calendar) ShouldLayout() bool {
...
func (w calendar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s calendar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s calendar) GetAccessibleRole() AccessibleRole {
...
func (b calendar) GetBuildableID() string {
