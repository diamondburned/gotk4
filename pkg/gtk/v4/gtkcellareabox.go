...
func (a cellAreaBox) ActivateCell(widget Widget, renderer CellRenderer, event gdk.Event, cellArea *gdk.Rectangle, flags CellRendererState) bool {
	return WrapCellArea(gextras.InternObject(a)).ActivateCell(widget, renderer, event, cellArea, flags)
}
...
func (a cellAreaBox) Event(context CellAreaContext, widget Widget, event gdk.Event, cellArea *gdk.Rectangle, flags CellRendererState) int {
	return WrapCellArea(gextras.InternObject(a)).Event(context, widget, event, cellArea, flags)
}
...
func (a cellAreaBox) Snapshot(context CellAreaContext, widget Widget, snapshot Snapshot, backgroundArea *gdk.Rectangle, cellArea *gdk.Rectangle, flags CellRendererState, paintFocus bool) {
	WrapCellArea(gextras.InternObject(a)).Snapshot(context, widget, snapshot, backgroundArea, cellArea, flags, paintFocus)
}
...
func (b cellAreaBox) GetBuildableID() string {
