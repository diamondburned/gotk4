...
func (w cellEditable) ActionSetEnabled(actionName string, enabled bool) {
...
func (w cellEditable) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w cellEditable) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w cellEditable) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w cellEditable) AddCSSClass(cssClass string) {
...
func (w cellEditable) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w cellEditable) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w cellEditable) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w cellEditable) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w cellEditable) Contains(x float64, y float64) bool {
...
func (w cellEditable) GetCanTarget() bool {
...
func (w cellEditable) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w cellEditable) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s cellEditable) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w cellEditable) GetCursor() gdk.Cursor {
...
func (w cellEditable) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w cellEditable) GetFocusChild() Widget {
...
func (w cellEditable) GetFocusable() bool {
...
func (w cellEditable) GetHeight() int {
...
func (w cellEditable) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w cellEditable) GetLayoutManager() LayoutManager {
...
func (w cellEditable) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w cellEditable) GetNextSibling() Widget {
...
func (w cellEditable) GetOverflow() Overflow {
...
func (w cellEditable) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w cellEditable) GetPrimaryClipboard() gdk.Clipboard {
...
func (w cellEditable) GetRoot() Root {
...
func (w cellEditable) GetSize(orientation Orientation) int {
...
func (w cellEditable) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w cellEditable) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w cellEditable) HasCSSClass(cssClass string) bool {
...
func (w cellEditable) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w cellEditable) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w cellEditable) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w cellEditable) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w cellEditable) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w cellEditable) RemoveCSSClass(cssClass string) {
...
func (w cellEditable) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w cellEditable) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w cellEditable) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w cellEditable) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w cellEditable) SetCursorFromName(name string) {
...
func (w cellEditable) SetFocusChild(child Widget) {
...
func (w cellEditable) SetFocusable(focusable bool) {
...
func (w cellEditable) SetLayoutManager(layoutManager LayoutManager) {
...
func (w cellEditable) SetOverflow(overflow Overflow) {
...
func (w cellEditable) ShouldLayout() bool {
...
func (w cellEditable) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s cellEditable) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s cellEditable) GetAccessibleRole() AccessibleRole {
	return WrapAccessible(gextras.InternObject(s)).GetAccessibleRole()
}

func (s cellEditable) ResetProperty(property AccessibleProperty) {
	WrapAccessible(gextras.InternObject(s)).ResetProperty(property)
}

func (s cellEditable) ResetRelation(relation AccessibleRelation) {
	WrapAccessible(gextras.InternObject(s)).ResetRelation(relation)
}

func (s cellEditable) ResetState(state AccessibleState) {
	WrapAccessible(gextras.InternObject(s)).ResetState(state)
}

func (s cellEditable) UpdatePropertyValue(properties []AccessibleProperty, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdatePropertyValue(properties, values)
}

func (s cellEditable) UpdateRelationValue(relations []AccessibleRelation, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateRelationValue(relations, values)
}

func (s cellEditable) UpdateStateValue(states []AccessibleState, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateStateValue(states, values)
}

func (b cellEditable) GetBuildableID() string {
