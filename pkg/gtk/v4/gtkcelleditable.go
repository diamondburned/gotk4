...
func ifaceInitCellEditabler(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("editing_done"))) = unsafe.Pointer(C._gotk4_gtk4_CellEditableIface_editing_done)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("remove_widget"))) = unsafe.Pointer(C._gotk4_gtk4_CellEditableIface_remove_widget)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), iface.StructFieldOffset("start_editing"))) = unsafe.Pointer(C._gotk4_gtk4_CellEditableIface_start_editing)
}
