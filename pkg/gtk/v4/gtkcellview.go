...
func (w cellView) ActionSetEnabled(actionName string, enabled bool) {
...
func (w cellView) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w cellView) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w cellView) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w cellView) AddCSSClass(cssClass string) {
...
func (w cellView) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w cellView) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w cellView) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w cellView) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w cellView) Contains(x float64, y float64) bool {
...
func (w cellView) GetCanTarget() bool {
...
func (w cellView) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w cellView) GetFocusChild() Widget {
...
func (w cellView) GetFocusable() bool {
...
func (w cellView) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w cellView) GetLayoutManager() LayoutManager {
...
func (w cellView) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w cellView) GetNextSibling() Widget {
...
func (w cellView) GetOverflow() Overflow {
...
func (w cellView) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w cellView) GetPrimaryClipboard() gdk.Clipboard {
...
func (w cellView) GetSize(orientation Orientation) int {
...
func (w cellView) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w cellView) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w cellView) HasCSSClass(cssClass string) bool {
...
func (w cellView) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w cellView) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w cellView) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w cellView) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w cellView) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w cellView) RemoveCSSClass(cssClass string) {
...
func (w cellView) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w cellView) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w cellView) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w cellView) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w cellView) SetCursorFromName(name string) {
...
func (w cellView) SetFocusChild(child Widget) {
...
func (w cellView) SetFocusable(focusable bool) {
...
func (w cellView) SetLayoutManager(layoutManager LayoutManager) {
...
func (w cellView) SetOverflow(overflow Overflow) {
...
func (w cellView) ShouldLayout() bool {
...
func (w cellView) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s cellView) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s cellView) GetAccessibleRole() AccessibleRole {
...
func (b cellView) GetBuildableID() string {
