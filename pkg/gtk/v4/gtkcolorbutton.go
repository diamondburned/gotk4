...
func (c colorButton) AsWidget() Widget {
...
func (w colorButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w colorButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w colorButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w colorButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w colorButton) AddCSSClass(cssClass string) {
...
func (w colorButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w colorButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w colorButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w colorButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w colorButton) Contains(x float64, y float64) bool {
...
func (w colorButton) GetCanTarget() bool {
...
func (w colorButton) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w colorButton) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s colorButton) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w colorButton) GetCursor() gdk.Cursor {
...
func (w colorButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w colorButton) GetFocusChild() Widget {
...
func (w colorButton) GetFocusable() bool {
...
func (w colorButton) GetHeight() int {
...
func (w colorButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w colorButton) GetLayoutManager() LayoutManager {
...
func (w colorButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w colorButton) GetNextSibling() Widget {
...
func (w colorButton) GetOverflow() Overflow {
...
func (w colorButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w colorButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w colorButton) GetRoot() Root {
...
func (w colorButton) GetSize(orientation Orientation) int {
...
func (w colorButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w colorButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w colorButton) HasCSSClass(cssClass string) bool {
...
func (w colorButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w colorButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w colorButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w colorButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w colorButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w colorButton) RemoveCSSClass(cssClass string) {
...
func (w colorButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w colorButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w colorButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w colorButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w colorButton) SetCursorFromName(name string) {
...
func (w colorButton) SetFocusChild(child Widget) {
...
func (w colorButton) SetFocusable(focusable bool) {
...
func (w colorButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w colorButton) SetOverflow(overflow Overflow) {
...
func (w colorButton) ShouldLayout() bool {
...
func (w colorButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s colorButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s colorButton) GetAccessibleRole() AccessibleRole {
...
func (b colorButton) GetBuildableID() string {
