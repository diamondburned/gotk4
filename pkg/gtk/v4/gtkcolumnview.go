...
// WrapColumnView wraps a GObject to a type that implements
// interface ColumnView. It is primarily used internally.
func WrapColumnView(obj *externglib.Object) ColumnView {
	return columnView{obj}
}
...
func (c columnView) AsWidget() Widget {
...
func (b columnView) GetBuildableID() string {
