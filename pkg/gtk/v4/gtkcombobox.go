...
func (c comboBox) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(c))
}

func (c comboBox) AsAccessible() Accessible {
...
func (c comboBox) AsConstraintTarget() ConstraintTarget {
	return WrapConstraintTarget(gextras.InternObject(c))
}

func (w comboBox) ActionSetEnabled(actionName string, enabled bool) {
...
func (w comboBox) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w comboBox) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w comboBox) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w comboBox) AddCSSClass(cssClass string) {
...
func (w comboBox) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w comboBox) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w comboBox) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w comboBox) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w comboBox) Contains(x float64, y float64) bool {
...
func (w comboBox) GetCanTarget() bool {
...
func (w comboBox) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w comboBox) GetFocusChild() Widget {
...
func (w comboBox) GetFocusable() bool {
...
func (w comboBox) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w comboBox) GetLayoutManager() LayoutManager {
...
func (w comboBox) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w comboBox) GetNextSibling() Widget {
...
func (w comboBox) GetOverflow() Overflow {
...
func (w comboBox) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w comboBox) GetPrimaryClipboard() gdk.Clipboard {
...
func (w comboBox) GetSize(orientation Orientation) int {
...
func (w comboBox) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w comboBox) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w comboBox) HasCSSClass(cssClass string) bool {
...
func (w comboBox) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w comboBox) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w comboBox) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w comboBox) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w comboBox) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w comboBox) RemoveCSSClass(cssClass string) {
...
func (w comboBox) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w comboBox) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w comboBox) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w comboBox) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w comboBox) SetCursorFromName(name string) {
...
func (w comboBox) SetFocusChild(child Widget) {
...
func (w comboBox) SetFocusable(focusable bool) {
...
func (w comboBox) SetLayoutManager(layoutManager LayoutManager) {
...
func (w comboBox) SetOverflow(overflow Overflow) {
...
func (w comboBox) ShouldLayout() bool {
...
func (w comboBox) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s comboBox) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s comboBox) GetAccessibleRole() AccessibleRole {
...
func (b comboBox) GetBuildableID() string {
