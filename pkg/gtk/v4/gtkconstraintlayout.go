...
func NewConstraintLayout() *ConstraintLayoutClass {
	...
	_constraintLayout = gextras.CastObject(
		externglib.AssumeOwnership(unsafe.Pointer(_cret))).(*ConstraintLayoutClass)
...
func (l *ConstraintLayoutClass) AddConstraint(constraint Constraint) {
	...
	_arg0 = (*C.GtkConstraintLayout)(unsafe.Pointer((&ConstraintLayout).Native()))
...
func (l *ConstraintLayoutClass) AddGuide(guide ConstraintGuide) {
	...
	_arg0 = (*C.GtkConstraintLayout)(unsafe.Pointer((&ConstraintLayout).Native()))
	_arg1 = (*C.GtkConstraintGuide)(unsafe.Pointer((&ConstraintGuide).Native()))
