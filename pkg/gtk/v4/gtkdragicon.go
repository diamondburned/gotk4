...
// WrapDragIcon wraps a GObject to a type that implements
// interface DragIcon. It is primarily used internally.
...
func (d dragIcon) AsWidget() Widget {
...
func (b dragIcon) GetBuildableID() string {
...
func (s dragIcon) GetRenderer() gsk.Renderer {
	return WrapNative(gextras.InternObject(s)).GetRenderer()
}

func (s dragIcon) GetSurface() gdk.Surface {
	return WrapNative(gextras.InternObject(s)).GetSurface()
}

func (s dragIcon) GetSurfaceTransform() (x float64, y float64) {
...
func (s dragIcon) GetDisplay() gdk.Display {
	return WrapRoot(gextras.InternObject(s)).GetDisplay()
}

func (s dragIcon) GetFocus() Widget {
