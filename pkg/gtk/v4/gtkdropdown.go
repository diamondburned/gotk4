...
// WrapDropDown wraps a GObject to a type that implements
// interface DropDown. It is primarily used internally.
...
func (d dropDown) AsWidget() Widget {
...
func (b dropDown) GetBuildableID() string {
