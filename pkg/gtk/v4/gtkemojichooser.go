...
type EmojiChooser interface {
	...
	// This method is inherited from Popover
	GetChild() Widget
	// GetHasArrow gets whether this popover is showing an arrow pointing at the
	// widget that it is relative to.
	//
	// This method is inherited from Popover
	GetHasArrow() bool
	// GetMnemonicsVisible gets whether mnemonics are visible.
	//
	// This method is inherited from Popover
	...
	//
	// This method is inherited from Popover
	GetOffset() (xOffset int, yOffset int)
	// GetPointingTo gets the rectangle that the popover points to.
	//
...
// WrapEmojiChooser wraps a GObject to a type that implements
// interface EmojiChooser. It is primarily used internally.
func WrapEmojiChooser(obj *externglib.Object) EmojiChooser {
	return emojiChooser{obj}
}
...
func (e emojiChooser) AsPopover() Popover {
	return WrapPopover(gextras.InternObject(e))
}
...
func (p emojiChooser) GetAutohide() bool {
	return WrapPopover(gextras.InternObject(p)).GetAutohide()
}

func (p emojiChooser) GetCascadePopdown() bool {
	return WrapPopover(gextras.InternObject(p)).GetCascadePopdown()
}

func (p emojiChooser) GetChild() Widget {
	return WrapPopover(gextras.InternObject(p)).GetChild()
}

func (p emojiChooser) GetHasArrow() bool {
	return WrapPopover(gextras.InternObject(p)).GetHasArrow()
}

func (p emojiChooser) GetMnemonicsVisible() bool {
	return WrapPopover(gextras.InternObject(p)).GetMnemonicsVisible()
}

func (p emojiChooser) GetOffset() (xOffset int, yOffset int) {
	return WrapPopover(gextras.InternObject(p)).GetOffset()
}

func (p emojiChooser) GetPointingTo() (gdk.Rectangle, bool) {
	return WrapPopover(gextras.InternObject(p)).GetPointingTo()
}

func (p emojiChooser) GetPosition() PositionType {
	return WrapPopover(gextras.InternObject(p)).GetPosition()
}

func (p emojiChooser) Popdown() {
	WrapPopover(gextras.InternObject(p)).Popdown()
}

func (p emojiChooser) Popup() {
	WrapPopover(gextras.InternObject(p)).Popup()
}

func (p emojiChooser) Present() {
	WrapPopover(gextras.InternObject(p)).Present()
}

func (p emojiChooser) SetAutohide(autohide bool) {
	WrapPopover(gextras.InternObject(p)).SetAutohide(autohide)
}

func (p emojiChooser) SetCascadePopdown(cascadePopdown bool) {
	WrapPopover(gextras.InternObject(p)).SetCascadePopdown(cascadePopdown)
}

func (p emojiChooser) SetChild(child Widget) {
	WrapPopover(gextras.InternObject(p)).SetChild(child)
}

func (p emojiChooser) SetDefaultWidget(widget Widget) {
	WrapPopover(gextras.InternObject(p)).SetDefaultWidget(widget)
}

func (p emojiChooser) SetHasArrow(hasArrow bool) {
	WrapPopover(gextras.InternObject(p)).SetHasArrow(hasArrow)
}

func (p emojiChooser) SetMnemonicsVisible(mnemonicsVisible bool) {
	WrapPopover(gextras.InternObject(p)).SetMnemonicsVisible(mnemonicsVisible)
}

func (p emojiChooser) SetOffset(xOffset int, yOffset int) {
	WrapPopover(gextras.InternObject(p)).SetOffset(xOffset, yOffset)
}

func (p emojiChooser) SetPointingTo(rect *gdk.Rectangle) {
	WrapPopover(gextras.InternObject(p)).SetPointingTo(rect)
}

func (p emojiChooser) SetPosition(position PositionType) {
	WrapPopover(gextras.InternObject(p)).SetPosition(position)
}

func (w emojiChooser) ActionSetEnabled(actionName string, enabled bool) {
	WrapWidget(gextras.InternObject(w)).ActionSetEnabled(actionName, enabled)
}

func (w emojiChooser) Activate() bool {
	return WrapWidget(gextras.InternObject(w)).Activate()
}

func (w emojiChooser) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w emojiChooser) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w emojiChooser) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w emojiChooser) AddCSSClass(cssClass string) {
	WrapWidget(gextras.InternObject(w)).AddCSSClass(cssClass)
}

func (w emojiChooser) AddMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).AddMnemonicLabel(label)
}

func (w emojiChooser) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
	WrapWidget(gextras.InternObject(w)).Allocate(width, height, baseline, transform)
}

func (w emojiChooser) ChildFocus(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).ChildFocus(direction)
}

func (w emojiChooser) ComputeBounds(target Widget) (graphene.Rect, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeBounds(target)
}

func (w emojiChooser) ComputeExpand(orientation Orientation) bool {
	return WrapWidget(gextras.InternObject(w)).ComputeExpand(orientation)
}

func (w emojiChooser) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w emojiChooser) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w emojiChooser) Contains(x float64, y float64) bool {
	return WrapWidget(gextras.InternObject(w)).Contains(x, y)
}

func (w emojiChooser) CreatePangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).CreatePangoContext()
}

func (w emojiChooser) CreatePangoLayout(text string) pango.Layout {
	return WrapWidget(gextras.InternObject(w)).CreatePangoLayout(text)
}

func (w emojiChooser) DragCheckThreshold(startX int, startY int, currentX int, currentY int) bool {
	return WrapWidget(gextras.InternObject(w)).DragCheckThreshold(startX, startY, currentX, currentY)
}

func (w emojiChooser) ErrorBell() {
	WrapWidget(gextras.InternObject(w)).ErrorBell()
}

func (w emojiChooser) GetAllocatedBaseline() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedBaseline()
}

func (w emojiChooser) GetAllocatedHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedHeight()
}

func (w emojiChooser) GetAllocatedWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetAllocatedWidth()
}

func (w emojiChooser) GetAncestor(widgetType externglib.Type) Widget {
	return WrapWidget(gextras.InternObject(w)).GetAncestor(widgetType)
}

func (w emojiChooser) GetCanFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanFocus()
}

func (w emojiChooser) GetCanTarget() bool {
	return WrapWidget(gextras.InternObject(w)).GetCanTarget()
}

func (w emojiChooser) GetChildVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetChildVisible()
}

func (w emojiChooser) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w emojiChooser) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s emojiChooser) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w emojiChooser) GetCursor() gdk.Cursor {
	return WrapWidget(gextras.InternObject(w)).GetCursor()
}

func (w emojiChooser) GetDirection() TextDirection {
	return WrapWidget(gextras.InternObject(w)).GetDirection()
}

func (w emojiChooser) GetDisplay() gdk.Display {
	return WrapWidget(gextras.InternObject(w)).GetDisplay()
}

func (w emojiChooser) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w emojiChooser) GetFocusChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFocusChild()
}

func (w emojiChooser) GetFocusOnClick() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusOnClick()
}

func (w emojiChooser) GetFocusable() bool {
	return WrapWidget(gextras.InternObject(w)).GetFocusable()
}

func (w emojiChooser) GetFontMap() pango.FontMap {
	return WrapWidget(gextras.InternObject(w)).GetFontMap()
}

func (w emojiChooser) GetFontOptions() *cairo.FontOptions {
	return WrapWidget(gextras.InternObject(w)).GetFontOptions()
}

func (w emojiChooser) GetFrameClock() gdk.FrameClock {
	return WrapWidget(gextras.InternObject(w)).GetFrameClock()
}

func (w emojiChooser) GetHAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetHAlign()
}

func (w emojiChooser) GetHasTooltip() bool {
	return WrapWidget(gextras.InternObject(w)).GetHasTooltip()
}

func (w emojiChooser) GetHeight() int {
	return WrapWidget(gextras.InternObject(w)).GetHeight()
}

func (w emojiChooser) GetHExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpand()
}

func (w emojiChooser) GetHExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetHExpandSet()
}

func (w emojiChooser) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w emojiChooser) GetLayoutManager() LayoutManager {
	return WrapWidget(gextras.InternObject(w)).GetLayoutManager()
}

func (w emojiChooser) GetMapped() bool {
	return WrapWidget(gextras.InternObject(w)).GetMapped()
}

func (w emojiChooser) GetMarginBottom() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginBottom()
}

func (w emojiChooser) GetMarginEnd() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginEnd()
}

func (w emojiChooser) GetMarginStart() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginStart()
}

func (w emojiChooser) GetMarginTop() int {
	return WrapWidget(gextras.InternObject(w)).GetMarginTop()
}

func (w emojiChooser) GetName() string {
	return WrapWidget(gextras.InternObject(w)).GetName()
}

func (w emojiChooser) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w emojiChooser) GetNextSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetNextSibling()
}

func (w emojiChooser) GetOpacity() float64 {
	return WrapWidget(gextras.InternObject(w)).GetOpacity()
}

func (w emojiChooser) GetOverflow() Overflow {
	return WrapWidget(gextras.InternObject(w)).GetOverflow()
}

func (w emojiChooser) GetPangoContext() pango.Context {
	return WrapWidget(gextras.InternObject(w)).GetPangoContext()
}

func (w emojiChooser) GetParent() Widget {
	return WrapWidget(gextras.InternObject(w)).GetParent()
}

func (w emojiChooser) GetPreferredSize() (minimumSize Requisition, naturalSize Requisition) {
	return WrapWidget(gextras.InternObject(w)).GetPreferredSize()
}

func (w emojiChooser) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w emojiChooser) GetPrimaryClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetPrimaryClipboard()
}

func (w emojiChooser) GetRealized() bool {
	return WrapWidget(gextras.InternObject(w)).GetRealized()
}

func (w emojiChooser) GetReceivesDefault() bool {
	return WrapWidget(gextras.InternObject(w)).GetReceivesDefault()
}

func (w emojiChooser) GetRequestMode() SizeRequestMode {
	return WrapWidget(gextras.InternObject(w)).GetRequestMode()
}

func (w emojiChooser) GetRoot() Root {
	return WrapWidget(gextras.InternObject(w)).GetRoot()
}

func (w emojiChooser) GetScaleFactor() int {
	return WrapWidget(gextras.InternObject(w)).GetScaleFactor()
}

func (w emojiChooser) GetSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).GetSensitive()
}

func (w emojiChooser) GetSettings() Settings {
	return WrapWidget(gextras.InternObject(w)).GetSettings()
}

func (w emojiChooser) GetSize(orientation Orientation) int {
	return WrapWidget(gextras.InternObject(w)).GetSize(orientation)
}

func (w emojiChooser) GetSizeRequest() (width int, height int) {
	return WrapWidget(gextras.InternObject(w)).GetSizeRequest()
}

func (w emojiChooser) GetStateFlags() StateFlags {
	return WrapWidget(gextras.InternObject(w)).GetStateFlags()
}

func (w emojiChooser) GetStyleContext() StyleContext {
	return WrapWidget(gextras.InternObject(w)).GetStyleContext()
}

func (w emojiChooser) GetTemplateChild(widgetType externglib.Type, name string) gextras.Objector {
	return WrapWidget(gextras.InternObject(w)).GetTemplateChild(widgetType, name)
}

func (w emojiChooser) GetTooltipMarkup() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipMarkup()
}

func (w emojiChooser) GetTooltipText() string {
	return WrapWidget(gextras.InternObject(w)).GetTooltipText()
}

func (w emojiChooser) GetVAlign() Align {
	return WrapWidget(gextras.InternObject(w)).GetVAlign()
}

func (w emojiChooser) GetVExpand() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpand()
}

func (w emojiChooser) GetVExpandSet() bool {
	return WrapWidget(gextras.InternObject(w)).GetVExpandSet()
}

func (w emojiChooser) GetVisible() bool {
	return WrapWidget(gextras.InternObject(w)).GetVisible()
}

func (w emojiChooser) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w emojiChooser) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w emojiChooser) HasCSSClass(cssClass string) bool {
	return WrapWidget(gextras.InternObject(w)).HasCSSClass(cssClass)
}

func (w emojiChooser) HasDefault() bool {
	return WrapWidget(gextras.InternObject(w)).HasDefault()
}

func (w emojiChooser) HasFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasFocus()
}

func (w emojiChooser) HasVisibleFocus() bool {
	return WrapWidget(gextras.InternObject(w)).HasVisibleFocus()
}

func (w emojiChooser) Hide() {
	WrapWidget(gextras.InternObject(w)).Hide()
}

func (w emojiChooser) InDestruction() bool {
	return WrapWidget(gextras.InternObject(w)).InDestruction()
}

func (w emojiChooser) InitTemplate() {
	WrapWidget(gextras.InternObject(w)).InitTemplate()
}

func (w emojiChooser) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w emojiChooser) InsertBefore(parent Widget, nextSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertBefore(parent, nextSibling)
}

func (w emojiChooser) IsAncestor(ancestor Widget) bool {
	return WrapWidget(gextras.InternObject(w)).IsAncestor(ancestor)
}

func (w emojiChooser) IsDrawable() bool {
	return WrapWidget(gextras.InternObject(w)).IsDrawable()
}

func (w emojiChooser) IsFocus() bool {
	return WrapWidget(gextras.InternObject(w)).IsFocus()
}

func (w emojiChooser) IsSensitive() bool {
	return WrapWidget(gextras.InternObject(w)).IsSensitive()
}

func (w emojiChooser) IsVisible() bool {
	return WrapWidget(gextras.InternObject(w)).IsVisible()
}

func (w emojiChooser) KeynavFailed(direction DirectionType) bool {
	return WrapWidget(gextras.InternObject(w)).KeynavFailed(direction)
}

func (w emojiChooser) Map() {
	WrapWidget(gextras.InternObject(w)).Map()
}

func (w emojiChooser) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).Measure(orientation, forSize)
}

func (w emojiChooser) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w emojiChooser) Pick(x float64, y float64, flags PickFlags) Widget {
	return WrapWidget(gextras.InternObject(w)).Pick(x, y, flags)
}

func (w emojiChooser) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w emojiChooser) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w emojiChooser) QueueResize() {
	WrapWidget(gextras.InternObject(w)).QueueResize()
}

func (w emojiChooser) Realize() {
	WrapWidget(gextras.InternObject(w)).Realize()
}

func (w emojiChooser) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w emojiChooser) RemoveCSSClass(cssClass string) {
	WrapWidget(gextras.InternObject(w)).RemoveCSSClass(cssClass)
}

func (w emojiChooser) RemoveMnemonicLabel(label Widget) {
	WrapWidget(gextras.InternObject(w)).RemoveMnemonicLabel(label)
}

func (w emojiChooser) RemoveTickCallback(id uint) {
	WrapWidget(gextras.InternObject(w)).RemoveTickCallback(id)
}

func (w emojiChooser) SetCanFocus(canFocus bool) {
	WrapWidget(gextras.InternObject(w)).SetCanFocus(canFocus)
}

func (w emojiChooser) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w emojiChooser) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w emojiChooser) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w emojiChooser) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w emojiChooser) SetCursorFromName(name string) {
	WrapWidget(gextras.InternObject(w)).SetCursorFromName(name)
}

func (w emojiChooser) SetDirection(dir TextDirection) {
	WrapWidget(gextras.InternObject(w)).SetDirection(dir)
}

func (w emojiChooser) SetFocusChild(child Widget) {
	WrapWidget(gextras.InternObject(w)).SetFocusChild(child)
}

func (w emojiChooser) SetFocusOnClick(focusOnClick bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusOnClick(focusOnClick)
}

func (w emojiChooser) SetFocusable(focusable bool) {
	WrapWidget(gextras.InternObject(w)).SetFocusable(focusable)
}

func (w emojiChooser) SetFontMap(fontMap pango.FontMap) {
	WrapWidget(gextras.InternObject(w)).SetFontMap(fontMap)
}

func (w emojiChooser) SetFontOptions(options *cairo.FontOptions) {
	WrapWidget(gextras.InternObject(w)).SetFontOptions(options)
}

func (w emojiChooser) SetHAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetHAlign(align)
}

func (w emojiChooser) SetHasTooltip(hasTooltip bool) {
	WrapWidget(gextras.InternObject(w)).SetHasTooltip(hasTooltip)
}

func (w emojiChooser) SetHExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpand(expand)
}

func (w emojiChooser) SetHExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetHExpandSet(set)
}

func (w emojiChooser) SetLayoutManager(layoutManager LayoutManager) {
	WrapWidget(gextras.InternObject(w)).SetLayoutManager(layoutManager)
}

func (w emojiChooser) SetMarginBottom(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginBottom(margin)
}

func (w emojiChooser) SetMarginEnd(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginEnd(margin)
}

func (w emojiChooser) SetMarginStart(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginStart(margin)
}

func (w emojiChooser) SetMarginTop(margin int) {
	WrapWidget(gextras.InternObject(w)).SetMarginTop(margin)
}

func (w emojiChooser) SetName(name string) {
	WrapWidget(gextras.InternObject(w)).SetName(name)
}

func (w emojiChooser) SetOpacity(opacity float64) {
	WrapWidget(gextras.InternObject(w)).SetOpacity(opacity)
}

func (w emojiChooser) SetOverflow(overflow Overflow) {
	WrapWidget(gextras.InternObject(w)).SetOverflow(overflow)
}

func (w emojiChooser) SetParent(parent Widget) {
	WrapWidget(gextras.InternObject(w)).SetParent(parent)
}

func (w emojiChooser) SetReceivesDefault(receivesDefault bool) {
	WrapWidget(gextras.InternObject(w)).SetReceivesDefault(receivesDefault)
}

func (w emojiChooser) SetSensitive(sensitive bool) {
	WrapWidget(gextras.InternObject(w)).SetSensitive(sensitive)
}

func (w emojiChooser) SetSizeRequest(width int, height int) {
	WrapWidget(gextras.InternObject(w)).SetSizeRequest(width, height)
}

func (w emojiChooser) SetStateFlags(flags StateFlags, clear bool) {
	WrapWidget(gextras.InternObject(w)).SetStateFlags(flags, clear)
}

func (w emojiChooser) SetTooltipMarkup(markup string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipMarkup(markup)
}

func (w emojiChooser) SetTooltipText(text string) {
	WrapWidget(gextras.InternObject(w)).SetTooltipText(text)
}

func (w emojiChooser) SetVAlign(align Align) {
	WrapWidget(gextras.InternObject(w)).SetVAlign(align)
}

func (w emojiChooser) SetVExpand(expand bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpand(expand)
}

func (w emojiChooser) SetVExpandSet(set bool) {
	WrapWidget(gextras.InternObject(w)).SetVExpandSet(set)
}

func (w emojiChooser) SetVisible(visible bool) {
	WrapWidget(gextras.InternObject(w)).SetVisible(visible)
}

func (w emojiChooser) ShouldLayout() bool {
	return WrapWidget(gextras.InternObject(w)).ShouldLayout()
}

func (w emojiChooser) Show() {
	WrapWidget(gextras.InternObject(w)).Show()
}

func (w emojiChooser) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s emojiChooser) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w emojiChooser) TriggerTooltipQuery() {
	WrapWidget(gextras.InternObject(w)).TriggerTooltipQuery()
}

func (w emojiChooser) Unmap() {
	WrapWidget(gextras.InternObject(w)).Unmap()
}

func (w emojiChooser) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w emojiChooser) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w emojiChooser) UnsetStateFlags(flags StateFlags) {
	WrapWidget(gextras.InternObject(w)).UnsetStateFlags(flags)
}

func (s emojiChooser) GetAccessibleRole() AccessibleRole {
...
func (b emojiChooser) GetBuildableID() string {
...
func (s emojiChooser) GetRenderer() gsk.Renderer {
	return WrapNative(gextras.InternObject(s)).GetRenderer()
}

func (s emojiChooser) GetSurface() gdk.Surface {
	return WrapNative(gextras.InternObject(s)).GetSurface()
}

func (s emojiChooser) GetSurfaceTransform() (x float64, y float64) {
