...
func (e expander) AsWidget() Widget {
...
func (w expander) ActionSetEnabled(actionName string, enabled bool) {
...
func (w expander) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w expander) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w expander) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w expander) AddCSSClass(cssClass string) {
...
func (w expander) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w expander) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w expander) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w expander) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w expander) Contains(x float64, y float64) bool {
...
func (w expander) GetCanTarget() bool {
...
func (w expander) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w expander) GetFocusChild() Widget {
...
func (w expander) GetFocusable() bool {
...
func (w expander) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w expander) GetLayoutManager() LayoutManager {
...
func (w expander) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w expander) GetNextSibling() Widget {
...
func (w expander) GetOverflow() Overflow {
...
func (w expander) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w expander) GetPrimaryClipboard() gdk.Clipboard {
...
func (w expander) GetSize(orientation Orientation) int {
...
func (w expander) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w expander) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w expander) HasCSSClass(cssClass string) bool {
...
func (w expander) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w expander) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w expander) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w expander) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w expander) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w expander) RemoveCSSClass(cssClass string) {
...
func (w expander) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w expander) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w expander) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w expander) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w expander) SetCursorFromName(name string) {
...
func (w expander) SetFocusChild(child Widget) {
...
func (w expander) SetFocusable(focusable bool) {
...
func (w expander) SetLayoutManager(layoutManager LayoutManager) {
...
func (w expander) SetOverflow(overflow Overflow) {
...
func (w expander) ShouldLayout() bool {
...
func (w expander) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s expander) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s expander) GetAccessibleRole() AccessibleRole {
...
func (b expander) GetBuildableID() string {
