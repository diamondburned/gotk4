...
func (w fixed) ActionSetEnabled(actionName string, enabled bool) {
...
func (w fixed) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w fixed) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w fixed) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w fixed) AddCSSClass(cssClass string) {
...
func (w fixed) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w fixed) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w fixed) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w fixed) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w fixed) Contains(x float64, y float64) bool {
...
func (w fixed) GetCanTarget() bool {
...
func (w fixed) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w fixed) GetFocusChild() Widget {
...
func (w fixed) GetFocusable() bool {
...
func (w fixed) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w fixed) GetLayoutManager() LayoutManager {
...
func (w fixed) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w fixed) GetNextSibling() Widget {
...
func (w fixed) GetOverflow() Overflow {
...
func (w fixed) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w fixed) GetPrimaryClipboard() gdk.Clipboard {
...
func (w fixed) GetSize(orientation Orientation) int {
...
func (w fixed) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w fixed) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w fixed) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w fixed) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w fixed) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w fixed) RemoveCSSClass(cssClass string) {
...
func (w fixed) SetFocusChild(child Widget) {
...
func (w fixed) SetFocusable(focusable bool) {
...
func (w fixed) SetLayoutManager(layoutManager LayoutManager) {
...
func (w fixed) SetOverflow(overflow Overflow) {
...
func (w fixed) ShouldLayout() bool {
...
func (w fixed) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s fixed) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s fixed) GetAccessibleRole() AccessibleRole {
...
func (b fixed) GetBuildableID() string {
