...
func (f fontButton) AsWidget() Widget {
...
func (w fontButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w fontButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w fontButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w fontButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w fontButton) AddCSSClass(cssClass string) {
...
func (w fontButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w fontButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w fontButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w fontButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w fontButton) Contains(x float64, y float64) bool {
...
func (w fontButton) GetCanTarget() bool {
...
func (w fontButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w fontButton) GetFocusChild() Widget {
...
func (w fontButton) GetFocusable() bool {
...
func (w fontButton) GetHeight() int {
...
func (w fontButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w fontButton) GetLayoutManager() LayoutManager {
...
func (w fontButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w fontButton) GetNextSibling() Widget {
...
func (w fontButton) GetOverflow() Overflow {
...
func (w fontButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w fontButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w fontButton) GetRoot() Root {
...
func (w fontButton) GetSize(orientation Orientation) int {
...
func (w fontButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w fontButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w fontButton) HasCSSClass(cssClass string) bool {
...
func (w fontButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w fontButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w fontButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w fontButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w fontButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w fontButton) RemoveCSSClass(cssClass string) {
...
func (w fontButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w fontButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w fontButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w fontButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w fontButton) SetCursorFromName(name string) {
...
func (w fontButton) SetFocusChild(child Widget) {
...
func (w fontButton) SetFocusable(focusable bool) {
...
func (w fontButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w fontButton) SetOverflow(overflow Overflow) {
...
func (w fontButton) ShouldLayout() bool {
...
func (w fontButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s fontButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s fontButton) GetAccessibleRole() AccessibleRole {
...
func (b fontButton) GetBuildableID() string {
