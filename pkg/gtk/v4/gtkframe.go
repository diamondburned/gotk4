...
func (w frame) ActionSetEnabled(actionName string, enabled bool) {
...
func (w frame) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w frame) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w frame) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w frame) AddCSSClass(cssClass string) {
...
func (w frame) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w frame) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w frame) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w frame) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w frame) Contains(x float64, y float64) bool {
...
func (w frame) GetCanTarget() bool {
...
func (w frame) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w frame) GetFocusChild() Widget {
...
func (w frame) GetFocusable() bool {
...
func (w frame) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w frame) GetLayoutManager() LayoutManager {
...
func (w frame) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w frame) GetNextSibling() Widget {
...
func (w frame) GetOverflow() Overflow {
...
func (w frame) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w frame) GetPrimaryClipboard() gdk.Clipboard {
...
func (w frame) GetSize(orientation Orientation) int {
...
func (w frame) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w frame) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w frame) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w frame) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w frame) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w frame) RemoveCSSClass(cssClass string) {
...
func (w frame) SetFocusChild(child Widget) {
...
func (w frame) SetFocusable(focusable bool) {
...
func (w frame) SetLayoutManager(layoutManager LayoutManager) {
...
func (w frame) SetOverflow(overflow Overflow) {
...
func (w frame) ShouldLayout() bool {
...
func (w frame) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s frame) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s frame) GetAccessibleRole() AccessibleRole {
...
func (b frame) GetBuildableID() string {
