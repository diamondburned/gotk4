...
func (g gestureDrag) GetLastEvent(sequence *gdk.EventSequence) gdk.Event {
...
func (c gestureDrag) SetName(name string) {
	WrapEventController(gextras.InternObject(c)).SetName(name)
}

func (c gestureDrag) SetPropagationLimit(limit PropagationLimit) {
