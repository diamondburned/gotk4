...
func (g gestureZoom) GetLastEvent(sequence *gdk.EventSequence) gdk.Event {
...
func (c gestureZoom) SetName(name string) {
	WrapEventController(gextras.InternObject(c)).SetName(name)
}

func (c gestureZoom) SetPropagationLimit(limit PropagationLimit) {
