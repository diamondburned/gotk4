...
func (w grid) ActionSetEnabled(actionName string, enabled bool) {
...
func (w grid) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w grid) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w grid) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w grid) AddCSSClass(cssClass string) {
...
func (w grid) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w grid) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w grid) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w grid) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w grid) Contains(x float64, y float64) bool {
...
func (w grid) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w grid) GetFocusChild() Widget {
...
func (w grid) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w grid) GetLayoutManager() LayoutManager {
...
func (w grid) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w grid) GetNextSibling() Widget {
...
func (w grid) GetOverflow() Overflow {
...
func (w grid) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w grid) GetPrimaryClipboard() gdk.Clipboard {
...
func (w grid) GetSize(orientation Orientation) int {
...
func (w grid) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w grid) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w grid) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w grid) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w grid) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w grid) RemoveCSSClass(cssClass string) {
...
func (w grid) SetFocusChild(child Widget) {
...
func (w grid) SetFocusable(focusable bool) {
...
func (w grid) SetLayoutManager(layoutManager LayoutManager) {
...
func (w grid) SetOverflow(overflow Overflow) {
...
func (w grid) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s grid) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s grid) GetAccessibleRole() AccessibleRole {
...
func (b grid) GetBuildableID() string {
