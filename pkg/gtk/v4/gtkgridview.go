...
// WrapGridView wraps a GObject to a type that implements
// interface GridView. It is primarily used internally.
...
func (g gridView) AsListBase() ListBase {
	return WrapListBase(gextras.InternObject(g))
}
...
func (b gridView) GetBuildableID() string {
...
func (o gridView) GetOrientation() Orientation {
