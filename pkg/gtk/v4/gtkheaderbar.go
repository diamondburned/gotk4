...
func (h headerBar) AsWidget() Widget {
...
func (w headerBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w headerBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w headerBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w headerBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w headerBar) AddCSSClass(cssClass string) {
...
func (w headerBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w headerBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w headerBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w headerBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w headerBar) Contains(x float64, y float64) bool {
...
func (w headerBar) GetCanTarget() bool {
...
func (w headerBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w headerBar) GetFocusChild() Widget {
...
func (w headerBar) GetFocusable() bool {
...
func (w headerBar) GetHeight() int {
...
func (w headerBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w headerBar) GetLayoutManager() LayoutManager {
...
func (w headerBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w headerBar) GetNextSibling() Widget {
...
func (w headerBar) GetOverflow() Overflow {
...
func (w headerBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w headerBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w headerBar) GetSize(orientation Orientation) int {
...
func (w headerBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w headerBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w headerBar) HasCSSClass(cssClass string) bool {
...
func (w headerBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w headerBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w headerBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w headerBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w headerBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w headerBar) RemoveCSSClass(cssClass string) {
...
func (w headerBar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w headerBar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w headerBar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w headerBar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w headerBar) SetCursorFromName(name string) {
...
func (w headerBar) SetFocusChild(child Widget) {
...
func (w headerBar) SetFocusable(focusable bool) {
...
func (w headerBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w headerBar) SetOverflow(overflow Overflow) {
...
func (w headerBar) ShouldLayout() bool {
...
func (w headerBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s headerBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s headerBar) GetAccessibleRole() AccessibleRole {
...
func (b headerBar) GetBuildableID() string {
