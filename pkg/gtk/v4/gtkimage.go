...
func (w image) ActionSetEnabled(actionName string, enabled bool) {
...
func (w image) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w image) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w image) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w image) AddCSSClass(cssClass string) {
...
func (w image) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w image) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w image) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w image) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w image) Contains(x float64, y float64) bool {
...
func (w image) GetCanTarget() bool {
...
func (w image) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w image) GetFocusChild() Widget {
...
func (w image) GetFocusable() bool {
...
func (w image) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w image) GetLayoutManager() LayoutManager {
...
func (w image) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w image) GetNextSibling() Widget {
...
func (w image) GetOverflow() Overflow {
...
func (w image) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w image) GetPrimaryClipboard() gdk.Clipboard {
...
func (w image) GetSize(orientation Orientation) int {
...
func (w image) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w image) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w image) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w image) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w image) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w image) RemoveCSSClass(cssClass string) {
...
func (w image) SetFocusChild(child Widget) {
...
func (w image) SetFocusable(focusable bool) {
...
func (w image) SetLayoutManager(layoutManager LayoutManager) {
...
func (w image) SetOverflow(overflow Overflow) {
...
func (w image) ShouldLayout() bool {
...
func (w image) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s image) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s image) GetAccessibleRole() AccessibleRole {
...
func (b image) GetBuildableID() string {
