...
func (i infoBar) AsWidget() Widget {
...
func (w infoBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w infoBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w infoBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w infoBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w infoBar) AddCSSClass(cssClass string) {
...
func (w infoBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w infoBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w infoBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w infoBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w infoBar) Contains(x float64, y float64) bool {
...
func (w infoBar) GetCanTarget() bool {
...
func (w infoBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w infoBar) GetFocusChild() Widget {
...
func (w infoBar) GetFocusable() bool {
...
func (w infoBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w infoBar) GetLayoutManager() LayoutManager {
...
func (w infoBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w infoBar) GetNextSibling() Widget {
...
func (w infoBar) GetOverflow() Overflow {
...
func (w infoBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w infoBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w infoBar) GetSize(orientation Orientation) int {
...
func (w infoBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w infoBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w infoBar) HasCSSClass(cssClass string) bool {
...
func (w infoBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w infoBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w infoBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w infoBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w infoBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w infoBar) RemoveCSSClass(cssClass string) {
...
func (w infoBar) SetFocusChild(child Widget) {
...
func (w infoBar) SetFocusable(focusable bool) {
...
func (w infoBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w infoBar) SetOverflow(overflow Overflow) {
...
func (w infoBar) ShouldLayout() bool {
...
func (w infoBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s infoBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s infoBar) GetAccessibleRole() AccessibleRole {
...
func (b infoBar) GetBuildableID() string {
