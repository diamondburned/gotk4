...
func (w levelBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w levelBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w levelBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w levelBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w levelBar) AddCSSClass(cssClass string) {
...
func (w levelBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w levelBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w levelBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w levelBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w levelBar) Contains(x float64, y float64) bool {
...
func (w levelBar) GetCanTarget() bool {
...
func (w levelBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w levelBar) GetFocusChild() Widget {
...
func (w levelBar) GetFocusable() bool {
...
func (w levelBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w levelBar) GetLayoutManager() LayoutManager {
...
func (w levelBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w levelBar) GetNextSibling() Widget {
...
func (w levelBar) GetOverflow() Overflow {
...
func (w levelBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w levelBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w levelBar) GetSize(orientation Orientation) int {
...
func (w levelBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w levelBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w levelBar) HasCSSClass(cssClass string) bool {
...
func (w levelBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w levelBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w levelBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w levelBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w levelBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w levelBar) RemoveCSSClass(cssClass string) {
...
func (w levelBar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w levelBar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w levelBar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w levelBar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w levelBar) SetCursorFromName(name string) {
...
func (w levelBar) SetFocusChild(child Widget) {
...
func (w levelBar) SetFocusable(focusable bool) {
...
func (w levelBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w levelBar) SetOverflow(overflow Overflow) {
...
func (w levelBar) ShouldLayout() bool {
...
func (w levelBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s levelBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s levelBar) GetAccessibleRole() AccessibleRole {
...
func (b levelBar) GetBuildableID() string {
