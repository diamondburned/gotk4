...
func (b linkButton) GetHasFrame() bool {
	return WrapButton(gextras.InternObject(b)).GetHasFrame()
}

func (b linkButton) GetIconName() string {
...
func (b linkButton) SetChild(child Widget) {
	WrapButton(gextras.InternObject(b)).SetChild(child)
}

func (b linkButton) SetHasFrame(hasFrame bool) {
	WrapButton(gextras.InternObject(b)).SetHasFrame(hasFrame)
}

func (b linkButton) SetIconName(iconName string) {
...
func (w linkButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w linkButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w linkButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w linkButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w linkButton) AddCSSClass(cssClass string) {
...
func (w linkButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w linkButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w linkButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w linkButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w linkButton) Contains(x float64, y float64) bool {
...
func (w linkButton) GetCanTarget() bool {
...
func (w linkButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w linkButton) GetFocusChild() Widget {
...
func (w linkButton) GetFocusable() bool {
...
func (w linkButton) GetHeight() int {
...
func (w linkButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w linkButton) GetLayoutManager() LayoutManager {
...
func (w linkButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w linkButton) GetNextSibling() Widget {
...
func (w linkButton) GetOverflow() Overflow {
...
func (w linkButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w linkButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w linkButton) GetRoot() Root {
...
func (w linkButton) GetSize(orientation Orientation) int {
...
func (w linkButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w linkButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w linkButton) HasCSSClass(cssClass string) bool {
...
func (w linkButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w linkButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w linkButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w linkButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w linkButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w linkButton) RemoveCSSClass(cssClass string) {
...
func (w linkButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w linkButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w linkButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w linkButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w linkButton) SetCursorFromName(name string) {
...
func (w linkButton) SetFocusChild(child Widget) {
...
func (w linkButton) SetFocusable(focusable bool) {
...
func (w linkButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w linkButton) SetOverflow(overflow Overflow) {
...
func (w linkButton) ShouldLayout() bool {
...
func (w linkButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s linkButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s linkButton) GetAccessibleRole() AccessibleRole {
...
func (b linkButton) GetBuildableID() string {
