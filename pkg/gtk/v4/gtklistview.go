...
// WrapListView wraps a GObject to a type that implements
// interface ListView. It is primarily used internally.
...
func (l listView) AsListBase() ListBase {
	return WrapListBase(gextras.InternObject(l))
}
...
func (b listView) GetBuildableID() string {
...
func (o listView) GetOrientation() Orientation {
