...
func (b lockButton) GetHasFrame() bool {
	return WrapButton(gextras.InternObject(b)).GetHasFrame()
}

func (b lockButton) GetIconName() string {
...
func (b lockButton) SetChild(child Widget) {
	WrapButton(gextras.InternObject(b)).SetChild(child)
}

func (b lockButton) SetHasFrame(hasFrame bool) {
	WrapButton(gextras.InternObject(b)).SetHasFrame(hasFrame)
}

func (b lockButton) SetIconName(iconName string) {
...
func (w lockButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w lockButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w lockButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w lockButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w lockButton) AddCSSClass(cssClass string) {
...
func (w lockButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w lockButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w lockButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w lockButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w lockButton) Contains(x float64, y float64) bool {
...
func (w lockButton) GetCanTarget() bool {
...
func (w lockButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w lockButton) GetFocusChild() Widget {
...
func (w lockButton) GetFocusable() bool {
...
func (w lockButton) GetHeight() int {
...
func (w lockButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w lockButton) GetLayoutManager() LayoutManager {
...
func (w lockButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w lockButton) GetNextSibling() Widget {
...
func (w lockButton) GetOverflow() Overflow {
...
func (w lockButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w lockButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w lockButton) GetRoot() Root {
...
func (w lockButton) GetSize(orientation Orientation) int {
...
func (w lockButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w lockButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w lockButton) HasCSSClass(cssClass string) bool {
...
func (w lockButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w lockButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w lockButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w lockButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w lockButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w lockButton) RemoveCSSClass(cssClass string) {
...
func (w lockButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w lockButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w lockButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w lockButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w lockButton) SetCursorFromName(name string) {
...
func (w lockButton) SetFocusChild(child Widget) {
...
func (w lockButton) SetFocusable(focusable bool) {
...
func (w lockButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w lockButton) SetOverflow(overflow Overflow) {
...
func (w lockButton) ShouldLayout() bool {
...
func (w lockButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s lockButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s lockButton) GetAccessibleRole() AccessibleRole {
...
func (b lockButton) GetBuildableID() string {
