...
// WrapMediaControls wraps a GObject to a type that implements
// interface MediaControls. It is primarily used internally.
func WrapMediaControls(obj *externglib.Object) MediaControls {
	return mediaControls{obj}
}
...
func (m mediaControls) AsWidget() Widget {
...
func (b mediaControls) GetBuildableID() string {
