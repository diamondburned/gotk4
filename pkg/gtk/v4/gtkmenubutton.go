...
func (m menuButton) AsWidget() Widget {
...
func (w menuButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w menuButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w menuButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w menuButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w menuButton) AddCSSClass(cssClass string) {
...
func (w menuButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w menuButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w menuButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w menuButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w menuButton) Contains(x float64, y float64) bool {
...
func (w menuButton) GetCanTarget() bool {
...
func (w menuButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w menuButton) GetFocusChild() Widget {
...
func (w menuButton) GetFocusable() bool {
...
func (w menuButton) GetHeight() int {
...
func (w menuButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w menuButton) GetLayoutManager() LayoutManager {
...
func (w menuButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w menuButton) GetNextSibling() Widget {
...
func (w menuButton) GetOverflow() Overflow {
...
func (w menuButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w menuButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w menuButton) GetRoot() Root {
...
func (w menuButton) GetSize(orientation Orientation) int {
...
func (w menuButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w menuButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w menuButton) HasCSSClass(cssClass string) bool {
...
func (w menuButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w menuButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w menuButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w menuButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w menuButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w menuButton) RemoveCSSClass(cssClass string) {
...
func (w menuButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w menuButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w menuButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w menuButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w menuButton) SetCursorFromName(name string) {
...
func (w menuButton) SetFocusChild(child Widget) {
...
func (w menuButton) SetFocusable(focusable bool) {
...
func (w menuButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w menuButton) SetOverflow(overflow Overflow) {
...
func (w menuButton) ShouldLayout() bool {
...
func (w menuButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s menuButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s menuButton) GetAccessibleRole() AccessibleRole {
...
func (b menuButton) GetBuildableID() string {
