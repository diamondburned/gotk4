...
func (o overlay) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(o))
}
...
func (w overlay) ActionSetEnabled(actionName string, enabled bool) {
...
func (w overlay) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w overlay) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w overlay) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w overlay) AddCSSClass(cssClass string) {
...
func (w overlay) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w overlay) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w overlay) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w overlay) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w overlay) Contains(x float64, y float64) bool {
...
func (w overlay) GetCanTarget() bool {
...
func (w overlay) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w overlay) GetFocusChild() Widget {
...
func (w overlay) GetFocusable() bool {
...
func (w overlay) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w overlay) GetLayoutManager() LayoutManager {
...
func (w overlay) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w overlay) GetNextSibling() Widget {
...
func (w overlay) GetOverflow() Overflow {
...
func (w overlay) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w overlay) GetPrimaryClipboard() gdk.Clipboard {
...
func (w overlay) GetSize(orientation Orientation) int {
...
func (w overlay) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w overlay) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w overlay) HasCSSClass(cssClass string) bool {
...
func (w overlay) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w overlay) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w overlay) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w overlay) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w overlay) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w overlay) RemoveCSSClass(cssClass string) {
...
func (w overlay) SetFocusChild(child Widget) {
...
func (w overlay) SetFocusable(focusable bool) {
...
func (w overlay) SetLayoutManager(layoutManager LayoutManager) {
...
func (w overlay) SetOverflow(overflow Overflow) {
...
func (w overlay) ShouldLayout() bool {
...
func (w overlay) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s overlay) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s overlay) GetAccessibleRole() AccessibleRole {
...
func (b overlay) GetBuildableID() string {
