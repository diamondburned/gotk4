...
// WrapPageSetupUnixDialog wraps a GObject to a type that implements
// interface PageSetupUnixDialog. It is primarily used internally.
func WrapPageSetupUnixDialog(obj *externglib.Object) PageSetupUnixDialog {
	return pageSetupUnixDialog{obj}
}
...
func (p pageSetupUnixDialog) AsDialog() Dialog {
...
func (b pageSetupUnixDialog) GetBuildableID() string {
...
func (s pageSetupUnixDialog) GetRenderer() gsk.Renderer {
	return WrapNative(gextras.InternObject(s)).GetRenderer()
}

func (s pageSetupUnixDialog) GetSurface() gdk.Surface {
	return WrapNative(gextras.InternObject(s)).GetSurface()
}

func (s pageSetupUnixDialog) GetSurfaceTransform() (x float64, y float64) {
...
func (s pageSetupUnixDialog) GetDisplay() gdk.Display {
	return WrapRoot(gextras.InternObject(s)).GetDisplay()
}

func (s pageSetupUnixDialog) GetFocus() Widget {
