...
func (w paned) ActionSetEnabled(actionName string, enabled bool) {
...
func (w paned) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w paned) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w paned) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w paned) AddCSSClass(cssClass string) {
...
func (w paned) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w paned) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w paned) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w paned) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w paned) Contains(x float64, y float64) bool {
...
func (w paned) GetCanTarget() bool {
...
func (w paned) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w paned) GetFocusChild() Widget {
...
func (w paned) GetFocusable() bool {
...
func (w paned) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w paned) GetLayoutManager() LayoutManager {
...
func (w paned) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w paned) GetNextSibling() Widget {
...
func (w paned) GetOverflow() Overflow {
...
func (w paned) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w paned) GetPrimaryClipboard() gdk.Clipboard {
...
func (w paned) GetSize(orientation Orientation) int {
...
func (w paned) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w paned) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w paned) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w paned) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w paned) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w paned) RemoveCSSClass(cssClass string) {
...
func (w paned) SetFocusChild(child Widget) {
...
func (w paned) SetFocusable(focusable bool) {
...
func (w paned) SetLayoutManager(layoutManager LayoutManager) {
...
func (w paned) SetOverflow(overflow Overflow) {
...
func (w paned) ShouldLayout() bool {
...
func (w paned) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s paned) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s paned) GetAccessibleRole() AccessibleRole {
...
func (b paned) GetBuildableID() string {
