...
// WrapPasswordEntry wraps a GObject to a type that implements
// interface PasswordEntry. It is primarily used internally.
func WrapPasswordEntry(obj *externglib.Object) PasswordEntry {
	return passwordEntry{obj}
}
...
func (p passwordEntry) AsWidget() Widget {
...
func (b passwordEntry) GetBuildableID() string {
