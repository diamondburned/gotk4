...
// WrapPicture wraps a GObject to a type that implements
// interface Picture. It is primarily used internally.
...
func (p picture) AsWidget() Widget {
...
func (b picture) GetBuildableID() string {
