...
func (p popover) AsWidget() Widget {
...
func (w popover) ActionSetEnabled(actionName string, enabled bool) {
...
func (w popover) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w popover) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w popover) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w popover) AddCSSClass(cssClass string) {
...
func (w popover) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w popover) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w popover) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w popover) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w popover) Contains(x float64, y float64) bool {
...
func (w popover) GetCanTarget() bool {
...
func (w popover) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w popover) GetFocusChild() Widget {
...
func (w popover) GetFocusable() bool {
...
func (w popover) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w popover) GetLayoutManager() LayoutManager {
...
func (w popover) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w popover) GetNextSibling() Widget {
...
func (w popover) GetOverflow() Overflow {
...
func (w popover) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w popover) GetPrimaryClipboard() gdk.Clipboard {
...
func (w popover) GetSize(orientation Orientation) int {
...
func (w popover) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w popover) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w popover) HasCSSClass(cssClass string) bool {
...
func (w popover) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w popover) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w popover) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w popover) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w popover) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w popover) RemoveCSSClass(cssClass string) {
...
func (w popover) SetFocusChild(child Widget) {
...
func (w popover) SetFocusable(focusable bool) {
...
func (w popover) SetLayoutManager(layoutManager LayoutManager) {
...
func (w popover) SetOverflow(overflow Overflow) {
...
func (w popover) ShouldLayout() bool {
...
func (w popover) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s popover) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s popover) GetAccessibleRole() AccessibleRole {
...
func (b popover) GetBuildableID() string {
...
func (s popover) GetRenderer() gsk.Renderer {
	return WrapNative(gextras.InternObject(s)).GetRenderer()
}

func (s popover) GetSurface() gdk.Surface {
	return WrapNative(gextras.InternObject(s)).GetSurface()
}

func (s popover) GetSurfaceTransform() (x float64, y float64) {
