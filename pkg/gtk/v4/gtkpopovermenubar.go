...
// WrapPopoverMenuBar wraps a GObject to a type that implements
// interface PopoverMenuBar. It is primarily used internally.
func WrapPopoverMenuBar(obj *externglib.Object) PopoverMenuBar {
	return popoverMenuBar{obj}
}
...
func (p popoverMenuBar) AsWidget() Widget {
...
func (b popoverMenuBar) GetBuildableID() string {
