...
func (w progressBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w progressBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w progressBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w progressBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w progressBar) AddCSSClass(cssClass string) {
...
func (w progressBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w progressBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w progressBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w progressBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w progressBar) Contains(x float64, y float64) bool {
...
func (w progressBar) GetCanTarget() bool {
...
func (w progressBar) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w progressBar) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s progressBar) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w progressBar) GetCursor() gdk.Cursor {
...
func (w progressBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w progressBar) GetFocusChild() Widget {
...
func (w progressBar) GetFocusable() bool {
...
func (w progressBar) GetHeight() int {
...
func (w progressBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w progressBar) GetLayoutManager() LayoutManager {
...
func (w progressBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w progressBar) GetNextSibling() Widget {
...
func (w progressBar) GetOverflow() Overflow {
...
func (w progressBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w progressBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w progressBar) GetRoot() Root {
...
func (w progressBar) GetSize(orientation Orientation) int {
...
func (w progressBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w progressBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w progressBar) HasCSSClass(cssClass string) bool {
...
func (w progressBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w progressBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w progressBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w progressBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w progressBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w progressBar) RemoveCSSClass(cssClass string) {
...
func (w progressBar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w progressBar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w progressBar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w progressBar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w progressBar) SetCursorFromName(name string) {
...
func (w progressBar) SetFocusChild(child Widget) {
...
func (w progressBar) SetFocusable(focusable bool) {
...
func (w progressBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w progressBar) SetOverflow(overflow Overflow) {
...
func (w progressBar) ShouldLayout() bool {
...
func (w progressBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s progressBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s progressBar) GetAccessibleRole() AccessibleRole {
...
func (b progressBar) GetBuildableID() string {
