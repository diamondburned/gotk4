...
func (w _range) ActionSetEnabled(actionName string, enabled bool) {
...
func (w _range) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w _range) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w _range) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w _range) AddCSSClass(cssClass string) {
...
func (w _range) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w _range) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w _range) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w _range) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w _range) Contains(x float64, y float64) bool {
...
func (w _range) GetCanTarget() bool {
...
func (w _range) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w _range) GetFocusChild() Widget {
...
func (w _range) GetFocusable() bool {
...
func (w _range) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w _range) GetLayoutManager() LayoutManager {
...
func (w _range) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w _range) GetNextSibling() Widget {
...
func (w _range) GetOverflow() Overflow {
...
func (w _range) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w _range) GetPrimaryClipboard() gdk.Clipboard {
...
func (w _range) GetSize(orientation Orientation) int {
...
func (w _range) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w _range) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w _range) HasCSSClass(cssClass string) bool {
...
func (w _range) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w _range) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w _range) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w _range) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w _range) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w _range) RemoveCSSClass(cssClass string) {
...
func (w _range) SetFocusChild(child Widget) {
...
func (w _range) SetFocusable(focusable bool) {
...
func (w _range) SetLayoutManager(layoutManager LayoutManager) {
...
func (w _range) SetOverflow(overflow Overflow) {
...
func (w _range) ShouldLayout() bool {
...
func (w _range) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s _range) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s _range) GetAccessibleRole() AccessibleRole {
...
func (b _range) GetBuildableID() string {
