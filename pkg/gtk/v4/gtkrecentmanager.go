...
func (info *RecentInfo) Added() *glib.DateTime {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(gextras.StructNative(unsafe.Pointer(info)))
	...
	C.g_date_time_ref(*(**C.void)(unsafe.Pointer(&_cret)))
	runtime.SetFinalizer(
...
func (info *RecentInfo) ApplicationInfo(appName string) (string, uint32, *glib.DateTime, bool) {
	...
	*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(appName)))
	...
	_stamp = (*glib.DateTime)(gextras.NewStructNative(unsafe.Pointer(*(**C.void)(unsafe.Pointer(&_outs[2])))))
	C.g_date_time_ref(*(**C.void)(unsafe.Pointer(&_outs[2])))
	runtime.SetFinalizer(
