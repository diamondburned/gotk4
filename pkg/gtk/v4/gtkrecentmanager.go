...
func (manager *RecentManager) MoveItem(uri, newUri string) error {
	...
	*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(uri)))
	defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	if newUri != "" {
		*(**C.char)(unsafe.Pointer(&_args[2])) = (*C.char)(unsafe.Pointer(C.CString(newUri)))
...
func (r *RecentData) DisplayName() string {
	...
	var v string // out
	v = C.GoString((*C.gchar)(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&*valptr)))))
	return v
}
...
func (r *RecentData) Groups() []string {
	...
	var v []string // out
	{
		var i int
		var z *C.char
		for p := *(***C.char)(unsafe.Pointer(&*valptr)); *p != z; p = &unsafe.Slice(p, 2)[1] {
			i++
		}

		src := unsafe.Slice(*(***C.char)(unsafe.Pointer(&*valptr)), i)
		v = make([]string, i)
		for i := range src {
			v[i] = C.GoString((*C.gchar)(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&src[i])))))
		}
	}
	return v
}
...
func (info *RecentInfo) CreateAppInfo(appName string) (*gio.AppInfo, error) {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(gextras.StructNative(unsafe.Pointer(info)))
	if appName != "" {
		*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(appName)))
		defer C.free(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_args[1]))))
	}
...
func (info *RecentInfo) Added() *glib.DateTime {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(gextras.StructNative(unsafe.Pointer(info)))
	...
	C.g_date_time_ref(*(**C.GDateTime)(unsafe.Pointer(&_cret)))
	runtime.SetFinalizer(
...
func (info *RecentInfo) ApplicationInfo(appName string) (string, uint32, *glib.DateTime, bool) {
	...
	*(**C.char)(unsafe.Pointer(&_args[1])) = (*C.char)(unsafe.Pointer(C.CString(appName)))
	...
	_appExec = C.GoString((*C.gchar)(unsafe.Pointer(*(**C.char)(unsafe.Pointer(&_outs[0])))))
	_count = uint32(*(*C.guint)(unsafe.Pointer(&_outs[1])))
	_stamp = (*glib.DateTime)(gextras.NewStructNative(unsafe.Pointer(*(**C.GDateTime)(unsafe.Pointer(&_outs[2])))))
	C.g_date_time_ref(*(**C.GDateTime)(unsafe.Pointer(&_outs[2])))
	runtime.SetFinalizer(
