...
func (r revealer) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(r))
}
...
func (w revealer) ActionSetEnabled(actionName string, enabled bool) {
...
func (w revealer) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w revealer) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w revealer) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w revealer) AddCSSClass(cssClass string) {
...
func (w revealer) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w revealer) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w revealer) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w revealer) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w revealer) Contains(x float64, y float64) bool {
...
func (w revealer) GetCanTarget() bool {
...
func (w revealer) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w revealer) GetFocusChild() Widget {
...
func (w revealer) GetFocusable() bool {
...
func (w revealer) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w revealer) GetLayoutManager() LayoutManager {
...
func (w revealer) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w revealer) GetNextSibling() Widget {
...
func (w revealer) GetOverflow() Overflow {
...
func (w revealer) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w revealer) GetPrimaryClipboard() gdk.Clipboard {
...
func (w revealer) GetSize(orientation Orientation) int {
...
func (w revealer) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w revealer) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w revealer) HasCSSClass(cssClass string) bool {
...
func (w revealer) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w revealer) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w revealer) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w revealer) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w revealer) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w revealer) RemoveCSSClass(cssClass string) {
...
func (w revealer) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w revealer) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w revealer) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w revealer) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w revealer) SetCursorFromName(name string) {
...
func (w revealer) SetFocusChild(child Widget) {
...
func (w revealer) SetFocusable(focusable bool) {
...
func (w revealer) SetLayoutManager(layoutManager LayoutManager) {
...
func (w revealer) SetOverflow(overflow Overflow) {
...
func (w revealer) ShouldLayout() bool {
...
func (w revealer) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s revealer) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s revealer) GetAccessibleRole() AccessibleRole {
...
func (b revealer) GetBuildableID() string {
