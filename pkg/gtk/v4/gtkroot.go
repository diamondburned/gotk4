...
func (r root) AsNative() Native {
	return WrapNative(gextras.InternObject(r))
}

func (r root) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(r))
}

func (s root) GetRenderer() gsk.Renderer {
	return WrapNative(gextras.InternObject(s)).GetRenderer()
}

func (s root) GetSurface() gdk.Surface {
	return WrapNative(gextras.InternObject(s)).GetSurface()
}

func (s root) GetSurfaceTransform() (x float64, y float64) {
...
func (w root) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
	return WrapWidget(gextras.InternObject(w)).Measure(orientation, forSize)
}

func (w root) MnemonicActivate(groupCycling bool) bool {
	return WrapWidget(gextras.InternObject(w)).MnemonicActivate(groupCycling)
}

func (w root) Pick(x float64, y float64, flags PickFlags) Widget {
	return WrapWidget(gextras.InternObject(w)).Pick(x, y, flags)
}

func (w root) QueueAllocate() {
	WrapWidget(gextras.InternObject(w)).QueueAllocate()
}

func (w root) QueueDraw() {
	WrapWidget(gextras.InternObject(w)).QueueDraw()
}

func (w root) QueueResize() {
...
func (w root) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s root) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
	return WrapWidget(gextras.InternObject(s)).TranslateCoordinates(destWidget, srcX, srcY)
}

func (w root) TriggerTooltipQuery() {
...
func (w root) Unparent() {
	WrapWidget(gextras.InternObject(w)).Unparent()
}

func (w root) Unrealize() {
	WrapWidget(gextras.InternObject(w)).Unrealize()
}

func (w root) UnsetStateFlags(flags StateFlags) {
	WrapWidget(gextras.InternObject(w)).UnsetStateFlags(flags)
}

func (s root) GetAccessibleRole() AccessibleRole {
	return WrapAccessible(gextras.InternObject(s)).GetAccessibleRole()
}

func (s root) ResetProperty(property AccessibleProperty) {
	WrapAccessible(gextras.InternObject(s)).ResetProperty(property)
}

func (s root) ResetRelation(relation AccessibleRelation) {
	WrapAccessible(gextras.InternObject(s)).ResetRelation(relation)
}

func (s root) ResetState(state AccessibleState) {
	WrapAccessible(gextras.InternObject(s)).ResetState(state)
}

func (s root) UpdatePropertyValue(properties []AccessibleProperty, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdatePropertyValue(properties, values)
}

func (s root) UpdateRelationValue(relations []AccessibleRelation, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateRelationValue(relations, values)
}

func (s root) UpdateStateValue(states []AccessibleState, values []externglib.Value) {
	WrapAccessible(gextras.InternObject(s)).UpdateStateValue(states, values)
}

func (b root) GetBuildableID() string {
