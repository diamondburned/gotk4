...
func (s scrollbar) AsWidget() Widget {
...
func (w scrollbar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w scrollbar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w scrollbar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w scrollbar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w scrollbar) AddCSSClass(cssClass string) {
...
func (w scrollbar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w scrollbar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w scrollbar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w scrollbar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w scrollbar) Contains(x float64, y float64) bool {
...
func (w scrollbar) GetCanTarget() bool {
...
func (w scrollbar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w scrollbar) GetFocusChild() Widget {
...
func (w scrollbar) GetFocusable() bool {
...
func (w scrollbar) GetHeight() int {
...
func (w scrollbar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w scrollbar) GetLayoutManager() LayoutManager {
...
func (w scrollbar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w scrollbar) GetNextSibling() Widget {
...
func (w scrollbar) GetOverflow() Overflow {
...
func (w scrollbar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w scrollbar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w scrollbar) GetSize(orientation Orientation) int {
...
func (w scrollbar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w scrollbar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w scrollbar) HasCSSClass(cssClass string) bool {
...
func (w scrollbar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w scrollbar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w scrollbar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w scrollbar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w scrollbar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w scrollbar) RemoveCSSClass(cssClass string) {
...
func (w scrollbar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w scrollbar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w scrollbar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w scrollbar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w scrollbar) SetCursorFromName(name string) {
...
func (w scrollbar) SetFocusChild(child Widget) {
...
func (w scrollbar) SetFocusable(focusable bool) {
...
func (w scrollbar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w scrollbar) SetOverflow(overflow Overflow) {
...
func (w scrollbar) ShouldLayout() bool {
...
func (w scrollbar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s scrollbar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s scrollbar) GetAccessibleRole() AccessibleRole {
...
func (b scrollbar) GetBuildableID() string {
