...
func (s scrolledWindow) AsWidget() Widget {
...
func (w scrolledWindow) ActionSetEnabled(actionName string, enabled bool) {
...
func (w scrolledWindow) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w scrolledWindow) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w scrolledWindow) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w scrolledWindow) AddCSSClass(cssClass string) {
...
func (w scrolledWindow) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w scrolledWindow) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w scrolledWindow) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w scrolledWindow) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w scrolledWindow) Contains(x float64, y float64) bool {
...
func (w scrolledWindow) GetCanTarget() bool {
...
func (w scrolledWindow) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w scrolledWindow) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s scrolledWindow) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w scrolledWindow) GetCursor() gdk.Cursor {
...
func (w scrolledWindow) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w scrolledWindow) GetFocusChild() Widget {
...
func (w scrolledWindow) GetFocusable() bool {
...
func (w scrolledWindow) GetHeight() int {
...
func (w scrolledWindow) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w scrolledWindow) GetLayoutManager() LayoutManager {
...
func (w scrolledWindow) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w scrolledWindow) GetNextSibling() Widget {
...
func (w scrolledWindow) GetOverflow() Overflow {
...
func (w scrolledWindow) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w scrolledWindow) GetPrimaryClipboard() gdk.Clipboard {
...
func (w scrolledWindow) GetRoot() Root {
...
func (w scrolledWindow) GetSize(orientation Orientation) int {
...
func (w scrolledWindow) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w scrolledWindow) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w scrolledWindow) HasCSSClass(cssClass string) bool {
...
func (w scrolledWindow) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w scrolledWindow) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w scrolledWindow) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w scrolledWindow) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w scrolledWindow) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w scrolledWindow) RemoveCSSClass(cssClass string) {
...
func (w scrolledWindow) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w scrolledWindow) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w scrolledWindow) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w scrolledWindow) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w scrolledWindow) SetCursorFromName(name string) {
...
func (w scrolledWindow) SetFocusChild(child Widget) {
...
func (w scrolledWindow) SetFocusable(focusable bool) {
...
func (w scrolledWindow) SetLayoutManager(layoutManager LayoutManager) {
...
func (w scrolledWindow) SetOverflow(overflow Overflow) {
...
func (w scrolledWindow) ShouldLayout() bool {
...
func (w scrolledWindow) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s scrolledWindow) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s scrolledWindow) GetAccessibleRole() AccessibleRole {
...
func (b scrolledWindow) GetBuildableID() string {
