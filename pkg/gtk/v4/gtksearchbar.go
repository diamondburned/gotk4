...
func (s searchBar) AsWidget() Widget {
...
func (w searchBar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w searchBar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w searchBar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w searchBar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w searchBar) AddCSSClass(cssClass string) {
...
func (w searchBar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w searchBar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w searchBar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w searchBar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w searchBar) Contains(x float64, y float64) bool {
...
func (w searchBar) GetCanTarget() bool {
...
func (w searchBar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w searchBar) GetFocusChild() Widget {
...
func (w searchBar) GetFocusable() bool {
...
func (w searchBar) GetHeight() int {
...
func (w searchBar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w searchBar) GetLayoutManager() LayoutManager {
...
func (w searchBar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w searchBar) GetNextSibling() Widget {
...
func (w searchBar) GetOverflow() Overflow {
...
func (w searchBar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w searchBar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w searchBar) GetSize(orientation Orientation) int {
...
func (w searchBar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w searchBar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w searchBar) HasCSSClass(cssClass string) bool {
...
func (w searchBar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w searchBar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w searchBar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w searchBar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w searchBar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w searchBar) RemoveCSSClass(cssClass string) {
...
func (w searchBar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w searchBar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w searchBar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w searchBar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w searchBar) SetCursorFromName(name string) {
...
func (w searchBar) SetFocusChild(child Widget) {
...
func (w searchBar) SetFocusable(focusable bool) {
...
func (w searchBar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w searchBar) SetOverflow(overflow Overflow) {
...
func (w searchBar) ShouldLayout() bool {
...
func (w searchBar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s searchBar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s searchBar) GetAccessibleRole() AccessibleRole {
...
func (b searchBar) GetBuildableID() string {
