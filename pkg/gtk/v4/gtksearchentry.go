...
func (s searchEntry) AsWidget() Widget {
...
func (w searchEntry) ActionSetEnabled(actionName string, enabled bool) {
...
func (w searchEntry) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w searchEntry) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w searchEntry) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w searchEntry) AddCSSClass(cssClass string) {
...
func (w searchEntry) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w searchEntry) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w searchEntry) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w searchEntry) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w searchEntry) Contains(x float64, y float64) bool {
...
func (w searchEntry) GetCanTarget() bool {
...
func (w searchEntry) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w searchEntry) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s searchEntry) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w searchEntry) GetCursor() gdk.Cursor {
...
func (w searchEntry) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w searchEntry) GetFocusChild() Widget {
...
func (w searchEntry) GetFocusable() bool {
...
func (w searchEntry) GetHeight() int {
...
func (w searchEntry) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w searchEntry) GetLayoutManager() LayoutManager {
...
func (w searchEntry) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w searchEntry) GetNextSibling() Widget {
...
func (w searchEntry) GetOverflow() Overflow {
...
func (w searchEntry) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w searchEntry) GetPrimaryClipboard() gdk.Clipboard {
...
func (w searchEntry) GetRoot() Root {
...
func (w searchEntry) GetSize(orientation Orientation) int {
...
func (w searchEntry) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w searchEntry) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w searchEntry) HasCSSClass(cssClass string) bool {
...
func (w searchEntry) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w searchEntry) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w searchEntry) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w searchEntry) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w searchEntry) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w searchEntry) RemoveCSSClass(cssClass string) {
...
func (w searchEntry) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w searchEntry) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w searchEntry) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w searchEntry) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w searchEntry) SetCursorFromName(name string) {
...
func (w searchEntry) SetFocusChild(child Widget) {
...
func (w searchEntry) SetFocusable(focusable bool) {
...
func (w searchEntry) SetLayoutManager(layoutManager LayoutManager) {
...
func (w searchEntry) SetOverflow(overflow Overflow) {
...
func (w searchEntry) ShouldLayout() bool {
...
func (w searchEntry) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s searchEntry) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s searchEntry) GetAccessibleRole() AccessibleRole {
...
func (b searchEntry) GetBuildableID() string {
...
func (e searchEntry) GetDelegate() Editable {
...
func (e searchEntry) GetEnableUndo() bool {
