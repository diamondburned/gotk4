...
func (w separator) ActionSetEnabled(actionName string, enabled bool) {
...
func (w separator) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w separator) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w separator) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w separator) AddCSSClass(cssClass string) {
...
func (w separator) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w separator) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w separator) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w separator) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w separator) Contains(x float64, y float64) bool {
...
func (w separator) GetCanTarget() bool {
...
func (w separator) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w separator) GetFocusChild() Widget {
...
func (w separator) GetFocusable() bool {
...
func (w separator) GetHeight() int {
...
func (w separator) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w separator) GetLayoutManager() LayoutManager {
...
func (w separator) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w separator) GetNextSibling() Widget {
...
func (w separator) GetOverflow() Overflow {
...
func (w separator) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w separator) GetPrimaryClipboard() gdk.Clipboard {
...
func (w separator) GetSize(orientation Orientation) int {
...
func (w separator) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w separator) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w separator) HasCSSClass(cssClass string) bool {
...
func (w separator) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w separator) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w separator) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w separator) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w separator) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w separator) RemoveCSSClass(cssClass string) {
...
func (w separator) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w separator) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w separator) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w separator) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w separator) SetCursorFromName(name string) {
...
func (w separator) SetFocusChild(child Widget) {
...
func (w separator) SetFocusable(focusable bool) {
...
func (w separator) SetLayoutManager(layoutManager LayoutManager) {
...
func (w separator) SetOverflow(overflow Overflow) {
...
func (w separator) ShouldLayout() bool {
...
func (w separator) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s separator) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s separator) GetAccessibleRole() AccessibleRole {
...
func (b separator) GetBuildableID() string {
