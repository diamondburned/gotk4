...
func (s shortcutLabel) AsWidget() Widget {
...
func (w shortcutLabel) ActionSetEnabled(actionName string, enabled bool) {
...
func (w shortcutLabel) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w shortcutLabel) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w shortcutLabel) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w shortcutLabel) AddCSSClass(cssClass string) {
...
func (w shortcutLabel) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w shortcutLabel) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w shortcutLabel) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w shortcutLabel) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w shortcutLabel) Contains(x float64, y float64) bool {
...
func (w shortcutLabel) GetCanTarget() bool {
...
func (w shortcutLabel) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w shortcutLabel) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s shortcutLabel) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w shortcutLabel) GetCursor() gdk.Cursor {
...
func (w shortcutLabel) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w shortcutLabel) GetFocusChild() Widget {
...
func (w shortcutLabel) GetFocusable() bool {
...
func (w shortcutLabel) GetHeight() int {
...
func (w shortcutLabel) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w shortcutLabel) GetLayoutManager() LayoutManager {
...
func (w shortcutLabel) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w shortcutLabel) GetNextSibling() Widget {
...
func (w shortcutLabel) GetOverflow() Overflow {
...
func (w shortcutLabel) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w shortcutLabel) GetPrimaryClipboard() gdk.Clipboard {
...
func (w shortcutLabel) GetRoot() Root {
...
func (w shortcutLabel) GetSize(orientation Orientation) int {
...
func (w shortcutLabel) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w shortcutLabel) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w shortcutLabel) HasCSSClass(cssClass string) bool {
...
func (w shortcutLabel) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w shortcutLabel) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w shortcutLabel) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w shortcutLabel) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w shortcutLabel) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w shortcutLabel) RemoveCSSClass(cssClass string) {
...
func (w shortcutLabel) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w shortcutLabel) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w shortcutLabel) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w shortcutLabel) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w shortcutLabel) SetCursorFromName(name string) {
...
func (w shortcutLabel) SetFocusChild(child Widget) {
...
func (w shortcutLabel) SetFocusable(focusable bool) {
...
func (w shortcutLabel) SetLayoutManager(layoutManager LayoutManager) {
...
func (w shortcutLabel) SetOverflow(overflow Overflow) {
...
func (w shortcutLabel) ShouldLayout() bool {
...
func (w shortcutLabel) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s shortcutLabel) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s shortcutLabel) GetAccessibleRole() AccessibleRole {
...
func (b shortcutLabel) GetBuildableID() string {
