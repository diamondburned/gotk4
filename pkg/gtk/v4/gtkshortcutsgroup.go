...
func (b shortcutsGroup) Append(child Widget) {
...
func (b shortcutsGroup) InsertChildAfter(child Widget, sibling Widget) {
	WrapBox(gextras.InternObject(b)).InsertChildAfter(child, sibling)
}

func (b shortcutsGroup) Prepend(child Widget) {
	WrapBox(gextras.InternObject(b)).Prepend(child)
}

func (b shortcutsGroup) Remove(child Widget) {
	WrapBox(gextras.InternObject(b)).Remove(child)
}

func (b shortcutsGroup) ReorderChildAfter(child Widget, sibling Widget) {
...
func (w shortcutsGroup) ActionSetEnabled(actionName string, enabled bool) {
...
func (w shortcutsGroup) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w shortcutsGroup) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w shortcutsGroup) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w shortcutsGroup) AddCSSClass(cssClass string) {
...
func (w shortcutsGroup) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w shortcutsGroup) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w shortcutsGroup) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w shortcutsGroup) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w shortcutsGroup) Contains(x float64, y float64) bool {
...
func (w shortcutsGroup) GetCanTarget() bool {
...
func (w shortcutsGroup) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w shortcutsGroup) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s shortcutsGroup) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w shortcutsGroup) GetCursor() gdk.Cursor {
...
func (w shortcutsGroup) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w shortcutsGroup) GetFocusChild() Widget {
...
func (w shortcutsGroup) GetFocusable() bool {
...
func (w shortcutsGroup) GetHeight() int {
...
func (w shortcutsGroup) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w shortcutsGroup) GetLayoutManager() LayoutManager {
...
func (w shortcutsGroup) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w shortcutsGroup) GetNextSibling() Widget {
...
func (w shortcutsGroup) GetOverflow() Overflow {
...
func (w shortcutsGroup) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w shortcutsGroup) GetPrimaryClipboard() gdk.Clipboard {
...
func (w shortcutsGroup) GetRoot() Root {
...
func (w shortcutsGroup) GetSize(orientation Orientation) int {
...
func (w shortcutsGroup) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w shortcutsGroup) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w shortcutsGroup) HasCSSClass(cssClass string) bool {
...
func (w shortcutsGroup) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w shortcutsGroup) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w shortcutsGroup) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w shortcutsGroup) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w shortcutsGroup) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w shortcutsGroup) RemoveCSSClass(cssClass string) {
...
func (w shortcutsGroup) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w shortcutsGroup) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w shortcutsGroup) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w shortcutsGroup) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w shortcutsGroup) SetCursorFromName(name string) {
...
func (w shortcutsGroup) SetFocusChild(child Widget) {
...
func (w shortcutsGroup) SetFocusable(focusable bool) {
...
func (w shortcutsGroup) SetLayoutManager(layoutManager LayoutManager) {
...
func (w shortcutsGroup) SetOverflow(overflow Overflow) {
...
func (w shortcutsGroup) ShouldLayout() bool {
...
func (w shortcutsGroup) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s shortcutsGroup) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s shortcutsGroup) GetAccessibleRole() AccessibleRole {
...
func (b shortcutsGroup) GetBuildableID() string {
