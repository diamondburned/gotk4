...
func (b shortcutsSection) Append(child Widget) {
	WrapBox(gextras.InternObject(b)).Append(child)
}
...
func (b shortcutsSection) InsertChildAfter(child Widget, sibling Widget) {
	WrapBox(gextras.InternObject(b)).InsertChildAfter(child, sibling)
}

func (b shortcutsSection) Prepend(child Widget) {
	WrapBox(gextras.InternObject(b)).Prepend(child)
}

func (b shortcutsSection) Remove(child Widget) {
	WrapBox(gextras.InternObject(b)).Remove(child)
}

func (b shortcutsSection) ReorderChildAfter(child Widget, sibling Widget) {
	WrapBox(gextras.InternObject(b)).ReorderChildAfter(child, sibling)
}
...
func (w shortcutsSection) ActionSetEnabled(actionName string, enabled bool) {
...
func (w shortcutsSection) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w shortcutsSection) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w shortcutsSection) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w shortcutsSection) AddCSSClass(cssClass string) {
...
func (w shortcutsSection) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w shortcutsSection) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w shortcutsSection) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w shortcutsSection) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w shortcutsSection) Contains(x float64, y float64) bool {
...
func (w shortcutsSection) GetCanTarget() bool {
...
func (w shortcutsSection) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w shortcutsSection) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s shortcutsSection) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w shortcutsSection) GetCursor() gdk.Cursor {
...
func (w shortcutsSection) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w shortcutsSection) GetFocusChild() Widget {
...
func (w shortcutsSection) GetFocusable() bool {
...
func (w shortcutsSection) GetHeight() int {
...
func (w shortcutsSection) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w shortcutsSection) GetLayoutManager() LayoutManager {
...
func (w shortcutsSection) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w shortcutsSection) GetNextSibling() Widget {
...
func (w shortcutsSection) GetOverflow() Overflow {
...
func (w shortcutsSection) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w shortcutsSection) GetPrimaryClipboard() gdk.Clipboard {
...
func (w shortcutsSection) GetRoot() Root {
...
func (w shortcutsSection) GetSize(orientation Orientation) int {
...
func (w shortcutsSection) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w shortcutsSection) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w shortcutsSection) HasCSSClass(cssClass string) bool {
...
func (w shortcutsSection) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w shortcutsSection) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w shortcutsSection) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w shortcutsSection) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w shortcutsSection) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w shortcutsSection) RemoveCSSClass(cssClass string) {
...
func (w shortcutsSection) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w shortcutsSection) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w shortcutsSection) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w shortcutsSection) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w shortcutsSection) SetCursorFromName(name string) {
...
func (w shortcutsSection) SetFocusChild(child Widget) {
...
func (w shortcutsSection) SetFocusable(focusable bool) {
...
func (w shortcutsSection) SetLayoutManager(layoutManager LayoutManager) {
...
func (w shortcutsSection) SetOverflow(overflow Overflow) {
...
func (w shortcutsSection) ShouldLayout() bool {
...
func (w shortcutsSection) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s shortcutsSection) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s shortcutsSection) GetAccessibleRole() AccessibleRole {
...
func (b shortcutsSection) GetBuildableID() string {
