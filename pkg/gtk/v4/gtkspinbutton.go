...
func (s spinButton) AsWidget() Widget {
...
func (w spinButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w spinButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w spinButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w spinButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w spinButton) AddCSSClass(cssClass string) {
...
func (w spinButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w spinButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w spinButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w spinButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w spinButton) Contains(x float64, y float64) bool {
...
func (w spinButton) GetCanTarget() bool {
...
func (w spinButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w spinButton) GetFocusChild() Widget {
...
func (w spinButton) GetFocusable() bool {
...
func (w spinButton) GetHeight() int {
...
func (w spinButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w spinButton) GetLayoutManager() LayoutManager {
...
func (w spinButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w spinButton) GetNextSibling() Widget {
...
func (w spinButton) GetOverflow() Overflow {
...
func (w spinButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w spinButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w spinButton) GetRoot() Root {
...
func (w spinButton) GetSize(orientation Orientation) int {
...
func (w spinButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w spinButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w spinButton) HasCSSClass(cssClass string) bool {
...
func (w spinButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w spinButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w spinButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w spinButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w spinButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w spinButton) RemoveCSSClass(cssClass string) {
...
func (w spinButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w spinButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w spinButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w spinButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w spinButton) SetCursorFromName(name string) {
...
func (w spinButton) SetFocusChild(child Widget) {
...
func (w spinButton) SetFocusable(focusable bool) {
...
func (w spinButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w spinButton) SetOverflow(overflow Overflow) {
...
func (w spinButton) ShouldLayout() bool {
...
func (w spinButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s spinButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s spinButton) GetAccessibleRole() AccessibleRole {
...
func (b spinButton) GetBuildableID() string {
...
func (e spinButton) GetDelegate() Editable {
...
func (e spinButton) GetEnableUndo() bool {
