...
func (w spinner) ActionSetEnabled(actionName string, enabled bool) {
...
func (w spinner) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w spinner) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w spinner) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w spinner) AddCSSClass(cssClass string) {
...
func (w spinner) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w spinner) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w spinner) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w spinner) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w spinner) Contains(x float64, y float64) bool {
...
func (w spinner) GetCanTarget() bool {
...
func (w spinner) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w spinner) GetFocusChild() Widget {
...
func (w spinner) GetFocusable() bool {
...
func (w spinner) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w spinner) GetLayoutManager() LayoutManager {
...
func (w spinner) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w spinner) GetNextSibling() Widget {
...
func (w spinner) GetOverflow() Overflow {
...
func (w spinner) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w spinner) GetPrimaryClipboard() gdk.Clipboard {
...
func (w spinner) GetSize(orientation Orientation) int {
...
func (w spinner) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w spinner) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w spinner) HasCSSClass(cssClass string) bool {
...
func (w spinner) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w spinner) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w spinner) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w spinner) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w spinner) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w spinner) RemoveCSSClass(cssClass string) {
...
func (w spinner) SetFocusChild(child Widget) {
...
func (w spinner) SetFocusable(focusable bool) {
...
func (w spinner) SetLayoutManager(layoutManager LayoutManager) {
...
func (w spinner) SetOverflow(overflow Overflow) {
...
func (w spinner) ShouldLayout() bool {
...
func (w spinner) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s spinner) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s spinner) GetAccessibleRole() AccessibleRole {
...
func (b spinner) GetBuildableID() string {
