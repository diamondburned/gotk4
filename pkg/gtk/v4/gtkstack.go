...
func (w stack) ActionSetEnabled(actionName string, enabled bool) {
...
func (w stack) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w stack) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w stack) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w stack) AddCSSClass(cssClass string) {
...
func (w stack) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w stack) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w stack) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w stack) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w stack) Contains(x float64, y float64) bool {
...
func (w stack) GetCanTarget() bool {
...
func (w stack) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w stack) GetFocusChild() Widget {
...
func (w stack) GetFocusable() bool {
...
func (w stack) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w stack) GetLayoutManager() LayoutManager {
...
func (w stack) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w stack) GetNextSibling() Widget {
...
func (w stack) GetOverflow() Overflow {
...
func (w stack) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w stack) GetPrimaryClipboard() gdk.Clipboard {
...
func (w stack) GetSize(orientation Orientation) int {
...
func (w stack) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w stack) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w stack) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w stack) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w stack) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w stack) RemoveCSSClass(cssClass string) {
...
func (w stack) SetFocusChild(child Widget) {
...
func (w stack) SetFocusable(focusable bool) {
...
func (w stack) SetLayoutManager(layoutManager LayoutManager) {
...
func (w stack) SetOverflow(overflow Overflow) {
...
func (w stack) ShouldLayout() bool {
...
func (w stack) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s stack) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s stack) GetAccessibleRole() AccessibleRole {
...
func (b stack) GetBuildableID() string {
...
// WrapStackPage wraps a GObject to a type that implements
// interface StackPage. It is primarily used internally.
func WrapStackPage(obj *externglib.Object) StackPage {
	return stackPage{obj}
}
...
func (s stackPage) GetAccessibleRole() AccessibleRole {
	return WrapAccessible(gextras.InternObject(s)).GetAccessibleRole()
}
