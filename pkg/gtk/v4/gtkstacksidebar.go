...
func (s stackSidebar) AsWidget() Widget {
...
func (w stackSidebar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w stackSidebar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w stackSidebar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w stackSidebar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w stackSidebar) AddCSSClass(cssClass string) {
...
func (w stackSidebar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w stackSidebar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w stackSidebar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w stackSidebar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w stackSidebar) Contains(x float64, y float64) bool {
...
func (w stackSidebar) GetCanTarget() bool {
...
func (w stackSidebar) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w stackSidebar) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s stackSidebar) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w stackSidebar) GetCursor() gdk.Cursor {
...
func (w stackSidebar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w stackSidebar) GetFocusChild() Widget {
...
func (w stackSidebar) GetFocusable() bool {
...
func (w stackSidebar) GetHeight() int {
...
func (w stackSidebar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w stackSidebar) GetLayoutManager() LayoutManager {
...
func (w stackSidebar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w stackSidebar) GetNextSibling() Widget {
...
func (w stackSidebar) GetOverflow() Overflow {
...
func (w stackSidebar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w stackSidebar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w stackSidebar) GetRoot() Root {
...
func (w stackSidebar) GetSize(orientation Orientation) int {
...
func (w stackSidebar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w stackSidebar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w stackSidebar) HasCSSClass(cssClass string) bool {
...
func (w stackSidebar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w stackSidebar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w stackSidebar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w stackSidebar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w stackSidebar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w stackSidebar) RemoveCSSClass(cssClass string) {
...
func (w stackSidebar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w stackSidebar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w stackSidebar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w stackSidebar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w stackSidebar) SetCursorFromName(name string) {
...
func (w stackSidebar) SetFocusChild(child Widget) {
...
func (w stackSidebar) SetFocusable(focusable bool) {
...
func (w stackSidebar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w stackSidebar) SetOverflow(overflow Overflow) {
...
func (w stackSidebar) ShouldLayout() bool {
...
func (w stackSidebar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s stackSidebar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s stackSidebar) GetAccessibleRole() AccessibleRole {
...
func (b stackSidebar) GetBuildableID() string {
