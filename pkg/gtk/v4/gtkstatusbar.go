...
func (s statusbar) AsWidget() Widget {
...
func (w statusbar) ActionSetEnabled(actionName string, enabled bool) {
...
func (w statusbar) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w statusbar) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w statusbar) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w statusbar) AddCSSClass(cssClass string) {
...
func (w statusbar) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w statusbar) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w statusbar) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w statusbar) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w statusbar) Contains(x float64, y float64) bool {
...
func (w statusbar) GetCanTarget() bool {
...
func (w statusbar) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w statusbar) GetFocusChild() Widget {
...
func (w statusbar) GetFocusable() bool {
...
func (w statusbar) GetHeight() int {
...
func (w statusbar) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w statusbar) GetLayoutManager() LayoutManager {
...
func (w statusbar) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w statusbar) GetNextSibling() Widget {
...
func (w statusbar) GetOverflow() Overflow {
...
func (w statusbar) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w statusbar) GetPrimaryClipboard() gdk.Clipboard {
...
func (w statusbar) GetSize(orientation Orientation) int {
...
func (w statusbar) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w statusbar) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w statusbar) HasCSSClass(cssClass string) bool {
...
func (w statusbar) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w statusbar) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w statusbar) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w statusbar) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w statusbar) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w statusbar) RemoveCSSClass(cssClass string) {
...
func (w statusbar) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w statusbar) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w statusbar) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w statusbar) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w statusbar) SetCursorFromName(name string) {
...
func (w statusbar) SetFocusChild(child Widget) {
...
func (w statusbar) SetFocusable(focusable bool) {
...
func (w statusbar) SetLayoutManager(layoutManager LayoutManager) {
...
func (w statusbar) SetOverflow(overflow Overflow) {
...
func (w statusbar) ShouldLayout() bool {
...
func (w statusbar) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s statusbar) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s statusbar) GetAccessibleRole() AccessibleRole {
...
func (b statusbar) GetBuildableID() string {
