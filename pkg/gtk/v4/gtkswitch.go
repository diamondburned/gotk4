...
func (w _switch) ActionSetEnabled(actionName string, enabled bool) {
...
func (w _switch) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w _switch) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w _switch) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w _switch) AddCSSClass(cssClass string) {
...
func (w _switch) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w _switch) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w _switch) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w _switch) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w _switch) Contains(x float64, y float64) bool {
...
func (w _switch) GetCanTarget() bool {
...
func (w _switch) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w _switch) GetFocusChild() Widget {
...
func (w _switch) GetFocusable() bool {
...
func (w _switch) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w _switch) GetLayoutManager() LayoutManager {
...
func (w _switch) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w _switch) GetNextSibling() Widget {
...
func (w _switch) GetOverflow() Overflow {
...
func (w _switch) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w _switch) GetPrimaryClipboard() gdk.Clipboard {
...
func (w _switch) GetSize(orientation Orientation) int {
...
func (w _switch) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w _switch) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w _switch) HasCSSClass(cssClass string) bool {
...
func (w _switch) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w _switch) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w _switch) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w _switch) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w _switch) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w _switch) RemoveCSSClass(cssClass string) {
...
func (w _switch) SetFocusChild(child Widget) {
...
func (w _switch) SetFocusable(focusable bool) {
...
func (w _switch) SetLayoutManager(layoutManager LayoutManager) {
...
func (w _switch) SetOverflow(overflow Overflow) {
...
func (w _switch) ShouldLayout() bool {
...
func (w _switch) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s _switch) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s _switch) GetAccessibleRole() AccessibleRole {
...
func (b _switch) GetBuildableID() string {
