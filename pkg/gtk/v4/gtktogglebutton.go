...
type ToggleButton interface {
	...
	// This method is inherited from Button
	GetHasFrame() bool
	// GetIconName returns the icon name of the button.
	//
	...
	// This method is inherited from Button
	GetIconName() string
	// GetLabel fetches the text from the label of the button.
	//
	...
	// This method is inherited from Button
	GetLabel() string
	// GetUseUnderline gets whether underlines are interpreted as mnemonics.
	//
...
func (b toggleButton) GetChild() Widget {
	return WrapButton(gextras.InternObject(b)).GetChild()
}

func (b toggleButton) GetHasFrame() bool {
	return WrapButton(gextras.InternObject(b)).GetHasFrame()
}

func (b toggleButton) GetIconName() string {
	return WrapButton(gextras.InternObject(b)).GetIconName()
}
...
func (b toggleButton) SetChild(child Widget) {
	WrapButton(gextras.InternObject(b)).SetChild(child)
}

func (b toggleButton) SetHasFrame(hasFrame bool) {
	WrapButton(gextras.InternObject(b)).SetHasFrame(hasFrame)
}

func (b toggleButton) SetIconName(iconName string) {
	WrapButton(gextras.InternObject(b)).SetIconName(iconName)
}
...
func (w toggleButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w toggleButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w toggleButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w toggleButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w toggleButton) AddCSSClass(cssClass string) {
...
func (w toggleButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w toggleButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w toggleButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w toggleButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w toggleButton) Contains(x float64, y float64) bool {
...
func (w toggleButton) GetCanTarget() bool {
...
func (w toggleButton) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w toggleButton) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s toggleButton) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w toggleButton) GetCursor() gdk.Cursor {
...
func (w toggleButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w toggleButton) GetFocusChild() Widget {
...
func (w toggleButton) GetFocusable() bool {
...
func (w toggleButton) GetHeight() int {
...
func (w toggleButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w toggleButton) GetLayoutManager() LayoutManager {
...
func (w toggleButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w toggleButton) GetNextSibling() Widget {
...
func (w toggleButton) GetOverflow() Overflow {
...
func (w toggleButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w toggleButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w toggleButton) GetRoot() Root {
...
func (w toggleButton) GetSize(orientation Orientation) int {
...
func (w toggleButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w toggleButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w toggleButton) HasCSSClass(cssClass string) bool {
...
func (w toggleButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w toggleButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w toggleButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w toggleButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w toggleButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w toggleButton) RemoveCSSClass(cssClass string) {
...
func (w toggleButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w toggleButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w toggleButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w toggleButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w toggleButton) SetCursorFromName(name string) {
...
func (w toggleButton) SetFocusChild(child Widget) {
...
func (w toggleButton) SetFocusable(focusable bool) {
...
func (w toggleButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w toggleButton) SetOverflow(overflow Overflow) {
...
func (w toggleButton) ShouldLayout() bool {
...
func (w toggleButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s toggleButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s toggleButton) GetAccessibleRole() AccessibleRole {
...
func (b toggleButton) GetBuildableID() string {
