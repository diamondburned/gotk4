...
func ifaceInitTreeDragDester(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("drag_data_received"))) = unsafe.Pointer(C._gotk4_gtk4_TreeDragDestIface_drag_data_received)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_drop_possible"))) = unsafe.Pointer(C._gotk4_gtk4_TreeDragDestIface_row_drop_possible)
}
...
func ifaceInitTreeDragSourcer(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("drag_data_delete"))) = unsafe.Pointer(C._gotk4_gtk4_TreeDragSourceIface_drag_data_delete)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("drag_data_get"))) = unsafe.Pointer(C._gotk4_gtk4_TreeDragSourceIface_drag_data_get)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_draggable"))) = unsafe.Pointer(C._gotk4_gtk4_TreeDragSourceIface_row_draggable)
}
