...
// WrapTreeExpander wraps a GObject to a type that implements
// interface TreeExpander. It is primarily used internally.
func WrapTreeExpander(obj *externglib.Object) TreeExpander {
	return treeExpander{obj}
}
...
func (t treeExpander) AsWidget() Widget {
...
func (b treeExpander) GetBuildableID() string {
