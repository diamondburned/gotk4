...
func ifaceInitTreeModeller(gifacePtr, data C.gpointer) {
	...
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_iter"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_get_iter)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_n_columns"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_get_n_columns)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_path"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_get_path)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("get_value"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_get_value)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_children"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_children)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_has_child"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_has_child)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_n_children"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_n_children)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_next"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_next)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_nth_child"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_nth_child)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_parent"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_parent)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("iter_previous"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_iter_previous)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("ref_node"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_ref_node)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_changed"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_row_changed)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_deleted"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_row_deleted)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_has_child_toggled"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_row_has_child_toggled)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("row_inserted"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_row_inserted)
	*(*unsafe.Pointer)(unsafe.Add(unsafe.Pointer(gifacePtr), pclass.StructFieldOffset("unref_node"))) = unsafe.Pointer(C._gotk4_gtk4_TreeModelIface_unref_node)
}
...
func (treeModel *TreeModel) RowsReordered(path *TreePath, iter *TreeIter, newOrder []int32) {
	...
	*(**C.void)(unsafe.Pointer(&_args[3])) = (*C.void)(C.calloc(C.size_t(len(newOrder)), C.size_t(C.sizeof_int)))
	defer C.free(unsafe.Pointer(_args[3]))
	{
		out := unsafe.Slice((*C.int)(*(**C.void)(unsafe.Pointer(&_args[3]))), len(newOrder))
...
func NewTreePathFromIndices(indices []int32) *TreePath {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(C.calloc(C.size_t(len(indices)), C.size_t(C.sizeof_int)))
	defer C.free(unsafe.Pointer(_args[0]))
	{
		out := unsafe.Slice((*C.int)(*(**C.void)(unsafe.Pointer(&_args[0]))), len(indices))
		for i := range indices {
...
func (path *TreePath) Indices() []int32 {
	...
	*(**C.void)(unsafe.Pointer(&_args[0])) = (*C.void)(gextras.StructNative(unsafe.Pointer(path)))
	...
	{
		src := unsafe.Slice((*C.int)(_cret), _outs[0])
