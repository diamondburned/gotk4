...
func (s *Bitset) Add(value uint) bool {
	...
	arg0 = (*C.GtkBitset)(s.Native())
	arg1 = C.guint(value)

	ret := C.gtk_bitset_add(arg0, arg1)
...
func (s *Bitset) Contains(value uint) bool {
	...
	ret := C.gtk_bitset_contains(arg0, arg1)
...
func (s *Bitset) Equals(other *Bitset) bool {
	...
	ret := C.gtk_bitset_equals(arg0, arg1)
...
func (s *Bitset) Maximum() uint {
	...
	ret := C.gtk_bitset_get_maximum(arg0)
...
func (s *Bitset) Minimum() uint {
	...
	ret := C.gtk_bitset_get_minimum(arg0)
...
func (s *Bitset) Nth(nth uint) uint {
	...
	ret := C.gtk_bitset_get_nth(arg0, arg1)
...
func (s *Bitset) Size() uint64 {
	...
	ret := C.gtk_bitset_get_size(arg0)
...
func (s *Bitset) SizeInRange(first uint, last uint) uint64 {
	...
	ret := C.gtk_bitset_get_size_in_range(arg0, arg1, arg2)
...
func (s *Bitset) IsEmpty() bool {
	...
	ret := C.gtk_bitset_is_empty(arg0)
...
func (s *Bitset) Remove(value uint) bool {
	...
	ret := C.gtk_bitset_remove(arg0, arg1)
