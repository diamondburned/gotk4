...
func (v viewport) AsWidget() Widget {
	return WrapWidget(gextras.InternObject(v))
}
...
func (w viewport) ActionSetEnabled(actionName string, enabled bool) {
...
func (w viewport) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w viewport) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w viewport) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w viewport) AddCSSClass(cssClass string) {
...
func (w viewport) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w viewport) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w viewport) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w viewport) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w viewport) Contains(x float64, y float64) bool {
...
func (w viewport) GetCanTarget() bool {
...
func (w viewport) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w viewport) GetFocusChild() Widget {
...
func (w viewport) GetFocusable() bool {
...
func (w viewport) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w viewport) GetLayoutManager() LayoutManager {
...
func (w viewport) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w viewport) GetNextSibling() Widget {
...
func (w viewport) GetOverflow() Overflow {
...
func (w viewport) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w viewport) GetPrimaryClipboard() gdk.Clipboard {
...
func (w viewport) GetSize(orientation Orientation) int {
...
func (w viewport) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w viewport) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w viewport) HasCSSClass(cssClass string) bool {
...
func (w viewport) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w viewport) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w viewport) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w viewport) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w viewport) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w viewport) RemoveCSSClass(cssClass string) {
...
func (w viewport) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w viewport) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w viewport) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w viewport) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w viewport) SetCursorFromName(name string) {
...
func (w viewport) SetFocusChild(child Widget) {
...
func (w viewport) SetFocusable(focusable bool) {
...
func (w viewport) SetLayoutManager(layoutManager LayoutManager) {
...
func (w viewport) SetOverflow(overflow Overflow) {
...
func (w viewport) ShouldLayout() bool {
...
func (w viewport) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s viewport) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s viewport) GetAccessibleRole() AccessibleRole {
...
func (b viewport) GetBuildableID() string {
