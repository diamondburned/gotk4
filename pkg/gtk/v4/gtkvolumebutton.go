...
type VolumeButton interface {
	...
	// GetAdjustment gets the `GtkAdjustment` associated with the
	...
	// GetMinusButton retrieves the minus button of the `GtkScaleButton`.
	//
	// This method is inherited from ScaleButton
	GetMinusButton() Button
	// GetPlusButton retrieves the plus button of the `GtkScaleButton.`
	//
	// This method is inherited from ScaleButton
	GetPlusButton() Button
	// GetPopup retrieves the popup of the `GtkScaleButton`.
	//
	// This method is inherited from ScaleButton
	GetPopup() Widget
...
func (w volumeButton) ActionSetEnabled(actionName string, enabled bool) {
...
func (w volumeButton) ActivateActionVariant(name string, args *glib.Variant) bool {
	return WrapWidget(gextras.InternObject(w)).ActivateActionVariant(name, args)
}

func (w volumeButton) ActivateDefault() {
	WrapWidget(gextras.InternObject(w)).ActivateDefault()
}

func (w volumeButton) AddController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).AddController(controller)
}

func (w volumeButton) AddCSSClass(cssClass string) {
...
func (w volumeButton) Allocate(width int, height int, baseline int, transform *gsk.Transform) {
...
func (w volumeButton) ComputeBounds(target Widget) (graphene.Rect, bool) {
...
func (w volumeButton) ComputePoint(target Widget, point *graphene.Point) (graphene.Point, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputePoint(target, point)
}

func (w volumeButton) ComputeTransform(target Widget) (graphene.Matrix, bool) {
	return WrapWidget(gextras.InternObject(w)).ComputeTransform(target)
}

func (w volumeButton) Contains(x float64, y float64) bool {
...
func (w volumeButton) GetCanTarget() bool {
...
func (w volumeButton) GetClipboard() gdk.Clipboard {
	return WrapWidget(gextras.InternObject(w)).GetClipboard()
}

func (w volumeButton) GetCSSClasses() []string {
	return WrapWidget(gextras.InternObject(w)).GetCSSClasses()
}

func (s volumeButton) GetCSSName() string {
	return WrapWidget(gextras.InternObject(s)).GetCSSName()
}

func (w volumeButton) GetCursor() gdk.Cursor {
...
func (w volumeButton) GetFirstChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetFirstChild()
}

func (w volumeButton) GetFocusChild() Widget {
...
func (w volumeButton) GetFocusable() bool {
...
func (w volumeButton) GetHeight() int {
...
func (w volumeButton) GetLastChild() Widget {
	return WrapWidget(gextras.InternObject(w)).GetLastChild()
}

func (w volumeButton) GetLayoutManager() LayoutManager {
...
func (w volumeButton) GetNative() Native {
	return WrapWidget(gextras.InternObject(w)).GetNative()
}

func (w volumeButton) GetNextSibling() Widget {
...
func (w volumeButton) GetOverflow() Overflow {
...
func (w volumeButton) GetPrevSibling() Widget {
	return WrapWidget(gextras.InternObject(w)).GetPrevSibling()
}

func (w volumeButton) GetPrimaryClipboard() gdk.Clipboard {
...
func (w volumeButton) GetRoot() Root {
...
func (w volumeButton) GetSize(orientation Orientation) int {
...
func (w volumeButton) GetWidth() int {
	return WrapWidget(gextras.InternObject(w)).GetWidth()
}

func (w volumeButton) GrabFocus() bool {
	return WrapWidget(gextras.InternObject(w)).GrabFocus()
}

func (w volumeButton) HasCSSClass(cssClass string) bool {
...
func (w volumeButton) InsertAfter(parent Widget, previousSibling Widget) {
	WrapWidget(gextras.InternObject(w)).InsertAfter(parent, previousSibling)
}

func (w volumeButton) InsertBefore(parent Widget, nextSibling Widget) {
...
func (w volumeButton) Measure(orientation Orientation, forSize int) (minimum int, natural int, minimumBaseline int, naturalBaseline int) {
...
func (w volumeButton) Pick(x float64, y float64, flags PickFlags) Widget {
...
func (w volumeButton) RemoveController(controller EventController) {
	WrapWidget(gextras.InternObject(w)).RemoveController(controller)
}

func (w volumeButton) RemoveCSSClass(cssClass string) {
...
func (w volumeButton) SetCanTarget(canTarget bool) {
	WrapWidget(gextras.InternObject(w)).SetCanTarget(canTarget)
}

func (w volumeButton) SetChildVisible(childVisible bool) {
	WrapWidget(gextras.InternObject(w)).SetChildVisible(childVisible)
}

func (w volumeButton) SetCSSClasses(classes []string) {
	WrapWidget(gextras.InternObject(w)).SetCSSClasses(classes)
}

func (w volumeButton) SetCursor(cursor gdk.Cursor) {
	WrapWidget(gextras.InternObject(w)).SetCursor(cursor)
}

func (w volumeButton) SetCursorFromName(name string) {
...
func (w volumeButton) SetFocusChild(child Widget) {
...
func (w volumeButton) SetFocusable(focusable bool) {
...
func (w volumeButton) SetLayoutManager(layoutManager LayoutManager) {
...
func (w volumeButton) SetOverflow(overflow Overflow) {
...
func (w volumeButton) ShouldLayout() bool {
...
func (w volumeButton) SnapshotChild(child Widget, snapshot Snapshot) {
	WrapWidget(gextras.InternObject(w)).SnapshotChild(child, snapshot)
}

func (s volumeButton) TranslateCoordinates(destWidget Widget, srcX float64, srcY float64) (destX float64, destY float64, ok bool) {
...
func (s volumeButton) GetAccessibleRole() AccessibleRole {
...
func (b volumeButton) GetBuildableID() string {
