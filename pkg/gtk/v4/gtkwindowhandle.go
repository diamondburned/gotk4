...
// WrapWindowHandle wraps a GObject to a type that implements
// interface WindowHandle. It is primarily used internally.
func WrapWindowHandle(obj *externglib.Object) WindowHandle {
	return windowHandle{obj}
}
...
func (w windowHandle) AsWidget() Widget {
...
func (b windowHandle) GetBuildableID() string {
