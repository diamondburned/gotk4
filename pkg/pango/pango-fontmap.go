...
type FontMapOverrider interface {
	...
	Family(name string) *FontFamilyClass
	...
	// @desc.
	LoadFont(context Context, desc *FontDescription) *FontClass
	// LoadFontset: load a set of fonts in the fontmap that can be used to
	// render a font matching @desc.
	LoadFontset(context Context, desc *FontDescription, language *Language) *FontsetClass
}
...
func (fontmap *FontMapClass) Changed() {
...
func (fontmap *FontMapClass) CreateContext() *ContextClass {
	var _arg0 *C.PangoFontMap // out
...
// Family gets a font family by name.
func (fontmap *FontMapClass) Family(name string) *FontFamilyClass {
	var _arg0 *C.PangoFontMap    // out
...
// `PangoContext`.
func (fontmap *FontMapClass) Serial() uint {
	var _arg0 *C.PangoFontMap // out
...
// ListFamilies: list all families for a fontmap.
func (fontmap *FontMapClass) ListFamilies() []*FontFamilyClass {
	var _arg0 *C.PangoFontMap // out
...
func (fontmap *FontMapClass) LoadFont(context Context, desc *FontDescription) *FontClass {
	var _arg0 *C.PangoFontMap         // out
...
// font matching @desc.
func (fontmap *FontMapClass) LoadFontset(context Context, desc *FontDescription, language *Language) *FontsetClass {
	var _arg0 *C.PangoFontMap         // out
	var _arg1 *C.PangoContext         // out
	var _arg2 *C.PangoFontDescription // out
