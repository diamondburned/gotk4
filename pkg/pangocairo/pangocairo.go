...
// surface by [func@update_context].
	func ContextGetFontOptions(context pango.ContextClass) *cairo.FontOptions {
...
// [func@PangoCairo.context_set_resolution]
	func ContextGetResolution(context pango.ContextClass) float64 {
var _arg1 *C.PangoContext // out
...
// the target surface.
	func ContextSetFontOptions(context pango.ContextClass, options *cairo.FontOptions)  {
var _arg1 *C.PangoContext // out
...
// be 13 units high. (10 * 96. / 72. = 13.3).
	func ContextSetResolution(context pango.ContextClass, dpi float64)  {
var _arg1 *C.PangoContext // out
...
// current point of the cairo context.
	func GlyphStringPath(cr *cairo.Context, font pango.FontClass, glyphs *pango.GlyphString)  {
var _arg1 *C.cairo_t // out
...
// cairo context.
	func LayoutPath(cr *cairo.Context, layout pango.LayoutClass)  {
var _arg1 *C.cairo_t // out
...
// The origin of the glyphs (the left edge of the baseline) will be drawn at the
// current point of the cairo context.
	func ShowGlyphString(cr *cairo.Context, font pango.FontClass, glyphs *pango.GlyphString)  {
var _arg1 *C.cairo_t // out
var _arg2 *C.PangoFont // out
var _arg3 *C.PangoGlyphString // out
...
// of the cairo context.
	func ShowLayout(cr *cairo.Context, layout pango.LayoutClass)  {
var _arg1 *C.cairo_t // out
var _arg2 *C.PangoLayout // out
...
// [method@Pango.Layout.context_changed] on those layouts.
	func UpdateContext(cr *cairo.Context, context pango.ContextClass)  {
var _arg1 *C.cairo_t // out
...
// surface of a Cairo context.
	func UpdateLayout(cr *cairo.Context, layout pango.LayoutClass)  {
var _arg1 *C.cairo_t // out
var _arg2 *C.PangoLayout // out
...
} map[github.com/diamondburned/gotk4/pkg/pango:pango github.com/gotk3/gotk3/glib:externglib]}, nil
	}
